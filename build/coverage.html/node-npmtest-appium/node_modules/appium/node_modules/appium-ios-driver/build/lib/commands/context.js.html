...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-ios-driver/build/lib/commands/context.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-ios-driver/build/lib/commands/context.js</span></h1>
    <h2>
        
        Statements: <span class="metric">6.58% <small>(51 / 775)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">6.77% <small>(51 / 753)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-ios-driver/build/lib/commands/</a> &#187; context.js</div>
</div>
<div class="body">
...
1494
1495
1496</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
var commands = {},
    ...
    extensions = {};
&nbsp;
commands.getCurrentContext = <span class="fstat-no" title="function not covered" >function callee$0$0() {</span>
...
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        if (!(this.curContext &amp;&amp; this.curContext !== NATIVE_WIN)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 4;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', '' + WEBVIEW_BASE + this.curContext);</span>
&nbsp;
      case 4:
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', NATIVE_WIN);</span>
&nbsp;
      case 5:
      case 'end':
...
&nbsp;
commands.getContexts = <span class="fstat-no" title="function not covered" >function callee$0$0() {</span>
<span class="cstat-no" title="statement not covered" >  var contexts;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Getting list of available contexts');</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 3;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.getContextsAndViews(false));</span>
&nbsp;
      case 3:
<span class="cstat-no" title="statement not covered" >        contexts = context$1$0.sent;</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', contexts.map(<span class="fstat-no" title="function not covered" >function (context) {</span></span>
<span class="cstat-no" title="statement not covered" >          return context.id.toString();</span>
        }));
&nbsp;
      case 5:
      case 'end':
...
&nbsp;
commands.setContext = <span class="fstat-no" title="function not covered" >function callee$0$0(name, callback, skipReadyCheck) {</span>
<span class="cstat-no" title="statement not covered" >  var alreadyInContext, contextId, _$map, _$map2, appIdKey, pageIdKey;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        alreadyInContext = <span class="fstat-no" title="function not covered" >function alreadyInContext(desired, current) {</span></span>
<span class="cstat-no" title="statement not covered" >          return desired === current || desired === null &amp;&amp; current === NATIVE_WIN || desired === NATIVE_WIN &amp;&amp; current === null;</span>
        };
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Attempting to set context to \'' + name + '\'');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!alreadyInContext(name, this.curContext)) {</span>
...
&nbsp;
      case 5:
<span class="cstat-no" title="statement not covered" >        if (!(name === NATIVE_WIN || name === null)) {</span>
...
<span class="cstat-no" title="statement not covered" >          this.remote.disconnect();</span>
        }
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 33;</span>
<span class="cstat-no" title="statement not covered" >        break;</span>
&nbsp;
      case 10:
<span class="cstat-no" title="statement not covered" >        if (!_lodash2['default'].isUndefined(this.contexts)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 13;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 13;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.getContexts());</span>
&nbsp;
      case 13:
<span class="cstat-no" title="statement not covered" >        contextId = name.replace(WEBVIEW_BASE, '');</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >          contextId = this.contexts[1];</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (_lodash2['default'].includes(this.contexts, contextId)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 17;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        throw new _appiumBaseDriver.errors.NoSuchContextError();</span>
&nbsp;
      case 17:
<span class="cstat-no" title="statement not covered" >        if (!this.isRealDevice()) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 21;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.remote.disconnect());</span>
&nbsp;
      case 21:
<span class="cstat-no" title="statement not covered" >        this.curContext = contextId;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 24;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.remote.connect(contextId));</span>
&nbsp;
      case 24:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 33;</span>
<span class="cstat-no" title="statement not covered" >        break;</span>
&nbsp;
      case 26:
<span class="cstat-no" title="statement not covered" >        _$map = _lodash2['default'].map(contextId.split('.'), <span class="fstat-no" title="function not covered" >function (id) {</span></span>
<span class="cstat-no" title="statement not covered" >          return parseInt(id, 10);</span>
        });
<span class="cstat-no" title="statement not covered" >        _$map2 = _slicedToArray(_$map, 2);</span>
<span class="cstat-no" title="statement not covered" >        appIdKey = _$map2[0];</span>
<span class="cstat-no" title="statement not covered" >        pageIdKey = _$map2[1];</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 32;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.remote.selectPage(appIdKey, pageIdKey, skipReadyCheck));</span>
&nbsp;
      case 32:
<span class="cstat-no" title="statement not covered" >        this.curContext = contextId;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        if (this.perfLogEnabled &amp;&amp; this.remote) {</span>
<span class="cstat-no" title="statement not covered" >          _logger2['default'].debug('Starting performance log on \'' + this.curContext + '\'');</span>
<span class="cstat-no" title="statement not covered" >          this.logs.performance = new _deviceLogIosPerformanceLog.IOSPerformanceLog(this.remote);</span>
<span class="cstat-no" title="statement not covered" >          this.logs.performance.startCapture();</span>
        }
&nbsp;
      case 34:
      case 'end':
...
&nbsp;
commands.getWindowHandle = <span class="fstat-no" title="function not covered" >function callee$0$0() {</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
...
&nbsp;
      case 2:
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', this.curContext.toString());</span>
&nbsp;
      case 3:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
commands.getWindowHandles = <span class="fstat-no" title="function not covered" >function callee$0$0() {</span>
<span class="cstat-no" title="statement not covered" >  var pageArray, idArray;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        if (this.isWebContext()) {</span>
...
&nbsp;
      case 2:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 4;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.listWebFrames());</span>
&nbsp;
      case 4:
<span class="cstat-no" title="statement not covered" >        pageArray = context$1$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        this.windowHandleCache = _lodash2['default'].map(pageArray, this.massagePage);</span>
<span class="cstat-no" title="statement not covered" >        idArray = _lodash2['default'].map(this.windowHandleCache, 'id');</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >          this.contexts = idArray;</span>
        }
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', _lodash2['default'].map(idArray, <span class="fstat-no" title="function not covered" >function (id) {</span></span>
...
&nbsp;
commands.setWindow = <span class="fstat-no" title="function not covered" >function callee$0$0(name, skipReadyCheck) {</span>
<span class="cstat-no" title="statement not covered" >  var pageIdKey;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        if (this.isWebContext()) {</span>
...
&nbsp;
      case 2:
<span class="cstat-no" title="statement not covered" >        if (_lodash2['default'].includes(_lodash2['default'].map(this.windowHandleCache, 'id'), name)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 4;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        throw new _appiumBaseDriver.errors.NoSuchWindowError();</span>
&nbsp;
      case 4:
<span class="cstat-no" title="statement not covered" >        pageIdKey = parseInt(name, 10);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (this.isRealDevice()) {</span>
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.remote.selectPage(pageIdKey, skipReadyCheck));</span>
&nbsp;
      case 8:
<span class="cstat-no" title="statement not covered" >        this.curContext = this.curWindowHandle = name;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 24;</span>
<span class="cstat-no" title="statement not covered" >        break;</span>
&nbsp;
      case 11:
<span class="cstat-no" title="statement not covered" >        if (!(name === this.curWindowHandle)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 15;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Remote debugger is already connected to window \'' + name + '\'');</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 24;</span>
<span class="cstat-no" title="statement not covered" >        break;</span>
&nbsp;
      case 15:
...
<span class="cstat-no" title="statement not covered" >        this.curContext = this.curWindowHandle = name;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 24;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.remote.connect(name));</span>
&nbsp;
      case 24:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
helpers.webContextIndex = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >  return this.curContext.replace(WEBVIEW_BASE, '') - 1;</span>
};
&nbsp;
extensions.initAutoWebview = <span class="fstat-no" title="function not covered" >function callee$0$0() {</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Setting auto webview');</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 4;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.navToInitialWebview(this));</span>
&nbsp;
      case 4:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
extensions.getContextsAndViews = <span class="fstat-no" title="function not covered" >function callee$0$0() {</span>
<span class="cstat-no" title="statement not covered" >  var useUrl = arguments.length &lt;= 0 || arguments[0] === undefined ? true : arguments[0];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var webviews, ctxs, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, view;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Retrieving contexts and views');</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 3;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.listWebFrames(useUrl));</span>
&nbsp;
      case 3:
<span class="cstat-no" title="statement not covered" >        webviews = context$1$0.sent;</span>
<span class="cstat-no" title="statement not covered" >        ctxs = [{ id: NATIVE_WIN }];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        this.contexts = [NATIVE_WIN];</span>
...
<span class="cstat-no" title="statement not covered" >        for (_iterator = _getIterator(webviews); !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {</span>
<span class="cstat-no" title="statement not covered" >          view = _step.value;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          ctxs.push({ id: '' + WEBVIEW_BASE + view.id, view: view });</span>
<span class="cstat-no" title="statement not covered" >          this.contexts.push(view.id.toString());</span>
        }
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 17;</span>
<span class="cstat-no" title="statement not covered" >        break;</span>
&nbsp;
...
&nbsp;
      case 25:
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', ctxs);</span>
&nbsp;
      case 26:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
extensions.listWebFrames = <span class="fstat-no" title="function not covered" >function callee$0$0() {</span>
<span class="cstat-no" title="statement not covered" >  var useUrl = arguments.length &lt;= 0 || arguments[0] === undefined ? true : arguments[0];</span>
<span class="cstat-no" title="statement not covered" >  var currentUrl, pageArray, appInfo, tryClosingAlert;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
...
<span class="cstat-no" title="statement not covered" >          _logger2['default'].errorAndThrow('Cannot enter web frame without a bundle ID');</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        useUrl = useUrl &amp;&amp; !!this.getCurrentUrl();</span>
        /* jshint ignore:start */
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Selecting by url: ' + useUrl + ' ' + (useUrl ? '(expected url: \'' + this.getCurrentUrl() + '\')' : ''));</span>
        /* jshint ignore:end */
&nbsp;
<span class="cstat-no" title="statement not covered" >        currentUrl = useUrl ? this.getCurrentUrl() : undefined;</span>
<span class="cstat-no" title="statement not covered" >        pageArray = undefined;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!(this.isRealDevice() &amp;&amp; this.remote &amp;&amp; this.opts.bundleId)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 11;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 8;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.remote.pageArrayFromJson());</span>
&nbsp;
      case 8:
<span class="cstat-no" title="statement not covered" >        pageArray = context$1$0.sent;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 54;</span>
<span class="cstat-no" title="statement not covered" >        break;</span>
&nbsp;
      case 11:
<span class="cstat-no" title="statement not covered" >        if (!(this.remote &amp;&amp; this.remote.appIdKey)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 17;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 14;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.remote.selectApp(currentUrl, this.opts.webviewConnectRetries));</span>
&nbsp;
      case 14:
<span class="cstat-no" title="statement not covered" >        pageArray = context$1$0.sent;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 54;</span>
...
<span class="cstat-no" title="statement not covered" >        context$1$0.prev = 18;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        this.remote = new _appiumRemoteDebugger.WebKitRemoteDebugger({ port: this.opts.webkitDebugProxyPort });</span>
...
<span class="cstat-no" title="statement not covered" >        context$1$0.t0 = context$1$0['catch'](18);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (_lodash2['default'].includes(context$1$0.t0.message, 'connect ECONNREFUSED')) {</span>
...
&nbsp;
      case 29:
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].warn('Attempted to get a list of webview contexts but could not connect to ' + 'ios-webkit-debug-proxy. If you expect to find webviews, please ensure ' + 'that the proxy is running and accessible');</span>
<span class="cstat-no" title="statement not covered" >        this.remote = null;</span>
<span class="cstat-no" title="statement not covered" >        pageArray = [];</span>
&nbsp;
      case 32:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 54;</span>
<span class="cstat-no" title="statement not covered" >        break;</span>
...
<span class="cstat-no" title="statement not covered" >        this.remote = new _appiumRemoteDebugger.RemoteDebugger({</span>
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.remote.connect());</span>
&nbsp;
      case 37:
<span class="cstat-no" title="statement not covered" >        appInfo = context$1$0.sent;</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Unable to connect to the remote debugger.');</span>
...
<span class="cstat-no" title="statement not covered" >        pageArray = context$1$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        this.remote.on(_appiumRemoteDebugger.RemoteDebugger.EVENT_PAGE_CHANGE, this.onPageChange.bind(this));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        tryClosingAlert = <span class="fstat-no" title="function not covered" >function tryClosingAlert() {</span></span>
<span class="cstat-no" title="statement not covered" >          var didDismiss;</span>
<span class="cstat-no" title="statement not covered" >          return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function tryClosingAlert$(context$2$0) {</span></span>
...
<span class="cstat-no" title="statement not covered" >                return _regeneratorRuntime.awrap(this.closeAlertBeforeTest());</span>
&nbsp;
              case 2:
<span class="cstat-no" title="statement not covered" >                didDismiss = context$2$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (didDismiss) {</span>
<span class="cstat-no" title="statement not covered" >                  context$2$0.next = 5;</span>
<span class="cstat-no" title="statement not covered" >                  break;</span>
                }
&nbsp;
<span class="cstat-no" title="statement not covered" >                throw new Error('Close alert failed. Retry.');</span>
&nbsp;
              case 5:
              case 'end':
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        context$1$0.prev = 46;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 49;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _asyncbox.retryInterval)(3, 4000, tryClosingAlert));</span>
&nbsp;
      case 49:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 54;</span>
<span class="cstat-no" title="statement not covered" >        break;</span>
&nbsp;
      case 51:
<span class="cstat-no" title="statement not covered" >        context$1$0.prev = 51;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.t1 = context$1$0['catch'](46);</span>
&nbsp;
        // if the loop to close alerts failed to dismiss, ignore,
        // otherwise log and throw the error
<span class="cstat-no" title="statement not covered" >        if (context$1$0.t1.message !== 'Close alert failed. Retry.') {</span>
<span class="cstat-no" title="statement not covered" >          _logger2['default'].errorAndThrow(context$1$0.t1);</span>
        }
&nbsp;
      case 54:
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (pageArray.length === 0) {</span>
          // we have no web frames, but continue anyway
<span class="cstat-no" title="statement not covered" >          _logger2['default'].debug('No web frames found.');</span>
        }
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', pageArray);</span>
&nbsp;
      case 56:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
extensions.onPageChange = <span class="fstat-no" title="function not covered" >function callee$0$0(pageChangeNotification) {</span>
<span class="cstat-no" title="statement not covered" >  var appIdKey, pageArray, newIds, newPages, keyId, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, page, id, contextId, newPage, _curContext$split, _curContext$split2, curAppIdKey, curPageIdKey, needsPageLoad;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
...
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Remote debugger notified us of a new page listing: ' + JSON.stringify(pageChangeNotification));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!this.selectingNewPage) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 4;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('We are in the middle of selecting a page, ignoring');</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return');</span>
&nbsp;
      case 4:
<span class="cstat-no" title="statement not covered" >        if (this.remote.appIdKey) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 7;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('We have not yet connected, ignoring');</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return');</span>
&nbsp;
      case 7:
<span class="cstat-no" title="statement not covered" >        appIdKey = pageChangeNotification.appIdKey;</span>
<span class="cstat-no" title="statement not covered" >        pageArray = pageChangeNotification.pageArray;</span>
<span class="cstat-no" title="statement not covered" >        newIds = [];</span>
<span class="cstat-no" title="statement not covered" >        newPages = [];</span>
<span class="cstat-no" title="statement not covered" >        keyId = null;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        for (_iterator2 = _getIterator(pageArray); !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {</span>
<span class="cstat-no" title="statement not covered" >          page = _step2.value;</span>
<span class="cstat-no" title="statement not covered" >          id = page.id.toString();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          newIds.push(id);</span>
<span class="cstat-no" title="statement not covered" >          if (page.isKey) {</span>
<span class="cstat-no" title="statement not covered" >            keyId = id;</span>
          }
<span class="cstat-no" title="statement not covered" >          contextId = appIdKey + '.' + id;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (!_lodash2['default'].includes(this.contexts, contextId)) {</span>
<span class="cstat-no" title="statement not covered" >            newPages.push(id);</span>
<span class="cstat-no" title="statement not covered" >            this.contexts.push(contextId);</span>
          }
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 23;</span>
...
<span class="cstat-no" title="statement not covered" >        context$1$0.t0 = context$1$0['catch'](15);</span>
...
<span class="cstat-no" title="statement not covered" >        if (!keyId) {</span>
          ...
          // as a stand in
<span class="cstat-no" title="statement not covered" >          _logger2['default'].debug('No key id found. Choosing first id from page array');</span>
<span class="cstat-no" title="statement not covered" >          keyId = newIds[0] || null;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        newPage = null;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!(this.curContext === null)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 37;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('We do not appear to have window set yet, ignoring');</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 69;</span>
<span class="cstat-no" title="statement not covered" >        break;</span>
&nbsp;
      case 37:
<span class="cstat-no" title="statement not covered" >        _curContext$split = this.curContext.split('.');</span>
<span class="cstat-no" title="statement not covered" >        _curContext$split2 = _slicedToArray(_curContext$split, 2);</span>
<span class="cstat-no" title="statement not covered" >        curAppIdKey = _curContext$split2[0];</span>
<span class="cstat-no" title="statement not covered" >        curPageIdKey = _curContext$split2[1];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!(curAppIdKey !== appIdKey)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 44;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Page change not referring to currently selected app, ignoring.');</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return');</span>
&nbsp;
      case 44:
<span class="cstat-no" title="statement not covered" >        if (!newPages.length) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 49;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        newPage = _lodash2['default'].last(newPages);</span>
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('We have new pages, going to select page \'' + newPage + '\'');</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 69;</span>
<span class="cstat-no" title="statement not covered" >        break;</span>
&nbsp;
      case 49:
<span class="cstat-no" title="statement not covered" >        if (_lodash2['default'].includes(newIds, curPageIdKey)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 62;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('New page listing from remote debugger does not contain ' + 'current window; assuming it is closed');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!(keyId !== null)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 55;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Debugger already selected page \'' + keyId + '\', ' + 'confirming that choice.');</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 58;</span>
<span class="cstat-no" title="statement not covered" >        break;</span>
&nbsp;
      case 55:
<span class="cstat-no" title="statement not covered" >        _logger2['default'].error('Do not have our current window anymore, and there ' + 'are not any more to load! Doing nothing...');</span>
<span class="cstat-no" title="statement not covered" >        this.setCurrentUrl(undefined);</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return');</span>
&nbsp;
      case 58:
<span class="cstat-no" title="statement not covered" >        this.curContext = appIdKey + '.' + keyId;</span>
<span class="cstat-no" title="statement not covered" >        newPage = keyId;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 69;</span>
<span class="cstat-no" title="statement not covered" >        break;</span>
&nbsp;
      case 62:
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Checking if page needs to load');</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        needsPageLoad = (<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >          var item = <span class="fstat-no" title="function not covered" >function item(arr) {</span></span>
<span class="cstat-no" title="statement not covered" >            return _lodash2['default'].filter(arr, <span class="fstat-no" title="function not covered" >function (obj) {</span></span>
<span class="cstat-no" title="statement not covered" >              return obj.id === _this2.curContext;</span>
            })[0];
          };
&nbsp;
          // need to map the page ids to context ids
<span class="cstat-no" title="statement not covered" >          var contextArray = _lodash2['default'].map(pageArray, <span class="fstat-no" title="function not covered" >function (arr) {</span></span>
<span class="cstat-no" title="statement not covered" >            return { id: appIdKey + '.' + arr.id };</span>
          });
<span class="cstat-no" title="statement not covered" >          return !_lodash2['default'].isEqual(item(_this2.contexts), item(contextArray));</span>
        })();
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!needsPageLoad) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 68;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Page load needed. Loading.');</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 68;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.remote.pageLoad());</span>
&nbsp;
      case 68:
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('New page listing is same as old, doing nothing');</span>
&nbsp;
      case 69:
&nbsp;
        // make sure that the page listing isn't indicating a redirect
<span class="cstat-no" title="statement not covered" >        if (_appiumSupport.util.hasValue(this.curContext)) {</span>
<span class="cstat-no" title="statement not covered" >          (<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >            var currentPageId = parseInt(_lodash2['default'].last(_this2.curContext.split('.')), 10);</span>
<span class="cstat-no" title="statement not covered" >            var page = _lodash2['default'].find(pageArray, <span class="fstat-no" title="function not covered" >function (p) {</span></span>
<span class="cstat-no" title="statement not covered" >              return parseInt(p.id, 10) === currentPageId;</span>
            });
<span class="cstat-no" title="statement not covered" >            if (page &amp;&amp; page.url !== _this2.getCurrentUrl()) {</span>
<span class="cstat-no" title="statement not covered" >              _logger2['default'].debug('Redirected from \'' + _this2.getCurrentUrl() + '\' to \'' + page.url + '\'');</span>
<span class="cstat-no" title="statement not covered" >              _this2.setCurrentUrl(page.url);</span>
            }
          })();
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!_appiumSupport.util.hasValue(newPage)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 76;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        this.selectingNewPage = true;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 74;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.remote.selectPage(appIdKey, parseInt(newPage, 10)));</span>
&nbsp;
      case 74:
<span class="cstat-no" title="statement not covered" >        this.selectingNewPage = false;</span>
<span class="cstat-no" title="statement not covered" >        this.curContext = appIdKey + '.' + newPage;</span>
&nbsp;
      case 76:
<span class="cstat-no" title="statement not covered" >        this.windowHandleCache = _lodash2['default'].map(pageArray, this.massagePage);</span>
&nbsp;
...
&nbsp;
extensions.getLatestWebviewContextForTitle = <span class="fstat-no" title="function not covered" >function callee$0$0(regExp) {</span>
<span class="cstat-no" title="statement not covered" >  var contexts, matchingCtx, _iteratorNormalCompletion3, _didIteratorError3, _iteratorError3, _iterator3, _step3, ctx;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.getContextsAndViews());</span>
&nbsp;
      case 2:
<span class="cstat-no" title="statement not covered" >        contexts = context$1$0.sent;</span>
<span class="cstat-no" title="statement not covered" >        matchingCtx = undefined;</span>
...
<span class="cstat-no" title="statement not covered" >        _iterator3 = _getIterator(contexts);</span>
&nbsp;
      case 9:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        ctx = _step3.value;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!(ctx.view &amp;&amp; ((ctx.view.title || '').match(regExp) || (ctx.view.url || '').match(regExp)))) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 14;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (ctx.view.url !== 'about:blank') {</span>
<span class="cstat-no" title="statement not covered" >          matchingCtx = ctx;</span>
        } else {
...
<span class="cstat-no" title="statement not covered" >          if (parseFloat(this.iosSdkVersion) &lt; 7 || parseFloat(this.iosSdkVersion) &gt;= 9 || this.opts.platformVersion === '7.1' &amp;&amp; this.opts.app &amp;&amp; this.opts.app.toLowerCase() !== 'safari') {</span>
<span class="cstat-no" title="statement not covered" >            matchingCtx = ctx;</span>
          }
        }
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('break', 17);</span>
&nbsp;
      case 14:
<span class="cstat-no" title="statement not covered" >        _iteratorNormalCompletion3 = true;</span>
...
&nbsp;
      case 19:
<span class="cstat-no" title="statement not covered" >        context$1$0.prev = 19;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.t0 = context$1$0['catch'](7);</span>
...
&nbsp;
      case 31:
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', matchingCtx ? matchingCtx.id : undefined);</span>
&nbsp;
      case 32:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
extensions.useNewSafari = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >  return parseFloat(this.iosSdkVersion) &gt;= 8.1 &amp;&amp; parseFloat(this.opts.platformVersion) &gt;= 8.1 &amp;&amp; !this.isRealDevice() &amp;&amp; this.opts.safari;</span>
};
&nbsp;
extensions.navToInitialWebview = <span class="fstat-no" title="function not covered" >function callee$0$0() {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (this.isRealDevice()) {</span>
<span class="cstat-no" title="statement not covered" >          timeout = 3000;</span>
<span class="cstat-no" title="statement not covered" >          _logger2['default'].debug('Waiting for ' + timeout + ' ms before navigating to view.');</span>
        }
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 4;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_bluebird2['default'].delay(timeout));</span>
&nbsp;
      case 4:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 7;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.typeAndNavToUrl());</span>
&nbsp;
      case 7:
...
&nbsp;
      case 9:
<span class="cstat-no" title="statement not covered" >        if (!(parseInt(this.iosSdkVersion, 10) &gt;= 7 &amp;&amp; !this.isRealDevice() &amp;&amp; this.opts.safari)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 14;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 12;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.navToViewThroughFavorites());</span>
&nbsp;
      case 12:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 16;</span>
<span class="cstat-no" title="statement not covered" >        break;</span>
&nbsp;
      case 14:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 16;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.navToViewWithTitle(/.*/));</span>
&nbsp;
      case 16:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function openNewPage() {</span>
<span class="cstat-no" title="statement not covered" >  var newPageButton;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function openNewPage$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.findElement('xpath', "//UIAButton[contains(@name,'New page')]"));</span>
&nbsp;
      case 2:
<span class="cstat-no" title="statement not covered" >        newPageButton = context$1$0.sent;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 5;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.nativeTap(newPageButton.ELEMENT));</span>
&nbsp;
      case 5:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
extensions.typeAndNavToUrl = <span class="fstat-no" title="function not covered" >function callee$0$0() {</span>
<span class="cstat-no" title="statement not covered" >  var address, tries, MAX_TRIES, navigate;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    var _this4 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        address = this.opts.address ? this.opts.address : '127.0.0.1';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        this.setCurrentUrl(this.caps.safariInitialUrl || 'http://' + address + ':' + this.opts.port + '/welcome');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        tries = 0;</span>
<span class="cstat-no" title="statement not covered" >        MAX_TRIES = 2;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        navigate = <span class="fstat-no" title="function not covered" >function navigate() {</span></span>
<span class="cstat-no" title="statement not covered" >          var oldImpWait, el, _el;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function navigate$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >            var _this3 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
              case 0:
<span class="cstat-no" title="statement not covered" >                oldImpWait = this.implicitWaitMs;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                this.implicitWaitMs = 7000;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                return _regeneratorRuntime.awrap((0, _asyncbox.retryInterval)(3, 1000, <span class="fstat-no" title="function not covered" >function callee$2$0() {</span></span>
...
<span class="cstat-no" title="statement not covered" >                        return _regeneratorRuntime.awrap(this.findElement('accessibility id', 'URL'));</span>
&nbsp;
                      case 2:
...
&nbsp;
              case 4:
<span class="cstat-no" title="statement not covered" >                el = context$2$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                this.implicitWaitMs = oldImpWait;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                return _regeneratorRuntime.awrap(this.nativeTap(el.ELEMENT));</span>
&nbsp;
              case 9:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (!_lodash2['default'].includes(context$2$0.t0.message, 'could not be tapped')) {</span>
...
<span class="cstat-no" title="statement not covered" >                return _regeneratorRuntime.awrap(openNewPage());</span>
&nbsp;
              case 18:
<span class="cstat-no" title="statement not covered" >                context$2$0.next = 20;</span>
<span class="cstat-no" title="statement not covered" >                return _regeneratorRuntime.awrap(navigate());</span>
&nbsp;
              case 20:
...
<span class="cstat-no" title="statement not covered" >                return _regeneratorRuntime.awrap(this.findElement('class name', 'UIATextField'));</span>
&nbsp;
              case 27:
<span class="cstat-no" title="statement not covered" >                _el = context$2$0.sent;</span>
<span class="cstat-no" title="statement not covered" >                context$2$0.next = 30;</span>
<span class="cstat-no" title="statement not covered" >                return _regeneratorRuntime.awrap(this.setValueImmediate(this.getCurrentUrl(), _el));</span>
&nbsp;
              case 30:
...
<span class="cstat-no" title="statement not covered" >                context$2$0.t1 = context$2$0['catch'](24);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (!(tries++ &gt;= MAX_TRIES)) {</span>
...
&nbsp;
              case 39:
<span class="cstat-no" title="statement not covered" >                context$2$0.prev = 39;</span>
<span class="cstat-no" title="statement not covered" >                context$2$0.next = 42;</span>
<span class="cstat-no" title="statement not covered" >                return _regeneratorRuntime.awrap(this.findElement('accessibility id', 'Go'));</span>
&nbsp;
              case 42:
<span class="cstat-no" title="statement not covered" >                el = context$2$0.sent;</span>
...
&nbsp;
              case 45:
<span class="cstat-no" title="statement not covered" >                context$2$0.next = 51;</span>
<span class="cstat-no" title="statement not covered" >                break;</span>
&nbsp;
              case 47:
<span class="cstat-no" title="statement not covered" >                context$2$0.prev = 47;</span>
<span class="cstat-no" title="statement not covered" >                context$2$0.t2 = context$2$0['catch'](39);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (_lodash2['default'].includes(context$2$0.t2.message, 'could not be tapped')) {</span>
<span class="cstat-no" title="statement not covered" >                  _logger2['default'].error('Unable to submit URL because \'Go\' button could not be tapped. ' + 'Please make sure your keyboard is toggled on.');</span>
                }
<span class="cstat-no" title="statement not covered" >                throw context$2$0.t2;</span>
&nbsp;
              case 51:
<span class="cstat-no" title="statement not covered" >                context$2$0.next = 53;</span>
<span class="cstat-no" title="statement not covered" >                return _regeneratorRuntime.awrap(this.navToViewWithTitle(undefined, new RegExp(this.getCurrentUrl(), 'i')));</span>
&nbsp;
              case 53:
<span class="cstat-no" title="statement not covered" >                context$2$0.next = 55;</span>
<span class="cstat-no" title="statement not covered" >                return _regeneratorRuntime.awrap(this.remote.pageUnload());</span>
&nbsp;
              case 55:
              case 'end':
<span class="cstat-no" title="statement not covered" >                return context$2$0.stop();</span>
...
&nbsp;
extensions.navToViewThroughFavorites = <span class="fstat-no" title="function not covered" >function callee$0$0() {</span>
<span class="cstat-no" title="statement not covered" >  var oldImpWait, el, msg;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('We are on iOS7+ simulator: clicking apple button to get into a webview');</span>
<span class="cstat-no" title="statement not covered" >        oldImpWait = this.implicitWaitMs;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        this.implicitWaitMs = 7000; </span>// wait 7s for apple button to exist
&nbsp;
<span class="cstat-no" title="statement not covered" >        el = undefined;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.prev = 4;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 7;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.findElement('xpath', '//UIAScrollView[1]/UIAButton[1]'));</span>
&nbsp;
      case 7:
<span class="cstat-no" title="statement not covered" >        el = context$1$0.sent;</span>
...
<span class="cstat-no" title="statement not covered" >        msg = 'Could not find button to click to get into webview. ' + 'Proceeding on the assumption we have a working one.';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].error(msg);</span>
<span class="cstat-no" title="statement not covered" >        this.implicitWaitMs = oldImpWait;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 17;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.navToViewWithTitle(/.*/i));</span>
&nbsp;
      case 17:
...
&nbsp;
      case 24:
<span class="cstat-no" title="statement not covered" >        context$1$0.prev = 24;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.t1 = context$1$0['catch'](19);</span>
<span class="cstat-no" title="statement not covered" >        msg = 'Could not click button to get into webview. ' + 'Proceeding on the assumption we have a working one.';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].error(msg);</span>
&nbsp;
      case 28:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 30;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.navToViewWithTitle(/apple/i));</span>
&nbsp;
      case 30:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
extensions.navToViewWithTitle = <span class="fstat-no" title="function not covered" >function callee$0$0(titleRegex, urlRegExp) {</span>
<span class="cstat-no" title="statement not covered" >  var start, spinTime, spinHandles;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    var _this5 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Navigating to most recently opened webview');</span>
<span class="cstat-no" title="statement not covered" >        start = Date.now();</span>
<span class="cstat-no" title="statement not covered" >        spinTime = 500;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        spinHandles = <span class="fstat-no" title="function not covered" >function spinHandles() {</span></span>
<span class="cstat-no" title="statement not covered" >          var res, latestWindow, element;</span>
<span class="cstat-no" title="statement not covered" >          return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function spinHandles$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >            while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
              case 0:
...
<span class="cstat-no" title="statement not covered" >                context$2$0.next = 4;</span>
<span class="cstat-no" title="statement not covered" >                return _regeneratorRuntime.awrap(this.getLatestWebviewContextForTitle(titleRegex || urlRegExp));</span>
&nbsp;
              case 4:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (!(context$2$0.t0.message.indexOf('Could not connect to a valid app after') === -1)) {</span>
<span class="cstat-no" title="statement not covered" >                  context$2$0.next = 11;</span>
<span class="cstat-no" title="statement not covered" >                  break;</span>
                }
&nbsp;
<span class="cstat-no" title="statement not covered" >                throw new Error('Could not navigate to webview! Err: ' + context$2$0.t0.message);</span>
&nbsp;
              case 11:
<span class="cstat-no" title="statement not covered" >                _logger2['default'].debug('Could not navigate to webview. Retrying if possible.');</span>
&nbsp;
              case 12:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                latestWindow = res;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                _logger2['default'].debug('Picking webview \'' + latestWindow + '\'');</span>
<span class="cstat-no" title="statement not covered" >                context$2$0.next = 17;</span>
<span class="cstat-no" title="statement not covered" >                return _regeneratorRuntime.awrap(this.setContext(latestWindow));</span>
&nbsp;
              case 17:
<span class="cstat-no" title="statement not covered" >                context$2$0.next = 19;</span>
<span class="cstat-no" title="statement not covered" >                return _regeneratorRuntime.awrap(this.remote.cancelPageLoad());</span>
&nbsp;
              case 19:
<span class="cstat-no" title="statement not covered" >                return context$2$0.abrupt('return');</span>
&nbsp;
              case 20:
<span class="cstat-no" title="statement not covered" >                if (!(Date.now() - start &gt;= 90000)) {</span>
<span class="cstat-no" title="statement not covered" >                  context$2$0.next = 22;</span>
<span class="cstat-no" title="statement not covered" >                  break;</span>
                }
&nbsp;
<span class="cstat-no" title="statement not covered" >                throw new Error('Could not navigate to webview; there are none!');</span>
&nbsp;
              case 22:
&nbsp;
<span class="cstat-no" title="statement not covered" >                _logger2['default'].warn("Could not find any webviews yet, refreshing/retrying");</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (!(this.isRealDevice() || !this.opts.safari)) {</span>
...
<span class="cstat-no" title="statement not covered" >                return _regeneratorRuntime.awrap(_bluebird2['default'].delay(spinTime));</span>
&nbsp;
              case 26:
<span class="cstat-no" title="statement not covered" >                context$2$0.next = 28;</span>
<span class="cstat-no" title="statement not covered" >                return _regeneratorRuntime.awrap(spinHandles());</span>
&nbsp;
              case 28:
<span class="cstat-no" title="statement not covered" >                return context$2$0.abrupt('return', context$2$0.sent);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                _logger2['default'].debug('Finding and tapping reload button');</span>
<span class="cstat-no" title="statement not covered" >                context$2$0.next = 34;</span>
<span class="cstat-no" title="statement not covered" >                return _regeneratorRuntime.awrap(this.findUIElementOrElements('accessibility id', 'ReloadButton', '', false));</span>
&nbsp;
              case 34:
...
<span class="cstat-no" title="statement not covered" >                return _regeneratorRuntime.awrap(this.nativeTap(element.ELEMENT));</span>
&nbsp;
              case 37:
<span class="cstat-no" title="statement not covered" >                context$2$0.next = 45;</span>
<span class="cstat-no" title="statement not covered" >                break;</span>
&nbsp;
              case 39:
<span class="cstat-no" title="statement not covered" >                context$2$0.prev = 39;</span>
<span class="cstat-no" title="statement not covered" >                context$2$0.t1 = context$2$0['catch'](30);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                _logger2['default'].warn('Error finding and tapping reload button: ' + context$2$0.t1.message);</span>
<span class="cstat-no" title="statement not covered" >                _logger2['default'].warn('Retrying.');</span>
<span class="cstat-no" title="statement not covered" >                context$2$0.next = 45;</span>
<span class="cstat-no" title="statement not covered" >                return _regeneratorRuntime.awrap(_bluebird2['default'].delay(spinTime));</span>
&nbsp;
              case 45:
...
&nbsp;
helpers.closeAlertBeforeTest = <span class="fstat-no" title="function not covered" >function callee$0$0() {</span>
...
&nbsp;
      case 5:
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Alert present before starting test, let us banish it');</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 8;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.uiAutoClient.sendCommand('au.dismissAlert()'));</span>
&nbsp;
      case 8:
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Alert banished!');</span>
...
&nbsp;
helpers.stopRemote = <span class="fstat-no" title="function not covered" >function callee$0$0() {</span>
<span class="cstat-no" title="statement not covered" >  var closeWindowBeforeDisconnecting = arguments.length &lt;= 0 || arguments[0] === undefined ? false : arguments[0];</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        if (!this.remote) {</span>
<span class="cstat-no" title="statement not covered" >          _logger2['default'].errorAndThrow('Tried to leave a web frame but were not in one');</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!closeWindowBeforeDisconnecting) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 4;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 4;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.closeWindow());</span>
&nbsp;
      case 4:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 6;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.remote.disconnect());</span>
...
&nbsp;
helpers.isWebContext = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >  return !!this.curContext &amp;&amp; this.curContext !== NATIVE_WIN;</span>
};
&nbsp;
helpers.setCurrentUrl = <span class="fstat-no" title="function not covered" >function (url) {</span>
<span class="cstat-no" title="statement not covered" >  this._currentUrl = url;</span>
};
&nbsp;
helpers.getCurrentUrl = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >  return this._currentUrl;</span>
};
&nbsp;
