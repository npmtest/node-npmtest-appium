...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-ios-driver/build/lib/commands/execute.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-ios-driver/build/lib/commands/execute.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-ios-driver/build/lib/commands/</a> &#187; execute.js</div>
</div>
<div class="body">
...
var commands = {},
    ...
    extensions = {};
&nbsp;
commands.execute = <span class="fstat-no" title="function not covered" >function callee$0$0(script, args) {</span>
...
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        if (!script.match(/^mobile\:/)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 7;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        script = script.replace(/^mobile\:/, '').trim();</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 4;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.executeMobile(script, _lodash2['default'].isArray(args) ? args[0] : args));</span>
&nbsp;
      case 4:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        args = this.convertElementsForAtoms(args);</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 11;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.executeAtom('execute_script', [script, args]));</span>
&nbsp;
      case 11:
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', context$1$0.sent);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.uiAutoClient.sendCommand(script));</span>
&nbsp;
      case 16:
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', context$1$0.sent);</span>
&nbsp;
...
&nbsp;
commands.executeAsync = <span class="fstat-no" title="function not covered" >function callee$0$0(script, args, sessionId) {</span>
<span class="cstat-no" title="statement not covered" >  var address, port, responseUrl, defaultHost, urlObject;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        if (this.isWebContext()) {</span>
...
&nbsp;
      case 4:
<span class="cstat-no" title="statement not covered" >        address = this.opts.callbackAddress || this.opts.address;</span>
<span class="cstat-no" title="statement not covered" >        port = this.opts.callbackPort || this.opts.port;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        sessionId = sessionId || this.sessionId;</span>
<span class="cstat-no" title="statement not covered" >        responseUrl = 'http://' + address + ':' + port + '/wd/hub/session/' + sessionId + '/receive_async_response';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (this.isRealDevice()) {</span>
<span class="cstat-no" title="statement not covered" >          defaultHost = this.opts.address;</span>
<span class="cstat-no" title="statement not covered" >          urlObject = _url2['default'].parse(responseUrl);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (urlObject.hostname === defaultHost) {</span>
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Real device safari test and no custom callback address ' + 'set, changing callback address to local ip.');</span>
<span class="cstat-no" title="statement not covered" >            urlObject.hostname = _appiumSupport.util.localIp();</span>
<span class="cstat-no" title="statement not covered" >            urlObject.host = null; </span>// set to null, otherwise hostname is ignored
<span class="cstat-no" title="statement not covered" >            responseUrl = _url2['default'].format(urlObject);</span>
          } else {
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Custom callback address set, leaving as is.');</span>
          }
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Response url for executeAsync: ' + responseUrl);</span>
<span class="cstat-no" title="statement not covered" >        args = this.convertElementsForAtoms(args);</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 13;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.executeAtomAsync('execute_async_script', [script, args, this.asyncWaitMs], responseUrl));</span>
&nbsp;
      case 13:
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', context$1$0.sent);</span>
&nbsp;
...
&nbsp;
commands.receiveAsyncResponse = <span class="fstat-no" title="function not covered" >function callee$0$0(status, value) {</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Received async response: ' + JSON.stringify(value));</span>
<span class="cstat-no" title="statement not covered" >        if (!_lodash2['default'].isNull(this.asyncPromise) &amp;&amp; !_lodash2['default'].isUndefined(this.asyncPromise)) {</span>
<span class="cstat-no" title="statement not covered" >          if (status !== 0) {</span>
<span class="cstat-no" title="statement not covered" >            this.asyncPromise.reject((0, _appiumBaseDriver.errorFromCode)(status, value.message));</span>
          } else {
<span class="cstat-no" title="statement not covered" >            this.asyncPromise.resolve(value);</span>
          }
        } else {
<span class="cstat-no" title="statement not covered" >          _logger2['default'].warn('Received async response when we were not expecting one! ' + ('Response was: ' + JSON.stringify(value)));</span>
        }
&nbsp;
      case 2:
      case 'end':
...
&nbsp;
commands.executeMobile = <span class="fstat-no" title="function not covered" >function callee$0$0(mobileCommand) {</span>
<span class="cstat-no" title="statement not covered" >  var opts = arguments.length &lt;= 1 || arguments[1] === undefined ? {} : arguments[1];</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        if (!(mobileCommand === 'scroll')) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 5;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 3;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.mobileScroll(opts));</span>
&nbsp;
      case 3:
...
&nbsp;
      case 5:
<span class="cstat-no" title="statement not covered" >        throw new _appiumBaseDriver.errors.UnknownCommandError('Unknown command, all the mobile commands except scroll have been removed.');</span>
&nbsp;
      case 6:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
