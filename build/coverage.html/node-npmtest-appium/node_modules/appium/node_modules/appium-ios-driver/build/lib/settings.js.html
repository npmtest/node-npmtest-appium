...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-ios-driver/build/lib/settings.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-ios-driver/build/lib/settings.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-ios-driver/build/lib/</a> &#187; settings.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >function launchAndQuitSimulator(sim, safari) {</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function launchAndQuitSimulator$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('No simulator directories found.');</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 3;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(sim.launchAndQuit(safari));</span>
&nbsp;
      case 3:
...
&nbsp;
<span class="fstat-no" title="function not covered" >function checkPreferences(settings) {</span>
...
<span class="cstat-no" title="statement not covered" >    for (var _iterator = _getIterator(settings), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {</span>
<span class="cstat-no" title="statement not covered" >      var setting = _step.value;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (_lodash2['default'].has(opts, setting)) {</span>
...
// whatever they have
<span class="fstat-no" title="function not covered" >function setLocale(sim, opts) {</span>
<span class="cstat-no" title="statement not covered" >  var localeConfig = arguments.length &lt;= 2 || arguments[2] === undefined ? {} : arguments[2];</span>
<span class="cstat-no" title="statement not covered" >  var safari = arguments.length &lt;= 3 || arguments[3] === undefined ? false : arguments[3];</span>
<span class="cstat-no" title="statement not covered" >  var updated;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function setLocale$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        if (!(!opts.language &amp;&amp; !opts.locale &amp;&amp; !opts.calendarFormat)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 3;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug("No reason to set locale");</span>
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(sim.isFresh());</span>
&nbsp;
      case 5:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 8;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(launchAndQuitSimulator(sim, safari));</span>
&nbsp;
      case 8:
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Setting locale information');</span>
<span class="cstat-no" title="statement not covered" >        localeConfig = {</span>
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(sim.updateLocale(opts.language, opts.locale, opts.calendarFormat));</span>
&nbsp;
      case 13:
<span class="cstat-no" title="statement not covered" >        updated = context$1$0.sent;</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Locale was updated. Stopping simulator.');</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 18;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _device.endSimulator)(sim));</span>
&nbsp;
      case 18:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].errorAndThrow('Appium was unable to set locale info: ' + context$1$0.t0);</span>
&nbsp;
      case 23:
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', localeConfig);</span>
&nbsp;
      case 24:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function setPreferences(sim, opts) {</span>
<span class="cstat-no" title="statement not covered" >  var safari = arguments.length &lt;= 2 || arguments[2] === undefined ? false : arguments[2];</span>
<span class="cstat-no" title="statement not covered" >  var needToSetPrefs, needToSetSafariPrefs;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function setPreferences$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        needToSetPrefs = checkPreferences(SETTINGS_CAPS, opts);</span>
<span class="cstat-no" title="statement not covered" >        needToSetSafariPrefs = checkPreferences(SAFARI_SETTINGS_CAPS, opts);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!(!needToSetPrefs &amp;&amp; !needToSetSafariPrefs)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 5;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug("No iOS / app preferences to set");</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return');</span>
&nbsp;
      case 5:
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug("Setting iOS and app preferences");</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 8;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(sim.isFresh());</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!needToSetPrefs) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 15;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 15;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(setLocServicesPrefs(sim, opts));</span>
&nbsp;
      case 15:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].error("Error setting location services preferences, prefs will not work");</span>
<span class="cstat-no" title="statement not covered" >        _logger2['default'].error(context$1$0.t0);</span>
&nbsp;
      case 21:
<span class="cstat-no" title="statement not covered" >        context$1$0.prev = 21;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!needToSetSafariPrefs) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 25;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 25;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(setSafariPrefs(sim, opts));</span>
&nbsp;
      case 25:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].error("Error setting safari preferences, prefs will not work");</span>
<span class="cstat-no" title="statement not covered" >        _logger2['default'].error(context$1$0.t1);</span>
&nbsp;
      case 31:
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug("Updated plist files, rebooting the simulator if it's already open");</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function setLocServicesPrefs(sim) {</span>
<span class="cstat-no" title="statement not covered" >  var opts = arguments.length &lt;= 1 || arguments[1] === undefined ? {} : arguments[1];</span>
<span class="cstat-no" title="statement not covered" >  var locServ, msg, locAuth;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function setLocServicesPrefs$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        locServ = _lodash2['default'].find([opts.locationServicesEnabled, opts.locationServicesAuthorized], <span class="fstat-no" title="function not covered" >function (c) {</span></span>
<span class="cstat-no" title="statement not covered" >          return !_lodash2['default'].isUndefined(c);</span>
        });
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (_lodash2['default'].isUndefined(locServ)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 6;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        locServ = locServ ? 1 : 0;</span>
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Setting location services to ' + locServ);</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 6;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(sim.updateSettings('locationServices', {</span>
...
&nbsp;
      case 6:
<span class="cstat-no" title="statement not covered" >        if (_lodash2['default'].isUndefined(opts.locationServicesAuthorized)) {</span>
...
<span class="cstat-no" title="statement not covered" >          msg = "Can't set location services for app without bundle ID";</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          _logger2['default'].errorAndThrow(msg);</span>
        }
<span class="cstat-no" title="statement not covered" >        locAuth = !!opts.locationServicesAuthorized;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (locAuth) {</span>
<span class="cstat-no" title="statement not covered" >          _logger2['default'].debug("Authorizing location services for app");</span>
        } else {
<span class="cstat-no" title="statement not covered" >          _logger2['default'].debug("De-authorizing location services for app");</span>
        }
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 12;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(sim.updateLocationSettings(opts.bundleId, locAuth));</span>
&nbsp;
      case 12:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function setSafariPrefs(sim) {</span>
<span class="cstat-no" title="statement not covered" >  var opts = arguments.length &lt;= 1 || arguments[1] === undefined ? {} : arguments[1];</span>
<span class="cstat-no" title="statement not covered" >  var safariSettings, val;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function setSafariPrefs$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        safariSettings = {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (_lodash2['default'].has(opts, 'safariAllowPopups')) {</span>
<span class="cstat-no" title="statement not covered" >          val = !!opts.safariAllowPopups;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          _logger2['default'].debug('Setting javascript window opening to \'' + val + '\'');</span>
<span class="cstat-no" title="statement not covered" >          safariSettings.WebKitJavaScriptCanOpenWindowsAutomatically = val;</span>
<span class="cstat-no" title="statement not covered" >          safariSettings.JavaScriptCanOpenWindowsAutomatically = val;</span>
        }
<span class="cstat-no" title="statement not covered" >        if (_lodash2['default'].has(opts, 'safariIgnoreFraudWarning')) {</span>
<span class="cstat-no" title="statement not covered" >          val = !opts.safariIgnoreFraudWarning;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          _logger2['default'].debug('Setting fraudulent website warning to \'' + val + '\'');</span>
<span class="cstat-no" title="statement not covered" >          safariSettings.WarnAboutFraudulentWebsites = val;</span>
        }
<span class="cstat-no" title="statement not covered" >        if (_lodash2['default'].has(opts, 'safariOpenLinksInBackground')) {</span>
<span class="cstat-no" title="statement not covered" >          val = opts.safariOpenLinksInBackground ? 1 : 0;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          _logger2['default'].debug('Setting opening links in background to \'' + !!val + '\'');</span>
<span class="cstat-no" title="statement not covered" >          safariSettings.OpenLinksInBackground = val;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!(_lodash2['default'].size(safariSettings) &gt; 0)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 7;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 7;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(sim.updateSafariSettings(safariSettings));</span>
&nbsp;
      case 7:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
