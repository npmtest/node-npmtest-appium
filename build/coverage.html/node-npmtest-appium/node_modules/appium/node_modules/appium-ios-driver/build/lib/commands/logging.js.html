...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-ios-driver/build/lib/commands/logging.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-ios-driver/build/lib/commands/logging.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-ios-driver/build/lib/commands/</a> &#187; logging.js</div>
</div>
<div class="body">
...
&nbsp;
commands.getLogTypes = <span class="fstat-no" title="function not covered" >function callee$0$0() {</span>
...
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Retrieving supported log types');</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', _lodash2['default'].keys(SUPPORTED_LOG_TYPES));</span>
&nbsp;
      case 2:
      case 'end':
...
&nbsp;
commands.getLog = <span class="fstat-no" title="function not covered" >function callee$0$0(logType) {</span>
<span class="cstat-no" title="statement not covered" >  var logs;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Retrieving \'' + logType + '\' logs');</span>
        // Check if passed logType is supported
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (_lodash2['default'].has(SUPPORTED_LOG_TYPES, logType)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 3;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        throw new Error('Unsupported log type \'' + logType + '\' for this device. Supported types : ' + JSON.stringify(SUPPORTED_LOG_TYPES));</span>
&nbsp;
      case 3:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        throw new Error('No logs currently available. Is the device/simulator started?');</span>
&nbsp;
      case 5:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 7;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.logs[logType].getLogs());</span>
&nbsp;
      case 7:
<span class="cstat-no" title="statement not covered" >        logs = context$1$0.sent;</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', logs);</span>
&nbsp;
      case 12:
<span class="cstat-no" title="statement not covered" >        throw new Error('No logs of type \'' + logType + '\' found.');</span>
&nbsp;
      case 13:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
helpers.startLogCapture = <span class="fstat-no" title="function not covered" >function callee$0$0(sim) {</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        if (_lodash2['default'].isEmpty(this.logs)) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].warn("Trying to start iOS log capture but it's already started!");</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return');</span>
&nbsp;
      case 3:
<span class="cstat-no" title="statement not covered" >        this.logs.crashlog = new _deviceLogIosCrashLog2['default']();</span>
<span class="cstat-no" title="statement not covered" >        this.logs.syslog = new _deviceLogIosLog2['default']({</span>
          sim: sim,
          udid: this.opts.udid,
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.logs.syslog.startCapture());</span>
&nbsp;
      case 8:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].warn("Could not capture logs from device. Continuing without capturing logs.");</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return');</span>
&nbsp;
      case 14:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 16;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.logs.crashlog.startCapture());</span>
&nbsp;
      case 16:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
