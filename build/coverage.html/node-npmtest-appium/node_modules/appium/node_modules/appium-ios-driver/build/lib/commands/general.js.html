...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-ios-driver/build/lib/commands/general.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-ios-driver/build/lib/commands/general.js</span></h1>
    <h2>
        
        Statements: <span class="metric">13.64% <small>(33 / 242)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">14.41% <small>(33 / 229)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-ios-driver/build/lib/commands/</a> &#187; general.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.uiAutoClient.sendCommand("au.getActiveElement()"));</span>
&nbsp;
      case 8:
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', context$1$0.sent);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >  var idevicedate, _ref, stdout, date;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        _logger2['default'].info('Attempting to capture iOS device date and time');</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_appiumSupport.fs.which('idevicedate'));</span>
&nbsp;
      case 5:
<span class="cstat-no" title="statement not covered" >        idevicedate = context$1$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].info('Found idevicedate: \'' + idevicedate + '\'');</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 9;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _teen_process.exec)(idevicedate, ['-u', this.opts.udid]));</span>
&nbsp;
      case 9:
...
<span class="cstat-no" title="statement not covered" >        date = new Date(stdout);</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', date.toString());</span>
&nbsp;
      case 17:
...
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Unable to parse date \'' + stdout + '\'. Returning as is');</span>
...
<span class="cstat-no" title="statement not covered" >        context$1$0.t1 = context$1$0['catch'](2);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].errorAndThrow('Could not capture device date and time using libimobiledevice idevicedate. ' + 'Libimobiledevice is probably not installed');</span>
&nbsp;
      case 26:
...
&nbsp;
      case 28:
<span class="cstat-no" title="statement not covered" >        _logger2['default'].warn('On simulator. Assuming device time is the same as host time');</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', new Date().toString());</span>
&nbsp;
      case 30:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
<span class="cstat-no" title="statement not covered" >        key = _lodash2['default'].find(possibleKeys, <span class="fstat-no" title="function not covered" >function (k) {</span></span>
<span class="cstat-no" title="statement not covered" >          return k;</span>
        });
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (key) {</span>
<span class="cstat-no" title="statement not covered" >          strategy = strategy || 'pressKey';</span>
<span class="cstat-no" title="statement not covered" >          cmd = 'au.hideKeyboard(\'' + strategy + '\', \'' + key + '\')';</span>
        } else {
<span class="cstat-no" title="statement not covered" >          strategy = strategy || 'default';</span>
<span class="cstat-no" title="statement not covered" >          cmd = 'au.hideKeyboard(\'' + strategy + '\')';</span>
        }
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 6;</span>
...
&nbsp;
commands.getPageSource = <span class="fstat-no" title="function not covered" >function callee$0$0() {</span>
<span class="cstat-no" title="statement not covered" >  var cmd, jsonSource, xmlSource;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        if (!this.isWebContext()) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        cmd = 'document.getElementsByTagName("html")[0].outerHTML';</span>
...
&nbsp;
      case 9:
<span class="cstat-no" title="statement not covered" >        jsonSource = context$1$0.sent;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        xmlSource = (0, _js2xmlparser22['default'])("AppiumAUT", jsonSource, {</span>
          wrapArray: { enabled: false, elementName: "element" },
          declaration: { include: true },
          prettyPrinting: { indentString: "    " }
        });
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', xmlSource);</span>
&nbsp;
      case 13:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
commands.background = <span class="fstat-no" title="function not covered" >function callee$0$0(secs) {</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.uiAutoClient.sendCommand('au.background(' + secs + ')'));</span>
&nbsp;
      case 2:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
commands.lock = <span class="fstat-no" title="function not covered" >function callee$0$0(secs) {</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        if (!secs) {</span>
<span class="cstat-no" title="statement not covered" >          _logger2['default'].debug('No seconds parameter. Using 0 seconds');</span>
<span class="cstat-no" title="statement not covered" >          secs = 0;</span>
        }
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 3;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.uiAutoClient.sendCommand('au.lock(' + secs + ')'));</span>
&nbsp;
      case 3:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        appName = this.opts.app || this.opts.bundleId;</span>
...
&nbsp;
      case 4:
<span class="cstat-no" title="statement not covered" >        _logger2['default'].info('Successfully closed the \'' + appName + '\' app.');</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].warn('Something went wrong while closing the \'' + appName + '\' app.');</span>
...
&nbsp;
      case 4:
<span class="cstat-no" title="statement not covered" >        _logger2['default'].info('Successfully launched the \'' + appName + '\' app.');</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 11;</span>
<span class="cstat-no" title="statement not covered" >        break;</span>
&nbsp;
      case 7:
...
<span class="cstat-no" title="statement not covered" >        context$1$0.t0 = context$1$0['catch'](1);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].warn('Something went wrong while launching the \'' + appName + '\' app.');</span>
<span class="cstat-no" title="statement not covered" >        throw context$1$0.t0;</span>
&nbsp;
      case 11:
      case 'end':
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 3;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.realDevice.remove(bundleId));</span>
&nbsp;
      case 3:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 7;</span>
<span class="cstat-no" title="statement not covered" >        break;</span>
&nbsp;
      case 5:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 7;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.sim.removeApp(bundleId));</span>
&nbsp;
      case 7:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
<span class="cstat-no" title="statement not covered" >  var el, command;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        if (!this.isWebContext()) {</span>
...
&nbsp;
      case 10:
<span class="cstat-no" title="statement not covered" >        if (_lodash2['default'].isArray(keys)) {</span>
<span class="cstat-no" title="statement not covered" >          keys = keys.join('');</span>
        }
<span class="cstat-no" title="statement not covered" >        if (!_lodash2['default'].isString(keys)) {</span>
<span class="cstat-no" title="statement not covered" >          keys = keys.toString();</span>
        }
<span class="cstat-no" title="statement not covered" >        keys = _appiumSupport.util.escapeSpecialChars(keys, "'");</span>
<span class="cstat-no" title="statement not covered" >        command = 'au.sendKeysToActiveElement(\'' + keys + '\')';</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 16;</span>
...
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.uiAutoClient.sendCommand('target.setLocation(' + JSON.stringify(location) + ')'));</span>
&nbsp;
      case 2:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
      case 8:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 10;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.uiAutoClient.sendCommand("au.getWindowSize()"));</span>
&nbsp;
      case 10:
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', context$1$0.sent);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >  var stringFile = arguments.length &lt;= 1 || arguments[1] === undefined ? null : arguments[1];</span>
<span class="cstat-no" title="statement not covered" >  var strings;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Gettings strings for language \'' + language + '\' and string file \'' + stringFile + '\'');</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 3;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_utils2['default'].parseLocalizableStrings(_lodash2['default'].defaults({ language: language, stringFile: stringFile }, this.opts)));</span>
&nbsp;
      case 3:
<span class="cstat-no" title="statement not covered" >        strings = context$1$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (strings &amp;&amp; strings.length &gt;= 1) {</span>
<span class="cstat-no" title="statement not covered" >          strings = strings[0];</span>
        }
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', strings);</span>
&nbsp;
      case 6:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
