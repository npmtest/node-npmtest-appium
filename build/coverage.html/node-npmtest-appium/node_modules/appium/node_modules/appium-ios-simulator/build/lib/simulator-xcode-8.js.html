...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-ios-simulator/build/lib/simulator-xcode-8.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-ios-simulator/build/lib/simulator-xcode-8.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-ios-simulator/build/lib/</a> &#187; simulator-xcode-8.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function SimulatorXcode8(udid, xcodeVersion) {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, SimulatorXcode8);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _get(Object.getPrototypeOf(SimulatorXcode8.prototype), 'constructor', this).call(this, udid, xcodeVersion);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    this.isFreshFiles = ['Library/Cookies', 'Library/Preferences/.GlobalPreferences.plist', 'Library/Preferences/com.apple.springboard.plist', 'var/run/syslog.pid'];</span>
  }
&nbsp;
  _createClass(SimulatorXcode8, [{
    key: 'isAppInstalled',
    value: <span class="fstat-no" title="function not covered" >function isAppInstalled(bundleId) {</span>
<span class="cstat-no" title="statement not covered" >      var appContainer;</span>
...
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap((0, _nodeSimctl.getAppContainer)(this.udid, bundleId, false));</span>
&nbsp;
          case 3:
<span class="cstat-no" title="statement not covered" >            appContainer = context$2$0.sent;</span>
<span class="cstat-no" title="statement not covered" >            return context$2$0.abrupt('return', appContainer.endsWith('.app'));</span>
&nbsp;
          case 7:
...
<span class="cstat-no" title="statement not covered" >      var startupTimestamp;</span>
...
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            startupTimestamp = process.hrtime();</span>
...
<span class="cstat-no" title="statement not covered" >              var isOnBootCompletedEmitted;</span>
...
<span class="cstat-no" title="statement not covered" >                while (1) <span class="cstat-no" title="statement not covered" >switch (context$3$0.prev = context$3$0.next) {</span></span>
                  case 0:
<span class="cstat-no" title="statement not covered" >                    isOnBootCompletedEmitted = false;</span>
<span class="cstat-no" title="statement not covered" >                    context$3$0.next = 3;</span>
<span class="cstat-no" title="statement not covered" >                    return _regeneratorRuntime.awrap((0, _asyncbox.waitForCondition)(<span class="fstat-no" title="function not covered" >function callee$3$0() {</span></span>
...
<span class="cstat-no" title="statement not covered" >                            return _regeneratorRuntime.awrap((0, _teen_process.exec)('bash', ['-c', 'ps axo command | grep Simulator | grep nsurlstoraged | grep -v bash | grep -v grep']));</span>
&nbsp;
                          case 3:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                            if (!(stdout.trim().length &gt; 0)) {</span>
...
<span class="cstat-no" title="statement not covered" >                              this.emit(_simulatorXcode6.BOOT_COMPLETED_EVENT);</span>
                            }
...
<span class="cstat-no" title="statement not covered" >                            return _regeneratorRuntime.awrap((0, _teen_process.exec)('xcrun', ['simctl', 'launch', this.udid, 'com.apple.springboard']));</span>
&nbsp;
                          case 9:
<span class="cstat-no" title="statement not covered" >                            return context$4$0.abrupt('return', true);</span>
&nbsp;
                          case 10:
<span class="cstat-no" title="statement not covered" >                            context$4$0.next = 14;</span>
<span class="cstat-no" title="statement not covered" >                            break;</span>
&nbsp;
                          case 12:
<span class="cstat-no" title="statement not covered" >                            context$4$0.prev = 12;</span>
<span class="cstat-no" title="statement not covered" >                            context$4$0.t0 = context$4$0['catch'](0);</span>
&nbsp;
                          case 14:
<span class="cstat-no" title="statement not covered" >                            return context$4$0.abrupt('return', false);</span>
&nbsp;
                          case 15:
                          case 'end':
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].errorAndThrow('Simulator is not booted after ' + process.hrtime(startupTimestamp)[0] + ' seconds');</span>
&nbsp;
          case 9:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
...
<span class="cstat-no" title="statement not covered" >      var SAFARI_STARTUP_TIMEOUT, launchTimestamp;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            throw new Error('Tried to open ' + url + ', but Simulator is not in Booted state');</span>
&nbsp;
          case 5:
<span class="cstat-no" title="statement not covered" >            launchTimestamp = process.hrtime();</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.prev = 6;</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 9;</span>
...
<span class="cstat-no" title="statement not covered" >              var stdout, _ref2, _ref2$stdout;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >              return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$2$0$(context$3$0) {</span></span>
<span class="cstat-no" title="statement not covered" >                while (1) <span class="cstat-no" title="statement not covered" >switch (context$3$0.prev = context$3$0.next) {</span></span>
                  case 0:
...
<span class="cstat-no" title="statement not covered" >                    return _regeneratorRuntime.awrap((0, _teen_process.exec)('bash', ['-c', 'ps axo command | grep Simulator | grep MobileSafari | grep -v bash | grep -v grep']));</span>
&nbsp;
                  case 5:
<span class="cstat-no" title="statement not covered" >                    _ref2 = context$3$0.sent;</span>
<span class="cstat-no" title="statement not covered" >                    _ref2$stdout = _ref2.stdout;</span>
&nbsp;
                    // jshint ignore:start
<span class="cstat-no" title="statement not covered" >                    stdout = _ref2$stdout === undefined ? '' : _ref2$stdout;</span>
<span class="cstat-no" title="statement not covered" >                    context$3$0.next = 15;</span>
<span class="cstat-no" title="statement not covered" >                    break;</span>
&nbsp;
                  case 10:
<span class="cstat-no" title="statement not covered" >                    context$3$0.prev = 10;</span>
<span class="cstat-no" title="statement not covered" >                    context$3$0.t0 = context$3$0['catch'](2);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                    if (!(context$3$0.t0.code !== 1)) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                    context$3$0.next = 18;</span>
<span class="cstat-no" title="statement not covered" >                    return _regeneratorRuntime.awrap((0, _teen_process.exec)('xcrun', ['simctl', 'openurl', this.udid, url]));</span>
&nbsp;
                  case 18:
...
&nbsp;
                  case 20:
<span class="cstat-no" title="statement not covered" >                    context$3$0.next = 22;</span>
<span class="cstat-no" title="statement not covered" >                    return _regeneratorRuntime.awrap((0, _teen_process.exec)('xcrun', ['simctl', 'launch', this.udid, 'com.apple.mobilesafari', url]));</span>
&nbsp;
                  case 22:
<span class="cstat-no" title="statement not covered" >                    return context$3$0.abrupt('return', true);</span>
&nbsp;
                  case 25:
<span class="cstat-no" title="statement not covered" >                    context$3$0.prev = 25;</span>
<span class="cstat-no" title="statement not covered" >                    context$3$0.t1 = context$3$0['catch'](0);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                    _logger2['default'].error('Failed to open \'' + url + '\' in Safari. Retrying...');</span>
&nbsp;
                  case 28:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].errorAndThrow('Safari cannot open \'' + url + '\' after ' + process.hrtime(launchTimestamp)[0] + ' seconds');</span>
&nbsp;
          case 14:
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Safari has successfully opened \'' + url + '\' in ' + process.hrtime(launchTimestamp)[0] + ' seconds');</span>
&nbsp;
          case 15:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
