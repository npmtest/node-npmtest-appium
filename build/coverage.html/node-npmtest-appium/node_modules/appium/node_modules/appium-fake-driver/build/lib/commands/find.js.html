...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-fake-driver/build/lib/commands/find.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-fake-driver/build/lib/commands/find.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">18.33% <small>(22 / 120)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-fake-driver/build/lib/commands/</a> &#187; find.js</div>
</div>
<div class="body">
...
var commands = {},
    ...
    extensions = {};
&nbsp;
helpers.getExistingElementForNode = <span class="fstat-no" title="function not covered" >function (node) {</span>
...
<span class="cstat-no" title="statement not covered" >    for (var _iterator = _getIterator(_lodash2['default'].pairs(this.elMap)), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {</span>
<span class="cstat-no" title="statement not covered" >      var _step$value = _slicedToArray(_step.value, 2);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var id = _step$value[0];</span>
<span class="cstat-no" title="statement not covered" >      var el = _step$value[1];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (el.node === node) {</span>
...
&nbsp;
helpers.wrapNewEl = <span class="fstat-no" title="function not covered" >function (obj) {</span>
  // first check and see if we already have a ref to this element
<span class="cstat-no" title="statement not covered" >  var existingElId = this.getExistingElementForNode(obj);</span>
<span class="cstat-no" title="statement not covered" >  if (existingElId) {</span>
<span class="cstat-no" title="statement not covered" >    return { ELEMENT: existingElId };</span>
  }
&nbsp;
  // otherwise add the element to the map
<span class="cstat-no" title="statement not covered" >  this.maxElId++;</span>
<span class="cstat-no" title="statement not covered" >  this.elMap[this.maxElId.toString()] = new _fakeElement.FakeElement(obj, this.appModel);</span>
<span class="cstat-no" title="statement not covered" >  return { ELEMENT: this.maxElId.toString() };</span>
};
&nbsp;
helpers.findElOrEls = <span class="fstat-no" title="function not covered" >function callee$0$0(strategy, selector, mult, ctx) {</span>
<span class="cstat-no" title="statement not covered" >  var qMap, els, allEls, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, el;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        qMap = {</span>
          'xpath': 'xpathQuery',
          'id': 'idQuery',
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (_lodash2['default'].contains(_lodash2['default'].keys(qMap), strategy)) {</span>
...
&nbsp;
      case 3:
<span class="cstat-no" title="statement not covered" >        if (!(selector === "badsel")) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 5;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        throw new _appiumBaseDriver.errors.InvalidSelectorError();</span>
&nbsp;
      case 5:
<span class="cstat-no" title="statement not covered" >        els = this.appModel[qMap[strategy]](selector, ctx);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        allEls = [];</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        for (_iterator2 = _getIterator(els); !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {</span>
<span class="cstat-no" title="statement not covered" >          el = _step2.value;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          allEls.push(this.wrapNewEl(el));</span>
        }
...
&nbsp;
      case 28:
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', allEls);</span>
&nbsp;
      case 31:
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', this.wrapNewEl(els[0]));</span>
&nbsp;
      case 32:
...
&nbsp;
commands.findElement = <span class="fstat-no" title="function not covered" >function callee$0$0(strategy, selector) {</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', this.findElOrEls(strategy, selector, false));</span>
&nbsp;
      case 1:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
commands.findElements = <span class="fstat-no" title="function not covered" >function callee$0$0(strategy, selector) {</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', this.findElOrEls(strategy, selector, true));</span>
&nbsp;
      case 1:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
commands.findElementFromElement = <span class="fstat-no" title="function not covered" >function callee$0$0(strategy, selector, elementId) {</span>
<span class="cstat-no" title="statement not covered" >  var el;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        el = this.getElement(elementId);</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', this.findElOrEls(strategy, selector, false, el.xmlFragment));</span>
&nbsp;
      case 2:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
commands.findElementsFromElement = <span class="fstat-no" title="function not covered" >function callee$0$0(strategy, selector, elementId) {</span>
<span class="cstat-no" title="statement not covered" >  var el;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        el = this.getElement(elementId);</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', this.findElOrEls(strategy, selector, true, el.xmlFragment));</span>
&nbsp;
      case 2:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
