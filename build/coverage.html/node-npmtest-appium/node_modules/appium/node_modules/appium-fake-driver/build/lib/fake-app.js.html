...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-fake-driver/build/lib/fake-app.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-fake-driver/build/lib/fake-app.js</span></h1>
    <h2>
        
        Statements: <span class="metric">28.4% <small>(23 / 81)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">28.75% <small>(23 / 80)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-fake-driver/build/lib/</a> &#187; fake-app.js</div>
</div>
<div class="body">
...
<span class="fstat-no" title="function not covered" >  function FakeApp() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, FakeApp);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.dom = null;</span>
<span class="cstat-no" title="statement not covered" >    this.activeDom = null;</span>
<span class="cstat-no" title="statement not covered" >    this.activeWebview = null;</span>
<span class="cstat-no" title="statement not covered" >    this.activeFrame = null;</span>
<span class="cstat-no" title="statement not covered" >    this.activeAlert = null;</span>
<span class="cstat-no" title="statement not covered" >    this.lat = 0;</span>
<span class="cstat-no" title="statement not covered" >    this.long = 0;</span>
<span class="cstat-no" title="statement not covered" >    this.rawXml = '';</span>
<span class="cstat-no" title="statement not covered" >    this.currentOrientation = "PORTRAIT";</span>
  }
&nbsp;
  _createClass(FakeApp, [{
    key: 'loadApp',
    value: <span class="fstat-no" title="function not covered" >function loadApp(appPath) {</span>
<span class="cstat-no" title="statement not covered" >      var data;</span>
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function loadApp$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            _logger2['default'].info("Loading Mock app model");</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 3;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(readFile(appPath));</span>
&nbsp;
          case 3:
<span class="cstat-no" title="statement not covered" >            data = context$2$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].info("Parsing Mock app XML");</span>
<span class="cstat-no" title="statement not covered" >            this.rawXml = data.toString();</span>
<span class="cstat-no" title="statement not covered" >            this.dom = new _xmldom2['default'].DOMParser().parseFromString(this.rawXml);</span>
<span class="cstat-no" title="statement not covered" >            this.activeDom = this.dom;</span>
&nbsp;
          case 8:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    key: 'getWebviews',
    value: <span class="fstat-no" title="function not covered" >function getWebviews() {</span>
<span class="cstat-no" title="statement not covered" >      return this.xpathQuery('//MockWebView/*[1]').map(<span class="fstat-no" title="function not covered" >function (n) {</span></span>
<span class="cstat-no" title="statement not covered" >        return new FakeWebView(n);</span>
      });
    }
  }, {
    key: 'activateWebview',
    value: <span class="fstat-no" title="function not covered" >function activateWebview(wv) {</span>
<span class="cstat-no" title="statement not covered" >      this.activeWebview = wv;</span>
<span class="cstat-no" title="statement not covered" >      var fragment = new _xmldom2['default'].XMLSerializer().serializeToString(wv.node);</span>
<span class="cstat-no" title="statement not covered" >      this.activeDom = new _xmldom2['default'].DOMParser().parseFromString(fragment, "application/xml");</span>
    }
  }, {
    key: 'deactivateWebview',
    value: <span class="fstat-no" title="function not covered" >function deactivateWebview() {</span>
<span class="cstat-no" title="statement not covered" >      this.activeWebview = null;</span>
<span class="cstat-no" title="statement not covered" >      this.activeDom = this.dom;</span>
    }
  }, {
    key: 'activateFrame',
    value: <span class="fstat-no" title="function not covered" >function activateFrame(frame) {</span>
<span class="cstat-no" title="statement not covered" >      this.activeFrame = frame;</span>
<span class="cstat-no" title="statement not covered" >      var fragment = new _xmldom2['default'].XMLSerializer().serializeToString(frame);</span>
<span class="cstat-no" title="statement not covered" >      this.activeDom = new _xmldom2['default'].DOMParser().parseFromString(fragment, "application/xml");</span>
    }
  }, {
    key: 'deactivateFrame',
    value: <span class="fstat-no" title="function not covered" >function deactivateFrame() {</span>
<span class="cstat-no" title="statement not covered" >      this.activeFrame = null;</span>
<span class="cstat-no" title="statement not covered" >      this.activateWebview(this.activeWebview);</span>
    }
  }, {
    key: 'xpathQuery',
    value: <span class="fstat-no" title="function not covered" >function xpathQuery(sel, ctx) {</span>
<span class="cstat-no" title="statement not covered" >      return _xpath2['default'].select(sel, ctx || this.activeDom);</span>
    }
  }, {
    key: 'idQuery',
    value: <span class="fstat-no" title="function not covered" >function idQuery(id, ctx) {</span>
<span class="cstat-no" title="statement not covered" >      return this.xpathQuery('//*[@id="' + id + '"]', ctx);</span>
    }
  }, {
    key: 'classQuery',
    value: <span class="fstat-no" title="function not covered" >function classQuery(className, ctx) {</span>
<span class="cstat-no" title="statement not covered" >      return this.xpathQuery('//' + className, ctx);</span>
    }
  }, {
    key: 'hasAlert',
    value: <span class="fstat-no" title="function not covered" >function hasAlert() {</span>
<span class="cstat-no" title="statement not covered" >      return this.activeAlert !== null;</span>
    }
  }, {
    key: 'setAlertText',
    value: <span class="fstat-no" title="function not covered" >function setAlertText(text) {</span>
<span class="cstat-no" title="statement not covered" >      if (!this.activeAlert.hasPrompt()) {</span>
<span class="cstat-no" title="statement not covered" >        throw new Error("No prompt to set text of");</span>
      }
<span class="cstat-no" title="statement not covered" >      this.activeAlert.setAttr('prompt', text);</span>
    }
  }, {
    key: 'showAlert',
    value: <span class="fstat-no" title="function not covered" >function showAlert(alertId) {</span>
<span class="cstat-no" title="statement not covered" >      var nodes = this.xpathQuery('//alert[@id="' + alertId + '"]');</span>
<span class="cstat-no" title="statement not covered" >      if (nodes.length &lt; 1) {</span>
<span class="cstat-no" title="statement not covered" >        throw new Error('Alert ' + alertId + ' doesn\'t exist!');</span>
      }
<span class="cstat-no" title="statement not covered" >      this.activeAlert = new _fakeElement.FakeElement(nodes[0], this);</span>
    }
  }, {
    key: 'alertText',
    value: <span class="fstat-no" title="function not covered" >function alertText() {</span>
<span class="cstat-no" title="statement not covered" >      return this.activeAlert.getAttr('prompt') || this.activeAlert.nodeAttrs.text;</span>
    }
  }, {
    key: 'handleAlert',
    value: <span class="fstat-no" title="function not covered" >function handleAlert() {</span>
<span class="cstat-no" title="statement not covered" >      this.activeAlert = null;</span>
    }
  }, {
    key: 'getScreenshot',
    value: <span class="fstat-no" title="function not covered" >function getScreenshot() {</span>
<span class="cstat-no" title="statement not covered" >      return "hahahanotreallyascreenshot";</span>
    }
  }, {
    key: 'title',
    get: <span class="fstat-no" title="function not covered" >function get() {</span>
<span class="cstat-no" title="statement not covered" >      var nodes = this.xpathQuery('//title');</span>
<span class="cstat-no" title="statement not covered" >      if (nodes.length &lt; 1) {</span>
<span class="cstat-no" title="statement not covered" >        throw new Error("No title!");</span>
      }
<span class="cstat-no" title="statement not covered" >      return nodes[0].firstChild.data;</span>
    }
  }, {
...
<span class="cstat-no" title="statement not covered" >      return {</span>
    ...
    key: 'orientation',
    get: <span class="fstat-no" title="function not covered" >function get() {</span>
<span class="cstat-no" title="statement not covered" >      return this.currentOrientation;</span>
    },
    set: <span class="fstat-no" title="function not covered" >function set(o) {</span>
<span class="cstat-no" title="statement not covered" >      this.currentOrientation = o;</span>
    }
  }]);
&nbsp;
  return FakeApp;
...
&nbsp;
var FakeWebView = <span class="fstat-no" title="function not covered" >function FakeWebView(node) {</span>
<span class="cstat-no" title="statement not covered" >  _classCallCheck(this, FakeWebView);</span>
&nbsp;
