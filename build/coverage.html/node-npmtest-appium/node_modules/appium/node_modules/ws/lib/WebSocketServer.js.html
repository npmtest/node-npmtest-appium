...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/ws/lib/WebSocketServer.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/ws/lib/WebSocketServer.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">3.85% <small>(10 / 260)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/ws/lib/</a> &#187; WebSocketServer.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >  if (this instanceof WebSocketServer === false) {</span>
<span class="cstat-no" title="statement not covered" >    return new WebSocketServer(options, callback);</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      var body = http.STATUS_CODES[426];</span>
...
<span class="cstat-no" title="statement not covered" >    this._server.allowHalfOpen = false;</span>
<span class="cstat-no" title="statement not covered" >    this._server.listen(options.value.port, options.value.host, callback);</span>
<span class="cstat-no" title="statement not covered" >    this._closeServer = <span class="fstat-no" title="function not covered" >function() {</span> <span class="cstat-no" title="statement not covered" >if (self._server) <span class="cstat-no" title="statement not covered" >self._server.close(); </span></span>};</span>
  }
...
<span class="cstat-no" title="statement not covered" >    this._onceServerListening = <span class="fstat-no" title="function not covered" >function() {</span> <span class="cstat-no" title="statement not covered" >self.emit('listening'); </span>};</span>
<span class="cstat-no" title="statement not covered" >    this._server.once('listening', this._onceServerListening);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (typeof this._server != 'undefined') {</span>
<span class="cstat-no" title="statement not covered" >    this._onServerError = <span class="fstat-no" title="function not covered" >function(error) {</span> <span class="cstat-no" title="statement not covered" >self.emit('error', error) }</span>;</span>
<span class="cstat-no" title="statement not covered" >    this._server.on('error', this._onServerError);</span>
<span class="cstat-no" title="statement not covered" >    this._onServerUpgrade = <span class="fstat-no" title="function not covered" >function(req, socket, upgradeHead) {</span></span>
...
<span class="cstat-no" title="statement not covered" >    this._server.on('upgrade', this._onServerUpgrade);</span>
  }
&nbsp;
 ...
 */
&nbsp;
WebSocketServer.prototype.close = <span class="fstat-no" title="function not covered" >function(callback) {</span>
...
<span class="cstat-no" title="statement not covered" >    if (this._server) {</span>
<span class="cstat-no" title="statement not covered" >      this._server.removeListener('listening', this._onceServerListening);</span>
<span class="cstat-no" title="statement not covered" >      this._server.removeListener('error', this._onServerError);</span>
<span class="cstat-no" title="statement not covered" >      this._server.removeListener('upgrade', this._onServerUpgrade);</span>
    }
...
<span class="cstat-no" title="statement not covered" >  var extensionsOffer = Extensions.parse(req.headers['sec-websocket-extensions']);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    try {</span>
<span class="cstat-no" title="statement not covered" >      extensions = acceptExtensions.call(self, extensionsOffer);</span>
    } catch (err) {
<span class="cstat-no" title="statement not covered" >      abortConnection(socket, 400, 'Bad Request');</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (Object.keys(extensions).length) {</span>
<span class="cstat-no" title="statement not covered" >      var serverExtensions = {};</span>
<span class="cstat-no" title="statement not covered" >      Object.keys(extensions).forEach(<span class="fstat-no" title="function not covered" >function(token) {</span></span>
<span class="cstat-no" title="statement not covered" >        serverExtensions[token] = [extensions[token].params]</span>
      });
<span class="cstat-no" title="statement not covered" >      headers.push('Sec-WebSocket-Extensions: ' + Extensions.format(serverExtensions));</span>
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      this.options.verifyClient(info, <span class="fstat-no" title="function not covered" >function(result, code, name) {</span></span>
<span class="cstat-no" title="statement not covered" >        if (typeof code === 'undefined') <span class="cstat-no" title="statement not covered" >code = 401;</span></span>
<span class="cstat-no" title="statement not covered" >        if (typeof name === 'undefined') <span class="cstat-no" title="statement not covered" >name = http.STATUS_CODES[code];</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!result) <span class="cstat-no" title="statement not covered" >abortConnection(socket, code, name);</span></span>
...
<span class="cstat-no" title="statement not covered" >    var buildResponseHeader = <span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >      var headers = [</span>
          'HTTP/1.1 101 Switching Protocols'
        , 'Upgrade: WebSocket'
        , 'Connection: Upgrade'
...
<span class="cstat-no" title="statement not covered" >    var handshakeResponse = <span class="fstat-no" title="function not covered" >function() {</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      socket.setTimeout(0);</span>
<span class="cstat-no" title="statement not covered" >      socket.setNoDelay(true);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var headerBuffer = buildResponseHeader();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      try {</span>
<span class="cstat-no" title="statement not covered" >        socket.write(headerBuffer, 'binary', <span class="fstat-no" title="function not covered" >function(err) {</span></span>
          // remove listener if there was an error
<span class="cstat-no" title="statement not covered" >          if (err) <span class="cstat-no" title="statement not covered" >socket.removeListener('data', handler);</span></span>
<span class="cstat-no" title="statement not covered" >          return;</span>
        });
      } catch (e) {
<span class="cstat-no" title="statement not covered" >        try { <span class="cstat-no" title="statement not covered" >socket.destroy(); </span>} catch (e) {}</span>
...
<span class="cstat-no" title="statement not covered" >    var completeHandshake = <span class="fstat-no" title="function not covered" >function(nonce, rest, headerBuffer) {</span></span>
      // calculate key
...
<span class="cstat-no" title="statement not covered" >      completeHandshake.call(self, nonce, rest, buildResponseHeader());</span>
    }
    else {
...
<span class="cstat-no" title="statement not covered" >          completeHandshake.call(self, nonce, rest, new Buffer(0));</span>
        }
      }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      handshakeResponse();</span>
    }
  }
&nbsp;
  // verify client
...
&nbsp;
<span class="fstat-no" title="function not covered" >function acceptExtensions(offer) {</span>
<span class="cstat-no" title="statement not covered" >  var extensions = {};</span>
<span class="cstat-no" title="statement not covered" >  var options = this.options.perMessageDeflate;</span>
<span class="cstat-no" title="statement not covered" >  var maxPayload = this.options.maxPayload;</span>
<span class="cstat-no" title="statement not covered" >  if (options &amp;&amp; offer[PerMessageDeflate.extensionName]) {</span>
<span class="cstat-no" title="statement not covered" >    var perMessageDeflate = new PerMessageDeflate(options !== true ? options : {}, true, maxPayload);</span>
<span class="cstat-no" title="statement not covered" >    perMessageDeflate.accept(offer[PerMessageDeflate.extensionName]);</span>
<span class="cstat-no" title="statement not covered" >    extensions[PerMessageDeflate.extensionName] = perMessageDeflate;</span>
  }
