...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/ws/lib/Sender.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/ws/lib/Sender.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/ws/lib/</a> &#187; Sender.js</div>
</div>
<div class="body">
 ...
 */
&nbsp;
<span class="fstat-no" title="function not covered" >function Sender(socket, extensions) {</span>
<span class="cstat-no" title="statement not covered" >  if (this instanceof Sender === false) {</span>
...
<span class="cstat-no" title="statement not covered" >  this.compress = false;</span>
...
<span class="cstat-no" title="statement not covered" >    self.frameAndSend(0x8, dataBuffer, true, mask);</span>
...
<span class="cstat-no" title="statement not covered" >  var self = this;</span>
<span class="cstat-no" title="statement not covered" >  this.messageHandlers.push(<span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >    self.frameAndSend(0x9, data || '', true, mask);</span>
  });
<span class="cstat-no" title="statement not covered" >  this.flush();</span>
};
&nbsp;
...
<span class="cstat-no" title="statement not covered" >  var self = this;</span>
<span class="cstat-no" title="statement not covered" >  this.messageHandlers.push(<span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >    self.frameAndSend(0xa, data || '', true, mask);</span>
  });
<span class="cstat-no" title="statement not covered" >  this.flush();</span>
};
&nbsp;
...
<span class="cstat-no" title="statement not covered" >  var mask = options &amp;&amp; options.mask;</span>
<span class="cstat-no" title="statement not covered" >  var compress = options &amp;&amp; options.compress;</span>
<span class="cstat-no" title="statement not covered" >  var opcode = options &amp;&amp; options.binary ? 2 : 1;</span>
<span class="cstat-no" title="statement not covered" >  if (this.firstFragment === false) {</span>
<span class="cstat-no" title="statement not covered" >    opcode = 0;</span>
<span class="cstat-no" title="statement not covered" >    compress = false;</span>
  } else {
<span class="cstat-no" title="statement not covered" >    this.firstFragment = false;</span>
<span class="cstat-no" title="statement not covered" >    this.compress = compress;</span>
  }
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  var compressFragment = this.compress;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var self = this;</span>
<span class="cstat-no" title="statement not covered" >  this.messageHandlers.push(<span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >    if (!data || !compressFragment) {</span>
<span class="cstat-no" title="statement not covered" >      self.frameAndSend(opcode, data, finalFragment, mask, compress, cb);</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    self.processing = true;</span>
<span class="cstat-no" title="statement not covered" >    self.applyExtensions(data, finalFragment, compressFragment, <span class="fstat-no" title="function not covered" >function(err, data) {</span></span>
...
<span class="cstat-no" title="statement not covered" >        if (typeof cb == 'function') <span class="cstat-no" title="statement not covered" >cb(err);</span></span>
        else <span class="cstat-no" title="statement not covered" >self.emit('error', err);</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
<span class="cstat-no" title="statement not covered" >      self.frameAndSend(opcode, data, finalFragment, mask, compress, cb);</span>
 ...
 */
&nbsp;
Sender.prototype.frameAndSend = <span class="fstat-no" title="function not covered" >function(opcode, data, finalFragment, maskData, compressed, cb) {</span>
...
<span class="cstat-no" title="statement not covered" >      data = getArrayBuffer(data);</span>
      ...
      //
<span class="cstat-no" title="statement not covered" >      if (typeof data === 'number') <span class="cstat-no" title="statement not covered" >data = data.toString();</span></span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >  if (compressed) <span class="cstat-no" title="statement not covered" >outputBuffer[0] |= 0x40;</span></span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    var mask = getRandomMask();</span>
 ...
 */
&nbsp;
Sender.prototype.flush = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  while (!this.processing &amp;&amp; this.messageHandlers.length) {</span>
<span class="cstat-no" title="statement not covered" >    this.messageHandlers.shift()();</span>
  }
};
&nbsp;
/**
 ...
 */
&nbsp;
Sender.prototype.applyExtensions = <span class="fstat-no" title="function not covered" >function(data, fin, compress, callback) {</span>
<span class="cstat-no" title="statement not covered" >  if ((data.buffer || data) instanceof ArrayBuffer) {</span>
<span class="cstat-no" title="statement not covered" >    data = getArrayBuffer(data);</span>
  }
<span class="cstat-no" title="statement not covered" >  this.extensions[PerMessageDeflate.extensionName].compress(data, fin, callback);</span>
};
&nbsp;
...
<span class="cstat-no" title="statement not covered" >  return crypto.randomBytes(4);</span>
}
&nbsp;
&nbsp;</pre></td></tr>
</table></pre>
