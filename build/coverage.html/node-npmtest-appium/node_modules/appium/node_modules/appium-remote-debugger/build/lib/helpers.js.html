...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-remote-debugger/build/lib/helpers.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-remote-debugger/build/lib/helpers.js</span></h1>
    <h2>
        
        Statements: <span class="metric">13.26% <small>(35 / 264)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-remote-debugger/build/lib/</a> &#187; helpers.js</div>
</div>
<div class="body">
 ...
 */
<span class="fstat-no" title="function not covered" >function appInfoFromDict(dict) {</span>
<span class="cstat-no" title="statement not covered" >  var id = dict.WIRApplicationIdentifierKey;</span>
<span class="cstat-no" title="statement not covered" >  var isProxy = _lodash2['default'].isString(dict.WIRIsApplicationProxyKey) ? dict.WIRIsApplicationProxyKey.toLowerCase() === 'true' : dict.WIRIsApplicationProxyKey;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  return [id, entry];</span>
}
&nbsp;
/*
 ...
 */
<span class="fstat-no" title="function not covered" >function pageArrayFromDict(pageDict) {</span>
<span class="cstat-no" title="statement not covered" >  if (pageDict.id) {</span>
    // the page is already translated, so wrap in an array and pass back
<span class="cstat-no" title="statement not covered" >    return [pageDict];</span>
  }
<span class="cstat-no" title="statement not covered" >  var newPageArray = [];</span>
...
<span class="cstat-no" title="statement not covered" >    for (var _iterator = _getIterator(_lodash2['default'].values(pageDict)), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {</span>
<span class="cstat-no" title="statement not covered" >      var dict = _step.value;</span>
&nbsp;
      // count only WIRTypeWeb pages and ignore all others (WIRTypeJavaScript etc)
<span class="cstat-no" title="statement not covered" >      if (_lodash2['default'].isUndefined(dict.WIRTypeKey) || dict.WIRTypeKey === 'WIRTypeWeb') {</span>
<span class="cstat-no" title="statement not covered" >        newPageArray.push({</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  return newPageArray;</span>
}
&nbsp;
/*
 ...
 * connected.
 */
<span class="fstat-no" title="function not covered" >function getDebuggerAppKey(bundleId, platformVersion, appDict) {</span>
<span class="cstat-no" title="statement not covered" >  var appId = undefined;</span>
<span class="cstat-no" title="statement not covered" >  if (parseFloat(platformVersion) &gt;= 8) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    try {</span>
<span class="cstat-no" title="statement not covered" >      for (var _iterator2 = _getIterator(_lodash2['default'].toPairs(appDict)), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {</span>
...
<span class="cstat-no" title="statement not covered" >        var data = _step2$value[1];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (data.bundleId === bundleId) {</span>
<span class="cstat-no" title="statement not covered" >          appId = key;</span>
...
<span class="cstat-no" title="statement not covered" >      _logger2['default'].debug('Found app id key \'' + appId + '\' for bundle \'' + bundleId + '\'');</span>
<span class="cstat-no" title="statement not covered" >      var proxiedAppIds = [];</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      try {</span>
<span class="cstat-no" title="statement not covered" >        for (var _iterator3 = _getIterator(_lodash2['default'].toPairs(appDict)), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {</span>
<span class="cstat-no" title="statement not covered" >          var _step3$value = _slicedToArray(_step3.value, 2);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          var key = _step3$value[0];</span>
<span class="cstat-no" title="statement not covered" >          var data = _step3$value[1];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (data.isProxy &amp;&amp; data.hostId === appId) {</span>
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Found separate bundleId \'' + data.bundleId + '\' ' + ('acting as proxy for \'' + bundleId + '\', with app id \'' + key + '\''));</span>
<span class="cstat-no" title="statement not covered" >            proxiedAppIds.push(key);</span>
          }
        }
      } catch (err) {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (proxiedAppIds.length) {</span>
        // use the last app being proxied
<span class="cstat-no" title="statement not covered" >        appId = _lodash2['default'].last(proxiedAppIds);</span>
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Using proxied app id \'' + appId + '\'');</span>
      }
    }
  } else {
<span class="cstat-no" title="statement not covered" >    if (_lodash2['default'].has(appDict, bundleId)) {</span>
<span class="cstat-no" title="statement not covered" >      appId = bundleId;</span>
    }
  }
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >function appIdForBundle(_x2, _x3) {</span>
...
<span class="cstat-no" title="statement not covered" >    var bundleId = _x2,</span>
        appDict = _x3;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    try {</span>
<span class="cstat-no" title="statement not covered" >      for (var _iterator4 = _getIterator(_lodash2['default'].toPairs(appDict)), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {</span>
<span class="cstat-no" title="statement not covered" >        var _step4$value = _slicedToArray(_step4.value, 2);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        var key = _step4$value[0];</span>
<span class="cstat-no" title="statement not covered" >        var data = _step4$value[1];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (data.bundleId === bundleId) {</span>
<span class="cstat-no" title="statement not covered" >          appId = key;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!appId &amp;&amp; bundleId !== WEB_CONTENT_BUNDLE_ID) {</span>
<span class="cstat-no" title="statement not covered" >      _x2 = WEB_CONTENT_BUNDLE_ID;</span>
<span class="cstat-no" title="statement not covered" >      _x3 = appDict;</span>
<span class="cstat-no" title="statement not covered" >      _again = true;</span>
<span class="cstat-no" title="statement not covered" >      appId = _iteratorNormalCompletion4 = _didIteratorError4 = _iteratorError4 = undefined;</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function getPossibleDebuggerAppKeys(bundleId, platformVersion, appDict) {</span>
<span class="cstat-no" title="statement not covered" >  var proxiedAppIds = [];</span>
<span class="cstat-no" title="statement not covered" >  if (parseFloat(platformVersion) &gt;= 8) {</span>
<span class="cstat-no" title="statement not covered" >    var appId = appIdForBundle(bundleId, appDict);</span>
&nbsp;
    // now we need to determine if we should pick a proxy for this instead
<span class="cstat-no" title="statement not covered" >    if (appId) {</span>
<span class="cstat-no" title="statement not covered" >      _logger2['default'].debug('Found app id key \'' + appId + '\' for bundle \'' + bundleId + '\'');</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      try {</span>
<span class="cstat-no" title="statement not covered" >        for (var _iterator5 = _getIterator(_lodash2['default'].toPairs(appDict)), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {</span>
<span class="cstat-no" title="statement not covered" >          var _step5$value = _slicedToArray(_step5.value, 2);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          var key = _step5$value[0];</span>
<span class="cstat-no" title="statement not covered" >          var data = _step5$value[1];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (data.isProxy &amp;&amp; data.hostId === appId) {</span>
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Found separate bundleId \'' + data.bundleId + '\' ' + ('acting as proxy for \'' + bundleId + '\', with app id \'' + key + '\''));</span>
<span class="cstat-no" title="statement not covered" >            proxiedAppIds.push(key);</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (proxiedAppIds.length === 0) {</span>
<span class="cstat-no" title="statement not covered" >        proxiedAppIds = [appId];</span>
      }
    }
  } else {
<span class="cstat-no" title="statement not covered" >    if (_lodash2['default'].has(appDict, bundleId)) {</span>
<span class="cstat-no" title="statement not covered" >      proxiedAppIds = [bundleId];</span>
    }
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return proxiedAppIds;</span>
}
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  try {</span>
<span class="cstat-no" title="statement not covered" >    for (var _iterator6 = _getIterator(_lodash2['default'].toPairs(params)), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {</span>
<span class="cstat-no" title="statement not covered" >      var _step6$value = _slicedToArray(_step6.value, 2);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var param = _step6$value[0];</span>
<span class="cstat-no" title="statement not covered" >      var value = _step6$value[1];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      try {</span>
<span class="cstat-no" title="statement not covered" >        _assert2['default'].ok(value);</span>
      } catch (err) {
...
&nbsp;
<span class="fstat-no" title="function not covered" >function wrapScriptForFrame(script, frame) {</span>
<span class="cstat-no" title="statement not covered" >  var elFromCache;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function wrapScriptForFrame$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Wrapping script for frame \'' + frame + '\'');</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 3;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _atoms2['default'])('get_element_from_cache'));</span>
&nbsp;
      case 3:
<span class="cstat-no" title="statement not covered" >        elFromCache = context$1$0.sent;</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', '(function (window) { var document = window.document; ' + ('return (' + script + '); })((' + elFromCache.toString('utf8') + ')(' + JSON.stringify(frame) + '))'));</span>
&nbsp;
      case 5:
      case 'end':
...
&nbsp;
<span class="fstat-no" title="function not covered" >function getScriptForAtom(atom, args, frames) {</span>
<span class="cstat-no" title="statement not covered" >  var asyncCallBack = arguments.length &lt;= 3 || arguments[3] === undefined ? null : arguments[3];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var atomSrc, script, _iteratorNormalCompletion7, _didIteratorError7, _iteratorError7, _iterator7, _step7, frame;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function getScriptForAtom$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _atoms2['default'])(atom));</span>
&nbsp;
      case 2:
<span class="cstat-no" title="statement not covered" >        atomSrc = context$1$0.sent;</span>
<span class="cstat-no" title="statement not covered" >        script = undefined;</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        script = atomSrc;</span>
...
<span class="cstat-no" title="statement not covered" >        _iterator7 = _getIterator(frames);</span>
&nbsp;
      case 11:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        frame = _step7.value;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 15;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(wrapScriptForFrame(script, frame));</span>
&nbsp;
      case 15:
...
<span class="cstat-no" title="statement not covered" >        _iteratorError7 = context$1$0.t0;</span>
&nbsp;
      case 25:
...
&nbsp;
      case 35:
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Executing \'' + atom + '\' atom in default context');</span>
<span class="cstat-no" title="statement not covered" >        script = '(' + atomSrc + ')';</span>
&nbsp;
      case 37:
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        if (asyncCallBack) {</span>
<span class="cstat-no" title="statement not covered" >          script += '(' + args.join(',') + ', ' + asyncCallBack + ', true )';</span>
        } else {
<span class="cstat-no" title="statement not covered" >          script += '(' + args.join(',') + ')';</span>
        }
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >function simpleStringify(value) {</span>
<span class="cstat-no" title="statement not covered" >  if (!value) <span class="cstat-no" title="statement not covered" >return JSON.stringify(value);</span></span>
&nbsp;
  // we get back objects sometimes with string versions of functions
  // which muddy the logs
<span class="cstat-no" title="statement not covered" >  var cleanValue = _lodash2['default'].clone(value);</span>
<span class="cstat-no" title="statement not covered" >  var _arr = ['ceil', 'clone', 'floor', 'round', 'scale', 'toString'];</span>
<span class="cstat-no" title="statement not covered" >  for (var _i = 0; _i &lt; _arr.length; _i++) {</span>
<span class="cstat-no" title="statement not covered" >    var property = _arr[_i];</span>
<span class="cstat-no" title="statement not covered" >    delete cleanValue[property];</span>
  }
<span class="cstat-no" title="statement not covered" >  return JSON.stringify(cleanValue);</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function deferredPromise() {</span>
  // http://bluebirdjs.com/docs/api/deferred-migration.html
<span class="cstat-no" title="statement not covered" >  var resolve = undefined;</span>
<span class="cstat-no" title="statement not covered" >  var reject = undefined;</span>
<span class="cstat-no" title="statement not covered" >  var promise = new _bluebird2['default'](<span class="fstat-no" title="function not covered" >function (res, rej) {</span></span>
