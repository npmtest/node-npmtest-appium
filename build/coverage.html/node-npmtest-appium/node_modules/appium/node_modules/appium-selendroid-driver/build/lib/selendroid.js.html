...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-selendroid-driver/build/lib/selendroid.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-selendroid-driver/build/lib/selendroid.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">14.48% <small>(21 / 145)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-selendroid-driver/build/lib/</a> &#187; selendroid.js</div>
</div>
<div class="body">
...
<span class="fstat-no" title="function not covered" >  function SelendroidServer() {</span>
<span class="cstat-no" title="statement not covered" >    var opts = arguments.length &lt;= 0 || arguments[0] === undefined ? {} : arguments[0];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, SelendroidServer);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.modServerPkg = 'selendroid.' + this.appPackage;</span>
    // path to the repackaged selendroid server specific to this app
<span class="cstat-no" title="statement not covered" >    this.modServerPath = _path2['default'].resolve(this.tmpDir, this.modServerPkg + '.apk');</span>
...
&nbsp;
  _createClass(SelendroidServer, [{
    ...
    value: <span class="fstat-no" title="function not covered" >function prepareModifiedServer() {</span>
<span class="cstat-no" title="statement not covered" >      var needsUninstall;</span>
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function prepareModifiedServer$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            needsUninstall = false;</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 3;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(_appiumSupport.fs.exists(this.modServerPath));</span>
&nbsp;
          case 3:
...
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.buildNewModServer());</span>
&nbsp;
          case 6:
<span class="cstat-no" title="statement not covered" >            needsUninstall = true;</span>
&nbsp;
          case 7:
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 9;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.checkAndSignCert(this.modServerPath));</span>
&nbsp;
          case 9:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            context$2$0.t0 = needsUninstall;</span>
&nbsp;
          case 12:
<span class="cstat-no" title="statement not covered" >            needsUninstall = context$2$0.t0;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (!needsUninstall) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 17;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].info("New server was built, uninstalling any instances of it");</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 17;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.adb.uninstallApk(this.modServerPkg));</span>
&nbsp;
          case 17:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    value: <span class="fstat-no" title="function not covered" >function installModifiedServer() {</span>
<span class="cstat-no" title="statement not covered" >      var installed;</span>
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function installModifiedServer$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.adb.isAppInstalled(this.modServerPkg));</span>
&nbsp;
          case 2:
<span class="cstat-no" title="statement not covered" >            installed = context$2$0.sent;</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 6;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.adb.install(this.modServerPath));</span>
&nbsp;
          case 6:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    value: <span class="fstat-no" title="function not covered" >function buildNewModServer() {</span>
<span class="cstat-no" title="statement not covered" >      var packageTmpDir, newManifestPath;</span>
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function buildNewModServer$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            _logger2['default'].info('Repackaging selendroid for: \'' + this.appPackage + '\'');</span>
<span class="cstat-no" title="statement not covered" >            packageTmpDir = _path2['default'].resolve(this.tmpDir, this.appPackage);</span>
<span class="cstat-no" title="statement not covered" >            newManifestPath = _path2['default'].resolve(this.tmpDir, 'AndroidManifest.xml');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].info('Creating new manifest: \'' + newManifestPath + '\'');</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 6;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(_appiumSupport.fs.mkdir(packageTmpDir));</span>
&nbsp;
          case 6:
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 8;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(_appiumSupport.fs.copyFile(_installer.SE_MANIFEST_PATH, newManifestPath));</span>
&nbsp;
          case 8:
...
&nbsp;
          case 10:
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 12;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.adb.compileManifest(newManifestPath, this.modServerPkg, this.appPackage));</span>
&nbsp;
          case 12:
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 14;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.adb.insertManifest(newManifestPath, _installer.SE_APK_PATH, this.modServerPath));</span>
&nbsp;
          case 14:
<span class="cstat-no" title="statement not covered" >            _logger2['default'].info('Repackaged selendroid ready: \'' + this.modServerPath + '\'');</span>
&nbsp;
          case 15:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    value: <span class="fstat-no" title="function not covered" >function checkAndSignCert(apk) {</span>
...
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.adb.checkApkCert(apk, this.appPackage));</span>
&nbsp;
          case 2:
...
<span class="cstat-no" title="statement not covered" >      var instrumentWith;</span>
...
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            instrumentWith = this.modServerPkg + '/' + 'io.selendroid.server.ServerInstrumentation';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].info('Starting selendroid server with instrumentation: ' + ('' + instrumentWith));</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 4;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.adb.instrument(this.appPackage, this.appActivity, instrumentWith));</span>
&nbsp;
          case 4:
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].info('Waiting for Selendroid to be online...');</span>
...
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Deleting Selendroid server session');</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].warn('Did not get confirmation Selendroid deleteSession worked; ' + ('Error was: ' + context$2$0.t0));</span>
&nbsp;
          case 9:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
