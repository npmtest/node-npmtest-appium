...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-selendroid-driver/build/lib/commands.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-selendroid-driver/build/lib/commands.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-selendroid-driver/build/lib/</a> &#187; commands.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >  var oldImpWait, oldCommandTimeoutMs, oldSessionId;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
...
<span class="cstat-no" title="statement not covered" >        oldCommandTimeoutMs = this.commandTimeoutMs;</span>
<span class="cstat-no" title="statement not covered" >        oldSessionId = this.sessionId;</span>
...
&nbsp;
      case 9:
<span class="cstat-no" title="statement not covered" >        this.implicitWait(oldImpWait);</span>
<span class="cstat-no" title="statement not covered" >        this.timeouts('command', oldCommandTimeoutMs);</span>
<span class="cstat-no" title="statement not covered" >        this.sessionId = oldSessionId;</span>
&nbsp;
      case 12:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
commands.performMultiAction = <span class="fstat-no" title="function not covered" >function callee$0$0(elId, actions) {</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        if (!elId) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        throw new Error("Selendroid actions do not support element id");</span>
&nbsp;
      case 2:
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', this.selendroid.jwproxy.command('/action', 'POST', { payload: actions }));</span>
&nbsp;
      case 3:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function encodeString(value, unicode) {</span>
<span class="cstat-no" title="statement not covered" >  for (var i = 0; i &lt; value.length; i++) {</span>
<span class="cstat-no" title="statement not covered" >    var c = value.charCodeAt(i);</span>
    // if we're using the unicode keyboard, and this is unicode, maybe encode
<span class="cstat-no" title="statement not covered" >    if (unicode &amp;&amp; (c &gt; 127 || c === 38)) {</span>
      // this is not simple ascii, or it is an ampersand (`&amp;`)
<span class="cstat-no" title="statement not covered" >      if (c &gt;= parseInt("E000", 16) &amp;&amp; c &lt;= parseInt("E040", 16)) {</span>
        ...
        // see https://code.google.com/p/selenium/source/browse/java/client/src/org/openqa/selenium/Keys.java
          ...
          // encode the text
<span class="cstat-no" title="statement not covered" >          value = imap.encode(value);</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
    }
  }
...
commands.setValue = <span class="fstat-no" title="function not covered" >function callee$0$0(value, elementId) {</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
...
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Setting text on element \'' + elementId + '\': \'' + value + '\'');</span>
<span class="cstat-no" title="statement not covered" >        value = encodeString(value, this.opts.unicodeKeyboard);</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 5;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.selendroid.jwproxy.command('/element/' + elementId + '/value', 'POST', { value: [value] }));</span>
&nbsp;
      case 5:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Setting text: \'' + value + '\'');</span>
<span class="cstat-no" title="statement not covered" >        value = encodeString(value, this.opts.unicodeKeyboard);</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 5;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.selendroid.jwproxy.command('/keys', 'POST', { value: [value] }));</span>
&nbsp;
      case 5:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
<span class="cstat-no" title="statement not covered" >  var chromiumViews, webviews, selendroidViews;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        chromiumViews = [];</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 3;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_appiumAndroidDriver.webviewHelpers.getWebviews(this.adb, this.opts.androidDeviceSocket));</span>
&nbsp;
      case 3:
<span class="cstat-no" title="statement not covered" >        webviews = context$1$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (_lodash2['default'].contains(webviews, _appiumAndroidDriver.CHROMIUM_WIN)) {</span>
<span class="cstat-no" title="statement not covered" >          chromiumViews = [_appiumAndroidDriver.CHROMIUM_WIN];</span>
        } else {
<span class="cstat-no" title="statement not covered" >          chromiumViews = [];</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].info('Getting window handles from Selendroid');</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 8;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.selendroid.jwproxy.command('/window_handles', 'GET', {}));</span>
&nbsp;
      case 8:
<span class="cstat-no" title="statement not covered" >        selendroidViews = context$1$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        this.contexts = _lodash2['default'].union(selendroidViews, chromiumViews);</span>
<span class="cstat-no" title="statement not covered" >        _logger2['default'].info('Available contexts: ' + JSON.stringify(this.contexts));</span>
...
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.selendroid.jwproxy.command('/window', 'POST', { name: name }));</span>
&nbsp;
      case 2:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
helpers.isChromedriverContext = <span class="fstat-no" title="function not covered" >function (windowName) {</span>
<span class="cstat-no" title="statement not covered" >  return windowName === _appiumAndroidDriver.CHROMIUM_WIN;</span>
};
&nbsp;
...
&nbsp;
      case 4:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 6;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.adb.forwardPort(this.opts.systemPort, _driver.DEVICE_PORT));</span>
&nbsp;
      case 6:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
