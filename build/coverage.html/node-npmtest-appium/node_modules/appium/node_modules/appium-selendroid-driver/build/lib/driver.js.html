...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-selendroid-driver/build/lib/driver.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-selendroid-driver/build/lib/driver.js</span></h1>
    <h2>
        
        Statements: <span class="metric">22.37% <small>(68 / 304)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">5.93% <small>(8 / 135)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">4% <small>(1 / 25)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">23.05% <small>(68 / 295)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-selendroid-driver/build/lib/</a> &#187; driver.js</div>
</div>
<div class="body">
...
678
679
680</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function SelendroidDriver() {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, SelendroidDriver);</span>
&nbsp;
    // `shell` overwrites adb.shell, so remove
<span class="cstat-no" title="statement not covered" >    delete opts.shell;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _get(Object.getPrototypeOf(SelendroidDriver.prototype), 'constructor', this).call(this, opts, shouldValidateCaps);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.desiredCapConstraints = _desiredCaps2['default'];</span>
<span class="cstat-no" title="statement not covered" >    this.selendroid = null;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.opts.systemPort = opts.selendroidPort || SYSTEM_PORT_RANGE[0];</span>
<span class="cstat-no" title="statement not covered" >    this.opts.adbPort = opts.adbPort || _appiumAdb.DEFAULT_ADB_PORT;</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      var sessionId, _ref, _ref2;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap((0, _installer.serverExists)());</span>
&nbsp;
          case 3:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            throw new Error('Cannot start a selendroid session because the server ' + 'apk does not exist. Please run `npm run-script ' + 'selendroid` in the appium-selendroid-driver package');</span>
&nbsp;
          case 5:
...
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(_get(Object.getPrototypeOf(SelendroidDriver.prototype), 'createSession', this).call(this, caps));</span>
&nbsp;
          case 8:
...
&nbsp;
          case 17:
<span class="cstat-no" title="statement not covered" >            this.opts.systemPort = this.opts.selendroidPort || SYSTEM_PORT_RANGE[0];</span>
...
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.startSelendroidSession());</span>
&nbsp;
          case 21:
...
<span class="cstat-no" title="statement not covered" >      var res = _get(Object.getPrototypeOf(SelendroidDriver.prototype), 'validateDesiredCaps', this).call(this, caps);</span>
...
<span class="cstat-no" title="statement not covered" >          _logger2['default'].errorAndThrow('avd or deviceName should be specified when reboot option is enabled');</span>
        }
...
<span class="cstat-no" title="statement not covered" >        this.opts.avd = avdDevice + '__' + caps.platformVersion;</span>
    ...
    value: <span class="fstat-no" title="function not covered" >function startSelendroidSession() {</span>
<span class="cstat-no" title="statement not covered" >      var _ref3,</span>
&nbsp;
      // get device udid for this session
      udid, emPort, appInfo;
&nbsp;
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function startSelendroidSession$(context$2$0) {</span></span>
...
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(helpers.ensureInternetPermissionForApp(this.adb, this.opts.app));</span>
&nbsp;
          case 16:
...
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.initSelendroidServer());</span>
&nbsp;
          case 22:
...
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.selendroid.startSession(this.caps));</span>
&nbsp;
          case 32:
...
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    value: <span class="fstat-no" title="function not covered" >function initSelendroidServer() {</span>
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function initSelendroidServer$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
            // now that we have package and activity, we can create an instance of
            // selendroid with the appropriate data
<span class="cstat-no" title="statement not covered" >            this.selendroid = new _selendroid2['default']({</span>
...
<span class="cstat-no" title="statement not covered" >            this.proxyReqRes = this.selendroid.proxyReqRes.bind(this.selendroid);</span>
            // let selendroid repackage itself for our AUT
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 4;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.selendroid.prepareModifiedServer());</span>
&nbsp;
          case 4:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
...
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Initializing application under test');</span>
...
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 3;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(helpers.pushStrings(this.opts.language, this.adb, this.opts));</span>
&nbsp;
          case 3:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Application not signed. Signing.');</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 15;</span>
...
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.selendroid.installModifiedServer());</span>
&nbsp;
          case 19:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
...
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 5;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.adb.waitForActivity(appWaitPackage, appWaitActivity, 5000));</span>
&nbsp;
          case 5:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].info('Selendroid did not start the activity we were waiting for, ' + ('\'' + appWaitPackage + '/' + appWaitActivity + '\'. ') + 'Starting it ourselves');</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 12;</span>
...
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Deleting Selendroid session');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (!this.selendroid) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 6;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
            }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 5;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.selendroid.deleteSession());</span>
&nbsp;
          case 5:
<span class="cstat-no" title="statement not covered" >            this.selendroid = null;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(_get(Object.getPrototypeOf(SelendroidDriver.prototype), 'deleteSession', this).call(this));</span>
&nbsp;
          case 23:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
...
<span class="cstat-no" title="statement not covered" >      _get(Object.getPrototypeOf(SelendroidDriver.prototype), 'proxyActive', this).call(this, sessionId);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      _get(Object.getPrototypeOf(SelendroidDriver.prototype), 'getProxyAvoidList', this).call(this, sessionId);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      _get(Object.getPrototypeOf(SelendroidDriver.prototype), 'canProxy', this).call(this, sessionId);</span>
&nbsp;
