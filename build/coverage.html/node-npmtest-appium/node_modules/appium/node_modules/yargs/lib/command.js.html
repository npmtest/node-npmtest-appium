...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/yargs/lib/command.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/yargs/lib/command.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/yargs/lib/</a> &#187; command.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >      cmd = cmd.replace(/\s/g, '')</span>
...
<span class="cstat-no" title="statement not covered" >    if (!yargs._hasOutput()) <span class="cstat-no" title="statement not covered" >populatePositionals(commandHandler, innerArgv, currentContext, yargs)</span></span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      populatePositional(demand, argv, yargs)</span>
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      populatePositional(maybe, argv, yargs)</span>
    }
&nbsp;
...
&nbsp;
  ...
  // aliases onto argv.
<span class="fstat-no" title="function not covered" >  function populatePositional (positional, argv, yargs) {</span>
