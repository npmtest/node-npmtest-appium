...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-support/build/lib/logging.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-support/build/lib/logging.js</span></h1>
    <h2>
        
        Statements: <span class="metric">80.26% <small>(61 / 76)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">80.26% <small>(61 / 76)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-support/build/lib/</a> &#187; logging.js</div>
</div>
<div class="body">
...
&nbsp;
    mockLog[level] = <span class="fstat-no" title="function not covered" >function () {</span>};
  }
} catch (err) {
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (testingMode &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >!forceLogMode)</span> {
    // in testing mode, use a mock logger object that we can query
<span class="cstat-no" title="statement not covered" >    logger = mockLog;</span>
  } else {
...
&nbsp;
  ...
  var wrappedLogger = { unwrap: <span class="fstat-no" title="function not covered" >function unwrap() {</span>
...
<span class="cstat-no" title="statement not covered" >      return logger.level;</span>
    },
...
&nbsp;
  wrappedLogger.errorAndThrow = <span class="fstat-no" title="function not covered" >function (err) {</span>
