...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-support/build/lib/util.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-support/build/lib/util.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-support/build/lib/</a> &#187; util.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >function hasContent(val) {</span>
<span class="cstat-no" title="statement not covered" >  return _lodash2['default'].isString(val) &amp;&amp; val !== "";</span>
}
&nbsp;
// return true if the the value is not undefined, null, or NaN.
<span class="fstat-no" title="function not covered" >function hasValue(val) {</span>
<span class="cstat-no" title="statement not covered" >  var hasVal = false;</span>
  // avoid incorrectly evaluating `0` as false
<span class="cstat-no" title="statement not covered" >  if (_lodash2['default'].isNumber(val)) {</span>
<span class="cstat-no" title="statement not covered" >    hasVal = !_lodash2['default'].isNaN(val);</span>
  } else {
<span class="cstat-no" title="statement not covered" >    hasVal = !_lodash2['default'].isUndefined(val) &amp;&amp; !_lodash2['default'].isNull(val);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return hasVal;</span>
}
&nbsp;
// escape spaces in string, for commandline calls
<span class="fstat-no" title="function not covered" >function escapeSpace(str) {</span>
<span class="cstat-no" title="statement not covered" >  return str.split(/ /).join('\\ ');</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function escapeSpecialChars(str, quoteEscape) {</span>
...
<span class="cstat-no" title="statement not covered" >  if (typeof quoteEscape === "undefined") {</span>
<span class="cstat-no" title="statement not covered" >    quoteEscape = false;</span>
  }
<span class="cstat-no" title="statement not covered" >  str = str.replace(/[\\]/g, '\\\\').replace(/[\/]/g, '\\/').replace(/[\b]/g, '\\b').replace(/[\f]/g, '\\f').replace(/[\n]/g, '\\n').replace(/[\r]/g, '\\r').replace(/[\t]/g, '\\t').replace(/[\"]/g, '\\"').replace(/\\'/g, "\\'");</span>
<span class="cstat-no" title="statement not covered" >  if (quoteEscape) {</span>
<span class="cstat-no" title="statement not covered" >    var re = new RegExp(quoteEscape, "g");</span>
<span class="cstat-no" title="statement not covered" >    str = str.replace(re, "\\" + quoteEscape);</span>
  }
<span class="cstat-no" title="statement not covered" >  return str;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function localIp() {</span>
<span class="cstat-no" title="statement not covered" >  var ip = _lodash2['default'].chain(_os2['default'].networkInterfaces()).values().flatten().filter(<span class="fstat-no" title="function not covered" >function (val) {</span></span>
<span class="cstat-no" title="statement not covered" >    return val.family === 'IPv4' &amp;&amp; val.internal === false;</span>
 ...
 * after `ms` delay
 */
<span class="fstat-no" title="function not covered" >function cancellableDelay(ms) {</span>
<span class="cstat-no" title="statement not covered" >  var timer = undefined;</span>
<span class="cstat-no" title="statement not covered" >  return new _bluebird2['default'].Promise(<span class="fstat-no" title="function not covered" >function (resolve) {</span></span>
...
<span class="cstat-no" title="statement not covered" >      resolve();</span>
  ...
  }).cancellable()['catch'](_bluebird2['default'].CancellationError, <span class="fstat-no" title="function not covered" >function (err) {</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function multiResolve(roots) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  return roots.map(<span class="fstat-no" title="function not covered" >function (root) {</span></span>
<span class="cstat-no" title="statement not covered" >    return _path2['default'].resolve.apply(_path2['default'], [root].concat(args));</span>
  });
}
&nbsp;
/*
 ...
 */
<span class="fstat-no" title="function not covered" >function safeJsonParse(obj) {</span>
 ...
 *   { ELEMENT: 4 } becomes 4
 */
<span class="fstat-no" title="function not covered" >function unwrapElement(el) {</span>
