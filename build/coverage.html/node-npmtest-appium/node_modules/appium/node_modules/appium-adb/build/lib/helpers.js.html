...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-adb/build/lib/helpers.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-adb/build/lib/helpers.js</span></h1>
    <h2>
        
        Statements: <span class="metric">15.77% <small>(44 / 279)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">16.06% <small>(44 / 274)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-adb/build/lib/</a> &#187; helpers.js</div>
</div>
<div class="body">
...
&nbsp;
var rootDir = _path2['default'].resolve(__dirname, process.env.NO_PRECOMPILE ? <span class="branch-0 cbranch-no" title="branch not covered" >'..' </span>: '../..');
...
&nbsp;
<span class="fstat-no" title="function not covered" >function getDirectories(rootPath) {</span>
<span class="cstat-no" title="statement not covered" >  var files, dirs, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, file, pathString;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function getDirectories$(context$1$0) {</span></span>
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_appiumSupport.fs.readdir(rootPath));</span>
&nbsp;
      case 2:
...
<span class="cstat-no" title="statement not covered" >        pathString = _path2['default'].resolve(rootPath, file);</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 14;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_appiumSupport.fs.lstat(pathString));</span>
&nbsp;
      case 14:
<span class="cstat-no" title="statement not covered" >        if (!context$1$0.sent.isDirectory()) {</span>
...
&nbsp;
      case 33:
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', dirs.sort());</span>
&nbsp;
      case 34:
      case 'end':
...
&nbsp;
<span class="fstat-no" title="function not covered" >function getAndroidPlatformAndPath() {</span>
<span class="cstat-no" title="statement not covered" >  var androidHome, platforms, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, platform, platformPath;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function getAndroidPlatformAndPath$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        androidHome = process.env.ANDROID_HOME;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (_lodash2['default'].isString(androidHome)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 4;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        _loggerJs2['default'].error("ANDROID_HOME was not exported!");</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', null);</span>
&nbsp;
      case 4:
<span class="cstat-no" title="statement not covered" >        platforms = _path2['default'].resolve(androidHome, 'platforms');</span>
...
<span class="cstat-no" title="statement not covered" >        _iterator2 = _getIterator(_lodash2['default'].clone(androidPlatforms).reverse());</span>
&nbsp;
      case 10:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        platform = _step2.value;</span>
<span class="cstat-no" title="statement not covered" >        platformPath = _path2['default'].resolve(platforms, platform);</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 15;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_appiumSupport.fs.exists(platformPath));</span>
&nbsp;
      case 15:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', { platform: platform, platformPath: platformPath });</span>
&nbsp;
      case 17:
<span class="cstat-no" title="statement not covered" >        _iteratorNormalCompletion2 = true;</span>
...
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        _loggerJs2['default'].debug('Unzipping ' + zipPath);</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.prev = 1;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 4;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(assertZipArchive(zipPath));</span>
&nbsp;
      case 4:
...
<span class="cstat-no" title="statement not covered" >        _loggerJs2['default'].debug("Unzip successful");</span>
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _teen_process.exec)('unzip', ['-o', zipPath], { cwd: _path2['default'].dirname(zipPath) }));</span>
&nbsp;
      case 12:
<span class="cstat-no" title="statement not covered" >        _loggerJs2['default'].debug("Unzip successful");</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        throw new Error('Error occurred while unzipping. Original error: ' + context$1$0.t0.message);</span>
&nbsp;
      case 18:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function assertZipArchive(zipPath) {</span>
<span class="cstat-no" title="statement not covered" >  var execOpts;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function assertZipArchive$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        _loggerJs2['default'].debug('Testing zip archive: ' + zipPath);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!_appiumSupport.system.isWindows()) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        _loggerJs2['default'].debug("Zip archive tested clean");</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 9;</span>
<span class="cstat-no" title="statement not covered" >        break;</span>
&nbsp;
      case 8:
<span class="cstat-no" title="statement not covered" >        throw new Error('Zip archive not present at ' + zipPath);</span>
&nbsp;
      case 9:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 14;</span>
<span class="cstat-no" title="statement not covered" >        break;</span>
&nbsp;
      case 11:
<span class="cstat-no" title="statement not covered" >        execOpts = { cwd: _path2['default'].dirname(zipPath) };</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 14;</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function getIMEListFromOutput(stdout) {</span>
<span class="cstat-no" title="statement not covered" >  var engines = [];</span>
...
<span class="cstat-no" title="statement not covered" >    for (var _iterator3 = _getIterator(stdout.split('\n')), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {</span>
<span class="cstat-no" title="statement not covered" >      var line = _step3.value;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (line.length &gt; 0 &amp;&amp; line[0] !== ' ') {</span>
        // remove newline and trailing colon, and add to the list
<span class="cstat-no" title="statement not covered" >        engines.push(line.trim().replace(/:$/, ''));</span>
      }
    }
  } catch (err) {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  return engines;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function getJavaForOs() {</span>
<span class="cstat-no" title="statement not covered" >  var sep = _path2['default'].sep;</span>
<span class="cstat-no" title="statement not covered" >  var java = '' + getJavaHome() + sep + 'bin' + sep + 'java';</span>
<span class="cstat-no" title="statement not covered" >  if (_appiumSupport.system.isWindows()) {</span>
<span class="cstat-no" title="statement not covered" >    java = java + '.exe';</span>
  }
<span class="cstat-no" title="statement not covered" >  return java;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function getJavaHome() {</span>
<span class="cstat-no" title="statement not covered" >  if (process.env.JAVA_HOME) {</span>
<span class="cstat-no" title="statement not covered" >    return process.env.JAVA_HOME;</span>
  }
<span class="cstat-no" title="statement not covered" >  throw new Error("JAVA_HOME is not set currently. Please set JAVA_HOME.");</span>
}
&nbsp;
/*
 * Checks mShowingLockscreen in dumpsys output to determine if lock screen is showing
 */
<span class="fstat-no" title="function not covered" >function isShowingLockscreen(dumpsys) {</span>
<span class="cstat-no" title="statement not covered" >  var m = /mShowingLockscreen=\w+/gi.exec(dumpsys);</span>
<span class="cstat-no" title="statement not covered" >  var ret = m &amp;&amp; m.length &amp;&amp; m[0].split('=')[1] === 'true' || false;</span>
 ...
 */
<span class="fstat-no" title="function not covered" >function isCurrentFocusOnKeyguard(dumpsys) {</span>
<span class="cstat-no" title="statement not covered" >  var m = /mCurrentFocus.+Keyguard/gi.exec(dumpsys);</span>
<span class="cstat-no" title="statement not covered" >  return m &amp;&amp; m.length &amp;&amp; m[0] ? true : false;</span>
}
&nbsp;
/*
 * Reads SurfaceOrientation in dumpsys output
 */
<span class="fstat-no" title="function not covered" >function getSurfaceOrientation(dumpsys) {</span>
<span class="cstat-no" title="statement not covered" >  var m = /SurfaceOrientation: \d/gi.exec(dumpsys);</span>
<span class="cstat-no" title="statement not covered" >  return m &amp;&amp; parseInt(m[0].split(':')[1]);</span>
}
&nbsp;
/*
 ...
 * Default is true
 */
<span class="fstat-no" title="function not covered" >function isScreenOnFully(dumpsys) {</span>
<span class="cstat-no" title="statement not covered" >  var m = /mScreenOnFully=\w+/gi.exec(dumpsys);</span>
<span class="cstat-no" title="statement not covered" >  return !m || // if information is missing we assume screen is fully on</span>
  m &amp;&amp; m.length &gt; 0 &amp;&amp; m[0].split('=')[1] === 'true' || false;
}
&nbsp;
<span class="fstat-no" title="function not covered" >function buildStartCmd(startAppOptions, apiLevel) {</span>
<span class="cstat-no" title="statement not covered" >  var cmd = ['am', 'start', '-W', '-n', startAppOptions.pkg + '/' + startAppOptions.activity];</span>
<span class="cstat-no" title="statement not covered" >  if (startAppOptions.stopApp &amp;&amp; apiLevel &gt;= 15) {</span>
<span class="cstat-no" title="statement not covered" >    cmd.push('-S');</span>
  }
<span class="cstat-no" title="statement not covered" >  if (startAppOptions.action) {</span>
<span class="cstat-no" title="statement not covered" >    cmd.push('-a', startAppOptions.action);</span>
  }
<span class="cstat-no" title="statement not covered" >  if (startAppOptions.category) {</span>
<span class="cstat-no" title="statement not covered" >    cmd.push('-c', startAppOptions.category);</span>
  }
<span class="cstat-no" title="statement not covered" >  if (startAppOptions.flags) {</span>
<span class="cstat-no" title="statement not covered" >    cmd.push('-f', startAppOptions.flags);</span>
  }
<span class="cstat-no" title="statement not covered" >  if (startAppOptions.optionalIntentArguments) {</span>
...
&nbsp;
    ...
    // the first space
<span class="cstat-no" title="statement not covered" >    var parseKeyValue = <span class="fstat-no" title="function not covered" >function parseKeyValue(str) {</span></span>
<span class="cstat-no" title="statement not covered" >      str = str.trim();</span>
<span class="cstat-no" title="statement not covered" >      var space = str.indexOf(' ');</span>
<span class="cstat-no" title="statement not covered" >      if (space === -1) {</span>
<span class="cstat-no" title="statement not covered" >        return str.length ? [str] : [];</span>
      } else {
<span class="cstat-no" title="statement not covered" >        return [str.substring(0, space).trim(), str.substring(space + 1).trim()];</span>
      }
    };
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    var optionalIntentArguments = ' ' + startAppOptions.optionalIntentArguments;</span>
...
<span class="cstat-no" title="statement not covered" >      var args = re.exec(optionalIntentArguments);</span>
<span class="cstat-no" title="statement not covered" >      if (!args) {</span>
<span class="cstat-no" title="statement not covered" >        if (optionalIntentArguments.length) {</span>
          // no more flags, so the remainder can be treated as 'key' or 'key value'
<span class="cstat-no" title="statement not covered" >          cmd.push.apply(cmd, parseKeyValue(optionalIntentArguments));</span>
        }
        // we are done
<span class="cstat-no" title="statement not covered" >        break;</span>
      }
...
<span class="cstat-no" title="statement not covered" >      var flag = args[1];</span>
<span class="cstat-no" title="statement not covered" >      var flagPos = optionalIntentArguments.indexOf(flag);</span>
<span class="cstat-no" title="statement not covered" >      if (flagPos !== 0) {</span>
<span class="cstat-no" title="statement not covered" >        var prevArgs = optionalIntentArguments.substring(0, flagPos);</span>
<span class="cstat-no" title="statement not covered" >        cmd.push.apply(cmd, parseKeyValue(prevArgs));</span>
      }
&nbsp;
      // add the flag, as there are no more earlier arguments
<span class="cstat-no" title="statement not covered" >      cmd.push(flag);</span>
&nbsp;
      // make optionalIntentArguments hold the remainder
<span class="cstat-no" title="statement not covered" >      optionalIntentArguments = args[2];</span>
    }
  }
<span class="cstat-no" title="statement not covered" >  return cmd;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function getSdkToolsVersion() {</span>
<span class="cstat-no" title="statement not covered" >  var androidHome, propertiesPath, propertiesContent, versionMatcher, match;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function getSdkToolsVersion$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        androidHome = process.env.ANDROID_HOME;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!androidHome) {</span>
<span class="cstat-no" title="statement not covered" >          _loggerJs2['default'].errorAndThrow('ANDROID_HOME environment varibale is expected to be set');</span>
        }
<span class="cstat-no" title="statement not covered" >        propertiesPath = _path2['default'].resolve(androidHome, 'tools', 'source.properties');</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 5;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_appiumSupport.fs.exists(propertiesPath));</span>
&nbsp;
      case 5:
<span class="cstat-no" title="statement not covered" >        if (context$1$0.sent) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 8;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        _loggerJs2['default'].warn('Cannot find ' + propertiesPath + ' file to read SDK version from');</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return');</span>
&nbsp;
      case 8:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 10;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_appiumSupport.fs.readFile(propertiesPath, 'utf8'));</span>
&nbsp;
      case 10:
<span class="cstat-no" title="statement not covered" >        propertiesContent = context$1$0.sent;</span>
<span class="cstat-no" title="statement not covered" >        versionMatcher = new RegExp(/Pkg\.Revision=(\d+)\.?(\d+)?\.?(\d+)?/);</span>
<span class="cstat-no" title="statement not covered" >        match = versionMatcher.exec(propertiesContent);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', { major: parseInt(match[1], 10),</span>
          minor: match[2] ? parseInt(match[2], 10) : 0,
          build: match[3] ? parseInt(match[3], 10) : 0 });
&nbsp;
      case 15:
<span class="cstat-no" title="statement not covered" >        _loggerJs2['default'].warn('Cannot parse "Pkg.Revision" value from ' + propertiesPath);</span>
&nbsp;
      case 16:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
