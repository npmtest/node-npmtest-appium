...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-adb/build/lib/logcat.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-adb/build/lib/logcat.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-adb/build/lib/</a> &#187; logcat.js</div>
</div>
<div class="body">
...
&nbsp;
var Logcat = (function () {
<span class="fstat-no" title="function not covered" >  function Logcat() {</span>
<span class="cstat-no" title="statement not covered" >    var opts = arguments.length &lt;= 0 || arguments[0] === undefined ? {} : arguments[0];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, Logcat);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.adb = opts.adb;</span>
<span class="cstat-no" title="statement not covered" >    this.debug = opts.debug;</span>
<span class="cstat-no" title="statement not covered" >    this.debugTrace = opts.debugTrace;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      return new _Promise(<span class="fstat-no" title="function not covered" >function callee$2$0(resolve, reject) {</span></span>
...
<span class="cstat-no" title="statement not covered" >          while (1) <span class="cstat-no" title="statement not covered" >switch (context$3$0.prev = context$3$0.next) {</span></span>
            case 0:
<span class="cstat-no" title="statement not covered" >              log.debug("Starting logcat capture");</span>
<span class="cstat-no" title="statement not covered" >              this.proc = new _teen_process.SubProcess(this.adb.path, this.adb.defaultArgs.concat(['logcat', '-v', 'threadtime']));</span>
<span class="cstat-no" title="statement not covered" >              context$3$0.next = 4;</span>
<span class="cstat-no" title="statement not covered" >              return _regeneratorRuntime.awrap(this.proc.start(0));</span>
&nbsp;
            case 4:
...
<span class="cstat-no" title="statement not covered" >                log.error('Logcat terminated with code ' + code + ', signal ' + signal);</span>
<span class="cstat-no" title="statement not covered" >                _this.proc = null;</span>
              });
<span class="cstat-no" title="statement not covered" >              this.proc.on('lines-stderr', <span class="fstat-no" title="function not covered" >function (lines) {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                    if (/execvp\(\)/.test(line)) {</span>
<span class="cstat-no" title="statement not covered" >                      log.error('Logcat process failed to start');</span>
<span class="cstat-no" title="statement not covered" >                      reject(new Error('Logcat process failed to start. stderr: ' + line));</span>
                    }
<span class="cstat-no" title="statement not covered" >                    _this.outputHandler(line, 'STDERR: ');</span>
                  }
                } catch (err) {
...
<span class="cstat-no" title="statement not covered" >              this.proc.on('lines-stdout', <span class="fstat-no" title="function not covered" >function (lines) {</span></span>
<span class="cstat-no" title="statement not covered" >                resolve();</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                    _this.outputHandler(line);</span>
                  }
                } catch (err) {
...
<span class="cstat-no" title="statement not covered" >              return context$3$0.stop();</span>
    ...
    key: 'outputHandler',
    value: <span class="fstat-no" title="function not covered" >function outputHandler(output) {</span>
...
<span class="cstat-no" title="statement not covered" >        var outputObj = {</span>
          timestamp: Date.now(),
          level: 'ALL',
          message: output
        };
<span class="cstat-no" title="statement not covered" >        this.logs.push(outputObj);</span>
<span class="cstat-no" title="statement not covered" >        this.logsSinceLastRequest.push(outputObj);</span>
<span class="cstat-no" title="statement not covered" >        var isTrace = /W\/Trace/.test(output);</span>
<span class="cstat-no" title="statement not covered" >        if (this.debug &amp;&amp; (!isTrace || this.debugTrace)) {</span>
<span class="cstat-no" title="statement not covered" >          log.debug(prefix + output);</span>
        }
      }
    }
  }, {
...
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            log.debug("Stopping logcat capture");</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (!(this.proc === null)) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 4;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            log.debug("Logcat already stopped");</span>
<span class="cstat-no" title="statement not covered" >            return context$2$0.abrupt('return');</span>
&nbsp;
          case 4:
<span class="cstat-no" title="statement not covered" >            this.proc.removeAllListeners('exit');</span>
...
<span class="cstat-no" title="statement not covered" >      var logs = this.logsSinceLastRequest;</span>
<span class="cstat-no" title="statement not covered" >      this.logsSinceLastRequest = [];</span>
