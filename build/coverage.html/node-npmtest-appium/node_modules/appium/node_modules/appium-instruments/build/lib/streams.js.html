...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-instruments/build/lib/streams.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-instruments/build/lib/streams.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-instruments/build/lib/</a> &#187; streams.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >function clearBufferChars(output) {</span>
...
<span class="cstat-no" title="statement not covered" >  output = output.replace(re, '');</span>
<span class="cstat-no" title="statement not covered" >  return output;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function outputStream() {</span>
<span class="cstat-no" title="statement not covered" >  return (0, _through2['default'])(<span class="fstat-no" title="function not covered" >function outputStreamHandler(output) {</span></span>
<span class="cstat-no" title="statement not covered" >    output = clearBufferChars(output);</span>
&nbsp;
    // if we have multiple log lines, indent non-first ones
<span class="cstat-no" title="statement not covered" >    if (output !== '') {</span>
      // get rid of newline at the end
<span class="cstat-no" title="statement not covered" >      output = output.replace(/\n$/m, '');</span>
      // indent instead of newline
<span class="cstat-no" title="statement not covered" >      output = output.replace(/\n/m, '\n       ');</span>
<span class="cstat-no" title="statement not covered" >      output = '[INST] ' + output;</span>
<span class="cstat-no" title="statement not covered" >      output = output.green;</span>
<span class="cstat-no" title="statement not covered" >      _logger2['default'].debug(output);</span>
    }
<span class="cstat-no" title="statement not covered" >    this.queue(output);</span>
  });
}
&nbsp;
<span class="fstat-no" title="function not covered" >function errorStream() {</span>
<span class="cstat-no" title="statement not covered" >  return (0, _through2['default'])(<span class="fstat-no" title="function not covered" >function errorStreamHandler(output) {</span></span>
    // get rid of newline at the end
<span class="cstat-no" title="statement not covered" >    output = output.replace(/\n$/m, '');</span>
<span class="cstat-no" title="statement not covered" >    output = '[INST STDERR] ' + output;</span>
<span class="cstat-no" title="statement not covered" >    output = output.yellow;</span>
<span class="cstat-no" title="statement not covered" >    _logger2['default'].debug(output);</span>
<span class="cstat-no" title="statement not covered" >    this.queue(output);</span>
  });
}
&nbsp;
<span class="fstat-no" title="function not covered" >function webSocketAlertStream(webSocket) {</span>
<span class="cstat-no" title="statement not covered" >  return (0, _through2['default'])(<span class="fstat-no" title="function not covered" >function webSocketAlertStreamHandler(output) {</span></span>
<span class="cstat-no" title="statement not covered" >    if (webSocket) {</span>
<span class="cstat-no" title="statement not covered" >      var re = /Call to onAlert returned 'YES'/;</span>
<span class="cstat-no" title="statement not covered" >      if (re.test(output)) {</span>
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Emiting alert message...');</span>
<span class="cstat-no" title="statement not covered" >        webSocket.sockets.emit('alert', { message: output });</span>
      }
    }
<span class="cstat-no" title="statement not covered" >    this.queue(output);</span>
  });
...
&nbsp;
<span class="fstat-no" title="function not covered" >function dumpStream() {</span>
<span class="cstat-no" title="statement not covered" >  return (0, _through2['default'])(<span class="fstat-no" title="function not covered" >function nullStreamHandler() {</span>/* ignore all stream output */});</span>
}
&nbsp;
