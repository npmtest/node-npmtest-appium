...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-android-driver/build/lib/commands/touch.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-android-driver/build/lib/commands/touch.js</span></h1>
    <h2>
        
        Statements: <span class="metric">7.23% <small>(29 / 401)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-android-driver/build/lib/commands/</a> &#187; touch.js</div>
</div>
<div class="body">
...
var commands = {},
    ...
    extensions = {};
&nbsp;
commands.doTouchAction = <span class="fstat-no" title="function not covered" >function callee$0$0(action, opts) {</span>
...
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        context$1$0.t0 = action;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = context$1$0.t0 === 'tap' ? 3 : context$1$0.t0 === 'press' ? 6 : context$1$0.t0 === 'release' ? 9 : context$1$0.t0 === 'moveTo' ? 12 : context$1$0.t0 === 'wait' ? 15 : context$1$0.t0 === 'longPress' ? 18 : context$1$0.t0 === 'cancel' ? 22 : 24;</span>
<span class="cstat-no" title="statement not covered" >        break;</span>
&nbsp;
      case 3:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 5;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.tap(opts.element, opts.x, opts.y, opts.count));</span>
&nbsp;
      case 5:
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.touchDown(opts.element, opts.x, opts.y));</span>
&nbsp;
      case 8:
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', context$1$0.sent);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.touchUp(opts.element, opts.x, opts.y));</span>
&nbsp;
      case 11:
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', context$1$0.sent);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.touchMove(opts.element, opts.x, opts.y));</span>
&nbsp;
      case 14:
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', context$1$0.sent);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_bluebird2['default'].delay(opts.ms));</span>
&nbsp;
      case 17:
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', context$1$0.sent);</span>
&nbsp;
      case 18:
<span class="cstat-no" title="statement not covered" >        if (typeof opts.duration === 'undefined' || !opts.duration) {</span>
<span class="cstat-no" title="statement not covered" >          opts.duration = 1000;</span>
        }
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 21;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.touchLongClick(opts.element, opts.x, opts.y, opts.duration));</span>
&nbsp;
      case 21:
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', context$1$0.sent);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        _logger2['default'].warn("Cancel action currently has no effect");</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('break', 25);</span>
&nbsp;
      case 24:
<span class="cstat-no" title="statement not covered" >        _logger2['default'].errorAndThrow('unknown action ' + action);</span>
&nbsp;
      case 25:
      case 'end':
...
helpers.doTouchDrag = <span class="fstat-no" title="function not covered" >function callee$0$0(gestures) {</span>
<span class="cstat-no" title="statement not covered" >  var longPress, moveTo, startX, startY, endX, endY, _ref, x, y, _ref2, apiLevel, duration;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        longPress = gestures[0];</span>
<span class="cstat-no" title="statement not covered" >        moveTo = gestures[1];</span>
<span class="cstat-no" title="statement not covered" >        startX = longPress.options.x || 0, startY = longPress.options.y || 0, endX = moveTo.options.x || 0, endY = moveTo.options.y || 0;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!longPress.options.element) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 11;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 6;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.getLocationInView(longPress.options.element));</span>
&nbsp;
      case 6:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 14;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.getLocationInView(moveTo.options.element));</span>
&nbsp;
      case 14:
<span class="cstat-no" title="statement not covered" >        _ref2 = context$1$0.sent;</span>
<span class="cstat-no" title="statement not covered" >        x = _ref2.x;</span>
<span class="cstat-no" title="statement not covered" >        y = _ref2.y;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        endX += x || 0;</span>
<span class="cstat-no" title="statement not covered" >        endY += y || 0;</span>
&nbsp;
      case 19:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 21;</span>
...
<span class="cstat-no" title="statement not covered" >        duration = apiLevel &gt;= 5 ? 2 : 1;</span>
&nbsp;
        // make sure that if the long press has a duration, we use it.
<span class="cstat-no" title="statement not covered" >        if (longPress.options &amp;&amp; longPress.options.duration) {</span>
<span class="cstat-no" title="statement not covered" >          duration = Math.max(longPress.options.duration / 1000, duration);</span>
        }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.drag(startX, startY, endX, endY, duration, 1, longPress.options.element, moveTo.options.element));</span>
&nbsp;
      case 26:
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', context$1$0.sent);</span>
&nbsp;
...
helpers.fixRelease = <span class="fstat-no" title="function not covered" >function callee$0$0(gestures) {</span>
<span class="cstat-no" title="statement not covered" >  var release, ref, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, gesture, opts, loc, size;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        release = _lodash2['default'].last(gestures);</span>
&nbsp;
        // sometimes there are no options
<span class="cstat-no" title="statement not covered" >        release.options = release.options || {};</span>
        // nothing to do if release options are already set
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!(release.options.element || release.options.x &amp;&amp; release.options.y)) {</span>
...
&nbsp;
      case 4:
        ...
        // offset coordinates
<span class="cstat-no" title="statement not covered" >        gestures = _lodash2['default'].clone(gestures);</span>
...
<span class="cstat-no" title="statement not covered" >        _iterator = _getIterator(gestures.reverse());</span>
&nbsp;
      case 11:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        gesture = _step.value;</span>
<span class="cstat-no" title="statement not covered" >        opts = gesture.options;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!(opts.element || opts.x &amp;&amp; opts.y)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 17;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        ref = gesture;</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('break', 20);</span>
&nbsp;
      case 17:
<span class="cstat-no" title="statement not covered" >        _iteratorNormalCompletion = true;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 11;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        opts = ref.options;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.getLocationInView(opts.element));</span>
&nbsp;
      case 39:
<span class="cstat-no" title="statement not covered" >        loc = context$1$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!(opts.x &amp;&amp; opts.y)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 44;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
        // this is an offset from the element
<span class="cstat-no" title="statement not covered" >        release.options = {</span>
          x: loc.x + opts.x,
          y: loc.y + opts.y
        };
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.getSize(opts.element));</span>
&nbsp;
      case 46:
<span class="cstat-no" title="statement not covered" >        size = context$1$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        release.options = {</span>
...
&nbsp;
      case 50:
<span class="cstat-no" title="statement not covered" >        release.options = _lodash2['default'].pick(opts, 'x', 'y');</span>
&nbsp;
      case 51:
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', release);</span>
&nbsp;
      case 52:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
// Perform one gesture
helpers.performGesture = <span class="fstat-no" title="function not covered" >function callee$0$0(gesture) {</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.doTouchAction(gesture.action, gesture.options || {}));</span>
&nbsp;
      case 3:
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', context$1$0.sent);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!((0, _appiumBaseDriver.isErrorType)(context$1$0.t0, _appiumBaseDriver.errors.NoSuchElementError) &amp;&amp; gesture.action === 'release' &amp;&amp; gesture.options.element)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 14;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        delete gesture.options.element;</span>
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('retrying release without element opts: ' + gesture.options + '.');</span>
...
<span class="cstat-no" title="statement not covered" >  var swipeOpts, actions, press, wait, fixedGestures, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, g;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
...
&nbsp;
      case 2:
<span class="cstat-no" title="statement not covered" >        if (!(gestures.length === 4 &amp;&amp; gestures[0].action === 'press' &amp;&amp; gestures[1].action === 'wait' &amp;&amp; gestures[2].action === 'moveTo' &amp;&amp; gestures[3].action === 'release')) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 9;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 5;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.getSwipeOptions(gestures));</span>
&nbsp;
      case 5:
<span class="cstat-no" title="statement not covered" >        swipeOpts = context$1$0.sent;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 8;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.swipe(swipeOpts.startX, swipeOpts.startY, swipeOpts.endX, swipeOpts.endY, swipeOpts.duration, swipeOpts.touchCount, swipeOpts.element));</span>
&nbsp;
      case 8:
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', context$1$0.sent);</span>
&nbsp;
      case 9:
<span class="cstat-no" title="statement not covered" >        actions = _lodash2['default'].pluck(gestures, "action");</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!(actions[0] === 'longPress' &amp;&amp; actions[1] === 'moveTo' &amp;&amp; actions[2] === 'release')) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 16;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 13;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.doTouchDrag(gestures));</span>
&nbsp;
      case 13:
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', context$1$0.sent);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >          if (_lodash2['default'].first(actions) === 'press' &amp;&amp; _lodash2['default'].last(actions) === 'release') {</span>
<span class="cstat-no" title="statement not covered" >            actions[0] = 'tap';</span>
<span class="cstat-no" title="statement not covered" >            gestures[0].action = 'tap';</span>
          }
&nbsp;
          // the `longPress` and `tap` methods release on their own
<span class="cstat-no" title="statement not covered" >          if ((_lodash2['default'].first(actions) === 'tap' || _lodash2['default'].first(actions) === 'longPress') &amp;&amp; _lodash2['default'].last(actions) === 'release') {</span>
<span class="cstat-no" title="statement not covered" >            gestures.pop();</span>
<span class="cstat-no" title="statement not covered" >            actions.pop();</span>
          }
        } else {
          // longpress followed by anything other than release should become a press and wait
<span class="cstat-no" title="statement not covered" >          if (actions[0] === 'longPress') {</span>
<span class="cstat-no" title="statement not covered" >            actions = ['press', 'wait'].concat(_toConsumableArray(actions.slice(1)));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            press = gestures.shift();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            press.action = 'press';</span>
<span class="cstat-no" title="statement not covered" >            wait = {</span>
              action: 'wait',
              options: { ms: press.options.duration || 1000 }
            };
&nbsp;
<span class="cstat-no" title="statement not covered" >            delete press.options.duration;</span>
<span class="cstat-no" title="statement not covered" >            gestures = [press, wait].concat(_toConsumableArray(gestures));</span>
          }
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 19;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.parseTouch(gestures, false));</span>
&nbsp;
      case 19:
<span class="cstat-no" title="statement not covered" >        fixedGestures = context$1$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!(actions[actions.length - 1] === 'release')) {</span>
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.fixRelease(gestures));</span>
&nbsp;
      case 23:
<span class="cstat-no" title="statement not covered" >        actions[actions.length - 1] = context$1$0.sent;</span>
&nbsp;
      case 24:
...
<span class="cstat-no" title="statement not covered" >        context$1$0.prev = 27;</span>
<span class="cstat-no" title="statement not covered" >        _iterator2 = _getIterator(fixedGestures);</span>
&nbsp;
      case 29:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        g = _step2.value;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 33;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.performGesture(g));</span>
&nbsp;
      case 33:
<span class="cstat-no" title="statement not covered" >        _iteratorNormalCompletion2 = true;</span>
...
&nbsp;
      case 38:
<span class="cstat-no" title="statement not covered" >        context$1$0.prev = 38;</span>
...
&nbsp;
      case 42:
<span class="cstat-no" title="statement not covered" >        context$1$0.prev = 42;</span>
...
&nbsp;
      case 48:
<span class="cstat-no" title="statement not covered" >        return context$1$0.finish(45);</span>
&nbsp;
      case 49:
<span class="cstat-no" title="statement not covered" >        return context$1$0.finish(42);</span>
&nbsp;
      case 50:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
helpers.parseTouch = <span class="fstat-no" title="function not covered" >function callee$0$0(gestures, multi) {</span>
<span class="cstat-no" title="statement not covered" >  var touchStateObjects, prevPos, time, _iteratorNormalCompletion3, _didIteratorError3, _iteratorError3, _iterator3, _step3, state, timeOffset;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
...
<span class="cstat-no" title="statement not covered" >        if (multi &amp;&amp; _lodash2['default'].last(gestures).action === 'release') {</span>
<span class="cstat-no" title="statement not covered" >          gestures.pop();</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 3;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _asyncbox.asyncmap)(gestures, <span class="fstat-no" title="function not covered" >function callee$1$0(gesture) {</span></span>
<span class="cstat-no" title="statement not covered" >          var options, elementId, pos, size, touchStateObject, offset;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (!_lodash2['default'].contains(['press', 'moveTo', 'tap', 'longPress'], gesture.action)) {</span>
<span class="cstat-no" title="statement not covered" >                  context$2$0.next = 23;</span>
<span class="cstat-no" title="statement not covered" >                  break;</span>
                }
&nbsp;
<span class="cstat-no" title="statement not covered" >                options.offset = false;</span>
<span class="cstat-no" title="statement not covered" >                elementId = gesture.options.element;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                return _regeneratorRuntime.awrap(this.getLocationInView(elementId));</span>
&nbsp;
              case 7:
<span class="cstat-no" title="statement not covered" >                pos = context$2$0.sent;</span>
<span class="cstat-no" title="statement not covered" >                context$2$0.next = 10;</span>
<span class="cstat-no" title="statement not covered" >                return _regeneratorRuntime.awrap(this.getSize(elementId));</span>
&nbsp;
              case 10:
<span class="cstat-no" title="statement not covered" >                size = context$2$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (gesture.options.x || gesture.options.y) {</span>
<span class="cstat-no" title="statement not covered" >                  options.x = pos.x + (gesture.options.x || 0);</span>
<span class="cstat-no" title="statement not covered" >                  options.y = pos.y + (gesture.options.y || 0);</span>
                } else {
<span class="cstat-no" title="statement not covered" >                  options.x = pos.x + size.width / 2;</span>
<span class="cstat-no" title="statement not covered" >                  options.y = pos.y + size.height / 2;</span>
                }
...
<span class="cstat-no" title="statement not covered" >                return context$2$0.abrupt('return', touchStateObject);</span>
&nbsp;
              case 16:
                // expects absolute coordinates, so we need to save these as offsets
                // and then translate when everything is done
<span class="cstat-no" title="statement not covered" >                options.offset = true;</span>
<span class="cstat-no" title="statement not covered" >                options.x = gesture.options.x || 0;</span>
<span class="cstat-no" title="statement not covered" >                options.y = gesture.options.y || 0;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                touchStateObject = {</span>
                  action: gesture.action,
                  options: options,
...
&nbsp;
              case 23:
<span class="cstat-no" title="statement not covered" >                offset = 0.005;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (gesture.action === 'wait') {</span>
<span class="cstat-no" title="statement not covered" >                  options = gesture.options;</span>
<span class="cstat-no" title="statement not covered" >                  offset = parseInt(gesture.options.ms) / 1000;</span>
                }
<span class="cstat-no" title="statement not covered" >                touchStateObject = {</span>
                  action: gesture.action,
                  options: options,
...
<span class="cstat-no" title="statement not covered" >        prevPos = null, time = 0;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        for (_iterator3 = _getIterator(touchStateObjects); !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {</span>
<span class="cstat-no" title="statement not covered" >          state = _step3.value;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (_lodash2['default'].isUndefined(state.options.x) &amp;&amp; _lodash2['default'].isUndefined(state.options.y) &amp;&amp; prevPos !== null) {</span>
            // this happens with wait
<span class="cstat-no" title="statement not covered" >            state.options.x = prevPos.x;</span>
<span class="cstat-no" title="statement not covered" >            state.options.y = prevPos.y;</span>
          }
<span class="cstat-no" title="statement not covered" >          if (state.options.offset &amp;&amp; prevPos) {</span>
            // the current position is an offset
<span class="cstat-no" title="statement not covered" >            state.options.x += prevPos.x;</span>
<span class="cstat-no" title="statement not covered" >            state.options.y += prevPos.y;</span>
          }
<span class="cstat-no" title="statement not covered" >          delete state.options.offset;</span>
<span class="cstat-no" title="statement not covered" >          if (!_lodash2['default'].isUndefined(state.options.x) &amp;&amp; !_lodash2['default'].isUndefined(state.options.y)) <span class="cstat-no" title="statement not covered" >prevPos = state.options;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (multi) {</span>
<span class="cstat-no" title="statement not covered" >            timeOffset = state.timeOffset;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            time += timeOffset;</span>
<span class="cstat-no" title="statement not covered" >            state.time = _androidHelpers2['default'].truncateDecimals(time, 3);</span>
&nbsp;
            // multi gestures require 'touch' rather than 'options'
<span class="cstat-no" title="statement not covered" >            if (!_lodash2['default'].isUndefined(state.options.x) &amp;&amp; !_lodash2['default'].isUndefined(state.options.y)) <span class="cstat-no" title="statement not covered" >state.touch = {</span></span>
              x: state.options.x,
              y: state.options.y
            };
<span class="cstat-no" title="statement not covered" >            delete state.options;</span>
          }
...
&nbsp;
      case 22:
<span class="cstat-no" title="statement not covered" >        return context$1$0.finish(19);</span>
&nbsp;
      case 23:
<span class="cstat-no" title="statement not covered" >        return context$1$0.finish(16);</span>
&nbsp;
      case 24:
...
&nbsp;
commands.performMultiAction = <span class="fstat-no" title="function not covered" >function callee$0$0(actions, elementId) {</span>
...
&nbsp;
      case 2:
<span class="cstat-no" title="statement not covered" >        if (!(actions.length === 1)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 4;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        throw new Error("Multi Pointer Gestures need at least two actions. " + "Use Touch Actions for a single action.");</span>
&nbsp;
      case 4:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 6;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _asyncbox.asyncmap)(actions, <span class="fstat-no" title="function not covered" >function callee$1$0(action) {</span></span>
<span class="cstat-no" title="statement not covered" >          return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$1$0$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >            while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
              case 0:
<span class="cstat-no" title="statement not covered" >                context$2$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >                return _regeneratorRuntime.awrap(this.parseTouch(action, true));</span>
&nbsp;
              case 2:
...
&nbsp;
      case 6:
<span class="cstat-no" title="statement not covered" >        states = context$1$0.sent;</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', this.doPerformMultiAction(elementId, states));</span>
&nbsp;
      case 8:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
 ...
 */
commands.doPerformMultiAction = <span class="fstat-no" title="function not covered" >function callee$0$0(elementId, states) {</span>
...
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 5;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.bootstrap.sendAction("element:performMultiPointerGesture", opts));</span>
&nbsp;
      case 5:
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', context$1$0.sent);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 11;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.bootstrap.sendAction("performMultiPointerGesture", opts));</span>
&nbsp;
      case 11:
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', context$1$0.sent);</span>
&nbsp;
