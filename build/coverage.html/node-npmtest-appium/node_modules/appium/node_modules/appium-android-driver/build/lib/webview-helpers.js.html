...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-android-driver/build/lib/webview-helpers.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-android-driver/build/lib/webview-helpers.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">14.53% <small>(25 / 172)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-android-driver/build/lib/</a> &#187; webview-helpers.js</div>
</div>
<div class="body">
...
<span class="fstat-no" title="function not covered" >function webviewsFromProcs(adb, deviceSocket) {</span>
<span class="cstat-no" title="statement not covered" >  var webviews, out, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, line, webviewPid;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function webviewsFromProcs$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        webviews = [];</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 3;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(adb.shell(["cat", "/proc/net/unix"]));</span>
&nbsp;
      case 3:
...
<span class="cstat-no" title="statement not covered" >          webviewPid = line.match(/@?webview_devtools_remote_(\d+)/);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (deviceSocket) {</span>
<span class="cstat-no" title="statement not covered" >            if (line.indexOf('@' + deviceSocket) === line.length - deviceSocket.length - 1) {</span>
<span class="cstat-no" title="statement not covered" >              if (webviewPid) {</span>
<span class="cstat-no" title="statement not covered" >                webviews.push(WEBVIEW_BASE + webviewPid[1]);</span>
              } else {
<span class="cstat-no" title="statement not covered" >                webviews.push(CHROMIUM_WIN);</span>
              }
            }
          } else <span class="cstat-no" title="statement not covered" >if (webviewPid) {</span>
...
&nbsp;
      case 22:
<span class="cstat-no" title="statement not covered" >        return context$1$0.finish(15);</span>
&nbsp;
      case 23:
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', _lodash2['default'].uniq(webviews));</span>
&nbsp;
      case 24:
      case 'end':
...
<span class="fstat-no" title="function not covered" >function procFromWebview(adb, webview) {</span>
<span class="cstat-no" title="statement not covered" >  var pid, out, pkg, lines, header, pidColumn, pkgColumn, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, line;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function procFromWebview$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        pid = webview.match(/\d+$/);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        throw new Error('Could not find PID for webview ' + webview);</span>
&nbsp;
      case 3:
<span class="cstat-no" title="statement not covered" >        pid = pid[0];</span>
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug(webview + ' mapped to pid ' + pid);</span>
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug("Getting process name for webview");</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 8;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(adb.shell("ps"));</span>
&nbsp;
      case 8:
<span class="cstat-no" title="statement not covered" >        out = context$1$0.sent;</span>
<span class="cstat-no" title="statement not covered" >        pkg = "unknown";</span>
<span class="cstat-no" title="statement not covered" >        lines = out.split(/\r?\n/);</span>
<span class="cstat-no" title="statement not covered" >        header = lines[0].trim().split(/\s+/);</span>
<span class="cstat-no" title="statement not covered" >        pidColumn = header.indexOf("PID");</span>
<span class="cstat-no" title="statement not covered" >        pkgColumn = header.indexOf("NAME") + 1;</span>
...
<span class="cstat-no" title="statement not covered" >        _iterator2 = _getIterator(lines);</span>
&nbsp;
      case 19:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!(line[pidColumn].indexOf(pid) !== -1)) {</span>
...
<span class="cstat-no" title="statement not covered" >        pkg = _lodash2['default'].isUndefined(line[pkgColumn]) ? line[pkgColumn - 1] : line[pkgColumn];</span>
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Parsed pid: ' + line[pidColumn] + ' pkg: ' + pkg + '!');</span>
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('from: ' + line);</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('break', 30);</span>
&nbsp;
      case 27:
<span class="cstat-no" title="statement not covered" >        _iteratorNormalCompletion2 = true;</span>
...
<span class="cstat-no" title="statement not covered" >        context$1$0.t0 = context$1$0['catch'](17);</span>
...
&nbsp;
      case 44:
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('returning process name: ' + pkg);</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', pkg);</span>
&nbsp;
      case 46:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
helpers.getWebviews = <span class="fstat-no" title="function not covered" >function callee$0$0(adb, deviceSocket) {</span>
...
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug("Getting a list of available webviews");</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 3;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(webviewsFromProcs(adb, deviceSocket));</span>
&nbsp;
      case 3:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', webviews);</span>
&nbsp;
      case 6:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 8;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _asyncbox.asyncmap)(webviews, <span class="fstat-no" title="function not covered" >function callee$1$0(webviewName) {</span></span>
...
<span class="cstat-no" title="statement not covered" >                return _regeneratorRuntime.awrap(procFromWebview(adb, webviewName));</span>
&nbsp;
              case 2:
<span class="cstat-no" title="statement not covered" >                pkg = context$2$0.sent;</span>
<span class="cstat-no" title="statement not covered" >                return context$2$0.abrupt('return', WEBVIEW_BASE + pkg);</span>
&nbsp;
              case 4:
              case 'end':
...
<span class="cstat-no" title="statement not covered" >        webviews = context$1$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Found webviews: ' + JSON.stringify(webviews));</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', webviews);</span>
&nbsp;
      case 11:
      case 'end':
...
&nbsp;
helpers.decorateChromeOptions = <span class="fstat-no" title="function not covered" >function (caps, opts, deviceId) {</span>
  // add options from appium session caps
<span class="cstat-no" title="statement not covered" >  if (opts.chromeOptions) {</span>
...
<span class="cstat-no" title="statement not covered" >      for (var _iterator3 = _getIterator(_lodash2['default'].pairs(opts.chromeOptions)), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {</span>
<span class="cstat-no" title="statement not covered" >        var _step3$value = _slicedToArray(_step3.value, 2);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        var opt = _step3$value[0];</span>
<span class="cstat-no" title="statement not covered" >        var val = _step3$value[1];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (_lodash2['default'].isUndefined(caps.chromeOptions[opt])) {</span>
<span class="cstat-no" title="statement not covered" >          caps.chromeOptions[opt] = val;</span>
        } else {
<span class="cstat-no" title="statement not covered" >          _logger2['default'].warn('Cannot pass option ' + caps.chromeOptions[opt] + ' because ' + "Appium needs it to make chromeDriver work");</span>
        }
      }
    } catch (err) {
...
<span class="cstat-no" title="statement not covered" >  caps.chromeOptions.androidDeviceSerial = deviceId;</span>
