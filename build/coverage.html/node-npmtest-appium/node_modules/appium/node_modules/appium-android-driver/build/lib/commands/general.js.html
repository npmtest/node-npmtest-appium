...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-android-driver/build/lib/commands/general.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-android-driver/build/lib/commands/general.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">16.01% <small>(49 / 306)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-android-driver/build/lib/commands/</a> &#187; general.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >        keys = _lodash2['default'].isArray(keys) ? keys.join('') : keys;</span>
<span class="cstat-no" title="statement not covered" >        params = {</span>
          text: keys,
          replace: false
        };
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (this.opts.unicodeKeyboard) {</span>
<span class="cstat-no" title="statement not covered" >          params.unicodeKeyboard = true;</span>
        }
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 5;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.doSendKeys(params));</span>
&nbsp;
      case 5:
      case 'end':
...
&nbsp;
commands.doSendKeys = <span class="fstat-no" title="function not covered" >function callee$0$0(params) {</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.bootstrap.sendAction('setText', params));</span>
&nbsp;
      case 2:
...
&nbsp;
commands.getDeviceTime = <span class="fstat-no" title="function not covered" >function callee$0$0() {</span>
<span class="cstat-no" title="statement not covered" >  var out;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        _logger2['default'].info('Attempting to capture android device date and time');</span>
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.adb.shell(['date']));</span>
&nbsp;
      case 4:
<span class="cstat-no" title="statement not covered" >        out = context$1$0.sent;</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', out.trim());</span>
&nbsp;
      case 8:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].errorAndThrow('Could not capture device date and time: ' + context$1$0.t0);</span>
&nbsp;
      case 11:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
commands.getPageSource = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >  return this.bootstrap.sendAction('source');</span>
};
&nbsp;
commands.back = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >  return this.bootstrap.sendAction('pressBack');</span>
};
&nbsp;
commands.isKeyboardShown = <span class="fstat-no" title="function not covered" >function callee$0$0() {</span>
<span class="cstat-no" title="statement not covered" >  var keyboardInfo;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.adb.isSoftKeyboardPresent());</span>
&nbsp;
      case 2:
<span class="cstat-no" title="statement not covered" >        keyboardInfo = context$1$0.sent;</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', keyboardInfo.isKeyboardShown);</span>
&nbsp;
      case 4:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
commands.hideKeyboard = <span class="fstat-no" title="function not covered" >function callee$0$0() {</span>
<span class="cstat-no" title="statement not covered" >  var _ref, isKeyboardShown, canCloseKeyboard;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
...
<span class="cstat-no" title="statement not covered" >        isKeyboardShown = _ref.isKeyboardShown;</span>
<span class="cstat-no" title="statement not covered" >        canCloseKeyboard = _ref.canCloseKeyboard;</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        throw new Error("Soft keyboard not present, cannot hide keyboard");</span>
&nbsp;
      case 7:
<span class="cstat-no" title="statement not covered" >        if (!canCloseKeyboard) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 11;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', this.back());</span>
&nbsp;
      case 11:
<span class="cstat-no" title="statement not covered" >        _logger2['default'].info("Keyboard has no UI; no closing necessary");</span>
&nbsp;
      case 12:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
commands.openSettingsActivity = <span class="fstat-no" title="function not covered" >function callee$0$0(setting) {</span>
<span class="cstat-no" title="statement not covered" >  var _ref2, appPackage, appActivity;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
...
<span class="cstat-no" title="statement not covered" >        appPackage = _ref2.appPackage;</span>
<span class="cstat-no" title="statement not covered" >        appActivity = _ref2.appActivity;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 7;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.adb.shell(['am', 'start', '-a', 'android.settings.' + setting]));</span>
&nbsp;
      case 7:
...
<span class="cstat-no" title="statement not covered" >  return this.bootstrap.sendAction('getDeviceSize');</span>
};
&nbsp;
commands.getCurrentActivity = <span class="fstat-no" title="function not covered" >function callee$0$0() {</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 2;</span>
...
&nbsp;
      case 2:
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', context$1$0.sent.appActivity);</span>
&nbsp;
      case 3:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
commands.getLogTypes = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >  return _lodash2['default'].keys(logTypesSupported);</span>
};
&nbsp;
commands.getLog = <span class="fstat-no" title="function not covered" >function (logType) {</span>
<span class="cstat-no" title="statement not covered" >  if (!_lodash2['default'].has(logTypesSupported, logType)) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('Unsupported log type ' + logType + '. ' + ('Supported types are ' + JSON.stringify(logTypesSupported)));</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (logType === 'logcat') {</span>
<span class="cstat-no" title="statement not covered" >    return this.adb.getLogcatLogs();</span>
  }
};
&nbsp;
commands.isAppInstalled = <span class="fstat-no" title="function not covered" >function (appPackage) {</span>
<span class="cstat-no" title="statement not covered" >  return this.adb.isAppInstalled(appPackage);</span>
};
&nbsp;
commands.removeApp = <span class="fstat-no" title="function not covered" >function (appPackage) {</span>
<span class="cstat-no" title="statement not covered" >  return this.adb.uninstallApk(appPackage);</span>
};
&nbsp;
commands.installApp = <span class="fstat-no" title="function not covered" >function callee$0$0(appPath) {</span>
<span class="cstat-no" title="statement not covered" >  var _ref3, apkPackage, opts;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.helpers.configureApp(appPath, APP_EXTENSION));</span>
&nbsp;
      case 2:
<span class="cstat-no" title="statement not covered" >        appPath = context$1$0.sent;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 5;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_appiumSupport.fs.exists(appPath));</span>
&nbsp;
      case 5:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].errorAndThrow('Could not find app apk at ' + appPath);</span>
&nbsp;
      case 7:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 9;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.adb.packageAndLaunchActivityFromManifest(appPath));</span>
&nbsp;
      case 9:
<span class="cstat-no" title="statement not covered" >        _ref3 = context$1$0.sent;</span>
<span class="cstat-no" title="statement not covered" >        apkPackage = _ref3.apkPackage;</span>
<span class="cstat-no" title="statement not covered" >        opts = {</span>
          app: appPath,
          appPackage: apkPackage,
          fastReset: this.opts.fastReset
        };
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', _androidHelpers2['default'].installApkRemotely(this.adb, opts));</span>
&nbsp;
      case 13:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
commands.background = <span class="fstat-no" title="function not covered" >function callee$0$0(seconds) {</span>
<span class="cstat-no" title="statement not covered" >  var _ref4, appPackage, appActivity;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
...
<span class="cstat-no" title="statement not covered" >        appPackage = _ref4.appPackage;</span>
<span class="cstat-no" title="statement not covered" >        appActivity = _ref4.appActivity;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 11;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_bluebird2['default'].delay(seconds * 1000));</span>
&nbsp;
      case 11:
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', this.adb.startApp({</span>
...
&nbsp;
commands.getStrings = <span class="fstat-no" title="function not covered" >function callee$0$0(language) {</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.adb.getDeviceLanguage());</span>
&nbsp;
      case 3:
<span class="cstat-no" title="statement not covered" >        language = context$1$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].info('No language specified, returning strings for: ' + language);</span>
&nbsp;
      case 5:
<span class="cstat-no" title="statement not covered" >        if (!this.apkStrings[language]) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 7;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', this.apkStrings[language]);</span>
&nbsp;
      case 7:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 9;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_androidHelpers2['default'].pushStrings(language, this.adb, this.opts));</span>
&nbsp;
      case 9:
<span class="cstat-no" title="statement not covered" >        this.apkStrings[language] = context$1$0.sent;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 12;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.bootstrap.sendAction('updateStrings'));</span>
&nbsp;
      case 12:
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', this.apkStrings[language]);</span>
&nbsp;
...
&nbsp;
commands.launchApp = <span class="fstat-no" title="function not covered" >function callee$0$0() {</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 2;</span>
...
&nbsp;
commands.startActivity = <span class="fstat-no" title="function not covered" >function callee$0$0(appPackage, appActivity, appWaitPackage, appWaitActivity, intentAction, intentCategory, intentFlags, optionalIntentArguments, dontStopAppOnReset) {</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Starting package \'' + appPackage + '\' and activity \'' + appActivity + '\'');</span>
&nbsp;
        // dontStopAppOnReset is both an argument here, and a desired capability
        // if the argument is set, use it, otherwise use the cap
<span class="cstat-no" title="statement not covered" >        if (!_appiumSupport.util.hasValue(dontStopAppOnReset)) {</span>
<span class="cstat-no" title="statement not covered" >          dontStopAppOnReset = !!this.opts.dontStopAppOnReset;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 4;</span>
...
&nbsp;
commands.reset = <span class="fstat-no" title="function not covered" >function callee$0$0() {</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].info("Running old fashion reset (reinstall)");</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 4;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.adb.stopAndClear(this.opts.appPackage));</span>
&nbsp;
      case 4:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 6;</span>
...
&nbsp;
      case 10:
<span class="cstat-no" title="statement not covered" >        _logger2['default'].info("Running fast reset (stop and clear)");</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 13;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.adb.stopAndClear(this.opts.appPackage));</span>
&nbsp;
      case 13:
...
&nbsp;
commands.startAUT = <span class="fstat-no" title="function not covered" >function callee$0$0() {</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 2;</span>
...
commands.setUrl = <span class="fstat-no" title="function not covered" >function callee$0$0(uri) {</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.adb.startUri(uri, this.opts.appPackage));</span>
&nbsp;
      case 2:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
commands.closeApp = <span class="fstat-no" title="function not covered" >function callee$0$0() {</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 2;</span>
...
&nbsp;
commands.getDisplayDensity = <span class="fstat-no" title="function not covered" >function callee$0$0() {</span>
<span class="cstat-no" title="statement not covered" >  var out, val;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.adb.shell(['getprop', 'ro.sf.lcd_density']));</span>
&nbsp;
      case 2:
<span class="cstat-no" title="statement not covered" >        out = context$1$0.sent;</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        val = parseInt(out, 10);</span>
&nbsp;
...
&nbsp;
      case 7:
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Parsed density value was NaN: "' + out + '"');</span>
&nbsp;
      case 8:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 10;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.adb.shell(['getprop', 'qemu.sf.lcd_density']));</span>
&nbsp;
      case 10:
<span class="cstat-no" title="statement not covered" >        out = context$1$0.sent;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        _logger2['default'].errorAndThrow('Failed to get display density property.');</span>
&nbsp;
      case 17:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
 ...
 */
<span class="fstat-no" title="function not covered" >function parseSurfaceLine(line) {</span>
...
<span class="cstat-no" title="statement not covered" >  var bounds = line.split('rect=')[1].replace(/[\(\), x]+/g, ' ').trim().split(' ');</span>
&nbsp;
 ...
 */
<span class="fstat-no" title="function not covered" >function parseWindows(lines) {</span>
<span class="cstat-no" title="statement not covered" >  var atStatusBar = false;</span>
<span class="cstat-no" title="statement not covered" >  var atNavBar = false;</span>
<span class="cstat-no" title="statement not covered" >  var statusBar = undefined;</span>
<span class="cstat-no" title="statement not covered" >  var navigationBar = undefined;</span>
  // the window manager output looks like:
  // Window #1 ... WindowID
  //   A bunch of properties
  // Window #2 ... WindowID
  //   A bunch of properties
<span class="cstat-no" title="statement not covered" >  lines.split('\n').forEach(<span class="fstat-no" title="function not covered" >function (line) {</span></span>
    // the start of a new window section
<span class="cstat-no" title="statement not covered" >    if (line.indexOf('  Window #') !== -1) {</span>
      // determine which section we're in
      // only one will be true
<span class="cstat-no" title="statement not covered" >      atStatusBar = line.indexOf('StatusBar') !== -1;</span>
<span class="cstat-no" title="statement not covered" >      atNavBar = line.indexOf('NavigationBar') !== -1;</span>
      // don't need anything else. move to next line
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
    // once we're in a window section, look for the surface data line
<span class="cstat-no" title="statement not covered" >    if (line.indexOf('      Surface:') === -1) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
<span class="cstat-no" title="statement not covered" >    if (atStatusBar) {</span>
<span class="cstat-no" title="statement not covered" >      statusBar = parseSurfaceLine(line);</span>
<span class="cstat-no" title="statement not covered" >      atStatusBar = false;</span>
    } else <span class="cstat-no" title="statement not covered" >if (atNavBar) {</span>
<span class="cstat-no" title="statement not covered" >      navigationBar = parseSurfaceLine(line);</span>
<span class="cstat-no" title="statement not covered" >      atNavBar = false;</span>
    }
  });
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!statusBar) {</span>
<span class="cstat-no" title="statement not covered" >    _logger2['default'].errorAndThrow('Failed to parse status bar information.');</span>
  }
<span class="cstat-no" title="statement not covered" >  if (!navigationBar) {</span>
<span class="cstat-no" title="statement not covered" >    _logger2['default'].errorAndThrow('Failed to parse navigation bar information.');</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return { statusBar: statusBar, navigationBar: navigationBar };</span>
}
&nbsp;
commands.getSystemBars = <span class="fstat-no" title="function not covered" >function callee$0$0() {</span>
<span class="cstat-no" title="statement not covered" >  var out;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.adb.shell(['dumpsys', 'window', 'windows']));</span>
&nbsp;
      case 2:
<span class="cstat-no" title="statement not covered" >        out = context$1$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!out) {</span>
<span class="cstat-no" title="statement not covered" >          _logger2['default'].errorAndThrow('Did not get window manager output.');</span>
        }
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', parseWindows(out));</span>
&nbsp;
      case 5:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
