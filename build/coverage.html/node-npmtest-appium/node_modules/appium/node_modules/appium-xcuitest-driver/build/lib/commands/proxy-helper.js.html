...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-xcuitest-driver/build/lib/commands/proxy-helper.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-xcuitest-driver/build/lib/commands/proxy-helper.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-xcuitest-driver/build/lib/commands/</a> &#187; proxy-helper.js</div>
</div>
<div class="body">
...
var helpers = {},
    extensions = {};
&nbsp;
helpers.proxyCommand = <span class="fstat-no" title="function not covered" >function callee$0$0(endpoint, method, body) {</span>
<span class="cstat-no" title="statement not covered" >  var isSessionCommand = arguments.length &lt;= 3 || arguments[3] === undefined ? true : arguments[3];</span>
<span class="cstat-no" title="statement not covered" >  var proxy, cmdName, timeout, res, isCommandExpired, errMsg;</span>
...
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        if (!this.shutdownUnexpectedly) {</span>
...
<span class="cstat-no" title="statement not covered" >          _logger2['default'].errorAndThrow('Proxying requires an endpoint');</span>
        } else <span class="cstat-no" title="statement not covered" >if (SUPPORTED_METHODS.indexOf(method) === -1) {</span>
<span class="cstat-no" title="statement not covered" >          _logger2['default'].errorAndThrow('Proxying only works for the following requests: ' + SUPPORTED_METHODS.join(', '));</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (this.wda) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 5;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        throw new Error("Can't call proxyCommand without WDA driver active");</span>
&nbsp;
      case 5:
<span class="cstat-no" title="statement not covered" >        proxy = isSessionCommand ? this.wda.jwproxy : this.wda.noSessionProxy;</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        throw new Error("Can't call proxyCommand without WDA proxy active");</span>
&nbsp;
      case 8:
<span class="cstat-no" title="statement not covered" >        cmdName = (0, _appiumBaseDriver.routeToCommandName)(endpoint, method);</span>
<span class="cstat-no" title="statement not covered" >        timeout = this._getCommandTimeout(cmdName);</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Setting custom timeout to ' + timeout + ' ms for "' + cmdName + '" command');</span>
<span class="cstat-no" title="statement not covered" >        isCommandExpired = false;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 16;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_bluebird2['default'].Promise.resolve(proxy.command(endpoint, method, body)).timeout(timeout)['catch'](_bluebird2['default'].Promise.TimeoutError, <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >          isCommandExpired = true;</span>
        }));
&nbsp;
      case 16:
<span class="cstat-no" title="statement not covered" >        res = context$1$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!isCommandExpired) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 23;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        proxy.cancelActiveRequests();</span>
<span class="cstat-no" title="statement not covered" >        errMsg = 'Appium did not get any response from "' + cmdName + '" command in ' + timeout + ' ms';</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 22;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.startUnexpectedShutdown(new _appiumBaseDriver.errors.TimeoutError(errMsg)));</span>
&nbsp;
      case 22:
<span class="cstat-no" title="statement not covered" >        _logger2['default'].errorAndThrow(errMsg);</span>
&nbsp;
      case 23:
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(proxy.command(endpoint, method, body));</span>
&nbsp;
      case 27:
<span class="cstat-no" title="statement not covered" >        res = context$1$0.sent;</span>
&nbsp;
      case 28:
<span class="cstat-no" title="statement not covered" >        if (!(res &amp;&amp; res.status &amp;&amp; parseInt(res.status, 10) !== 0)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 30;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        throw (0, _appiumBaseDriver.errorFromCode)(res.status, res.value);</span>
&nbsp;
      case 30:
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (res &amp;&amp; cmdName === GET_STATUS_COMMAND) {</span>
<span class="cstat-no" title="statement not covered" >          this.cachedWdaStatus = res;</span>
        }
&nbsp;
