...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-base-driver/build/lib/express/express-logging.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-base-driver/build/lib/express/express-logging.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-base-driver/build/lib/express/</a> &#187; express-logging.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >function requestEndLoggingFormat(tokens, req, res) {</span>
<span class="cstat-no" title="statement not covered" >  var status = res.statusCode;</span>
<span class="cstat-no" title="statement not covered" >  var statusStr = ':status';</span>
<span class="cstat-no" title="statement not covered" >  if (status &gt;= 500) {</span>
<span class="cstat-no" title="statement not covered" >    statusStr = statusStr.red;</span>
  } else <span class="cstat-no" title="statement not covered" >if (status &gt;= 400) {</span>
<span class="cstat-no" title="statement not covered" >    statusStr = statusStr.yellow;</span>
  } else <span class="cstat-no" title="statement not covered" >if (status &gt;= 300) {</span>
<span class="cstat-no" title="statement not covered" >    statusStr = statusStr.cyan;</span>
  } else {
<span class="cstat-no" title="statement not covered" >    statusStr = statusStr.green;</span>
  }
<span class="cstat-no" title="statement not covered" >  var fn = compile('' + '&lt;-- :method :url '.white + statusStr + ' ' + ':response-time ms - :res[content-length]'.grey);</span>
<span class="cstat-no" title="statement not covered" >  return fn(tokens, req, res);</span>
}
&nbsp;
var endLogFormatter = (0, _morgan2['default'])(<span class="fstat-no" title="function not covered" >function (tokens, req, res) {</span>
<span class="cstat-no" title="statement not covered" >  _logger2['default'].info(requestEndLoggingFormat(tokens, req, res), (res.jsonResp || '').grey);</span>
});
&nbsp;
var requestStartLoggingFormat = compile('--&gt;'.white + ' ' + ':method'.white + ' ' + ':url'.white);
&nbsp;
var startLogFormatter = (0, _morgan2['default'])(<span class="fstat-no" title="function not covered" >function (tokens, req, res) {</span>
...
<span class="cstat-no" title="statement not covered" >      data = JSON.stringify(req.body).substring(0, 1000);</span>
    }
  } catch (ign) {}
<span class="cstat-no" title="statement not covered" >  _logger2['default'].info(requestStartLoggingFormat(tokens, req, res), data.grey);</span>
}, { immediate: true });
&nbsp;
