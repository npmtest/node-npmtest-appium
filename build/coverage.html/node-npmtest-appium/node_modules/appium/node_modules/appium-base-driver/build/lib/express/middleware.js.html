...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-base-driver/build/lib/express/middleware.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-base-driver/build/lib/express/middleware.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-base-driver/build/lib/express/</a> &#187; middleware.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >function allowCrossDomain(req, res, next) {</span>
<span class="cstat-no" title="statement not covered" >  try {</span>
<span class="cstat-no" title="statement not covered" >    res.header('Access-Control-Allow-Origin', '*');</span>
<span class="cstat-no" title="statement not covered" >    res.header('Access-Control-Allow-Methods', 'GET,POST,PUT,OPTIONS,DELETE');</span>
<span class="cstat-no" title="statement not covered" >    res.header('Access-Control-Allow-Headers', 'origin, content-type, accept');</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    _logger2['default'].error('Unexpected error: ' + err.stack);</span>
<span class="cstat-no" title="statement not covered" >    next();</span>
  }
}
&nbsp;
<span class="fstat-no" title="function not covered" >function fixPythonContentType(req, res, next) {</span>
  // hack because python client library gives us wrong content-type
<span class="cstat-no" title="statement not covered" >  if (/^\/wd/.test(req.path) &amp;&amp; /^Python/.test(req.headers['user-agent'])) {</span>
<span class="cstat-no" title="statement not covered" >    if (req.headers['content-type'] === 'application/x-www-form-urlencoded') {</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function defaultToJSONContentType(req, res, next) {</span>
<span class="cstat-no" title="statement not covered" >  if (!req.headers['content-type']) {</span>
<span class="cstat-no" title="statement not covered" >    req.headers['content-type'] = 'application/json';</span>
  }
<span class="cstat-no" title="statement not covered" >  next();</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function catchAllHandler(err, req, res, next) {</span>
<span class="cstat-no" title="statement not covered" >  _logger2['default'].error('Uncaught error: ' + err.message);</span>
<span class="cstat-no" title="statement not covered" >  _logger2['default'].error('Sending generic error response');</span>
<span class="cstat-no" title="statement not covered" >  try {</span>
...
<span class="cstat-no" title="statement not covered" >    _logger2['default'].error(err);</span>
  } catch (ign) {
<span class="cstat-no" title="statement not covered" >    next(ign);</span>
  }
}
&nbsp;
<span class="fstat-no" title="function not covered" >function catch4XXHandler(err, req, res, next) {</span>
<span class="cstat-no" title="statement not covered" >  if (err.status &gt;= 400 &amp;&amp; err.status &lt; 500) {</span>
    // set the content type to `text/plain`
    // https://code.google.com/p/selenium/wiki/JsonWireProtocol#Responses
<span class="cstat-no" title="statement not covered" >    _logger2['default'].debug('Setting content type to \'text/plain\' for HTTP status \'' + err.status + '\'');</span>
<span class="cstat-no" title="statement not covered" >    res.set('Content-Type', 'text/plain');</span>
<span class="cstat-no" title="statement not covered" >    res.status(err.status).send('Unable to process request: ' + err.message);</span>
  } else {
<span class="cstat-no" title="statement not covered" >    next(err);</span>
  }
}
&nbsp;
<span class="fstat-no" title="function not covered" >function catch404Handler(req, res) {</span>
  // set the content type to `text/plain`
  // https://code.google.com/p/selenium/wiki/JsonWireProtocol#Responses
<span class="cstat-no" title="statement not covered" >  _logger2['default'].debug('No route found. Setting content type to \'text/plain\'');</span>
<span class="cstat-no" title="statement not covered" >  res.set('Content-Type', 'text/plain');</span>
<span class="cstat-no" title="statement not covered" >  res.status(404).send('The URL \'' + req.originalUrl + '\' did not map to a valid resource');</span>
}
&nbsp;
