...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/build/lib/main.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/build/lib/main.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/build/lib/</a> &#187; main.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >function preflightChecks(parser, args) {</span>
<span class="cstat-no" title="statement not covered" >  var throwInsteadOfExit = arguments.length &lt;= 2 || arguments[2] === undefined ? false : arguments[2];</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function preflightChecks$(context$1$0) {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        (0, _config.checkNodeOk)();</span>
<span class="cstat-no" title="statement not covered" >        if (args.asyncTrace) {</span>
<span class="cstat-no" title="statement not covered" >          require('longjohn').async_trace_limit = -1;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!args.showConfig) {</span>
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _config.showConfig)());</span>
&nbsp;
      case 6:
<span class="cstat-no" title="statement not covered" >        process.exit(0);</span>
&nbsp;
      case 7:
<span class="cstat-no" title="statement not covered" >        (0, _config.warnNodeDeprecations)();</span>
<span class="cstat-no" title="statement not covered" >        (0, _config.validateServerArgs)(parser, args);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!args.tmpDir) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 12;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 12;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _config.validateTmpDir)(args.tmpDir));</span>
&nbsp;
      case 12:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].error(context$1$0.t0.message.red);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!throwInsteadOfExit) {</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function logDeprecationWarning(deprecatedArgs) {</span>
<span class="cstat-no" title="statement not covered" >  _logger2['default'].warn('Deprecated server args:');</span>
...
<span class="cstat-no" title="statement not covered" >    for (var _iterator = _getIterator(_lodash2['default'].toPairs(deprecatedArgs)), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {</span>
<span class="cstat-no" title="statement not covered" >      var _step$value = _slicedToArray(_step.value, 2);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var arg = _step$value[0];</span>
<span class="cstat-no" title="statement not covered" >      var realArg = _step$value[1];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      _logger2['default'].warn('  ' + arg.red + ' =&gt; ' + realArg);</span>
    }
  } catch (err) {
...
&nbsp;
<span class="fstat-no" title="function not covered" >function logNonDefaultArgsWarning(args) {</span>
  // cleanly print out the default arguments, allowing for prefix and timestamp
<span class="fstat-no" title="function not covered" >  function getValueArray(obj) {</span>
<span class="cstat-no" title="statement not covered" >    var indent = arguments.length &lt;= 1 || arguments[1] === undefined ? '  ' : arguments[1];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!_lodash2['default'].isObject(obj)) {</span>
<span class="cstat-no" title="statement not covered" >      return [obj];</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    var strArr = ['{'];</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    try {</span>
<span class="cstat-no" title="statement not covered" >      for (var _iterator2 = _getIterator(_lodash2['default'].toPairs(obj)), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {</span>
<span class="cstat-no" title="statement not covered" >        var _step2$value = _slicedToArray(_step2.value, 2);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        var arg = _step2$value[0];</span>
...
<span class="cstat-no" title="statement not covered" >          strArr.push(indent + '  ' + arg + ': ' + value);</span>
        } else {
<span class="cstat-no" title="statement not covered" >          value = getValueArray(value, indent + '  ');</span>
<span class="cstat-no" title="statement not covered" >          strArr.push(indent + '  ' + arg + ': ' + value.shift());</span>
<span class="cstat-no" title="statement not covered" >          strArr.push.apply(strArr, _toConsumableArray(value));</span>
        }
      }
    } catch (err) {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    strArr.push(indent + '}');</span>
<span class="cstat-no" title="statement not covered" >    return strArr;</span>
  }
<span class="cstat-no" title="statement not covered" >  _logger2['default'].info('Non-default server args:');</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  try {</span>
<span class="cstat-no" title="statement not covered" >    for (var _iterator3 = _getIterator(_lodash2['default'].toPairs(args)), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {</span>
<span class="cstat-no" title="statement not covered" >      var _step3$value = _slicedToArray(_step3.value, 2);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var arg = _step3$value[0];</span>
<span class="cstat-no" title="statement not covered" >      var value = _step3$value[1];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      value = getValueArray(value);</span>
<span class="cstat-no" title="statement not covered" >      _logger2['default'].info('  ' + arg + ': ' + value.shift());</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      try {</span>
<span class="cstat-no" title="statement not covered" >        for (var _iterator4 = _getIterator(value), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {</span>
<span class="cstat-no" title="statement not covered" >          var val = _step4.value;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          _logger2['default'].info(val);</span>
        }
      } catch (err) {
...
&nbsp;
<span class="fstat-no" title="function not covered" >function logDefaultCapabilitiesWarning(caps) {</span>
<span class="cstat-no" title="statement not covered" >  _logger2['default'].info('Default capabilities, which will be added to each request ' + 'unless overridden by desired capabilities:');</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  try {</span>
<span class="cstat-no" title="statement not covered" >    for (var _iterator5 = _getIterator(_lodash2['default'].toPairs(caps)), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {</span>
<span class="cstat-no" title="statement not covered" >      var _step5$value = _slicedToArray(_step5.value, 2);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var cap = _step5$value[0];</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function logStartupInfo(parser, args) {</span>
<span class="cstat-no" title="statement not covered" >  var welcome, appiumRev, showArgs, deprecatedArgs;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function logStartupInfo$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        welcome = 'Welcome to Appium v' + _config.APPIUM_VER;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 3;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _config.getGitRev)());</span>
&nbsp;
      case 3:
<span class="cstat-no" title="statement not covered" >        appiumRev = context$1$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (appiumRev) {</span>
<span class="cstat-no" title="statement not covered" >          welcome += ' (REV ' + appiumRev + ')';</span>
        }
<span class="cstat-no" title="statement not covered" >        _logger2['default'].info(welcome);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        showArgs = (0, _config.getNonDefaultArgs)(parser, args);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (_lodash2['default'].size(showArgs)) {</span>
<span class="cstat-no" title="statement not covered" >          logNonDefaultArgsWarning(showArgs);</span>
        }
<span class="cstat-no" title="statement not covered" >        deprecatedArgs = (0, _config.getDeprecatedArgs)(parser, args);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (_lodash2['default'].size(deprecatedArgs)) {</span>
<span class="cstat-no" title="statement not covered" >          logDeprecationWarning(deprecatedArgs);</span>
        }
<span class="cstat-no" title="statement not covered" >        if (!_lodash2['default'].isEmpty(args.defaultCapabilities)) {</span>
<span class="cstat-no" title="statement not covered" >          logDefaultCapabilitiesWarning(args.defaultCapabilities);</span>
        }
...
&nbsp;
<span class="fstat-no" title="function not covered" >function logServerPort(address, port) {</span>
<span class="cstat-no" title="statement not covered" >  var logMessage = 'Appium REST http interface listener started on ' + (address + ':' + port);</span>
<span class="cstat-no" title="statement not covered" >  _logger2['default'].info(logMessage);</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function main() {</span>
<span class="cstat-no" title="statement not covered" >  var args = arguments.length &lt;= 0 || arguments[0] === undefined ? null : arguments[0];</span>
<span class="cstat-no" title="statement not covered" >  var parser, throwInsteadOfExit, router, server;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function main$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        parser = (0, _parser2['default'])();</span>
<span class="cstat-no" title="statement not covered" >        throwInsteadOfExit = false;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (args) {</span>
          ...
          // with defaults
<span class="cstat-no" title="statement not covered" >          args = _Object$assign({}, (0, _parser.getDefaultArgs)(), args);</span>
&nbsp;
          // if we have a containing package instead of running as a CLI process,
          // that package might not appreciate us calling 'process.exit' willy-
          // nilly, so give it the option to have us throw instead of exit
<span class="cstat-no" title="statement not covered" >          if (args.throwInsteadOfExit) {</span>
<span class="cstat-no" title="statement not covered" >            throwInsteadOfExit = true;</span>
            // but remove it since it's not a real server arg per se
<span class="cstat-no" title="statement not covered" >            delete args.throwInsteadOfExit;</span>
          }
        } else {
          // otherwise parse from CLI
<span class="cstat-no" title="statement not covered" >          args = parser.parseArgs();</span>
        }
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 5;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _logsink.init)(args));</span>
&nbsp;
      case 5:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 7;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(preflightChecks(parser, args, throwInsteadOfExit));</span>
&nbsp;
      case 7:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 9;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(logStartupInfo(parser, args));</span>
&nbsp;
      case 9:
<span class="cstat-no" title="statement not covered" >        router = (0, _appium2['default'])(args);</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 12;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _appiumBaseDriver.server)(router, args.port, args.address));</span>
&nbsp;
      case 12:
<span class="cstat-no" title="statement not covered" >        server = context$1$0.sent;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.prev = 13;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!(args.nodeconfig !== null)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 17;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 17;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _gridRegister2['default'])(args.nodeconfig, args.address, args.port));</span>
&nbsp;
      case 17:
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(server.close());</span>
&nbsp;
      case 23:
<span class="cstat-no" title="statement not covered" >        throw context$1$0.t0;</span>
&nbsp;
      case 24:
&nbsp;
<span class="cstat-no" title="statement not covered" >        process.once('SIGINT', <span class="fstat-no" title="function not covered" >function callee$1$0() {</span></span>
...
<span class="cstat-no" title="statement not covered" >            while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
              case 0:
<span class="cstat-no" title="statement not covered" >                _logger2['default'].info('Received SIGINT - shutting down');</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        process.once('SIGTERM', <span class="fstat-no" title="function not covered" >function callee$1$0() {</span></span>
<span class="cstat-no" title="statement not covered" >          return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$1$0$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >            while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
              case 0:
<span class="cstat-no" title="statement not covered" >                _logger2['default'].info('Received SIGTERM - shutting down');</span>
<span class="cstat-no" title="statement not covered" >                context$2$0.next = 3;</span>
<span class="cstat-no" title="statement not covered" >                return _regeneratorRuntime.awrap(server.close());</span>
&nbsp;
              case 3:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        logServerPort(args.address, args.port);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', server);</span>
&nbsp;
      case 28:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
<span class="cstat-no" title="statement not covered" >  (0, _asyncbox.asyncify)(main);</span>
}
&nbsp;
exports.main = main;
&nbsp;
