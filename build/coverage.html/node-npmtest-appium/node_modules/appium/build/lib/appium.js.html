...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/build/lib/appium.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/build/lib/appium.js</span></h1>
    <h2>
        
        Statements: <span class="metric">12.79% <small>(38 / 297)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">13.06% <small>(38 / 291)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/build/lib/</a> &#187; appium.js</div>
</div>
<div class="body">
...
627
628
629</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function AppiumDriver(args) {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, AppiumDriver);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _get(Object.getPrototypeOf(AppiumDriver.prototype), 'constructor', this).call(this);</span>
&nbsp;
    // the main Appium Driver has no new command timeout
<span class="cstat-no" title="statement not covered" >    this.newCommandTimeoutMs = 0;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      return _lodash2['default'].includes(_lodash2['default'].keys(this.sessions), sessionId) &amp;&amp; this.sessions[sessionId].sessionId !== null;</span>
    }
  }, {
...
<span class="cstat-no" title="statement not covered" >      return this.sessions[sessionId];</span>
    ...
    value: <span class="fstat-no" title="function not covered" >function getDriverForCaps(caps) {</span>
      // TODO if this logic ever becomes complex, should probably factor out
      // into its own file
<span class="cstat-no" title="statement not covered" >      if (!caps.platformName || !_lodash2['default'].isString(caps.platformName)) {</span>
<span class="cstat-no" title="statement not covered" >        throw new Error("You must include a platformName capability");</span>
      }
&nbsp;
      // we don't necessarily have an `automationName` capability,
<span class="cstat-no" title="statement not covered" >      if (caps.automationName) {</span>
<span class="cstat-no" title="statement not covered" >        if (caps.automationName.toLowerCase() === 'selendroid') {</span>
          // but if we do and it is 'Selendroid', act on it
<span class="cstat-no" title="statement not covered" >          return _appiumSelendroidDriver.SelendroidDriver;</span>
        } else <span class="cstat-no" title="statement not covered" >if (caps.automationName.toLowerCase() === 'uiautomator2') {</span>
          // but if we do and it is 'Uiautomator2', act on it
<span class="cstat-no" title="statement not covered" >          return _appiumUiautomator2Driver.AndroidUiautomator2Driver;</span>
        } else <span class="cstat-no" title="statement not covered" >if (caps.automationName.toLowerCase() === 'xcuitest') {</span>
          // but if we do and it is 'XCUITest', act on it
<span class="cstat-no" title="statement not covered" >          return _appiumXcuitestDriver.XCUITestDriver;</span>
        } else <span class="cstat-no" title="statement not covered" >if (caps.automationName.toLowerCase() === 'youiengine') {</span>
          // but if we do and it is 'YouiEngine', act on it
<span class="cstat-no" title="statement not covered" >          return _appiumYouiengineDriver.YouiEngineDriver;</span>
        }
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (caps.platformName.toLowerCase() === "fake") {</span>
<span class="cstat-no" title="statement not covered" >        return _appiumFakeDriver.FakeDriver;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (caps.platformName.toLowerCase() === 'android') {</span>
<span class="cstat-no" title="statement not covered" >        return _appiumAndroidDriver.AndroidDriver;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (caps.platformName.toLowerCase() === 'ios') {</span>
<span class="cstat-no" title="statement not covered" >        if (caps.platformVersion) {</span>
<span class="cstat-no" title="statement not covered" >          var majorVer = caps.platformVersion.toString().split(".")[0];</span>
<span class="cstat-no" title="statement not covered" >          if (parseInt(majorVer, 10) &gt;= 10) {</span>
<span class="cstat-no" title="statement not covered" >            _logger2['default'].info("Requested iOS support with version &gt;= 10, using XCUITest " + "driver instead of UIAutomation-based driver, since the " + "latter is unsupported on iOS 10 and up.");</span>
<span class="cstat-no" title="statement not covered" >            return _appiumXcuitestDriver.XCUITestDriver;</span>
          }
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        return _appiumIosDriver.IosDriver;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (caps.platformName.toLowerCase() === 'windows') {</span>
<span class="cstat-no" title="statement not covered" >        return _appiumWindowsDriver.WindowsDriver;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (caps.platformName.toLowerCase() === 'mac') {</span>
<span class="cstat-no" title="statement not covered" >        return _appiumMacDriver.MacDriver;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      var msg = undefined;</span>
<span class="cstat-no" title="statement not covered" >      if (caps.automationName) {</span>
<span class="cstat-no" title="statement not covered" >        msg = 'Could not find a driver for automationName \'' + caps.automationName + '\' and platformName ' + ('\'' + caps.platformName + '\'.');</span>
      } else {
<span class="cstat-no" title="statement not covered" >        msg = 'Could not find a driver for platformName \'' + caps.platformName + '\'.';</span>
      }
<span class="cstat-no" title="statement not covered" >      throw new Error(msg + ' Please check your desired capabilities.');</span>
    }
  }, {
    key: 'getDriverVersion',
    value: <span class="fstat-no" title="function not covered" >function getDriverVersion(driver) {</span>
<span class="cstat-no" title="statement not covered" >      var NAME_DRIVER_MAP = {</span>
...
<span class="cstat-no" title="statement not covered" >      if (!NAME_DRIVER_MAP[driver.name]) {</span>
<span class="cstat-no" title="statement not covered" >        _logger2['default'].warn('Unable to get version of driver \'' + driver.name + '\'');</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      var _require = require(NAME_DRIVER_MAP[driver.name] + '/package.json');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var version = _require.version;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      var config, gitSha, status;</span>
...
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap((0, _config.getAppiumConfig)());</span>
&nbsp;
          case 2:
<span class="cstat-no" title="statement not covered" >            config = context$2$0.sent;</span>
<span class="cstat-no" title="statement not covered" >            gitSha = config['git-sha'];</span>
<span class="cstat-no" title="statement not covered" >            status = { build: { version: config.version } };</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (typeof gitSha !== "undefined") {</span>
<span class="cstat-no" title="statement not covered" >              status.build.revision = gitSha;</span>
            }
...
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    key: 'getSessions',
    value: <span class="fstat-no" title="function not covered" >function getSessions() {</span>
<span class="cstat-no" title="statement not covered" >      var sessions, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, _step$value, id, driver;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function getSessions$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            for (_iterator = _getIterator(_lodash2['default'].toPairs(this.sessions)); !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {</span>
<span class="cstat-no" title="statement not covered" >              _step$value = _slicedToArray(_step.value, 2);</span>
<span class="cstat-no" title="statement not covered" >              id = _step$value[0];</span>
<span class="cstat-no" title="statement not covered" >              driver = _step$value[1];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >              sessions.push({ id: id, capabilities: driver.caps });</span>
            }
...
&nbsp;
          case 18:
<span class="cstat-no" title="statement not covered" >            return context$2$0.finish(15);</span>
&nbsp;
          case 19:
<span class="cstat-no" title="statement not covered" >            return context$2$0.finish(12);</span>
&nbsp;
          case 20:
<span class="cstat-no" title="statement not covered" >            return context$2$0.abrupt('return', sessions);</span>
&nbsp;
          case 21:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    value: <span class="fstat-no" title="function not covered" >function printNewSessionAnnouncement(driver, caps) {</span>
<span class="cstat-no" title="statement not covered" >      var driverVersion = this.getDriverVersion(driver);</span>
<span class="cstat-no" title="statement not covered" >      var introString = driverVersion ? 'Creating new ' + driver.name + ' (v' + driverVersion + ') session' : 'Creating new ' + driver.name + ' session';</span>
<span class="cstat-no" title="statement not covered" >      _logger2['default'].info(introString);</span>
<span class="cstat-no" title="statement not covered" >      _logger2['default'].info('Capabilities:');</span>
<span class="cstat-no" title="statement not covered" >      _util2['default'].inspect(caps);</span>
...
<span class="cstat-no" title="statement not covered" >        for (var _iterator2 = _getIterator(_lodash2['default'].toPairs(caps)), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {</span>
<span class="cstat-no" title="statement not covered" >          var _step2$value = _slicedToArray(_step2.value, 2);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          var cap = _step2$value[0];</span>
<span class="cstat-no" title="statement not covered" >          var value = _step2$value[1];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          _logger2['default'].info('  ' + cap + ': ' + _util2['default'].inspect(value));</span>
        }
      } catch (err) {
...
<span class="cstat-no" title="statement not covered" >            throw _iteratorError2;</span>
    ...
    key: 'createSession',
    value: <span class="fstat-no" title="function not covered" >function createSession(caps, reqCaps) {</span>
<span class="cstat-no" title="statement not covered" >      var InnerDriver, _iteratorNormalCompletion3, _didIteratorError3, _iteratorError3, _iterator3, _step3, id, curSessions, d, _ref, _ref2, innerSessionId, dCaps;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            caps = _lodash2['default'].defaults(_lodash2['default'].clone(caps), this.args.defaultCapabilities);</span>
<span class="cstat-no" title="statement not covered" >            InnerDriver = this.getDriverForCaps(caps);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            this.printNewSessionAnnouncement(InnerDriver, caps);</span>
&nbsp;
            // sessionOverride server flag check
            // this will need to be re-thought when we go to multiple session support
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (!(this.args.sessionOverride &amp;&amp; !!this.sessions &amp;&amp; _lodash2['default'].keys(this.sessions).length &gt; 0)) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 37;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].info('Session override is on. Deleting other sessions.');</span>
...
<span class="cstat-no" title="statement not covered" >            context$2$0.prev = 8;</span>
<span class="cstat-no" title="statement not covered" >            _iterator3 = _getIterator(_lodash2['default'].keys(this.sessions));</span>
&nbsp;
          case 10:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            id = _step3.value;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].info('    Deleting session \'' + id + '\'');</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.prev = 13;</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 16;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.deleteSession(id));</span>
&nbsp;
          case 16:
...
<span class="cstat-no" title="statement not covered" >            _iteratorError3 = context$2$0.t1;</span>
&nbsp;
          case 29:
...
&nbsp;
          case 36:
<span class="cstat-no" title="statement not covered" >            return context$2$0.finish(29);</span>
&nbsp;
          case 37:
<span class="cstat-no" title="statement not covered" >            curSessions = undefined;</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.prev = 38;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            curSessions = this.curSessionDataForDriver(InnerDriver);</span>
...
<span class="cstat-no" title="statement not covered" >            context$2$0.t2 = context$2$0['catch'](38);</span>
<span class="cstat-no" title="statement not covered" >            throw new _appiumBaseDriver.errors.SessionNotCreatedError(context$2$0.t2.message);</span>
&nbsp;
          case 45:
<span class="cstat-no" title="statement not covered" >            d = new InnerDriver(this.args);</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 48;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(d.createSession(caps, reqCaps, curSessions));</span>
&nbsp;
          case 48:
<span class="cstat-no" title="statement not covered" >            _ref = context$2$0.sent;</span>
<span class="cstat-no" title="statement not covered" >            _ref2 = _slicedToArray(_ref, 2);</span>
<span class="cstat-no" title="statement not covered" >            innerSessionId = _ref2[0];</span>
<span class="cstat-no" title="statement not covered" >            dCaps = _ref2[1];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            this.sessions[innerSessionId] = d;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            this.attachUnexpectedShutdownHandler(d, innerSessionId);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].info('New ' + InnerDriver.name + ' session created successfully, session ' + (innerSessionId + ' added to master session list'));</span>
&nbsp;
            // set the New Command Timeout for the inner driver
<span class="cstat-no" title="statement not covered" >            d.startNewCommandTimeout();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            return context$2$0.abrupt('return', [innerSessionId, dCaps]);</span>
&nbsp;
          case 57:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    value: <span class="fstat-no" title="function not covered" >function attachUnexpectedShutdownHandler(driver, innerSessionId) {</span>
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function attachUnexpectedShutdownHandler$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
...
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(driver.onUnexpectedShutdown);</span>
&nbsp;
          case 3:
<span class="cstat-no" title="statement not covered" >            throw new Error('Unexpected shutdown');</span>
&nbsp;
          case 6:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (!(context$2$0.t0 instanceof _bluebird2['default'].CancellationError)) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 10;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
            }
&nbsp;
...
&nbsp;
          case 10:
<span class="cstat-no" title="statement not covered" >            _logger2['default'].warn('Closing session, cause was \'' + context$2$0.t0.message + '\'');</span>
<span class="cstat-no" title="statement not covered" >            _logger2['default'].info('Removing session ' + innerSessionId + ' from our master session list');</span>
<span class="cstat-no" title="statement not covered" >            delete this.sessions[innerSessionId];</span>
&nbsp;
          case 13:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    value: <span class="fstat-no" title="function not covered" >function curSessionDataForDriver(InnerDriver) {</span>
<span class="cstat-no" title="statement not covered" >      var data = _lodash2['default'].values(this.sessions).filter(<span class="fstat-no" title="function not covered" >function (s) {</span></span>
<span class="cstat-no" title="statement not covered" >        return s.constructor.name === InnerDriver.name;</span>
      }).map(<span class="fstat-no" title="function not covered" >function (s) {</span>
<span class="cstat-no" title="statement not covered" >        return s.driverData;</span>
      });
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      try {</span>
<span class="cstat-no" title="statement not covered" >        for (var _iterator4 = _getIterator(data), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {</span>
<span class="cstat-no" title="statement not covered" >          var datum = _step4.value;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (!datum) {</span>
<span class="cstat-no" title="statement not covered" >            throw new Error('Problem getting session data for driver type ' + (InnerDriver.name + '; does it implement \'get ') + 'driverData\'?');</span>
          }
        }
      } catch (err) {
...
<span class="cstat-no" title="statement not covered" >      return data;</span>
    ...
    key: 'deleteSession',
    value: <span class="fstat-no" title="function not covered" >function deleteSession(sessionId) {</span>
...
<span class="cstat-no" title="statement not covered" >            context$2$0.prev = 0;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (!this.sessions[sessionId]) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 4;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 4;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.sessions[sessionId].deleteSession());</span>
&nbsp;
          case 4:
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 10;</span>
<span class="cstat-no" title="statement not covered" >            break;</span>
...
<span class="cstat-no" title="statement not covered" >            context$2$0.t0 = context$2$0['catch'](0);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].error('Had trouble ending session ' + sessionId + ': ' + context$2$0.t0.message);</span>
...
&nbsp;
            ...
            // be in otherwise
<span class="cstat-no" title="statement not covered" >            _logger2['default'].info('Removing session ' + sessionId + ' from our master session list');</span>
<span class="cstat-no" title="statement not covered" >            delete this.sessions[sessionId];</span>
<span class="cstat-no" title="statement not covered" >            return context$2$0.finish(10);</span>
&nbsp;
          case 14:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
...
<span class="cstat-no" title="statement not covered" >      var _sessions$sessionId;</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      var _get2, sessionId;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            if (!isAppiumDriverCommand(cmd)) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            return context$2$0.abrupt('return', (_get2 = _get(Object.getPrototypeOf(AppiumDriver.prototype), 'executeCommand', this)).call.apply(_get2, [this, cmd].concat(args)));</span>
&nbsp;
          case 2:
<span class="cstat-no" title="statement not covered" >            sessionId = args[args.length - 1];</span>
<span class="cstat-no" title="statement not covered" >            return context$2$0.abrupt('return', (_sessions$sessionId = this.sessions[sessionId]).executeCommand.apply(_sessions$sessionId, [cmd].concat(args)));</span>
&nbsp;
          case 4:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
...
<span class="cstat-no" title="statement not covered" >      return this.sessions[sessionId] &amp;&amp; _lodash2['default'].isFunction(this.sessions[sessionId].proxyActive) &amp;&amp; this.sessions[sessionId].proxyActive(sessionId);</span>
    }
  }, {
...
<span class="cstat-no" title="statement not covered" >      return this.sessions[sessionId].getProxyAvoidList();</span>
    }
  }, {
    key: 'canProxy',
    value: <span class="fstat-no" title="function not covered" >function canProxy(sessionId) {</span>
<span class="cstat-no" title="statement not covered" >      return this.sessions[sessionId] &amp;&amp; this.sessions[sessionId].canProxy(sessionId);</span>
    }
  }]);
&nbsp;
  return AppiumDriver;
...
&nbsp;
<span class="fstat-no" title="function not covered" >function isAppiumDriverCommand(cmd) {</span>
<span class="cstat-no" title="statement not covered" >  return !(0, _appiumBaseDriver.isSessionCommand)(cmd) || cmd === "deleteSession";</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function getAppiumRouter(args) {</span>
<span class="cstat-no" title="statement not covered" >  var appium = new AppiumDriver(args);</span>
<span class="cstat-no" title="statement not covered" >  return (0, _appiumBaseDriver.routeConfiguringFunction)(appium);</span>
}
&nbsp;
