...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/build/lib/logsink.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/build/lib/logsink.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/build/lib/</a> &#187; logsink.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >    date = new Date(date.valueOf() + date.getTimezoneOffset() * 60000);</span>
  }
<span class="cstat-no" title="statement not covered" >  return date.toFormat("YYYY-MM-DD HH24:MI:SS:LL");</span>
}
&nbsp;
...
<span class="fstat-no" title="function not covered" >function applyStripColorPatch(transport) {</span>
<span class="cstat-no" title="statement not covered" >  var _log = transport.log.bind(transport);</span>
<span class="cstat-no" title="statement not covered" >  transport.log = <span class="fstat-no" title="function not covered" >function (level, msg, meta, callback) {</span></span>
...
<span class="cstat-no" title="statement not covered" >    _log(level, msg, meta, callback);</span>
  };
}
&nbsp;
<span class="fstat-no" title="function not covered" >function _createConsoleTransport(args, logLvl) {</span>
<span class="cstat-no" title="statement not covered" >  var transport = new _winston2['default'].transports.Console({</span>
    name: "console",
    ...
    json: false,
    level: logLvl,
    formatter: <span class="fstat-no" title="function not covered" >function formatter(options) {</span>
<span class="cstat-no" title="statement not covered" >      var meta = options.meta &amp;&amp; _Object$keys(options.meta).length ? '\n\t' + JSON.stringify(options.meta) : '';</span>
<span class="cstat-no" title="statement not covered" >      var timestampPrefix = '';</span>
<span class="cstat-no" title="statement not covered" >      if (options.timestamp) {</span>
<span class="cstat-no" title="statement not covered" >        timestampPrefix = options.timestamp() + ' - ';</span>
      }
<span class="cstat-no" title="statement not covered" >      return '' + timestampPrefix + (options.message || '') + meta;</span>
    }
  });
<span class="cstat-no" title="statement not covered" >  if (args.logNoColors) {</span>
<span class="cstat-no" title="statement not covered" >    applyStripColorPatch(transport);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return transport;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function _createFileTransport(args, logLvl) {</span>
<span class="cstat-no" title="statement not covered" >  var transport = new _winston2['default'].transports.File({</span>
    name: "file",
    timestamp: timestamp,
    filename: args.log,
    maxFiles: 1,
...
&nbsp;
<span class="fstat-no" title="function not covered" >function _createHttpTransport(args, logLvl) {</span>
<span class="cstat-no" title="statement not covered" >  var host = null,</span>
      port = null;
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (args.webhook.match(':')) {</span>
<span class="cstat-no" title="statement not covered" >    var hostAndPort = args.webhook.split(':');</span>
<span class="cstat-no" title="statement not covered" >    host = hostAndPort[0];</span>
<span class="cstat-no" title="statement not covered" >    port = parseInt(hostAndPort[1], 10);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  var transport = new _winston2['default'].transports.Http({</span>
    name: "http",
    host: host || '127.0.0.1',
    port: port || 9003,
    path: '/',
...
&nbsp;
<span class="fstat-no" title="function not covered" >function _createTransports(args) {</span>
<span class="cstat-no" title="statement not covered" >  var transports, consoleLogLevel, fileLogLevel, lvlPair;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function _createTransports$(context$1$0) {</span></span>
...
<span class="cstat-no" title="statement not covered" >        consoleLogLevel = null;</span>
<span class="cstat-no" title="statement not covered" >        fileLogLevel = null;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (args.loglevel &amp;&amp; args.loglevel.match(":")) {</span>
<span class="cstat-no" title="statement not covered" >          lvlPair = args.loglevel.split(':');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          consoleLogLevel = lvlPair[0] || consoleLogLevel;</span>
<span class="cstat-no" title="statement not covered" >          fileLogLevel = lvlPair[1] || fileLogLevel;</span>
        } else {
<span class="cstat-no" title="statement not covered" >          consoleLogLevel = fileLogLevel = args.loglevel;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        transports.push(_createConsoleTransport(args, consoleLogLevel));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!args.log) {</span>
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_appiumSupport.fs.exists(args.log));</span>
&nbsp;
      case 9:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 12;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_appiumSupport.fs.unlink(args.log));</span>
&nbsp;
      case 12:
&nbsp;
<span class="cstat-no" title="statement not covered" >        transports.push(_createFileTransport(args, fileLogLevel));</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 18;</span>
<span class="cstat-no" title="statement not covered" >        break;</span>
&nbsp;
      case 15:
...
<span class="cstat-no" title="statement not covered" >        console.log('Tried to attach logging to file ' + args.log + ' but an error ' + ('occurred: ' + context$1$0.t0.message));</span>
&nbsp;
      case 18:
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (args.webhook) {</span>
<span class="cstat-no" title="statement not covered" >          try {</span>
<span class="cstat-no" title="statement not covered" >            transports.push(_createHttpTransport(args, fileLogLevel));</span>
          } catch (e) {
            // eslint-disable-next-line no-console
<span class="cstat-no" title="statement not covered" >            console.log('Tried to attach logging to Http at ' + args.webhook + ' but ' + ('an error occurred: ' + e.message));</span>
          }
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', transports);</span>
&nbsp;
      case 20:
      case 'end':
...
&nbsp;
<span class="fstat-no" title="function not covered" >function init(args) {</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function init$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
        // set de facto param passed to timestamp function
<span class="cstat-no" title="statement not covered" >        timeZone = args.localTimezone;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        if (!args.logNoColors) {</span>
<span class="cstat-no" title="statement not covered" >          _winston2['default'].addColors(colors);</span>
        }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        context$1$0.t0 = _winston2['default'].Logger;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 6;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_createTransports(args));</span>
&nbsp;
      case 6:
<span class="cstat-no" title="statement not covered" >        context$1$0.t1 = context$1$0.sent;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.t2 = {</span>
          transports: context$1$0.t1
        };
<span class="cstat-no" title="statement not covered" >        log = new context$1$0.t0(context$1$0.t2);</span>
&nbsp;
        // Capture logs emitted via npmlog and pass them through winston
<span class="cstat-no" title="statement not covered" >        _npmlog2['default'].on('log', <span class="fstat-no" title="function not covered" >function (logObj) {</span></span>
<span class="cstat-no" title="statement not covered" >          var winstonLevel = npmToWinstonLevels[logObj.level] || 'info';</span>
<span class="cstat-no" title="statement not covered" >          var msg = logObj.message;</span>
<span class="cstat-no" title="statement not covered" >          if (logObj.prefix) {</span>
<span class="cstat-no" title="statement not covered" >            var prefix = '[' + logObj.prefix + ']';</span>
<span class="cstat-no" title="statement not covered" >            msg = prefix.magenta + ' ' + msg;</span>
          }
<span class="cstat-no" title="statement not covered" >          log[winstonLevel](msg);</span>
<span class="cstat-no" title="statement not covered" >          if (args.logHandler &amp;&amp; typeof args.logHandler === "function") {</span>
<span class="cstat-no" title="statement not covered" >            args.logHandler(logObj.level, msg);</span>
          }
        });
&nbsp;
<span class="cstat-no" title="statement not covered" >        log.setLevels(levels);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        if (levels[log.transports.console.level] === levels.debug) {</span>
<span class="cstat-no" title="statement not covered" >          log.debug = <span class="fstat-no" title="function not covered" >function (msg) {</span></span>
<span class="cstat-no" title="statement not covered" >            log.info('[debug] ' + msg);</span>
          };
        }
&nbsp;
      case 12:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    try {</span>
<span class="cstat-no" title="statement not covered" >      for (var _iterator = _getIterator(_lodash2['default'].keys(log.transports)), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {</span>
<span class="cstat-no" title="statement not covered" >        var transport = _step.value;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        log.remove(transport);</span>
      }
    } catch (err) {
...
<span class="cstat-no" title="statement not covered" >  _npmlog2['default'].removeAllListeners('log');</span>
}
&nbsp;
exports.init = init;
exports.clear = clear;
