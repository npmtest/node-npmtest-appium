...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/build/lib/config.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/build/lib/config.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">19.29% <small>(38 / 197)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/build/lib/</a> &#187; config.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >function getNodeVersion() {</span>
  // expect v&lt;major&gt;.&lt;minor&gt;.&lt;patch&gt;
  // we will pull out `major` and `minor`
<span class="cstat-no" title="statement not covered" >  var version = process.version.match(/^v(\d+)\.(\d+)/);</span>
<span class="cstat-no" title="statement not covered" >  return [Number(version[1]), Number(version[2])];</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function getGitRev() {</span>
<span class="cstat-no" title="statement not covered" >  var cwd, rev, _ref, stdout;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function getGitRev$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        cwd = _path2['default'].resolve(__dirname, "..", "..");</span>
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _teen_process.exec)("git", ["rev-parse", "HEAD"], { cwd: cwd }));</span>
&nbsp;
      case 5:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        rev = stdout.trim();</span>
...
&nbsp;
      case 12:
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', rev);</span>
&nbsp;
      case 13:
      case 'end':
...
&nbsp;
<span class="fstat-no" title="function not covered" >function getAppiumConfig() {</span>
<span class="cstat-no" title="statement not covered" >  var stat, built, config;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function getAppiumConfig$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(getGitRev());</span>
&nbsp;
      case 6:
<span class="cstat-no" title="statement not covered" >        context$1$0.t0 = context$1$0.sent;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.t1 = built;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.t2 = APPIUM_VER;</span>
...
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', config);</span>
&nbsp;
      case 11:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function checkNodeOk() {</span>
<span class="cstat-no" title="statement not covered" >  var _getNodeVersion = getNodeVersion();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var _getNodeVersion2 = _slicedToArray(_getNodeVersion, 2);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var major = _getNodeVersion2[0];</span>
<span class="cstat-no" title="statement not covered" >  var minor = _getNodeVersion2[1];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (major &lt; 4) {</span>
<span class="cstat-no" title="statement not covered" >    var msg = 'Node version must be &gt;= 4. Currently ' + major + '.' + minor;</span>
<span class="cstat-no" title="statement not covered" >    _logger2['default'].errorAndThrow(msg);</span>
  }
}
&nbsp;
<span class="fstat-no" title="function not covered" >function warnNodeDeprecations() {</span>
<span class="cstat-no" title="statement not covered" >  var _getNodeVersion3 = getNodeVersion();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var _getNodeVersion32 = _slicedToArray(_getNodeVersion3, 1);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var major = _getNodeVersion32[0];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (major &lt; 4) {</span>
<span class="cstat-no" title="statement not covered" >    _logger2['default'].warn("Appium support for versions of node &lt; 4 has been " + "deprecated and will be removed in a future version. Please " + "upgrade!");</span>
  }
}
&nbsp;
<span class="fstat-no" title="function not covered" >function showConfig() {</span>
<span class="cstat-no" title="statement not covered" >  var config;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function showConfig$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(getAppiumConfig());</span>
&nbsp;
      case 2:
<span class="cstat-no" title="statement not covered" >        config = context$1$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        console.log(JSON.stringify(config)); </span>// eslint-disable-line no-console
&nbsp;
      case 4:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function getNonDefaultArgs(parser, args) {</span>
<span class="cstat-no" title="statement not covered" >  var nonDefaults = {};</span>
...
<span class="cstat-no" title="statement not covered" >    for (var _iterator = _getIterator(parser.rawArgs), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {</span>
<span class="cstat-no" title="statement not covered" >      var rawArg = _step.value;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var arg = rawArg[1].dest;</span>
<span class="cstat-no" title="statement not covered" >      if (args[arg] &amp;&amp; args[arg] !== rawArg[1].defaultValue) {</span>
<span class="cstat-no" title="statement not covered" >        nonDefaults[arg] = args[arg];</span>
      }
    }
  } catch (err) {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  return nonDefaults;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function getDeprecatedArgs(parser, args) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  try {</span>
<span class="cstat-no" title="statement not covered" >    for (var _iterator2 = _getIterator(parser.rawArgs), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {</span>
<span class="cstat-no" title="statement not covered" >      var rawArg = _step2.value;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var arg = rawArg[1].dest;</span>
<span class="cstat-no" title="statement not covered" >      var defaultValue = rawArg[1].defaultValue;</span>
<span class="cstat-no" title="statement not covered" >      var isDeprecated = !!rawArg[1].deprecatedFor;</span>
<span class="cstat-no" title="statement not covered" >      if (args[arg] &amp;&amp; args[arg] !== defaultValue &amp;&amp; isDeprecated) {</span>
<span class="cstat-no" title="statement not covered" >        deprecated[rawArg[0]] = rawArg[1].deprecatedFor;</span>
      }
    }
  } catch (err) {
...
&nbsp;
<span class="fstat-no" title="function not covered" >function checkValidPort(port, portName) {</span>
<span class="cstat-no" title="statement not covered" >  if (port &gt; 0 &amp;&amp; port &lt; 65536) <span class="cstat-no" title="statement not covered" >return true;</span></span>
<span class="cstat-no" title="statement not covered" >  _logger2['default'].error('Port \'' + portName + '\' must be greater than 0 and less than 65536. Currently ' + port);</span>
<span class="cstat-no" title="statement not covered" >  return false;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function validateServerArgs(parser, args) {</span>
  // arguments that cannot both be set
<span class="cstat-no" title="statement not covered" >  var exclusives = [['noReset', 'fullReset'], ['ipa', 'safari'], ['app', 'safari'], ['forceIphone', 'forceIpad'], ['deviceName', 'defaultDevice']];</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  try {</span>
<span class="cstat-no" title="statement not covered" >    for (var _iterator3 = _getIterator(exclusives), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {</span>
<span class="cstat-no" title="statement not covered" >      var exSet = _step3.value;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var numFoundInArgs = 0;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      try {</span>
<span class="cstat-no" title="statement not covered" >        for (var _iterator5 = _getIterator(exSet), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {</span>
<span class="cstat-no" title="statement not covered" >          var opt = _step5.value;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (_lodash2['default'].has(args, opt) &amp;&amp; args[opt]) {</span>
<span class="cstat-no" title="statement not covered" >            numFoundInArgs++;</span>
          }
        }
      } catch (err) {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (numFoundInArgs &gt; 1) {</span>
<span class="cstat-no" title="statement not covered" >        throw new Error('You can\'t pass in more than one argument from the ' + ('set ' + JSON.stringify(exSet) + ', since they are ') + 'mutually exclusive');</span>
      }
    }
  } catch (err) {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  var validations = {</span>
    port: checkValidPort,
    ...
    backendRetries: <span class="fstat-no" title="function not covered" >function backendRetries(r) {</span>
<span class="cstat-no" title="statement not covered" >      return r &gt;= 0;</span>
    }
  };
&nbsp;
<span class="cstat-no" title="statement not covered" >  var nonDefaultArgs = getNonDefaultArgs(parser, args);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  try {</span>
<span class="cstat-no" title="statement not covered" >    for (var _iterator4 = _getIterator(_lodash2['default'].toPairs(validations)), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {</span>
<span class="cstat-no" title="statement not covered" >      var _step4$value = _slicedToArray(_step4.value, 2);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var arg = _step4$value[0];</span>
<span class="cstat-no" title="statement not covered" >      var validator = _step4$value[1];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (_lodash2['default'].has(nonDefaultArgs, arg)) {</span>
<span class="cstat-no" title="statement not covered" >        if (!validator(args[arg], arg)) {</span>
<span class="cstat-no" title="statement not covered" >          throw new Error('Invalid argument for param ' + arg + ': ' + args[arg]);</span>
        }
      }
    }
  } catch (err) {
...
&nbsp;
<span class="fstat-no" title="function not covered" >function validateTmpDir(tmpDir) {</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function validateTmpDir$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _appiumSupport.mkdirp)(tmpDir));</span>
&nbsp;
      case 3:
...
<span class="cstat-no" title="statement not covered" >        throw new Error('We could not ensure that the temp dir you specified ' + ('(' + tmpDir + ') exists. Please make sure it\'s writeable.'));</span>
&nbsp;
      case 8:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
