...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/build/lib/grid-register.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/build/lib/grid-register.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/build/lib/</a> &#187; grid-register.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >function registerNode(configFile, addr, port) {</span>
<span class="cstat-no" title="statement not covered" >  var data;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function registerNode$(context$1$0) {</span></span>
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_appiumSupport.fs.readFile(configFile, 'utf-8'));</span>
&nbsp;
      case 4:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].error('Unable to load node configuration file to register with grid: ' + context$1$0.t0.message);</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].error('No data found in the node configuration file to send to the grid');</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return');</span>
&nbsp;
      case 14:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 16;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(postRequest(data, addr, port));</span>
&nbsp;
      case 16:
      case 'end':
...
&nbsp;
<span class="fstat-no" title="function not covered" >function registerToGrid(options_post, jsonObject) {</span>
<span class="cstat-no" title="statement not covered" >  var response, logMessage;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function registerToGrid$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _requestPromise2['default'])(options_post));</span>
&nbsp;
      case 3:
<span class="cstat-no" title="statement not covered" >        response = context$1$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!(response === undefined || response.statusCode !== 200)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 6;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        throw new Error('Request failed');</span>
&nbsp;
      case 6:
<span class="cstat-no" title="statement not covered" >        logMessage = 'Appium successfully registered with the grid on ' + jsonObject.configuration.hubHost + ':' + jsonObject.configuration.hubPort;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug(logMessage);</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].error('Request to register with grid was unsuccessful: ' + context$1$0.t0.message);</span>
&nbsp;
      case 13:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function postRequest(data, addr, port) {</span>
<span class="cstat-no" title="statement not covered" >  var jsonObject, configuration, property, post_headers, post_options, registerCycleTime;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function postRequest$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        jsonObject = undefined;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        try {</span>
<span class="cstat-no" title="statement not covered" >          jsonObject = JSON.parse(data);</span>
        } catch (err) {
<span class="cstat-no" title="statement not covered" >          _logger2['default'].errorAndThrow('Syntax error in node configuration file: ' + err.message);</span>
        }
&nbsp;
        // Move Selenium 3 configuration properties to configuration object
<span class="cstat-no" title="statement not covered" >        if (!jsonObject.hasOwnProperty('configuration')) {</span>
<span class="cstat-no" title="statement not covered" >          configuration = {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          for (property in jsonObject) {</span>
<span class="cstat-no" title="statement not covered" >            if (jsonObject.hasOwnProperty(property) &amp;&amp; property !== 'capabilities') {</span>
<span class="cstat-no" title="statement not covered" >              configuration[property] = jsonObject[property];</span>
<span class="cstat-no" title="statement not covered" >              delete jsonObject[property];</span>
            }
          }
<span class="cstat-no" title="statement not covered" >          jsonObject.configuration = configuration;</span>
        }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        if (!jsonObject.configuration.url || !jsonObject.configuration.host || !jsonObject.configuration.port) {</span>
<span class="cstat-no" title="statement not covered" >          jsonObject.configuration.url = 'http://' + addr + ':' + port + '/wd/hub';</span>
<span class="cstat-no" title="statement not covered" >          jsonObject.configuration.host = addr;</span>
<span class="cstat-no" title="statement not covered" >          jsonObject.configuration.port = port;</span>
        }
        // if the node config does not have id automatically add it
<span class="cstat-no" title="statement not covered" >        if (!jsonObject.configuration.id) {</span>
<span class="cstat-no" title="statement not covered" >          jsonObject.configuration.id = 'http://' + jsonObject.configuration.host + ':' + jsonObject.configuration.port;</span>
        }
&nbsp;
        // re-serialize the configuration with the auto populated data
<span class="cstat-no" title="statement not covered" >        data = JSON.stringify(jsonObject);</span>
&nbsp;
        // prepare the header
<span class="cstat-no" title="statement not covered" >        post_headers = {</span>
          'Content-Type': 'application/json',
          'Content-Length': data.length
        };
<span class="cstat-no" title="statement not covered" >        post_options = {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!(jsonObject.configuration.register !== true)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 11;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('No registration sent (' + jsonObject.configuration.register + ' = false)');</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return');</span>
&nbsp;
      case 11:
<span class="cstat-no" title="statement not covered" >        registerCycleTime = jsonObject.configuration.registerCycle;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (registerCycleTime !== null &amp;&amp; registerCycleTime &gt; 0) {</span>
...
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Starting auto register thread for grid. Will try to register every ' + registerCycleTime + ' ms.');</span>
<span class="cstat-no" title="statement not covered" >            setInterval(<span class="fstat-no" title="function not covered" >function callee$2$0() {</span></span>
<span class="cstat-no" title="statement not covered" >              var isRegistered;</span>
...
<span class="cstat-no" title="statement not covered" >                while (1) <span class="cstat-no" title="statement not covered" >switch (context$3$0.prev = context$3$0.next) {</span></span>
                  case 0:
<span class="cstat-no" title="statement not covered" >                    if (!(first !== true)) {</span>
<span class="cstat-no" title="statement not covered" >                      context$3$0.next = 9;</span>
<span class="cstat-no" title="statement not covered" >                      break;</span>
                    }
&nbsp;
<span class="cstat-no" title="statement not covered" >                    context$3$0.next = 3;</span>
<span class="cstat-no" title="statement not covered" >                    return _regeneratorRuntime.awrap(isAlreadyRegistered(jsonObject));</span>
&nbsp;
                  case 3:
<span class="cstat-no" title="statement not covered" >                    isRegistered = context$3$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                    if (!(isRegistered !== null &amp;&amp; isRegistered !== true)) {</span>
<span class="cstat-no" title="statement not covered" >                      context$3$0.next = 7;</span>
<span class="cstat-no" title="statement not covered" >                      break;</span>
                    }
&nbsp;
<span class="cstat-no" title="statement not covered" >                    context$3$0.next = 7;</span>
<span class="cstat-no" title="statement not covered" >                    return _regeneratorRuntime.awrap(registerToGrid(post_options, jsonObject));</span>
&nbsp;
                  case 7:
...
&nbsp;
<span class="fstat-no" title="function not covered" >function isAlreadyRegistered(jsonObject) {</span>
<span class="cstat-no" title="statement not covered" >  var id, response, responseData;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function isAlreadyRegistered$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        id = jsonObject.configuration.id;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.prev = 1;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 4;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _requestPromise2['default'])({</span>
...
&nbsp;
      case 7:
<span class="cstat-no" title="statement not covered" >        responseData = JSON.parse(response.body);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (responseData.success !== true) {</span>
          // if register fail, print the debug msg
<span class="cstat-no" title="statement not covered" >          _logger2['default'].debug('Grid registration error: ' + responseData.msg);</span>
        }
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', responseData.success);</span>
&nbsp;
      case 12:
<span class="cstat-no" title="statement not covered" >        context$1$0.prev = 12;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.t0 = context$1$0['catch'](1);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Hub down or not responding: ' + context$1$0.t0.message);</span>
&nbsp;
      case 15:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
