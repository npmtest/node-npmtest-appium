...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-android-driver/build/lib/commands/performance.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-android-driver/build/lib/commands/performance.js</span></h1>
    <h2>
        
        Statements: <span class="metric">9.57% <small>(31 / 324)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">9.84% <small>(31 / 315)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-android-driver/build/lib/commands/</a> &#187; performance.js</div>
</div>
<div class="body">
...
//
commands.getPerformanceDataTypes = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >  return _lodash2['default'].keys(SUPPORTED_PERFORMANCE_DATA_TYPES);</span>
};
&nbsp;
// returns the information type of the system state which is supported to read as like cpu, memory, network traffic, and battery.
...
//
commands.getPerformanceData = <span class="fstat-no" title="function not covered" >function callee$0$0(packageName, dataType) {</span>
<span class="cstat-no" title="statement not covered" >  var dataReadTimeout = arguments.length &lt;= 2 || arguments[2] === undefined ? 2 : arguments[2];</span>
...
<span class="cstat-no" title="statement not covered" >        context$1$0.t0 = dataType;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = context$1$0.t0 === 'batteryinfo' ? 4 : context$1$0.t0 === 'cpuinfo' ? 8 : context$1$0.t0 === 'memoryinfo' ? 12 : context$1$0.t0 === 'networkinfo' ? 16 : 20;</span>
<span class="cstat-no" title="statement not covered" >        break;</span>
&nbsp;
      case 4:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 6;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.getBatteryInfo(dataReadTimeout));</span>
&nbsp;
      case 6:
<span class="cstat-no" title="statement not covered" >        data = context$1$0.sent;</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('break', 21);</span>
&nbsp;
      case 8:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 10;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.getCPUInfo(packageName, dataReadTimeout));</span>
&nbsp;
      case 10:
<span class="cstat-no" title="statement not covered" >        data = context$1$0.sent;</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('break', 21);</span>
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.getMemoryInfo(packageName, dataReadTimeout));</span>
&nbsp;
      case 14:
<span class="cstat-no" title="statement not covered" >        data = context$1$0.sent;</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('break', 21);</span>
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.getNetworkTrafficInfo(dataReadTimeout));</span>
&nbsp;
      case 18:
<span class="cstat-no" title="statement not covered" >        data = context$1$0.sent;</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('break', 21);</span>
&nbsp;
      case 20:
<span class="cstat-no" title="statement not covered" >        throw new Error('No performance data of type \'' + dataType + '\' found.');</span>
&nbsp;
      case 21:
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', data);</span>
&nbsp;
      case 22:
      case 'end':
...
&nbsp;
helpers.getCPUInfo = <span class="fstat-no" title="function not covered" >function callee$0$0(packageName) {</span>
<span class="cstat-no" title="statement not covered" >  var dataReadTimeout = arguments.length &lt;= 1 || arguments[1] === undefined ? 2 : arguments[1];</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _asyncbox.retryInterval)(dataReadTimeout, RETRY_PAUSE, <span class="fstat-no" title="function not covered" >function callee$1$0() {</span></span>
<span class="cstat-no" title="statement not covered" >          var cmd, data, match, user, kernel;</span>
...
<span class="cstat-no" title="statement not covered" >            while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
              case 0:
<span class="cstat-no" title="statement not covered" >                cmd = ['dumpsys', 'cpuinfo', '|', 'grep', '\'' + packageName + '\''];</span>
<span class="cstat-no" title="statement not covered" >                context$2$0.next = 3;</span>
<span class="cstat-no" title="statement not covered" >                return _regeneratorRuntime.awrap(this.adb.shell(cmd));</span>
&nbsp;
              case 3:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                throw new Error('No data from dumpsys');</span>
&nbsp;
              case 6:
<span class="cstat-no" title="statement not covered" >                match = /(\d+)% user \+ (\d+)% kernel/.exec(data);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                throw new Error('Unable to parse cpu data: \'' + data + '\'');</span>
&nbsp;
              case 9:
<span class="cstat-no" title="statement not covered" >                user = match[1];</span>
<span class="cstat-no" title="statement not covered" >                kernel = match[2];</span>
<span class="cstat-no" title="statement not covered" >                return context$2$0.abrupt('return', [_lodash2['default'].clone(CPU_KEYS), [user, kernel]]);</span>
&nbsp;
              case 12:
              case 'end':
...
&nbsp;
helpers.getBatteryInfo = <span class="fstat-no" title="function not covered" >function callee$0$0() {</span>
<span class="cstat-no" title="statement not covered" >  var dataReadTimeout = arguments.length &lt;= 0 || arguments[0] === undefined ? 2 : arguments[0];</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
...
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _asyncbox.retryInterval)(dataReadTimeout, RETRY_PAUSE, <span class="fstat-no" title="function not covered" >function callee$1$0() {</span></span>
<span class="cstat-no" title="statement not covered" >          var cmd, data, power;</span>
<span class="cstat-no" title="statement not covered" >          return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$1$0$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >            while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
              case 0:
<span class="cstat-no" title="statement not covered" >                cmd = ['dumpsys', 'battery', '|', 'grep', 'level'];</span>
<span class="cstat-no" title="statement not covered" >                context$2$0.next = 3;</span>
<span class="cstat-no" title="statement not covered" >                return _regeneratorRuntime.awrap(this.adb.shell(cmd));</span>
&nbsp;
              case 3:
...
&nbsp;
              case 6:
<span class="cstat-no" title="statement not covered" >                power = parseInt((data.split(':')[1] || '').trim(), 10);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (_Number$isNaN(power)) {</span>
<span class="cstat-no" title="statement not covered" >                  context$2$0.next = 11;</span>
<span class="cstat-no" title="statement not covered" >                  break;</span>
                }
&nbsp;
<span class="cstat-no" title="statement not covered" >                return context$2$0.abrupt('return', [_lodash2['default'].clone(BATTERY_KEYS), [power.toString()]]);</span>
&nbsp;
              case 11:
<span class="cstat-no" title="statement not covered" >                throw new Error('Unable to parse battery data: \'' + data + '\'');</span>
&nbsp;
              case 12:
              case 'end':
<span class="cstat-no" title="statement not covered" >                return context$2$0.stop();</span>
...
&nbsp;
helpers.getMemoryInfo = <span class="fstat-no" title="function not covered" >function callee$0$0(packageName) {</span>
<span class="cstat-no" title="statement not covered" >  var dataReadTimeout = arguments.length &lt;= 1 || arguments[1] === undefined ? 2 : arguments[1];</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
...
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _asyncbox.retryInterval)(dataReadTimeout, RETRY_PAUSE, <span class="fstat-no" title="function not covered" >function callee$1$0() {</span></span>
<span class="cstat-no" title="statement not covered" >          var cmd, data, totalPrivateDirty, totalPss, nativePrivateDirty, nativePss, nativeHeapSize, nativeHeapAllocatedSize, dalvikPrivateDirty, dalvikPss, eglPrivateDirty, eglPss, glPrivateDirty, glPss, apilevel, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, line, entries, type, subType, headers, _data;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$1$0$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >            while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
              case 0:
<span class="cstat-no" title="statement not covered" >                cmd = ['dumpsys', 'meminfo', '\'' + packageName + '\'', '|', 'grep', '-E', "'Native|Dalvik|EGL|GL|TOTAL'"];</span>
<span class="cstat-no" title="statement not covered" >                context$2$0.next = 3;</span>
<span class="cstat-no" title="statement not covered" >                return _regeneratorRuntime.awrap(this.adb.shell(cmd));</span>
&nbsp;
              case 3:
...
&nbsp;
              case 6:
<span class="cstat-no" title="statement not covered" >                totalPrivateDirty = undefined, totalPss = undefined, nativePrivateDirty = undefined, nativePss = undefined, nativeHeapSize = undefined, nativeHeapAllocatedSize = undefined, dalvikPrivateDirty = undefined, dalvikPss = undefined, eglPrivateDirty = undefined, eglPss = undefined, glPrivateDirty = undefined, glPss = undefined;</span>
<span class="cstat-no" title="statement not covered" >                context$2$0.next = 9;</span>
...
<span class="cstat-no" title="statement not covered" >                apilevel = parseInt(context$2$0.t0, 10);</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                for (_iterator = _getIterator(data.split('\n')); !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {</span>
<span class="cstat-no" title="statement not covered" >                  line = _step.value;</span>
<span class="cstat-no" title="statement not covered" >                  entries = line.trim().split(' ').filter(Boolean);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                  if (apilevel &gt; 18) {</span>
<span class="cstat-no" title="statement not covered" >                    type = entries[0];</span>
<span class="cstat-no" title="statement not covered" >                    subType = entries[1];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                    if (type === 'Native' &amp;&amp; subType === 'Heap') {</span>
                      // native heap
<span class="cstat-no" title="statement not covered" >                      nativePss = entries[2];</span>
<span class="cstat-no" title="statement not covered" >                      nativePrivateDirty = entries[3];</span>
<span class="cstat-no" title="statement not covered" >                      nativeHeapSize = entries[6];</span>
<span class="cstat-no" title="statement not covered" >                      nativeHeapAllocatedSize = entries[7];</span>
                    } else <span class="cstat-no" title="statement not covered" >if (type === 'Dalvik' &amp;&amp; subType === 'Heap') {</span>
                      // dalvik heap
<span class="cstat-no" title="statement not covered" >                      dalvikPss = entries[2];</span>
<span class="cstat-no" title="statement not covered" >                      dalvikPrivateDirty = entries[3];</span>
                    } else <span class="cstat-no" title="statement not covered" >if (type === 'EGL' &amp;&amp; subType === 'mtrack') {</span>
                      // egl
<span class="cstat-no" title="statement not covered" >                      eglPss = entries[2];</span>
<span class="cstat-no" title="statement not covered" >                      eglPrivateDirty = entries[3];</span>
                    } else <span class="cstat-no" title="statement not covered" >if (type === 'GL' &amp;&amp; subType === 'mtrack') {</span>
                      // gl
<span class="cstat-no" title="statement not covered" >                      glPss = entries[2];</span>
<span class="cstat-no" title="statement not covered" >                      glPrivateDirty = entries[3];</span>
                    } else <span class="cstat-no" title="statement not covered" >if (type === 'TOTAL' &amp;&amp; entries.length === 8) {</span>
                      // there are two totals, and we only want the full listing, which has 8 entries
<span class="cstat-no" title="statement not covered" >                      totalPss = entries[1];</span>
<span class="cstat-no" title="statement not covered" >                      totalPrivateDirty = entries[2];</span>
                    }
                  } else {
<span class="cstat-no" title="statement not covered" >                    type = entries[0];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                    if (type === 'Native') {</span>
<span class="cstat-no" title="statement not covered" >                      nativePss = entries[1];</span>
<span class="cstat-no" title="statement not covered" >                      nativePrivateDirty = entries[3];</span>
<span class="cstat-no" title="statement not covered" >                      nativeHeapSize = entries[4];</span>
<span class="cstat-no" title="statement not covered" >                      nativeHeapAllocatedSize = entries[5];</span>
                    } else <span class="cstat-no" title="statement not covered" >if (type === 'Dalvik') {</span>
<span class="cstat-no" title="statement not covered" >                      dalvikPss = entries[1];</span>
<span class="cstat-no" title="statement not covered" >                      dalvikPrivateDirty = entries[3];</span>
                    } else <span class="cstat-no" title="statement not covered" >if (type === 'EGL') {</span>
<span class="cstat-no" title="statement not covered" >                      eglPss = entries[1];</span>
<span class="cstat-no" title="statement not covered" >                      eglPrivateDirty = entries[3];</span>
                    } else <span class="cstat-no" title="statement not covered" >if (type === 'GL') {</span>
<span class="cstat-no" title="statement not covered" >                      glPss = entries[1];</span>
<span class="cstat-no" title="statement not covered" >                      glPrivateDirty = entries[3];</span>
                    } else <span class="cstat-no" title="statement not covered" >if (type === 'TOTAL') {</span>
<span class="cstat-no" title="statement not covered" >                      totalPss = entries[1];</span>
<span class="cstat-no" title="statement not covered" >                      totalPrivateDirty = entries[3];</span>
                    }
                  }
                }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                context$2$0.t1 = context$2$0['catch'](14);</span>
...
&nbsp;
              case 30:
<span class="cstat-no" title="statement not covered" >                if (!(totalPrivateDirty &amp;&amp; totalPrivateDirty !== 'nodex')) {</span>
<span class="cstat-no" title="statement not covered" >                  context$2$0.next = 36;</span>
<span class="cstat-no" title="statement not covered" >                  break;</span>
                }
&nbsp;
<span class="cstat-no" title="statement not covered" >                headers = _lodash2['default'].clone(MEMORY_KEYS);</span>
<span class="cstat-no" title="statement not covered" >                _data = [totalPrivateDirty, nativePrivateDirty, dalvikPrivateDirty, eglPrivateDirty, glPrivateDirty, totalPss, nativePss, dalvikPss, eglPss, glPss, nativeHeapAllocatedSize, nativeHeapSize];</span>
<span class="cstat-no" title="statement not covered" >                return context$2$0.abrupt('return', [headers, _data]);</span>
&nbsp;
              case 36:
<span class="cstat-no" title="statement not covered" >                throw new Error('Unable to parse memory data: \'' + data + '\'');</span>
&nbsp;
              case 37:
              case 'end':
<span class="cstat-no" title="statement not covered" >                return context$2$0.stop();</span>
...
&nbsp;
helpers.getNetworkTrafficInfo = <span class="fstat-no" title="function not covered" >function callee$0$0() {</span>
<span class="cstat-no" title="statement not covered" >  var dataReadTimeout = arguments.length &lt;= 0 || arguments[0] === undefined ? 2 : arguments[0];</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
...
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _asyncbox.retryInterval)(dataReadTimeout, RETRY_PAUSE, <span class="fstat-no" title="function not covered" >function callee$1$0() {</span></span>
<span class="cstat-no" title="statement not covered" >          var returnValue, bucketDuration, bucketStart, activeTime, rxBytes, rxPackets, txBytes, txPackets, operations, cmd, data, index, fromXtstats, start, delimiter, end, pendingBytes, arrayList, j, k, returnIndex, i;</span>
<span class="cstat-no" title="statement not covered" >          return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$1$0$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >            while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
              case 0:
<span class="cstat-no" title="statement not covered" >                returnValue = [];</span>
<span class="cstat-no" title="statement not covered" >                bucketDuration = undefined, bucketStart = undefined, activeTime = undefined, rxBytes = undefined, rxPackets = undefined, txBytes = undefined, txPackets = undefined, operations = undefined;</span>
<span class="cstat-no" title="statement not covered" >                cmd = ['dumpsys', 'netstats'];</span>
...
<span class="cstat-no" title="statement not covered" >                fromXtstats = data.indexOf("Xt stats:");</span>
<span class="cstat-no" title="statement not covered" >                start = data.indexOf("Pending bytes:", fromXtstats);</span>
<span class="cstat-no" title="statement not covered" >                delimiter = data.indexOf(":", start + 1);</span>
<span class="cstat-no" title="statement not covered" >                end = data.indexOf("\n", delimiter + 1);</span>
<span class="cstat-no" title="statement not covered" >                pendingBytes = data.substring(delimiter + 1, end).trim();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (end &gt; delimiter) {</span>
<span class="cstat-no" title="statement not covered" >                  start = data.indexOf("bucketDuration", end + 1);</span>
<span class="cstat-no" title="statement not covered" >                  delimiter = data.indexOf("=", start + 1);</span>
<span class="cstat-no" title="statement not covered" >                  end = data.indexOf("\n", delimiter + 1);</span>
<span class="cstat-no" title="statement not covered" >                  bucketDuration = data.substring(delimiter + 1, end).trim();</span>
                }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                data = data.substring(end + 1, data.length);</span>
<span class="cstat-no" title="statement not covered" >                arrayList = data.split("\n");</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (!(arrayList.length &gt; 0)) {</span>
<span class="cstat-no" title="statement not covered" >                  context$2$0.next = 33;</span>
<span class="cstat-no" title="statement not covered" >                  break;</span>
                }
&nbsp;
...
&nbsp;
              case 21:
<span class="cstat-no" title="statement not covered" >                if (!(j &lt; NETWORK_KEYS.length)) {</span>
<span class="cstat-no" title="statement not covered" >                  context$2$0.next = 31;</span>
<span class="cstat-no" title="statement not covered" >                  break;</span>
                }
&nbsp;
<span class="cstat-no" title="statement not covered" >                start = arrayList[0].indexOf(NETWORK_KEYS[j][0]);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (!(start &gt;= 0)) {</span>
<span class="cstat-no" title="statement not covered" >                  context$2$0.next = 28;</span>
<span class="cstat-no" title="statement not covered" >                  break;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                index = j;</span>
<span class="cstat-no" title="statement not covered" >                returnValue[0] = [];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                for (k = 0; k &lt; NETWORK_KEYS[j].length; ++k) {</span>
<span class="cstat-no" title="statement not covered" >                  returnValue[0][k] = NETWORK_KEYS[j][k];</span>
                }<span class="cstat-no" title="statement not covered" >return context$2$0.abrupt('break', 31);</span>
&nbsp;
              case 28:
...
&nbsp;
              case 31:
<span class="cstat-no" title="statement not covered" >                returnIndex = 1;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                for (i = 0; i &lt; arrayList.length; i++) {</span>
<span class="cstat-no" title="statement not covered" >                  data = arrayList[i];</span>
<span class="cstat-no" title="statement not covered" >                  start = data.indexOf(NETWORK_KEYS[index][0]);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                  if (start &gt;= 0) {</span>
<span class="cstat-no" title="statement not covered" >                    delimiter = data.indexOf("=", start + 1);</span>
<span class="cstat-no" title="statement not covered" >                    end = data.indexOf(" ", delimiter + 1);</span>
<span class="cstat-no" title="statement not covered" >                    bucketStart = data.substring(delimiter + 1, end).trim();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                    if (end &gt; delimiter) {</span>
<span class="cstat-no" title="statement not covered" >                      start = data.indexOf(NETWORK_KEYS[index][1], end + 1);</span>
<span class="cstat-no" title="statement not covered" >                      if (start &gt;= 0) {</span>
<span class="cstat-no" title="statement not covered" >                        delimiter = data.indexOf("=", start + 1);</span>
<span class="cstat-no" title="statement not covered" >                        end = data.indexOf(" ", delimiter + 1);</span>
<span class="cstat-no" title="statement not covered" >                        activeTime = data.substring(delimiter + 1, end).trim();</span>
                      }
                    }
&nbsp;
<span class="cstat-no" title="statement not covered" >                    if (end &gt; delimiter) {</span>
<span class="cstat-no" title="statement not covered" >                      start = data.indexOf(NETWORK_KEYS[index][2], end + 1);</span>
<span class="cstat-no" title="statement not covered" >                      if (start &gt;= 0) {</span>
<span class="cstat-no" title="statement not covered" >                        delimiter = data.indexOf("=", start + 1);</span>
<span class="cstat-no" title="statement not covered" >                        end = data.indexOf(" ", delimiter + 1);</span>
<span class="cstat-no" title="statement not covered" >                        rxBytes = data.substring(delimiter + 1, end).trim();</span>
                      }
                    }
&nbsp;
<span class="cstat-no" title="statement not covered" >                    if (end &gt; delimiter) {</span>
<span class="cstat-no" title="statement not covered" >                      start = data.indexOf(NETWORK_KEYS[index][3], end + 1);</span>
<span class="cstat-no" title="statement not covered" >                      if (start &gt;= 0) {</span>
<span class="cstat-no" title="statement not covered" >                        delimiter = data.indexOf("=", start + 1);</span>
<span class="cstat-no" title="statement not covered" >                        end = data.indexOf(" ", delimiter + 1);</span>
<span class="cstat-no" title="statement not covered" >                        rxPackets = data.substring(delimiter + 1, end).trim();</span>
                      }
                    }
&nbsp;
<span class="cstat-no" title="statement not covered" >                    if (end &gt; delimiter) {</span>
<span class="cstat-no" title="statement not covered" >                      start = data.indexOf(NETWORK_KEYS[index][4], end + 1);</span>
<span class="cstat-no" title="statement not covered" >                      if (start &gt;= 0) {</span>
<span class="cstat-no" title="statement not covered" >                        delimiter = data.indexOf("=", start + 1);</span>
<span class="cstat-no" title="statement not covered" >                        end = data.indexOf(" ", delimiter + 1);</span>
<span class="cstat-no" title="statement not covered" >                        txBytes = data.substring(delimiter + 1, end).trim();</span>
                      }
                    }
&nbsp;
<span class="cstat-no" title="statement not covered" >                    if (end &gt; delimiter) {</span>
<span class="cstat-no" title="statement not covered" >                      start = data.indexOf(NETWORK_KEYS[index][5], end + 1);</span>
<span class="cstat-no" title="statement not covered" >                      if (start &gt;= 0) {</span>
<span class="cstat-no" title="statement not covered" >                        delimiter = data.indexOf("=", start + 1);</span>
<span class="cstat-no" title="statement not covered" >                        end = data.indexOf(" ", delimiter + 1);</span>
<span class="cstat-no" title="statement not covered" >                        txPackets = data.substring(delimiter + 1, end).trim();</span>
                      }
                    }
&nbsp;
<span class="cstat-no" title="statement not covered" >                    if (end &gt; delimiter) {</span>
<span class="cstat-no" title="statement not covered" >                      start = data.indexOf(NETWORK_KEYS[index][6], end + 1);</span>
<span class="cstat-no" title="statement not covered" >                      if (start &gt;= 0) {</span>
<span class="cstat-no" title="statement not covered" >                        delimiter = data.indexOf("=", start + 1);</span>
<span class="cstat-no" title="statement not covered" >                        end = data.length;</span>
<span class="cstat-no" title="statement not covered" >                        operations = data.substring(delimiter + 1, end).trim();</span>
                      }
                    }
<span class="cstat-no" title="statement not covered" >                    returnValue[returnIndex++] = [bucketStart, activeTime, rxBytes, rxPackets, txBytes, txPackets, operations, bucketDuration];</span>
                  }
                }
&nbsp;
              case 33:
<span class="cstat-no" title="statement not covered" >                if (!(!_lodash2['default'].isEqual(pendingBytes, "") &amp;&amp; !_lodash2['default'].isUndefined(pendingBytes) &amp;&amp; !_lodash2['default'].isEqual(pendingBytes, "nodex"))) {</span>
<span class="cstat-no" title="statement not covered" >                  context$2$0.next = 37;</span>
<span class="cstat-no" title="statement not covered" >                  break;</span>
                }
&nbsp;
<span class="cstat-no" title="statement not covered" >                return context$2$0.abrupt('return', returnValue);</span>
&nbsp;
              case 37:
<span class="cstat-no" title="statement not covered" >                throw new Error('Unable to parse network traffic data: \'' + data + '\'');</span>
&nbsp;
              case 38:
              case 'end':
<span class="cstat-no" title="statement not covered" >                return context$2$0.stop();</span>
