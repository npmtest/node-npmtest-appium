...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-android-driver/build/lib/driver.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-android-driver/build/lib/driver.js</span></h1>
    <h2>
        
        Statements: <span class="metric">7.85% <small>(39 / 497)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">8.14% <small>(39 / 479)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-android-driver/build/lib/</a> &#187; driver.js</div>
</div>
<div class="body">
...
1040
1041
1042</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function AndroidDriver() {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, AndroidDriver);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _get(Object.getPrototypeOf(AndroidDriver.prototype), 'constructor', this).call(this, opts, shouldValidateCaps);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _logger2['default'].debug('AndroidDriver version: ' + _packageJson.version);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    this.jwpProxyAvoid = _lodash2['default'].clone(NO_PROXY);</span>
...
<span class="cstat-no" title="statement not covered" >    this.apkStrings = {};</span>
<span class="cstat-no" title="statement not covered" >    this.bootstrapPort = opts.bootstrapPort || DEVICE_PORT;</span>
<span class="cstat-no" title="statement not covered" >    this.unlocker = _androidHelpers2['default'].unlocker;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      for (var _iterator = _getIterator(_lodash2['default'].pairs(_commandsIndex2['default'])), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {</span>
...
<span class="cstat-no" title="statement not covered" >        var fn = _step$value[1];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        AndroidDriver.prototype[cmd] = fn;</span>
      }
    } catch (err) {
...
<span class="cstat-no" title="statement not covered" >      var sessionId, _ref, _ref2, serverDetails, defaultOpts, _helpers$getChromePkg, pkg, activity, _ref3,</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(_get(Object.getPrototypeOf(AndroidDriver.prototype), 'createSession', this).call(this, caps));</span>
&nbsp;
          case 4:
...
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(_appiumSupport.tempDir.staticDir());</span>
&nbsp;
          case 11:
<span class="cstat-no" title="statement not covered" >            context$2$0.t0 = context$2$0.sent;</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.t1 = _appiumAdb.DEFAULT_ADB_PORT;</span>
...
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(_androidHelpers2['default'].getJavaVersion());</span>
&nbsp;
          case 18:
<span class="cstat-no" title="statement not covered" >            this.opts.javaVersion = context$2$0.sent;</span>
&nbsp;
          case 19:
<span class="cstat-no" title="statement not covered" >            this.useUnlockHelperApp = _lodash2['default'].isUndefined(this.caps.unlockType);</span>
&nbsp;
            // not user visible via caps
<span class="cstat-no" title="statement not covered" >            if (this.opts.noReset === true) <span class="cstat-no" title="statement not covered" >this.opts.fullReset = false;</span></span>
<span class="cstat-no" title="statement not covered" >            if (this.opts.fullReset === true) <span class="cstat-no" title="statement not covered" >this.opts.noReset = false;</span></span>
<span class="cstat-no" title="statement not covered" >            this.opts.fastReset = !this.opts.fullReset &amp;&amp; !this.opts.noReset;</span>
<span class="cstat-no" title="statement not covered" >            this.opts.skipUninstall = this.opts.fastReset || this.opts.noReset;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >              _logger2['default'].info("We're going to run a Chrome-based session");</span>
<span class="cstat-no" title="statement not covered" >              _helpers$getChromePkg = _androidHelpers2['default'].getChromePkg(this.opts.browserName);</span>
<span class="cstat-no" title="statement not covered" >              pkg = _helpers$getChromePkg.pkg;</span>
<span class="cstat-no" title="statement not covered" >              activity = _helpers$getChromePkg.activity;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >              this.opts.appPackage = pkg;</span>
<span class="cstat-no" title="statement not covered" >              this.opts.appActivity = activity;</span>
<span class="cstat-no" title="statement not covered" >              _logger2['default'].info('Chrome-type package and activity are ' + pkg + ' and ' + activity);</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (this.opts.nativeWebScreenshot) {</span>
<span class="cstat-no" title="statement not covered" >              this.jwpProxyAvoid.push(['GET', new RegExp('^/session/[^/]+/screenshot')]);</span>
            }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(_androidHelpers2['default'].getDeviceInfoFromCaps(this.opts));</span>
&nbsp;
          case 30:
...
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(_androidHelpers2['default'].createADB(this.opts.javaVersion, this.opts.udid, this.opts.emPort, this.opts.adbPort, this.opts.suppressKillServer));</span>
&nbsp;
          case 37:
<span class="cstat-no" title="statement not covered" >            this.adb = context$2$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (this.helpers.isPackageOrBundle(this.opts.app)) {</span>
              // user provided package instead of app for 'app' capability, massage options
<span class="cstat-no" title="statement not covered" >              this.opts.appPackage = this.opts.app;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            this.opts.appIsTemp = caps.app !== this.opts.app; </span>// did we make a temporary copy?
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 46;</span>
...
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.startAndroidSession(this.opts));</span>
&nbsp;
          case 54:
<span class="cstat-no" title="statement not covered" >            return context$2$0.abrupt('return', [sessionId, this.caps]);</span>
&nbsp;
          case 57:
<span class="cstat-no" title="statement not covered" >            context$2$0.prev = 57;</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.t2 = context$2$0['catch'](0);</span>
...
&nbsp;
          case 64:
<span class="cstat-no" title="statement not covered" >            context$2$0.prev = 64;</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.t3 = context$2$0['catch'](59);</span>
&nbsp;
          case 66:
...
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    key: 'isEmulator',
    value: <span class="fstat-no" title="function not covered" >function isEmulator() {</span>
<span class="cstat-no" title="statement not covered" >      return !!this.opts.avd;</span>
    }
  }, {
...
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    value: <span class="fstat-no" title="function not covered" >function startAndroidSession() {</span>
...
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            _logger2['default'].info('Starting Android session');</span>
            // set up the device to run on (real or emulator, etc)
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 3;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(_androidHelpers2['default'].initDevice(this.adb, this.opts));</span>
&nbsp;
          case 3:
<span class="cstat-no" title="statement not covered" >            this.defaultIME = context$2$0.sent;</span>
&nbsp;
...
&nbsp;
          case 21:
            // start UiAutomator
<span class="cstat-no" title="statement not covered" >            this.bootstrap = new _androidHelpers2['default'].bootstrap(this.adb, this.bootstrapPort, this.opts.websocket);</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 24;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.bootstrap.start(this.opts.appPackage, this.opts.disableAndroidWatchers, this.opts.acceptSslCerts));</span>
&nbsp;
          case 24:
            // handling unexpected shutdown
<span class="cstat-no" title="statement not covered" >            this.bootstrap.onUnexpectedShutdown['catch'](<span class="fstat-no" title="function not covered" >function callee$2$0(err) {</span></span>
...
<span class="cstat-no" title="statement not covered" >                while (1) <span class="cstat-no" title="statement not covered" >switch (context$3$0.prev = context$3$0.next) {</span></span>
                  case 0:
<span class="cstat-no" title="statement not covered" >                    if (this.bootstrap.ignoreUnexpectedShutdown) {</span>
...
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(_androidHelpers2['default'].unlock(this, this.adb, this.caps));</span>
&nbsp;
          case 27:
<span class="cstat-no" title="statement not covered" >            if (!this.opts.ignoreUnimportantViews) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 30;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 30;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.settings.update({ ignoreUnimportantViews: this.opts.ignoreUnimportantViews }));</span>
&nbsp;
          case 30:
<span class="cstat-no" title="statement not covered" >            if (!this.isChromeSession) {</span>
...
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.startChromeSession());</span>
&nbsp;
          case 33:
<span class="cstat-no" title="statement not covered" >            if (!this.shouldDismissChromeWelcome()) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 36;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 36;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.dismissChromeWelcome());</span>
&nbsp;
          case 36:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 41;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.startAUT());</span>
&nbsp;
          case 41:
...
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    value: <span class="fstat-no" title="function not covered" >function shouldDismissChromeWelcome() {</span>
<span class="cstat-no" title="statement not covered" >      return !_lodash2['default'].isUndefined(this.opts.chromeOptions) &amp;&amp; _lodash2['default'].isArray(this.opts.chromeOptions.args) &amp;&amp; this.opts.chromeOptions.args.indexOf('--no-first-run') !== -1;</span>
    }
  }, {
    key: 'dismissChromeWelcome',
    value: <span class="fstat-no" title="function not covered" >function dismissChromeWelcome() {</span>
<span class="cstat-no" title="statement not covered" >      var activity, el, _el;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function dismissChromeWelcome$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            _logger2['default'].info("Trying to dismiss Chrome welcome");</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 3;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.getCurrentActivity());</span>
&nbsp;
          case 3:
<span class="cstat-no" title="statement not covered" >            activity = context$2$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (!(activity !== "org.chromium.chrome.browser.firstrun.FirstRunActivity")) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 7;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].info("Chrome welcome dialog never showed up! Continuing");</span>
...
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.findElOrEls('id', 'com.android.chrome:id/terms_accept', false));</span>
&nbsp;
          case 9:
...
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.click(el.ELEMENT));</span>
&nbsp;
          case 12:
...
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.findElOrEls('id', 'com.android.chrome:id/negative_button', false));</span>
&nbsp;
          case 15:
<span class="cstat-no" title="statement not covered" >            _el = context$2$0.sent;</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 18;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.click(_el.ELEMENT));</span>
&nbsp;
          case 18:
...
<span class="cstat-no" title="statement not covered" >            _logger2['default'].warn('This device didnt show Chrome SignIn dialog, ' + context$2$0.t0.message);</span>
&nbsp;
          case 23:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    key: 'initAutoWebview',
    value: <span class="fstat-no" title="function not covered" >function initAutoWebview() {</span>
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function initAutoWebview$(context$2$0) {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 3;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap((<span class="fstat-no" title="function not covered" >function callee$2$0() {</span></span>
<span class="cstat-no" title="statement not covered" >              var viewName, timeout;</span>
<span class="cstat-no" title="statement not covered" >              return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$2$0$(context$3$0) {</span></span>
<span class="cstat-no" title="statement not covered" >                var _this2 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                while (1) <span class="cstat-no" title="statement not covered" >switch (context$3$0.prev = context$3$0.next) {</span></span>
                  case 0:
<span class="cstat-no" title="statement not covered" >                    viewName = this.defaultWebviewName();</span>
<span class="cstat-no" title="statement not covered" >                    timeout = this.opts.autoWebviewTimeout || 2000;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                    _logger2['default'].info('Setting auto webview to context \'' + viewName + '\' with timeout ' + timeout + 'ms');</span>
&nbsp;
                    // try every 500ms until timeout is over
<span class="cstat-no" title="statement not covered" >                    context$3$0.next = 5;</span>
<span class="cstat-no" title="statement not covered" >                    return _regeneratorRuntime.awrap((0, _asyncbox.retryInterval)(timeout / 500, 500, <span class="fstat-no" title="function not covered" >function callee$3$0() {</span></span>
...
<span class="cstat-no" title="statement not covered" >                            return _regeneratorRuntime.awrap(this.setContext(viewName));</span>
&nbsp;
                          case 2:
                          case 'end':
...
<span class="cstat-no" title="statement not covered" >      var launchInfo;</span>
...
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(_androidHelpers2['default'].getLaunchInfo(this.adb, this.opts));</span>
&nbsp;
          case 2:
<span class="cstat-no" title="statement not covered" >            launchInfo = context$2$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            _Object$assign(this.opts, launchInfo);</span>
<span class="cstat-no" title="statement not covered" >            _Object$assign(this.caps, launchInfo);</span>
            // install app
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (this.opts.app) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 14;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 11;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(_androidHelpers2['default'].resetApp(this.adb, this.opts.app, this.opts.appPackage, this.opts.fastReset));</span>
&nbsp;
          case 11:
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 13;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.grantPermissions());</span>
&nbsp;
          case 13:
<span class="cstat-no" title="statement not covered" >            return context$2$0.abrupt('return');</span>
&nbsp;
...
&nbsp;
          case 17:
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 19;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(_androidHelpers2['default'].installApkRemotely(this.adb, this.opts));</span>
&nbsp;
          case 19:
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 21;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.grantPermissions());</span>
&nbsp;
          case 21:
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 23;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(_androidHelpers2['default'].pushStrings(this.opts.language, this.adb, this.opts));</span>
&nbsp;
          case 23:
...
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    value: <span class="fstat-no" title="function not covered" >function startChromeSession() {</span>
<span class="cstat-no" title="statement not covered" >      var opts, knownPackages;</span>
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function startChromeSession$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >        var _this4 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            _logger2['default'].info("Starting a chrome-based browser session");</span>
<span class="cstat-no" title="statement not covered" >            opts = _lodash2['default'].cloneDeep(this.opts);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            opts.chromeUseRunningApp = false;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            knownPackages = ["org.chromium.chrome.shell", "com.android.chrome", "com.chrome.beta", "org.chromium.chrome", "org.chromium.webview_shell"];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (!_lodash2['default'].contains(knownPackages, this.opts.appPackage)) {</span>
<span class="cstat-no" title="statement not covered" >              opts.chromeAndroidActivity = this.opts.appActivity;</span>
            }
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 7;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap((0, _commandsContext.setupNewChromedriver)(opts, this.adb.curDeviceId, this.adb.getAdbServerPort()));</span>
&nbsp;
          case 7:
<span class="cstat-no" title="statement not covered" >            this.chromedriver = context$2$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            this.chromedriver.on(_appiumChromedriver2['default'].EVENT_CHANGED, <span class="fstat-no" title="function not covered" >function (msg) {</span></span>
<span class="cstat-no" title="statement not covered" >              if (msg.state === _appiumChromedriver2['default'].STATE_STOPPED) {</span>
<span class="cstat-no" title="statement not covered" >                _this4.onChromedriverStop(_webviewHelpers.CHROMIUM_WIN);</span>
              }
            });
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            this.curContext = _webviewHelpers.CHROMIUM_WIN;</span>
<span class="cstat-no" title="statement not covered" >            this.sessionChromedrivers[_webviewHelpers.CHROMIUM_WIN] = this.chromedriver;</span>
...
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    value: <span class="fstat-no" title="function not covered" >function checkPackagePresent() {</span>
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function checkPackagePresent$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug("Checking whether package is present on the device");</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 3;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.adb.shell(['pm', 'list', 'packages', this.opts.appPackage]));</span>
&nbsp;
          case 3:
<span class="cstat-no" title="statement not covered" >            if (context$2$0.sent) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 5;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].errorAndThrow('Could not find package ' + this.opts.appPackage + ' on the device');</span>
&nbsp;
          case 5:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    value: <span class="fstat-no" title="function not covered" >function grantPermissions() {</span>
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function grantPermissions$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
...
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.bootstrap.sendAction("compressedLayoutHierarchy", { compressLayout: compress }));</span>
&nbsp;
          case 2:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
...
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug("Shutting down Android driver");</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 3;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(_get(Object.getPrototypeOf(AndroidDriver.prototype), 'deleteSession', this).call(this));</span>
&nbsp;
          case 3:
<span class="cstat-no" title="statement not covered" >            if (!this.bootstrap) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 23;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
            }
&nbsp;
...
&nbsp;
          case 13:
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 15;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.adb.goToHome());</span>
&nbsp;
          case 15:
...
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.bootstrap.shutdown());</span>
&nbsp;
          case 20:
<span class="cstat-no" title="statement not covered" >            this.bootstrap = null;</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 24;</span>
<span class="cstat-no" title="statement not covered" >            break;</span>
&nbsp;
          case 23:
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug("Called deleteSession but bootstrap wasn't active");</span>
&nbsp;
          case 24:
...
&nbsp;
          case 26:
<span class="cstat-no" title="statement not covered" >            if (!this.useUnlockHelperApp) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 29;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 29;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.adb.forceStop('io.appium.unlock'));</span>
&nbsp;
          case 29:
<span class="cstat-no" title="statement not covered" >            if (!this.opts.reboot) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (!this.opts.appIsTemp) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 47;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Temporary copy of app was made: deleting \'' + this.opts.app + '\'');</span>
...
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(_appiumSupport.fs.rimraf(this.opts.app));</span>
&nbsp;
          case 40:
...
&nbsp;
          case 42:
<span class="cstat-no" title="statement not covered" >            context$2$0.prev = 42;</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.t0 = context$2$0['catch'](37);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].warn('Unable to delete temporary app: ' + context$2$0.t0.message);</span>
&nbsp;
          case 45:
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 48;</span>
<span class="cstat-no" title="statement not covered" >            break;</span>
&nbsp;
          case 47:
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('App was not copied, so not deleting');</span>
&nbsp;
          case 48:
...
&nbsp;
          case 50:
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Not cleaning generated files. Add `clearSystemFiles` capability if wanted.');</span>
&nbsp;
          case 51:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
...
<span class="cstat-no" title="statement not covered" >      var res = _get(Object.getPrototypeOf(AndroidDriver.prototype), 'validateDesiredCaps', this).call(this, caps);</span>
...
<span class="cstat-no" title="statement not covered" >      if ((!caps.browserName || !_androidHelpers2['default'].isChromeBrowser(caps.browserName)) &amp;&amp; !caps.app &amp;&amp; !caps.appPackage) {</span>
<span class="cstat-no" title="statement not covered" >        var msg = 'The desired capabilities must include either an app, appPackage or browserName';</span>
...
<span class="cstat-no" title="statement not covered" >      if (caps.browserName &amp;&amp; caps.app) {</span>
<span class="cstat-no" title="statement not covered" >        var msg = 'The desired capabilities should generally not include both an app and a browserName';</span>
...
<span class="cstat-no" title="statement not covered" >      _get(Object.getPrototypeOf(AndroidDriver.prototype), 'proxyActive', this).call(this, sessionId);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      _get(Object.getPrototypeOf(AndroidDriver.prototype), 'getProxyAvoidList', this).call(this, sessionId);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      _get(Object.getPrototypeOf(AndroidDriver.prototype), 'canProxy', this).call(this, sessionId);</span>
&nbsp;
      // this will change depending on ChromeDriver status
<span class="cstat-no" title="statement not covered" >      return _lodash2['default'].isFunction(this.proxyReqRes);</span>
    }
  }, {
    key: 'appOnDevice',
    get: <span class="fstat-no" title="function not covered" >function get() {</span>
<span class="cstat-no" title="statement not covered" >      return this.helpers.isPackageOrBundle(this.opts.app) || !this.opts.app &amp;&amp; this.helpers.isPackageOrBundle(this.opts.appPackage);</span>
    }
  }, {
    key: 'isChromeSession',
    get: <span class="fstat-no" title="function not covered" >function get() {</span>
<span class="cstat-no" title="statement not covered" >      return _androidHelpers2['default'].isChromeBrowser(this.opts.browserName);</span>
    }
  }]);
&nbsp;
