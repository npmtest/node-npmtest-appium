...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-adb/build/lib/tools/system-calls.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-adb/build/lib/tools/system-calls.js</span></h1>
    <h2>
        
        Statements: <span class="metric">5.96% <small>(47 / 788)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">6.16% <small>(47 / 763)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-adb/build/lib/tools/</a> &#187; system-calls.js</div>
</div>
<div class="body">
...
1465
1466
1467</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
systemCallMethods.getSdkBinaryPath = <span class="fstat-no" title="function not covered" >function callee$0$0(binaryName) {</span>
...
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        _loggerJs2['default'].info('Checking whether ' + binaryName + ' is present');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!this.sdkRoot) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 5;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', this.getBinaryFromSdkRoot(binaryName));</span>
&nbsp;
      case 5:
<span class="cstat-no" title="statement not covered" >        _loggerJs2['default'].warn('The ANDROID_HOME environment variable is not set to the Android SDK ' + 'root directory path. ANDROID_HOME is required for compatibility ' + ('with SDK 23+. Checking along PATH for ' + binaryName + '.'));</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 8;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.getBinaryFromPath(binaryName));</span>
&nbsp;
      case 8:
...
&nbsp;
systemCallMethods.getCommandForOS = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >  var cmd = "which";</span>
<span class="cstat-no" title="statement not covered" >  if (_appiumSupport.system.isWindows()) {</span>
<span class="cstat-no" title="statement not covered" >    cmd = "where";</span>
  }
<span class="cstat-no" title="statement not covered" >  return cmd;</span>
};
&nbsp;
systemCallMethods.getBinaryNameForOS = <span class="fstat-no" title="function not covered" >function (binaryName) {</span>
<span class="cstat-no" title="statement not covered" >  if (_appiumSupport.system.isWindows()) {</span>
<span class="cstat-no" title="statement not covered" >    if (binaryName === "android") {</span>
<span class="cstat-no" title="statement not covered" >      binaryName += ".bat";</span>
    } else {
<span class="cstat-no" title="statement not covered" >      if (binaryName.indexOf(".exe", binaryName.length - 4) === -1) {</span>
<span class="cstat-no" title="statement not covered" >        binaryName += ".exe";</span>
      }
    }
  }
<span class="cstat-no" title="statement not covered" >  return binaryName;</span>
};
&nbsp;
systemCallMethods.getBinaryFromSdkRoot = <span class="fstat-no" title="function not covered" >function callee$0$0(binaryName) {</span>
<span class="cstat-no" title="statement not covered" >  var binaryLoc, binaryLocs, buildToolDirs, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, versionDir, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, loc;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        binaryLoc = null;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        binaryName = this.getBinaryNameForOS(binaryName);</span>
<span class="cstat-no" title="statement not covered" >        binaryLocs = [_path2['default'].resolve(this.sdkRoot, "platform-tools", binaryName), _path2['default'].resolve(this.sdkRoot, "tools", binaryName), _path2['default'].resolve(this.sdkRoot, "tools", "bin", binaryName)];</span>
<span class="cstat-no" title="statement not covered" >        buildToolDirs = [];</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 6;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _helpers.getDirectories)(_path2['default'].resolve(this.sdkRoot, "build-tools")));</span>
&nbsp;
      case 6:
<span class="cstat-no" title="statement not covered" >        buildToolDirs = context$1$0.sent;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        for (_iterator = _getIterator(buildToolDirs); !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {</span>
<span class="cstat-no" title="statement not covered" >          versionDir = _step.value;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          binaryLocs.push(_path2['default'].resolve(this.sdkRoot, "build-tools", versionDir, binaryName));</span>
        }
...
&nbsp;
      case 18:
<span class="cstat-no" title="statement not covered" >        context$1$0.prev = 18;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.prev = 19;</span>
&nbsp;
...
&nbsp;
      case 24:
<span class="cstat-no" title="statement not covered" >        return context$1$0.finish(21);</span>
&nbsp;
      case 25:
<span class="cstat-no" title="statement not covered" >        return context$1$0.finish(18);</span>
&nbsp;
      case 26:
...
<span class="cstat-no" title="statement not covered" >        _iterator2 = _getIterator(binaryLocs);</span>
&nbsp;
      case 31:
<span class="cstat-no" title="statement not covered" >        if (_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 41;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        loc = _step2.value;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 35;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_appiumSupport.fs.exists(loc));</span>
&nbsp;
      case 35:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        binaryLoc = loc;</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('break', 41);</span>
&nbsp;
      case 38:
<span class="cstat-no" title="statement not covered" >        _iteratorNormalCompletion2 = true;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 31;</span>
<span class="cstat-no" title="statement not covered" >        break;</span>
&nbsp;
      case 41:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 47;</span>
<span class="cstat-no" title="statement not covered" >        break;</span>
&nbsp;
      case 43:
<span class="cstat-no" title="statement not covered" >        context$1$0.prev = 43;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.t1 = context$1$0['catch'](29);</span>
<span class="cstat-no" title="statement not covered" >        _didIteratorError2 = true;</span>
<span class="cstat-no" title="statement not covered" >        _iteratorError2 = context$1$0.t1;</span>
&nbsp;
      case 47:
<span class="cstat-no" title="statement not covered" >        context$1$0.prev = 47;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.prev = 48;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 53;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
...
&nbsp;
      case 53:
<span class="cstat-no" title="statement not covered" >        return context$1$0.finish(50);</span>
&nbsp;
      case 54:
<span class="cstat-no" title="statement not covered" >        return context$1$0.finish(47);</span>
&nbsp;
      case 55:
<span class="cstat-no" title="statement not covered" >        if (!(binaryLoc === null)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 57;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        throw new Error('Could not find ' + binaryName + ' in ' + binaryLocs + ', ' + ('or supported build-tools under ' + this.sdkRoot + ' ') + 'do you have the Android SDK installed at this location?');</span>
&nbsp;
      case 57:
<span class="cstat-no" title="statement not covered" >        binaryLoc = binaryLoc.trim();</span>
<span class="cstat-no" title="statement not covered" >        _loggerJs2['default'].info('Using ' + binaryName + ' from ' + binaryLoc);</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', binaryLoc);</span>
&nbsp;
      case 60:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
systemCallMethods.getBinaryFromPath = <span class="fstat-no" title="function not covered" >function callee$0$0(binaryName) {</span>
<span class="cstat-no" title="statement not covered" >  var binaryLoc, cmd, _ref, stdout;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        binaryLoc = null;</span>
<span class="cstat-no" title="statement not covered" >        cmd = this.getCommandForOS();</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.prev = 2;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 5;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _teen_process.exec)(cmd, [binaryName]));</span>
&nbsp;
      case 5:
<span class="cstat-no" title="statement not covered" >        _ref = context$1$0.sent;</span>
<span class="cstat-no" title="statement not covered" >        stdout = _ref.stdout;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        _loggerJs2['default'].info('Using ' + binaryName + ' from ' + stdout);</span>
        // TODO write a test for binaries with spaces.
<span class="cstat-no" title="statement not covered" >        binaryLoc = stdout.trim();</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', binaryLoc);</span>
&nbsp;
      case 12:
<span class="cstat-no" title="statement not covered" >        context$1$0.prev = 12;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.t0 = context$1$0['catch'](2);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        _loggerJs2['default'].errorAndThrow('Could not find ' + binaryName + ' Please set the ANDROID_HOME ' + 'environment variable with the Android SDK root directory path.');</span>
&nbsp;
      case 15:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
systemCallMethods.getConnectedDevices = <span class="fstat-no" title="function not covered" >function callee$0$0() {</span>
<span class="cstat-no" title="statement not covered" >  var _ref2, stdout, startingIndex, devices, _iteratorNormalCompletion3, _didIteratorError3, _iteratorError3, _iterator3, _step3, line, lineInfo;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        _loggerJs2['default'].debug("Getting connected devices...");</span>
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _teen_process.exec)(this.executable.path, ['devices']));</span>
&nbsp;
      case 4:
...
<span class="cstat-no" title="statement not covered" >        startingIndex = stdout.indexOf("List of devices");</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!(startingIndex === -1)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 11;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        throw new Error('Unexpected output while trying to get devices. output was: ' + stdout);</span>
&nbsp;
      case 11:
        // slicing ouput we care about.
<span class="cstat-no" title="statement not covered" >        stdout = stdout.slice(startingIndex);</span>
<span class="cstat-no" title="statement not covered" >        devices = [];</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        for (_iterator3 = _getIterator(stdout.split("\n")); !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {</span>
<span class="cstat-no" title="statement not covered" >          line = _step3.value;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (line.trim() !== "" &amp;&amp; line.indexOf("List of devices") === -1 &amp;&amp; line.indexOf("adb server") === -1 &amp;&amp; line.indexOf("* daemon") === -1 &amp;&amp; line.indexOf("offline") === -1) {</span>
<span class="cstat-no" title="statement not covered" >            lineInfo = line.split("\t");</span>
&nbsp;
            // state is either "device" or "offline", afaict
<span class="cstat-no" title="statement not covered" >            devices.push({ udid: lineInfo[0], state: lineInfo[1] });</span>
          }
        }
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 24;</span>
<span class="cstat-no" title="statement not covered" >        break;</span>
...
<span class="cstat-no" title="statement not covered" >        context$1$0.t0 = context$1$0['catch'](16);</span>
...
&nbsp;
      case 32:
<span class="cstat-no" title="statement not covered" >        _loggerJs2['default'].debug(devices.length + ' device(s) connected');</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', devices);</span>
&nbsp;
      case 34:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        _loggerJs2['default'].errorAndThrow('Error while getting connected devices. Original error: ' + context$1$0.t1.message);</span>
&nbsp;
      case 39:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
systemCallMethods.getDevicesWithRetry = <span class="fstat-no" title="function not covered" >function callee$0$0() {</span>
<span class="cstat-no" title="statement not covered" >  var timeoutMs = arguments.length &lt;= 0 || arguments[0] === undefined ? 20000 : arguments[0];</span>
<span class="cstat-no" title="statement not covered" >  var start, getDevices;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        _loggerJs2['default'].debug("Trying to find a connected android device");</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        getDevices = <span class="fstat-no" title="function not covered" >function getDevices() {</span></span>
<span class="cstat-no" title="statement not covered" >          var devices;</span>
<span class="cstat-no" title="statement not covered" >          return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function getDevices$(context$2$0) {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                throw new Error("Could not find a connected Android device.");</span>
&nbsp;
              case 2:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (!(devices.length &lt; 1)) {</span>
<span class="cstat-no" title="statement not covered" >                  context$2$0.next = 15;</span>
<span class="cstat-no" title="statement not covered" >                  break;</span>
                }
&nbsp;
<span class="cstat-no" title="statement not covered" >                _loggerJs2['default'].debug("Could not find devices, restarting adb server...");</span>
...
<span class="cstat-no" title="statement not covered" >                return _regeneratorRuntime.awrap((0, _asyncbox.sleep)(200));</span>
&nbsp;
              case 12:
<span class="cstat-no" title="statement not covered" >                context$2$0.next = 14;</span>
<span class="cstat-no" title="statement not covered" >                return _regeneratorRuntime.awrap(getDevices());</span>
&nbsp;
              case 14:
<span class="cstat-no" title="statement not covered" >                return context$2$0.abrupt('return', context$2$0.sent);</span>
&nbsp;
              case 15:
<span class="cstat-no" title="statement not covered" >                return context$2$0.abrupt('return', devices);</span>
&nbsp;
              case 18:
...
&nbsp;
systemCallMethods.restartAdb = <span class="fstat-no" title="function not covered" >function callee$0$0() {</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        if (!this.suppressKillServer) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 3;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        _loggerJs2['default'].debug('Not restarting abd since \'suppressKillServer\' is on');</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return');</span>
&nbsp;
      case 3:
&nbsp;
<span class="cstat-no" title="statement not covered" >        _loggerJs2['default'].debug('Restarting adb');</span>
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _teen_process.exec)(this.executable.path, ['kill-server']));</span>
&nbsp;
      case 7:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        _loggerJs2['default'].error("Error killing ADB server, going to see if it's online anyway");</span>
&nbsp;
      case 12:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
systemCallMethods.adbExec = <span class="fstat-no" title="function not covered" >function callee$0$0(cmd) {</span>
<span class="cstat-no" title="statement not covered" >  var opts = arguments.length &lt;= 1 || arguments[1] === undefined ? {} : arguments[1];</span>
<span class="cstat-no" title="statement not covered" >  var execFunc;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        throw new Error("You need to pass in a command to adbExec()");</span>
&nbsp;
      case 2:
        // setting default timeout for each command to prevent infinite wait.
<span class="cstat-no" title="statement not covered" >        opts.timeout = opts.timeout || DEFAULT_ADB_EXEC_TIMEOUT;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        execFunc = <span class="fstat-no" title="function not covered" >function execFunc() {</span></span>
<span class="cstat-no" title="statement not covered" >          var linkerWarningRe, args, _ref3, stdout, protocolFaultError, deviceNotFoundError;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function execFunc$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >            while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
              case 0:
<span class="cstat-no" title="statement not covered" >                linkerWarningRe = /^WARNING: linker.+$/m;</span>
<span class="cstat-no" title="statement not covered" >                context$2$0.prev = 1;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (!(cmd instanceof Array)) {</span>
<span class="cstat-no" title="statement not covered" >                  cmd = [cmd];</span>
                }
<span class="cstat-no" title="statement not covered" >                args = this.executable.defaultArgs.concat(cmd);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                _loggerJs2['default'].debug('Running \'' + this.executable.path + '\' with args: ' + ('' + JSON.stringify(args)));</span>
<span class="cstat-no" title="statement not covered" >                context$2$0.next = 7;</span>
<span class="cstat-no" title="statement not covered" >                return _regeneratorRuntime.awrap((0, _teen_process.exec)(this.executable.path, args, opts));</span>
&nbsp;
              case 7:
<span class="cstat-no" title="statement not covered" >                _ref3 = context$2$0.sent;</span>
<span class="cstat-no" title="statement not covered" >                stdout = _ref3.stdout;</span>
&nbsp;
                // sometimes ADB prints out weird stdout warnings that we don't want
                // to include in any of the response data, so let's strip it out
<span class="cstat-no" title="statement not covered" >                stdout = stdout.replace(linkerWarningRe, '').trim();</span>
<span class="cstat-no" title="statement not covered" >                return context$2$0.abrupt('return', stdout);</span>
&nbsp;
              case 13:
...
<span class="cstat-no" title="statement not covered" >                protocolFaultError = new RegExp("protocol fault \\(no status\\)", "i").test(context$2$0.t0);</span>
<span class="cstat-no" title="statement not covered" >                deviceNotFoundError = new RegExp("error: device ('.+' )?not found", "i").test(context$2$0.t0);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (!(protocolFaultError || deviceNotFoundError)) {</span>
<span class="cstat-no" title="statement not covered" >                  context$2$0.next = 23;</span>
<span class="cstat-no" title="statement not covered" >                  break;</span>
                }
&nbsp;
<span class="cstat-no" title="statement not covered" >                _loggerJs2['default'].info('Error sending command, reconnecting device and retrying: ' + cmd);</span>
<span class="cstat-no" title="statement not covered" >                context$2$0.next = 21;</span>
<span class="cstat-no" title="statement not covered" >                return _regeneratorRuntime.awrap((0, _asyncbox.sleep)(1000));</span>
&nbsp;
              case 21:
<span class="cstat-no" title="statement not covered" >                context$2$0.next = 23;</span>
<span class="cstat-no" title="statement not covered" >                return _regeneratorRuntime.awrap(this.getDevicesWithRetry());</span>
&nbsp;
              case 23:
<span class="cstat-no" title="statement not covered" >                if (!context$2$0.t0.stdout) {</span>
<span class="cstat-no" title="statement not covered" >                  context$2$0.next = 27;</span>
<span class="cstat-no" title="statement not covered" >                  break;</span>
                }
&nbsp;
<span class="cstat-no" title="statement not covered" >                stdout = context$2$0.t0.stdout;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                stdout = stdout.replace(linkerWarningRe, '').trim();</span>
<span class="cstat-no" title="statement not covered" >                return context$2$0.abrupt('return', stdout);</span>
&nbsp;
              case 27:
<span class="cstat-no" title="statement not covered" >                throw new Error('Error executing adbExec. Original error: \'' + context$2$0.t0.message + '\'; ' + ('Stderr: \'' + (context$2$0.t0.stderr || '').trim() + '\'; Code: \'' + context$2$0.t0.code + '\''));</span>
&nbsp;
              case 28:
              case 'end':
<span class="cstat-no" title="statement not covered" >                return context$2$0.stop();</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 6;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _asyncbox.retry)(2, execFunc));</span>
&nbsp;
      case 6:
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', context$1$0.sent);</span>
&nbsp;
...
&nbsp;
systemCallMethods.shell = <span class="fstat-no" title="function not covered" >function callee$0$0(cmd) {</span>
<span class="cstat-no" title="statement not covered" >  var opts = arguments.length &lt;= 1 || arguments[1] === undefined ? {} : arguments[1];</span>
<span class="cstat-no" title="statement not covered" >  var execCmd;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.isDeviceConnected());</span>
&nbsp;
      case 2:
<span class="cstat-no" title="statement not covered" >        if (context$1$0.sent) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 4;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        throw new Error('No device connected, cannot run adb shell command \'' + cmd.join(' ') + '\'');</span>
&nbsp;
      case 4:
<span class="cstat-no" title="statement not covered" >        execCmd = ['shell'];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (cmd instanceof Array) {</span>
<span class="cstat-no" title="statement not covered" >          execCmd = execCmd.concat(cmd);</span>
        } else {
<span class="cstat-no" title="statement not covered" >          execCmd.push(cmd);</span>
        }
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 8;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.adbExec(execCmd, opts));</span>
&nbsp;
      case 8:
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', context$1$0.sent);</span>
&nbsp;
...
&nbsp;
systemCallMethods.createSubProcess = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >  var args = arguments.length &lt;= 0 || arguments[0] === undefined ? [] : arguments[0];</span>
&nbsp;
  // add the default arguments
<span class="cstat-no" title="statement not covered" >  args = this.executable.defaultArgs.concat(args);</span>
<span class="cstat-no" title="statement not covered" >  _loggerJs2['default'].debug('Creating ADB subprocess with args: ' + JSON.stringify(args));</span>
<span class="cstat-no" title="statement not covered" >  return new _teen_process.SubProcess(this.getAdbPath(), args);</span>
};
&nbsp;
// TODO can probably deprecate this now that the logic is just to read
// this.adbPort
systemCallMethods.getAdbServerPort = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >  return this.adbPort;</span>
};
&nbsp;
systemCallMethods.getEmulatorPort = <span class="fstat-no" title="function not covered" >function callee$0$0() {</span>
<span class="cstat-no" title="statement not covered" >  var devices, port;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        _loggerJs2['default'].debug("Getting running emulator port");</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!(this.emulatorPort !== null)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 3;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', this.emulatorPort);</span>
&nbsp;
      case 3:
...
<span class="cstat-no" title="statement not covered" >        port = this.getPortFromEmulatorString(devices[0].udid);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', port);</span>
&nbsp;
      case 12:
<span class="cstat-no" title="statement not covered" >        throw new Error('Emulator port not found');</span>
&nbsp;
      case 13:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 18;</span>
<span class="cstat-no" title="statement not covered" >        break;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        _loggerJs2['default'].errorAndThrow('No devices connected. Original error: ' + context$1$0.t0.message);</span>
&nbsp;
      case 18:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
systemCallMethods.getPortFromEmulatorString = <span class="fstat-no" title="function not covered" >function (emStr) {</span>
<span class="cstat-no" title="statement not covered" >  var portPattern = /emulator-(\d+)/;</span>
<span class="cstat-no" title="statement not covered" >  if (portPattern.test(emStr)) {</span>
<span class="cstat-no" title="statement not covered" >    return parseInt(portPattern.exec(emStr)[1], 10);</span>
  }
<span class="cstat-no" title="statement not covered" >  return false;</span>
};
&nbsp;
systemCallMethods.getConnectedEmulators = <span class="fstat-no" title="function not covered" >function callee$0$0() {</span>
<span class="cstat-no" title="statement not covered" >  var devices, emulators, _iteratorNormalCompletion4, _didIteratorError4, _iteratorError4, _iterator4, _step4, device, port;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        _loggerJs2['default'].debug("Getting connected emulators");</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 4;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.getConnectedDevices());</span>
&nbsp;
      case 4:
<span class="cstat-no" title="statement not covered" >        devices = context$1$0.sent;</span>
<span class="cstat-no" title="statement not covered" >        emulators = [];</span>
...
<span class="cstat-no" title="statement not covered" >        context$1$0.prev = 9;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        for (_iterator4 = _getIterator(devices); !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {</span>
<span class="cstat-no" title="statement not covered" >          device = _step4.value;</span>
<span class="cstat-no" title="statement not covered" >          port = this.getPortFromEmulatorString(device.udid);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (port) {</span>
<span class="cstat-no" title="statement not covered" >            device.port = port;</span>
<span class="cstat-no" title="statement not covered" >            emulators.push(device);</span>
          }
        }
...
&nbsp;
      case 13:
<span class="cstat-no" title="statement not covered" >        context$1$0.prev = 13;</span>
...
&nbsp;
      case 24:
<span class="cstat-no" title="statement not covered" >        return context$1$0.finish(17);</span>
&nbsp;
      case 25:
<span class="cstat-no" title="statement not covered" >        _loggerJs2['default'].debug(emulators.length + ' emulator(s) connected');</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', emulators);</span>
&nbsp;
      case 29:
<span class="cstat-no" title="statement not covered" >        context$1$0.prev = 29;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.t1 = context$1$0['catch'](0);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        _loggerJs2['default'].errorAndThrow('Error getting emulators. Original error: ' + context$1$0.t1.message);</span>
&nbsp;
      case 32:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
systemCallMethods.setEmulatorPort = <span class="fstat-no" title="function not covered" >function (emPort) {</span>
<span class="cstat-no" title="statement not covered" >  this.emulatorPort = emPort;</span>
};
&nbsp;
systemCallMethods.setDeviceId = <span class="fstat-no" title="function not covered" >function (deviceId) {</span>
<span class="cstat-no" title="statement not covered" >  _loggerJs2['default'].debug('Setting device id to ' + deviceId);</span>
<span class="cstat-no" title="statement not covered" >  this.curDeviceId = deviceId;</span>
<span class="cstat-no" title="statement not covered" >  var argsHasDevice = this.executable.defaultArgs.indexOf('-s');</span>
<span class="cstat-no" title="statement not covered" >  if (argsHasDevice !== -1) {</span>
    // remove the old device id from the arguments
<span class="cstat-no" title="statement not covered" >    this.executable.defaultArgs.splice(argsHasDevice, 2);</span>
  }
<span class="cstat-no" title="statement not covered" >  this.executable.defaultArgs.push('-s', deviceId);</span>
};
&nbsp;
systemCallMethods.setDevice = <span class="fstat-no" title="function not covered" >function (deviceObj) {</span>
<span class="cstat-no" title="statement not covered" >  var deviceId = deviceObj.udid;</span>
<span class="cstat-no" title="statement not covered" >  var emPort = this.getPortFromEmulatorString(deviceId);</span>
<span class="cstat-no" title="statement not covered" >  this.setEmulatorPort(emPort);</span>
<span class="cstat-no" title="statement not covered" >  this.setDeviceId(deviceId);</span>
};
&nbsp;
systemCallMethods.getRunningAVD = <span class="fstat-no" title="function not covered" >function callee$0$0(avdName) {</span>
<span class="cstat-no" title="statement not covered" >  var emulators, _iteratorNormalCompletion5, _didIteratorError5, _iteratorError5, _iterator5, _step5, emulator, runningAVDName;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        context$1$0.prev = 0;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        _loggerJs2['default'].debug('Trying to find ' + avdName + ' emulator');</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 4;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.getConnectedEmulators());</span>
&nbsp;
      case 4:
<span class="cstat-no" title="statement not covered" >        emulators = context$1$0.sent;</span>
<span class="cstat-no" title="statement not covered" >        _iteratorNormalCompletion5 = true;</span>
<span class="cstat-no" title="statement not covered" >        _didIteratorError5 = false;</span>
<span class="cstat-no" title="statement not covered" >        _iteratorError5 = undefined;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.prev = 8;</span>
<span class="cstat-no" title="statement not covered" >        _iterator5 = _getIterator(emulators);</span>
&nbsp;
      case 10:
<span class="cstat-no" title="statement not covered" >        if (_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 23;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        emulator = _step5.value;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        this.setEmulatorPort(emulator.port);</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 15;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.sendTelnetCommand("avd name"));</span>
&nbsp;
      case 15:
<span class="cstat-no" title="statement not covered" >        runningAVDName = context$1$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!(avdName === runningAVDName)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 20;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        _loggerJs2['default'].debug('Found emulator ' + avdName + ' in port ' + emulator.port);</span>
<span class="cstat-no" title="statement not covered" >        this.setDeviceId(emulator.udid);</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', emulator);</span>
&nbsp;
      case 20:
<span class="cstat-no" title="statement not covered" >        _iteratorNormalCompletion5 = true;</span>
...
&nbsp;
      case 25:
<span class="cstat-no" title="statement not covered" >        context$1$0.prev = 25;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.t0 = context$1$0['catch'](8);</span>
<span class="cstat-no" title="statement not covered" >        _didIteratorError5 = true;</span>
<span class="cstat-no" title="statement not covered" >        _iteratorError5 = context$1$0.t0;</span>
&nbsp;
      case 29:
<span class="cstat-no" title="statement not covered" >        context$1$0.prev = 29;</span>
...
&nbsp;
      case 37:
<span class="cstat-no" title="statement not covered" >        _loggerJs2['default'].debug('Emulator ' + avdName + ' not running');</span>
...
<span class="cstat-no" title="statement not covered" >        context$1$0.t1 = context$1$0['catch'](0);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        _loggerJs2['default'].errorAndThrow('Error getting AVD. Original error: ' + context$1$0.t1.message);</span>
&nbsp;
      case 44:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
systemCallMethods.getRunningAVDWithRetry = <span class="fstat-no" title="function not covered" >function callee$0$0(avdName) {</span>
<span class="cstat-no" title="statement not covered" >  var timeoutMs = arguments.length &lt;= 1 || arguments[1] === undefined ? 20000 : arguments[1];</span>
<span class="cstat-no" title="statement not covered" >  var start, runningAVD;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        context$1$0.prev = 0;</span>
...
<span class="cstat-no" title="statement not covered" >        context$1$0.prev = 3;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 6;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.getRunningAVD(avdName.replace('@', '')));</span>
&nbsp;
      case 6:
<span class="cstat-no" title="statement not covered" >        runningAVD = context$1$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!runningAVD) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 9;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', runningAVD);</span>
&nbsp;
      case 9:
...
&nbsp;
        // Do nothing.
<span class="cstat-no" title="statement not covered" >        _loggerJs2['default'].info('Couldn\'t get running AVD, will retry. Error was: ' + context$1$0.t0.message);</span>
&nbsp;
      case 14:
...
&nbsp;
      case 18:
<span class="cstat-no" title="statement not covered" >        _loggerJs2['default'].errorAndThrow('Could not find ' + avdName + ' emulator.');</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 24;</span>
<span class="cstat-no" title="statement not covered" >        break;</span>
&nbsp;
      case 21:
...
<span class="cstat-no" title="statement not covered" >        context$1$0.t1 = context$1$0['catch'](0);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        _loggerJs2['default'].errorAndThrow('Error getting AVD with retry. Original error: ' + context$1$0.t1.message);</span>
&nbsp;
      case 24:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
systemCallMethods.killAllEmulators = <span class="fstat-no" title="function not covered" >function callee$0$0() {</span>
<span class="cstat-no" title="statement not covered" >  var cmd, args;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        cmd = undefined, args = undefined;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (_appiumSupport.system.isWindows()) {</span>
<span class="cstat-no" title="statement not covered" >          cmd = 'TASKKILL';</span>
<span class="cstat-no" title="statement not covered" >          args = ['TASKKILL', '/IM', 'emulator.exe'];</span>
        } else {
<span class="cstat-no" title="statement not covered" >          cmd = '/usr/bin/killall';</span>
<span class="cstat-no" title="statement not covered" >          args = ['-m', 'emulator*'];</span>
        }
<span class="cstat-no" title="statement not covered" >        context$1$0.prev = 2;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 5;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _teen_process.exec)(cmd, args));</span>
&nbsp;
      case 5:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 10;</span>
<span class="cstat-no" title="statement not covered" >        break;</span>
...
<span class="cstat-no" title="statement not covered" >        context$1$0.t0 = context$1$0['catch'](2);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        _loggerJs2['default'].errorAndThrow('Error killing emulators. Original error: ' + context$1$0.t0.message);</span>
&nbsp;
      case 10:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
systemCallMethods.killEmulator = <span class="fstat-no" title="function not covered" >function callee$0$0(avdName) {</span>
<span class="cstat-no" title="statement not covered" >  var device;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        _loggerJs2['default'].debug('killing avd \'' + avdName + '\'');</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 3;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.getRunningAVD(avdName));</span>
&nbsp;
      case 3:
<span class="cstat-no" title="statement not covered" >        device = context$1$0.sent;</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 7;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.adbExec(['emu', 'kill']));</span>
&nbsp;
      case 7:
<span class="cstat-no" title="statement not covered" >        _loggerJs2['default'].info('successfully killed emulator \'' + avdName + '\'');</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 11;</span>
<span class="cstat-no" title="statement not covered" >        break;</span>
&nbsp;
      case 10:
<span class="cstat-no" title="statement not covered" >        _loggerJs2['default'].info('no avd with name \'' + avdName + '\' running. skipping kill step.');</span>
&nbsp;
      case 11:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
systemCallMethods.launchAVD = <span class="fstat-no" title="function not covered" >function callee$0$0(avdName, avdArgs, language, country) {</span>
<span class="cstat-no" title="statement not covered" >  var avdLaunchTimeout = arguments.length &lt;= 4 || arguments[4] === undefined ? 60000 : arguments[4];</span>
<span class="cstat-no" title="statement not covered" >  var avdReadyTimeout = arguments.length &lt;= 5 || arguments[5] === undefined ? 60000 : arguments[5];</span>
<span class="cstat-no" title="statement not covered" >  var retryTimes = arguments.length &lt;= 6 || arguments[6] === undefined ? 1 : arguments[6];</span>
<span class="cstat-no" title="statement not covered" >  var emulatorBinaryPath, launchArgs, locale, proc;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        _loggerJs2['default'].debug('Launching Emulator with AVD ' + avdName + ', launchTimeout' + (avdLaunchTimeout + ' ms and readyTimeout ' + avdReadyTimeout + ' ms'));</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 3;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.getSdkBinaryPath("emulator"));</span>
&nbsp;
      case 3:
<span class="cstat-no" title="statement not covered" >        emulatorBinaryPath = context$1$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (avdName[0] === "@") {</span>
<span class="cstat-no" title="statement not covered" >          avdName = avdName.substr(1);</span>
        }
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 7;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.checkAvdExist(avdName));</span>
&nbsp;
      case 7:
<span class="cstat-no" title="statement not covered" >        launchArgs = ["-avd", avdName];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (typeof language === "string") {</span>
<span class="cstat-no" title="statement not covered" >          _loggerJs2['default'].debug('Setting Android Device Language to ' + language);</span>
<span class="cstat-no" title="statement not covered" >          launchArgs.push("-prop", 'persist.sys.language=' + language.toLowerCase());</span>
        }
<span class="cstat-no" title="statement not covered" >        if (typeof country === "string") {</span>
<span class="cstat-no" title="statement not covered" >          _loggerJs2['default'].debug('Setting Android Device Country to ' + country);</span>
<span class="cstat-no" title="statement not covered" >          launchArgs.push("-prop", 'persist.sys.country=' + country.toUpperCase());</span>
        }
<span class="cstat-no" title="statement not covered" >        locale = undefined;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (typeof language === "string" &amp;&amp; typeof country === "string") {</span>
<span class="cstat-no" title="statement not covered" >          locale = language.toLowerCase() + "-" + country.toUpperCase();</span>
        } else <span class="cstat-no" title="statement not covered" >if (typeof language === "string") {</span>
<span class="cstat-no" title="statement not covered" >          locale = language.toLowerCase();</span>
        } else <span class="cstat-no" title="statement not covered" >if (typeof country === "string") {</span>
<span class="cstat-no" title="statement not covered" >          locale = country;</span>
        }
<span class="cstat-no" title="statement not covered" >        if (typeof locale === "string") {</span>
<span class="cstat-no" title="statement not covered" >          _loggerJs2['default'].debug('Setting Android Device Locale to ' + locale);</span>
<span class="cstat-no" title="statement not covered" >          launchArgs.push("-prop", 'persist.sys.locale=' + locale);</span>
        }
<span class="cstat-no" title="statement not covered" >        if (typeof avdArgs === "string") {</span>
<span class="cstat-no" title="statement not covered" >          avdArgs = avdArgs.split(" ");</span>
<span class="cstat-no" title="statement not covered" >          launchArgs = launchArgs.concat(avdArgs);</span>
        }
<span class="cstat-no" title="statement not covered" >        _loggerJs2['default'].debug('Running \'' + emulatorBinaryPath + '\' with args: ' + JSON.stringify(launchArgs));</span>
<span class="cstat-no" title="statement not covered" >        proc = new _teen_process.SubProcess(emulatorBinaryPath, launchArgs);</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 18;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(proc.start(0));</span>
&nbsp;
      case 18:
<span class="cstat-no" title="statement not covered" >        proc.on('output', <span class="fstat-no" title="function not covered" >function (stdout, stderr) {</span></span>
<span class="cstat-no" title="statement not covered" >          _loggerJs2['default'].info('[AVD OUTPUT] ' + (stdout || stderr));</span>
        });
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 21;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _asyncbox.retry)(retryTimes, this.getRunningAVDWithRetry.bind(this), avdName, avdLaunchTimeout));</span>
&nbsp;
      case 21:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 23;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.waitForEmulatorReady(avdReadyTimeout));</span>
&nbsp;
      case 23:
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', proc);</span>
&nbsp;
      case 24:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
systemCallMethods.checkAvdExist = <span class="fstat-no" title="function not covered" >function callee$0$0(avdName) {</span>
<span class="cstat-no" title="statement not covered" >  var cmd, result, unknownOptionError, sdkVersion, binaryName, existings;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        cmd = undefined, result = undefined;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.prev = 1;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 4;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.getSdkBinaryPath('emulator'));</span>
&nbsp;
      case 4:
<span class="cstat-no" title="statement not covered" >        cmd = context$1$0.sent;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 7;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _teen_process.exec)(cmd, ['-list-avds']));</span>
&nbsp;
      case 7:
...
<span class="cstat-no" title="statement not covered" >        unknownOptionError = new RegExp("unknown option: -list-avds", "i").test(context$1$0.t0.stderr);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!unknownOptionError) {</span>
<span class="cstat-no" title="statement not covered" >          _loggerJs2['default'].errorAndThrow('Error executing checkAvdExist. Original error: \'' + context$1$0.t0.message + '\'; ' + ('Stderr: \'' + (context$1$0.t0.stderr || '').trim() + '\'; Code: \'' + context$1$0.t0.code + '\''));</span>
        }
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 16;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _helpers.getSdkToolsVersion)());</span>
&nbsp;
      case 16:
<span class="cstat-no" title="statement not covered" >        sdkVersion = context$1$0.sent;</span>
<span class="cstat-no" title="statement not covered" >        binaryName = 'android';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (sdkVersion) {</span>
<span class="cstat-no" title="statement not covered" >          if (sdkVersion.major &gt;= 25) {</span>
<span class="cstat-no" title="statement not covered" >            binaryName = 'avdmanager';</span>
          }
        } else {
<span class="cstat-no" title="statement not covered" >          _loggerJs2['default'].warn('Defaulting binary name to \'' + binaryName + '\', because SDK version cannot be parsed');</span>
        }
        // If -list-avds option is not available, use android command as an alternative
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 21;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.getSdkBinaryPath(binaryName));</span>
&nbsp;
      case 21:
<span class="cstat-no" title="statement not covered" >        cmd = context$1$0.sent;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 24;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _teen_process.exec)(cmd, ['list', 'avd', '-c']));</span>
&nbsp;
      case 24:
<span class="cstat-no" title="statement not covered" >        result = context$1$0.sent;</span>
&nbsp;
      case 25:
<span class="cstat-no" title="statement not covered" >        if (result.stdout.indexOf(avdName) === -1) {</span>
<span class="cstat-no" title="statement not covered" >          existings = '(' + result.stdout.trim().replace(/[\n]/g, '), (') + ')';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          _loggerJs2['default'].errorAndThrow('Avd \'' + avdName + '\' is not available. please select your avd name from one of these: \'' + existings + '\'');</span>
        }
&nbsp;
      case 26:
      case 'end':
...
&nbsp;
systemCallMethods.waitForEmulatorReady = <span class="fstat-no" title="function not covered" >function callee$0$0() {</span>
<span class="cstat-no" title="statement not covered" >  var timeoutMs = arguments.length &lt;= 0 || arguments[0] === undefined ? 20000 : arguments[0];</span>
<span class="cstat-no" title="statement not covered" >  var start, stdout;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        start = Date.now();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        _loggerJs2['default'].debug("Waiting until emulator is ready");</span>
&nbsp;
      case 2:
<span class="cstat-no" title="statement not covered" >        if (!(Date.now() - start &lt; timeoutMs)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 17;</span>
...
<span class="cstat-no" title="statement not covered" >        context$1$0.prev = 3;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 6;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.shell(["getprop", "init.svc.bootanim"]));</span>
&nbsp;
      case 6:
<span class="cstat-no" title="statement not covered" >        stdout = context$1$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!(stdout.indexOf('stopped') &gt; -1)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 9;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
...
&nbsp;
      case 13:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 15;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _asyncbox.sleep)(3000));</span>
&nbsp;
      case 15:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >        break;</span>
&nbsp;
      case 17:
<span class="cstat-no" title="statement not covered" >        _loggerJs2['default'].errorAndThrow('Emulator not ready');</span>
&nbsp;
      case 18:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
systemCallMethods.waitForDevice = <span class="fstat-no" title="function not covered" >function callee$0$0() {</span>
<span class="cstat-no" title="statement not covered" >  var appDeviceReadyTimeout = arguments.length &lt;= 0 || arguments[0] === undefined ? 30 : arguments[0];</span>
<span class="cstat-no" title="statement not covered" >  var retries, timeout;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    var _this3 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        this.appDeviceReadyTimeout = appDeviceReadyTimeout;</span>
<span class="cstat-no" title="statement not covered" >        retries = 3;</span>
<span class="cstat-no" title="statement not covered" >        timeout = parseInt(this.appDeviceReadyTimeout, 10) / retries * 1000;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 5;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _asyncbox.retry)(retries, <span class="fstat-no" title="function not covered" >function callee$1$0() {</span></span>
...
<span class="cstat-no" title="statement not covered" >                return _regeneratorRuntime.awrap(this.adbExec('wait-for-device', { timeout: timeout }));</span>
&nbsp;
              case 3:
<span class="cstat-no" title="statement not covered" >                context$2$0.next = 5;</span>
<span class="cstat-no" title="statement not covered" >                return _regeneratorRuntime.awrap(this.ping());</span>
&nbsp;
              case 5:
<span class="cstat-no" title="statement not covered" >                context$2$0.next = 14;</span>
<span class="cstat-no" title="statement not covered" >                break;</span>
...
&nbsp;
              case 13:
<span class="cstat-no" title="statement not covered" >                _loggerJs2['default'].errorAndThrow('Error in waiting for device. Original error: \'' + context$2$0.t0.message + '\'. ' + 'Retrying by restarting ADB');</span>
&nbsp;
              case 14:
              case 'end':
<span class="cstat-no" title="statement not covered" >                return context$2$0.stop();</span>
...
&nbsp;
systemCallMethods.reboot = <span class="fstat-no" title="function not covered" >function callee$0$0() {</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
...
<span class="cstat-no" title="statement not covered" >        context$1$0.prev = 1;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 4;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.shell(['stop']));</span>
&nbsp;
      case 4:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 15;</span>
<span class="cstat-no" title="statement not covered" >        break;</span>
...
<span class="cstat-no" title="statement not covered" >        context$1$0.t0 = context$1$0['catch'](1);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!(context$1$0.t0.message.indexOf('must be root') === -1)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 10;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        _loggerJs2['default'].debug('Device requires adb to be running as root in order to reboot. Restarting daemon');</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 13;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _teen_process.exec)(this.executable.path, ['root']));</span>
&nbsp;
      case 13:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 15;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.shell(['stop']));</span>
&nbsp;
      case 15:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 17;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_bluebird2['default'].delay(2000));</span>
&nbsp;
      case 17:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 19;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.setDeviceProperty('sys.boot_completed', 0));</span>
&nbsp;
      case 19:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 21;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.shell(['start']));</span>
&nbsp;
      case 21:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 23;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _asyncbox.retryInterval)(90, 1000, <span class="fstat-no" title="function not covered" >function callee$1$0() {</span></span>
<span class="cstat-no" title="statement not covered" >          var booted, msg;</span>
<span class="cstat-no" title="statement not covered" >          return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$1$0$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >            while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
              case 0:
<span class="cstat-no" title="statement not covered" >                context$2$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >                return _regeneratorRuntime.awrap(this.getDeviceProperty('sys.boot_completed'));</span>
&nbsp;
              case 2:
<span class="cstat-no" title="statement not covered" >                booted = context$2$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (!(booted === '1')) {</span>
<span class="cstat-no" title="statement not covered" >                  context$2$0.next = 7;</span>
<span class="cstat-no" title="statement not covered" >                  break;</span>
                }
&nbsp;
...
&nbsp;
              case 7:
<span class="cstat-no" title="statement not covered" >                msg = 'Waiting for reboot. This takes time';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                _loggerJs2['default'].debug(msg);</span>
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _teen_process.exec)(this.executable.path, ['unroot']));</span>
&nbsp;
      case 26:
...
&nbsp;
systemCallMethods.fileExists = <span class="fstat-no" title="function not covered" >function callee$0$0(remotePath) {</span>
<span class="cstat-no" title="statement not covered" >  var files;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.ls(remotePath));</span>
&nbsp;
      case 2:
<span class="cstat-no" title="statement not covered" >        files = context$1$0.sent;</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', files.length &gt; 0);</span>
&nbsp;
      case 4:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
systemCallMethods.ls = <span class="fstat-no" title="function not covered" >function callee$0$0(remotePath) {</span>
<span class="cstat-no" title="statement not covered" >  var stdout, lines;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        context$1$0.prev = 0;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 3;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.shell(['ls', remotePath]));</span>
&nbsp;
      case 3:
<span class="cstat-no" title="statement not covered" >        stdout = context$1$0.sent;</span>
<span class="cstat-no" title="statement not covered" >        lines = stdout.split("\n");</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', lines.map(<span class="fstat-no" title="function not covered" >function (l) {</span></span>
<span class="cstat-no" title="statement not covered" >          return l.trim();</span>
        }).filter(Boolean).filter(<span class="fstat-no" title="function not covered" >function (l) {</span>
<span class="cstat-no" title="statement not covered" >          return l.indexOf("No such file") === -1;</span>
        }));
&nbsp;
      case 8:
<span class="cstat-no" title="statement not covered" >        context$1$0.prev = 8;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!(context$1$0.t0.message.indexOf('No such file or directory') === -1)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 12;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
