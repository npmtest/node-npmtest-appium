...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-mac-driver/build/lib/appium-for-mac.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-mac-driver/build/lib/appium-for-mac.js</span></h1>
    <h2>
        
        Statements: <span class="metric">14.12% <small>(25 / 177)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-mac-driver/build/lib/</a> &#187; appium-for-mac.js</div>
</div>
<div class="body">
...
<span class="fstat-no" title="function not covered" >  function AppiumForMac() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, AppiumForMac);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.proxyHost = DEFAULT_A4M_HOST;</span>
<span class="cstat-no" title="statement not covered" >    this.proxyPort = DEFAULT_A4M_PORT;</span>
...
<span class="cstat-no" title="statement not covered" >      var startDetector, processIsAlive, a4mBinary, _arr, _loop, _i;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(_appiumSupport.fs.exists(REQ_A4M_APP_PATH));</span>
&nbsp;
          case 2:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            throw new Error("Could not verify AppiumForMacDriver install; please install to your /Applications folder");</span>
&nbsp;
          case 4:
<span class="cstat-no" title="statement not covered" >            startDetector = <span class="fstat-no" title="function not covered" >function startDetector(stdout, stderr) {</span></span>
<span class="cstat-no" title="statement not covered" >              return stderr.indexOf("Started HTTP server") !== -1;</span>
            };
&nbsp;
...
&nbsp;
          case 9:
<span class="cstat-no" title="statement not covered" >            a4mBinary = _path2['default'].resolve(REQ_A4M_APP_PATH, "Contents", "MacOS", "AppiumForMac");</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            this.proc = new _teen_process.SubProcess(a4mBinary, []);</span>
...
<span class="cstat-no" title="statement not covered" >                    var l = _step.value;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                    a4mLog.info('[' + stream + '] ' + l.trim());</span>
                  }
                } catch (err) {
...
<span class="cstat-no" title="statement not covered" >              processIsAlive = false;</span>
<span class="cstat-no" title="statement not covered" >              var msg = 'AppiumForMac exited unexpectedly with code ' + code + ', ' + ('signal ' + signal);</span>
<span class="cstat-no" title="statement not covered" >              _logger2['default'].error(msg);</span>
            });
<span class="cstat-no" title="statement not covered" >            _logger2['default'].info('Spawning AppiumForMac with: ' + this.appium4macdriver);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            this.emit(AppiumForMac.EVENT_ERROR, context$2$0.t0);</span>
...
<span class="cstat-no" title="statement not covered" >      if (this.state !== AppiumForMac.STATE_ONLINE) {</span>
...
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.sendCommand('/status', 'GET'));</span>
&nbsp;
          case 2:
...
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.sendCommand('/session', 'POST', { desiredCapabilities: caps }));</span>
&nbsp;
          case 3:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (!(context$2$0.t0.message.indexOf("Did not get a valid response object") === -1 || context$2$0.t0.message.indexOf("value") !== -1)) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 11;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
            }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      var processName;</span>
...
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            processName = "AppiumForMac";</span>
&nbsp;
            // js hint cannot handle backticks, even escaped, within template literals
<span class="cstat-no" title="statement not covered" >            _logger2['default'].info('Killing any old AppiumForMac');</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 4;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(_appiumSupport.process.killProcess(processName));</span>
&nbsp;
          case 4:
<span class="cstat-no" title="statement not covered" >            _logger2['default'].info("Successfully cleaned up old Appium4Mac servers");</span>
&nbsp;
          case 5:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
...
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Deleting AppiumForMac server session');</span>
            // rely on jwproxy's intelligence to know what we're talking about and
            // delete the current session
<span class="cstat-no" title="statement not covered" >            context$2$0.prev = 1;</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 4;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.sendCommand('/', 'DELETE'));</span>
&nbsp;
          case 4:
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 9;</span>
<span class="cstat-no" title="statement not covered" >            break;</span>
...
<span class="cstat-no" title="statement not covered" >            context$2$0.t0 = context$2$0['catch'](1);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].warn('Did not get confirmation AppiumForMac deleteSession worked; ' + ('Error was: ' + context$2$0.t0));</span>
&nbsp;
          case 9:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
