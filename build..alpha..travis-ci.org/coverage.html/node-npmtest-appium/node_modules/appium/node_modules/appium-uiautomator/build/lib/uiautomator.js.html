...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-uiautomator/build/lib/uiautomator.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-uiautomator/build/lib/uiautomator.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-uiautomator/build/lib/</a> &#187; uiautomator.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function UiAutomator(adb) {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, UiAutomator);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!adb) {</span>
<span class="cstat-no" title="statement not covered" >      log.errorAndThrow("adb is required to instantiate UiAutomator");</span>
    }
<span class="cstat-no" title="statement not covered" >    _get(Object.getPrototypeOf(UiAutomator.prototype), 'constructor', this).call(this);</span>
<span class="cstat-no" title="statement not covered" >    this.adb = adb;</span>
<span class="cstat-no" title="statement not covered" >    this.tempPath = "/data/local/tmp/";</span>
  }
&nbsp;
  _createClass(UiAutomator, [{
    key: 'start',
    value: <span class="fstat-no" title="function not covered" >function start(uiAutomatorBinaryPath, className, startDetector) {</span>
<span class="cstat-no" title="statement not covered" >      var processIsAlive,</span>
          jarName,
          _len,
          extraParams,
          _key,
...
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            processIsAlive = undefined;</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.prev = 1;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            log.debug("Starting UiAutomator");</span>
<span class="cstat-no" title="statement not covered" >            this.changeState(UiAutomator.STATE_STARTING);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            log.debug("Parsing uiautomator jar");</span>
            // expecting a path like /ads/ads/foo.jar or \asd\asd\foo.jar
<span class="cstat-no" title="statement not covered" >            jarName = this.parseJarNameFromPath(uiAutomatorBinaryPath);</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 8;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.adb.push(uiAutomatorBinaryPath, this.tempPath));</span>
&nbsp;
          case 8:
...
<span class="cstat-no" title="statement not covered" >            log.debug('Starting UIAutomator');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            for (_len = args$2$0.length, extraParams = Array(_len &gt; 3 ? _len - 3 : 0), _key = 3; _key &lt; _len; _key++) {</span>
<span class="cstat-no" title="statement not covered" >              extraParams[_key - 3] = args$2$0[_key];</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            args = ["shell", "uiautomator", "runtest", jarName, "-c", className].concat(extraParams);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            this.proc = this.adb.createSubProcess(args);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >              processIsAlive = false;</span>
              // cleanup
<span class="cstat-no" title="statement not covered" >              if (_this.state !== UiAutomator.STATE_STOPPED &amp;&amp; _this.state !== UiAutomator.STATE_STOPPING) {</span>
<span class="cstat-no" title="statement not covered" >                var msg = 'UiAutomator exited unexpectedly with code ' + code + ', ' + ('signal ' + signal);</span>
<span class="cstat-no" title="statement not covered" >                log.error(msg);</span>
              } else <span class="cstat-no" title="statement not covered" >if (_this.state === UiAutomator.STATE_STOPPING) {</span>
<span class="cstat-no" title="statement not covered" >                log.debug("UiAutomator shut down normally");</span>
              }
<span class="cstat-no" title="statement not covered" >              _this.changeState(UiAutomator.STATE_STOPPED);</span>
            });
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            this.changeState(UiAutomator.STATE_ONLINE);</span>
<span class="cstat-no" title="statement not covered" >            return context$2$0.abrupt('return', this.proc);</span>
&nbsp;
          case 22:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            this.emit(UiAutomator.EVENT_ERROR, context$2$0.t0);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            log.debug('Shutting down UiAutomator');</span>
<span class="cstat-no" title="statement not covered" >            this.changeState(UiAutomator.STATE_STOPPING);</span>
...
&nbsp;
          case 6:
<span class="cstat-no" title="statement not covered" >            this.changeState(UiAutomator.STATE_STOPPED);</span>
&nbsp;
          case 7:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    value: <span class="fstat-no" title="function not covered" >function parseJarNameFromPath(binaryPath) {</span>
<span class="cstat-no" title="statement not covered" >      var reTest = /.*(\/|\\)(.*\.jar)/.exec(binaryPath);</span>
<span class="cstat-no" title="statement not covered" >      if (!reTest) {</span>
<span class="cstat-no" title="statement not covered" >        throw new Error('Unable to parse jar name from ' + binaryPath);</span>
      }
<span class="cstat-no" title="statement not covered" >      var jarName = reTest[2];</span>
<span class="cstat-no" title="statement not covered" >      log.debug('Found jar name: \'' + jarName + '\'');</span>
<span class="cstat-no" title="statement not covered" >      return jarName;</span>
    }
  }, {
    key: 'changeState',
    value: <span class="fstat-no" title="function not covered" >function changeState(state) {</span>
<span class="cstat-no" title="statement not covered" >      log.debug('Moving to state \'' + state + '\'');</span>
<span class="cstat-no" title="statement not covered" >      this.state = state;</span>
<span class="cstat-no" title="statement not covered" >      this.emit(UiAutomator.EVENT_CHANGED, { state: state });</span>
    }
  }, {
...
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.adb.killProcessesByName('uiautomator'));</span>
&nbsp;
          case 3:
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 8;</span>
<span class="cstat-no" title="statement not covered" >            break;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            log.warn('Error while killing uiAutomator: ' + context$2$0.t0);</span>
&nbsp;
          case 8:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
