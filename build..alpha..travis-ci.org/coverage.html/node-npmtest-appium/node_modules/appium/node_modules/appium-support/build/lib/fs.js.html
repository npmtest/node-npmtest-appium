...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-support/build/lib/fs.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-support/build/lib/fs.js</span></h1>
    <h2>
        
        Statements: <span class="metric">59.74% <small>(46 / 77)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">28% <small>(7 / 25)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-support/build/lib/</a> &#187; fs.js</div>
</div>
<div class="body">
...
&nbsp;
var fs = {
  hasAccess: <span class="fstat-no" title="function not covered" >function hasAccess(path) {</span>
<span class="cstat-no" title="statement not covered" >    return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function hasAccess$(context$1$0) {</span></span>
...
<span class="cstat-no" title="statement not covered" >          return _regeneratorRuntime.awrap(this.access(path, fs.F_OK | fs.R_OK));</span>
&nbsp;
        case 3:
...
<span class="cstat-no" title="statement not covered" >          return context$1$0.stop();</span>
  ...
  exists: <span class="fstat-no" title="function not covered" >function exists(path) {</span>
<span class="cstat-no" title="statement not covered" >    return this.hasAccess(path);</span>
  },
...
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (!(context$1$0.t0 &amp;&amp; context$1$0.t0.code !== "EEXIST")) {</span>
...
&nbsp;
  ...
  md5: <span class="fstat-no" title="function not covered" >function md5(filePath) {</span>
<span class="cstat-no" title="statement not covered" >    return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function md5$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >      while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
        case 0:
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >          return _regeneratorRuntime.awrap(_md5(filePath));</span>
&nbsp;
        case 2:
