...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-support/build/lib/tempdir.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-support/build/lib/tempdir.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-support/build/lib/</a> &#187; tempdir.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">/* This library is originated from temp.js at http://github.com/bruce/node-temp */
'use strict';
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >function path(rawAffixes, defaultPrefix) {</span>
<span class="cstat-no" title="statement not covered" >  var affixes, name, tempDirectory;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function path$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        affixes = parseAffixes(rawAffixes, defaultPrefix);</span>
<span class="cstat-no" title="statement not covered" >        name = [affixes.prefix, affixes.suffix].join('');</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 4;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(tempDir());</span>
&nbsp;
      case 4:
<span class="cstat-no" title="statement not covered" >        tempDirectory = context$1$0.sent;</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', _path2['default'].join(tempDirectory, name));</span>
&nbsp;
      case 6:
      case 'end':
...
&nbsp;
<span class="fstat-no" title="function not covered" >function open(affixes) {</span>
<span class="cstat-no" title="statement not covered" >  var filePath, fd;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function open$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(path(affixes, 'f-'));</span>
&nbsp;
      case 2:
<span class="cstat-no" title="statement not covered" >        filePath = context$1$0.sent;</span>
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_fs2['default'].open(filePath, RDWR_EXCL, 384));</span>
&nbsp;
      case 6:
<span class="cstat-no" title="statement not covered" >        fd = context$1$0.sent;</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', { path: filePath, fd: fd });</span>
&nbsp;
      case 10:
...
&nbsp;
<span class="fstat-no" title="function not covered" >function parseAffixes(rawAffixes, defaultPrefix) {</span>
...
var openDir = tempDir;
&nbsp;
<span class="fstat-no" title="function not covered" >function staticDir() {</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function staticDir$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', _static);</span>
&nbsp;
      case 1:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
