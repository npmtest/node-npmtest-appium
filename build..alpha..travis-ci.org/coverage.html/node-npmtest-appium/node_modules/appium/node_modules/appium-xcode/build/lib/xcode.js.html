...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-xcode/build/lib/xcode.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-xcode/build/lib/xcode.js</span></h1>
    <h2>
        
        Statements: <span class="metric">11.51% <small>(35 / 304)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">11.9% <small>(35 / 294)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-xcode/build/lib/</a> &#187; xcode.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >function hasExpectedSubDir(path) {</span>
<span class="cstat-no" title="statement not covered" >  return path.substring(path.length - XCODE_SUBDIR.length) === XCODE_SUBDIR;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function runXcrunCommand(args) {</span>
<span class="cstat-no" title="statement not covered" >  var timeout = arguments.length &lt;= 1 || arguments[1] === undefined ? XCRUN_TIMEOUT : arguments[1];</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function runXcrunCommand$(context$1$0) {</span></span>
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _teen_process.exec)('xcrun', args, { timeout: timeout }));</span>
&nbsp;
      case 3:
...
<span class="cstat-no" title="statement not covered" >          context$1$0.t0.message = context$1$0.t0.message + ': ' + context$1$0.t0.stderr;</span>
        }
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >function getPathFromSymlink(failMessage) {</span>
<span class="cstat-no" title="statement not covered" >  var symlinkPath, legacySymlinkPath, xcodePath, customPath, mesg, msg;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function getPathFromSymlink$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
...
<span class="cstat-no" title="statement not covered" >        log.warn('Finding XcodePath by symlink because ' + failMessage);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        symlinkPath = "/var/db/xcode_select_link";</span>
<span class="cstat-no" title="statement not covered" >        legacySymlinkPath = "/usr/share/xcode-select/xcode_dir_link";</span>
<span class="cstat-no" title="statement not covered" >        xcodePath = null;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!_appiumSupport.util.hasContent(env.DEVELOPER_DIR)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 17;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        customPath = hasExpectedSubDir(env.DEVELOPER_DIR) ? env.DEVELOPER_DIR : env.DEVELOPER_DIR + XCODE_SUBDIR;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 8;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_appiumSupport.fs.exists(customPath));</span>
&nbsp;
      case 8:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        xcodePath = customPath;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 15;</span>
<span class="cstat-no" title="statement not covered" >        break;</span>
&nbsp;
      case 12:
<span class="cstat-no" title="statement not covered" >        mesg = 'Could not find path to Xcode, environment variable ' + ('DEVELOPER_DIR set to: ' + env.DEVELOPER_DIR + ' ') + 'but no Xcode found';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        log.warn(mesg);</span>
<span class="cstat-no" title="statement not covered" >        throw new Error(mesg);</span>
&nbsp;
      case 15:
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_appiumSupport.fs.exists(symlinkPath));</span>
&nbsp;
      case 19:
<span class="cstat-no" title="statement not covered" >        if (!context$1$0.sent) {</span>
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_appiumSupport.fs.readlink(symlinkPath));</span>
&nbsp;
      case 22:
<span class="cstat-no" title="statement not covered" >        xcodePath = context$1$0.sent;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 31;</span>
<span class="cstat-no" title="statement not covered" >        break;</span>
&nbsp;
      case 25:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 27;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_appiumSupport.fs.exists(legacySymlinkPath));</span>
&nbsp;
      case 27:
<span class="cstat-no" title="statement not covered" >        if (!context$1$0.sent) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 31;</span>
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_appiumSupport.fs.readlink(legacySymlinkPath));</span>
&nbsp;
      case 30:
<span class="cstat-no" title="statement not covered" >        xcodePath = context$1$0.sent;</span>
&nbsp;
      case 31:
<span class="cstat-no" title="statement not covered" >        if (!xcodePath) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 33;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', xcodePath.replace(new RegExp("/$"), "").trim());</span>
&nbsp;
      case 33:
<span class="cstat-no" title="statement not covered" >        msg = 'Could not find path to Xcode by symlinks located in ' + symlinkPath + ', or ' + legacySymlinkPath;</span>
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >function getPathFromXcodeSelect() {</span>
<span class="cstat-no" title="statement not covered" >  var timeout = arguments.length &lt;= 0 || arguments[0] === undefined ? XCRUN_TIMEOUT : arguments[0];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var _ref, stdout, xcodeFolderPath, msg;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function getPathFromXcodeSelect$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _teen_process.exec)('xcode-select', ['--print-path'], { timeout: timeout }));</span>
&nbsp;
      case 2:
...
<span class="cstat-no" title="statement not covered" >        xcodeFolderPath = stdout.replace(/\/$/, '').trim();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!_appiumSupport.util.hasContent(xcodeFolderPath)) {</span>
<span class="cstat-no" title="statement not covered" >          log.errorAndThrow('xcode-select returned an empty string');</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 8;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_appiumSupport.fs.exists(xcodeFolderPath));</span>
&nbsp;
      case 8:
<span class="cstat-no" title="statement not covered" >        if (!context$1$0.sent) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 12;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', xcodeFolderPath);</span>
&nbsp;
      case 12:
<span class="cstat-no" title="statement not covered" >        msg = 'xcode-select could not find xcode. Path \'' + xcodeFolderPath + '\' does not exist.';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        log.errorAndThrow(msg);</span>
&nbsp;
      case 14:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
var getPath = _lodash2['default'].memoize(<span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >  var timeout = arguments.length &lt;= 0 || arguments[0] === undefined ? XCRUN_TIMEOUT : arguments[0];</span>
&nbsp;
  // first we try using xcode-select to find the path
  // then we try using the symlinks that Apple has by default
<span class="cstat-no" title="statement not covered" >  return getPathFromXcodeSelect(timeout)['catch'](getPathFromSymlink);</span>
});
&nbsp;
<span class="fstat-no" title="function not covered" >function getVersionWithoutRetry() {</span>
<span class="cstat-no" title="statement not covered" >  var timeout = arguments.length &lt;= 0 || arguments[0] === undefined ? XCRUN_TIMEOUT : arguments[0];</span>
<span class="cstat-no" title="statement not covered" >  var xcodePath, plistPath, version, versionPattern, match;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function getVersionWithoutRetry$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(getPath(timeout));</span>
&nbsp;
      case 2:
<span class="cstat-no" title="statement not covered" >        xcodePath = context$1$0.sent;</span>
<span class="cstat-no" title="statement not covered" >        plistPath = _path2['default'].resolve(xcodePath, "..", "Info.plist");</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 6;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_appiumSupport.fs.exists(plistPath));</span>
&nbsp;
      case 6:
<span class="cstat-no" title="statement not covered" >        if (context$1$0.sent) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 8;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        throw new Error('Could not get Xcode version. ' + plistPath + ' does not exist on disk.');</span>
&nbsp;
      case 8:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 10;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_appiumSupport.plist.parsePlistFile(plistPath));</span>
&nbsp;
      case 10:
<span class="cstat-no" title="statement not covered" >        version = context$1$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        version = version.CFBundleShortVersionString;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        versionPattern = /\d\.\d\.*\d*/;</span>
<span class="cstat-no" title="statement not covered" >        match = version.match(versionPattern);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (match === null || !_appiumSupport.util.hasContent(match[0])) {</span>
<span class="cstat-no" title="statement not covered" >          log.errorAndThrow('Could not parse Xcode version. xcodebuild output was: ' + version);</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', match[0]);</span>
&nbsp;
      case 16:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
var getVersionMemoized = _lodash2['default'].memoize(<span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >  var retries = arguments.length &lt;= 0 || arguments[0] === undefined ? DEFAULT_NUMBER_OF_RETRIES : arguments[0];</span>
<span class="cstat-no" title="statement not covered" >  var timeout = arguments.length &lt;= 1 || arguments[1] === undefined ? XCRUN_TIMEOUT : arguments[1];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return (0, _asyncbox.retry)(retries, getVersionWithoutRetry, timeout);</span>
});
&nbsp;
<span class="fstat-no" title="function not covered" >function getVersion() {</span>
<span class="cstat-no" title="statement not covered" >  var parse = arguments.length &lt;= 0 || arguments[0] === undefined ? false : arguments[0];</span>
<span class="cstat-no" title="statement not covered" >  var retries = arguments.length &lt;= 1 || arguments[1] === undefined ? DEFAULT_NUMBER_OF_RETRIES : arguments[1];</span>
<span class="cstat-no" title="statement not covered" >  var timeout = arguments.length &lt;= 2 || arguments[2] === undefined ? XCRUN_TIMEOUT : arguments[2];</span>
<span class="cstat-no" title="statement not covered" >  var version, match;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function getVersion$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(getVersionMemoized(retries, timeout));</span>
&nbsp;
      case 2:
<span class="cstat-no" title="statement not covered" >        version = context$1$0.sent;</span>
&nbsp;
...
&nbsp;
      case 5:
<span class="cstat-no" title="statement not covered" >        match = /^(\d+)\.(\d+)(\.(\d+))?$/.exec(version);</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function getCommandLineToolsVersion() {</span>
<span class="cstat-no" title="statement not covered" >  var stdout, match;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function getCommandLineToolsVersion$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        stdout = undefined;</span>
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _teen_process.exec)('pkgutil', ['--pkg-info=com.apple.pkg.CLTools_Executables']));</span>
&nbsp;
      case 4:
<span class="cstat-no" title="statement not covered" >        stdout = context$1$0.sent.stdout;</span>
...
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 12;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _teen_process.exec)('pkgutil', ['--pkg-info=com.apple.pkg.DeveloperToolsCLI']));</span>
&nbsp;
      case 12:
<span class="cstat-no" title="statement not covered" >        stdout = context$1$0.sent.stdout;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 18;</span>
...
&nbsp;
      case 18:
<span class="cstat-no" title="statement not covered" >        match = /^version: (.+)$/m.exec(stdout);</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', match ? match[1] : undefined);</span>
&nbsp;
      case 20:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function getAutomationTraceTemplatePathWithoutRetry() {</span>
<span class="cstat-no" title="statement not covered" >  var timeout = arguments.length &lt;= 0 || arguments[0] === undefined ? XCRUN_TIMEOUT : arguments[0];</span>
<span class="cstat-no" title="statement not covered" >  var xcodePath, extensions, pathPrefix, pathSuffix, automationTraceTemplatePaths, msg;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function getAutomationTraceTemplatePathWithoutRetry$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(getPath(timeout));</span>
&nbsp;
      case 2:
<span class="cstat-no" title="statement not covered" >        xcodePath = context$1$0.sent;</span>
<span class="cstat-no" title="statement not covered" >        extensions = ['xrplugin', 'bundle'];</span>
<span class="cstat-no" title="statement not covered" >        pathPrefix = _path2['default'].resolve(xcodePath, "../Applications/Instruments.app/Contents/PlugIns");</span>
<span class="cstat-no" title="statement not covered" >        pathSuffix = "Contents/Resources/Automation.tracetemplate";</span>
<span class="cstat-no" title="statement not covered" >        automationTraceTemplatePaths = [_path2['default'].resolve(pathPrefix, 'AutomationInstrument.' + extensions[0], pathSuffix), _path2['default'].resolve(pathPrefix, 'AutomationInstrument.' + extensions[1], pathSuffix)];</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 9;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_appiumSupport.fs.exists(automationTraceTemplatePaths[0]));</span>
&nbsp;
      case 9:
<span class="cstat-no" title="statement not covered" >        if (!context$1$0.sent) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', automationTraceTemplatePaths[0]);</span>
&nbsp;
      case 11:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 13;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_appiumSupport.fs.exists(automationTraceTemplatePaths[1]));</span>
&nbsp;
      case 13:
<span class="cstat-no" title="statement not covered" >        if (!context$1$0.sent) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 15;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', automationTraceTemplatePaths[1]);</span>
&nbsp;
      case 15:
<span class="cstat-no" title="statement not covered" >        msg = "Could not find Automation.tracetemplate in any of the following" + ('locations ' + automationTraceTemplatePaths.toString());</span>
&nbsp;
...
&nbsp;
var getAutomationTraceTemplatePath = _lodash2['default'].memoize(<span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >  var retries = arguments.length &lt;= 0 || arguments[0] === undefined ? DEFAULT_NUMBER_OF_RETRIES : arguments[0];</span>
<span class="cstat-no" title="statement not covered" >  var timeout = arguments.length &lt;= 1 || arguments[1] === undefined ? XCRUN_TIMEOUT : arguments[1];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return (0, _asyncbox.retry)(retries, getAutomationTraceTemplatePathWithoutRetry, timeout);</span>
});
&nbsp;
<span class="fstat-no" title="function not covered" >function getMaxIOSSDKWithoutRetry() {</span>
<span class="cstat-no" title="statement not covered" >  var timeout = arguments.length &lt;= 0 || arguments[0] === undefined ? XCRUN_TIMEOUT : arguments[0];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var version, args, _ref2, stdout, sdkVersion, match;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function getMaxIOSSDKWithoutRetry$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(getVersion(false, DEFAULT_NUMBER_OF_RETRIES, timeout));</span>
&nbsp;
      case 2:
<span class="cstat-no" title="statement not covered" >        version = context$1$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!(version[0] === '4')) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 5;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', '6.1');</span>
&nbsp;
      case 5:
<span class="cstat-no" title="statement not covered" >        args = ['--sdk', 'iphonesimulator', '--show-sdk-version'];</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 8;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(runXcrunCommand(args, timeout));</span>
&nbsp;
      case 8:
...
<span class="cstat-no" title="statement not covered" >        sdkVersion = stdout.trim();</span>
<span class="cstat-no" title="statement not covered" >        match = /\d.\d/.exec(stdout);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        throw new Error('xcrun returned a non-numeric iOS SDK version: \'' + sdkVersion + '\'');</span>
&nbsp;
      case 14:
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', sdkVersion);</span>
&nbsp;
      case 15:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
var getMaxIOSSDK = _lodash2['default'].memoize(<span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >  var retries = arguments.length &lt;= 0 || arguments[0] === undefined ? DEFAULT_NUMBER_OF_RETRIES : arguments[0];</span>
<span class="cstat-no" title="statement not covered" >  var timeout = arguments.length &lt;= 1 || arguments[1] === undefined ? XCRUN_TIMEOUT : arguments[1];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return (0, _asyncbox.retry)(retries, getMaxIOSSDKWithoutRetry, timeout);</span>
});
&nbsp;
<span class="fstat-no" title="function not covered" >function getConnectedDevices() {</span>
<span class="cstat-no" title="statement not covered" >  var timeout = arguments.length &lt;= 0 || arguments[0] === undefined ? XCRUN_TIMEOUT : arguments[0];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var cmd, args, _ref3, stdout, plistContent, devicesFound, entriesToSearch, currentEntry, deviceInfo;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function getConnectedDevices$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        cmd = '/usr/sbin/system_profiler';</span>
<span class="cstat-no" title="statement not covered" >        args = ['-xml', 'SPUSBDataType'];</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 4;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _teen_process.exec)(cmd, args, { timeout: timeout }));</span>
&nbsp;
      case 4:
...
<span class="cstat-no" title="statement not covered" >        plistContent = (0, _plist.parse)(stdout);</span>
<span class="cstat-no" title="statement not covered" >        devicesFound = [];</span>
<span class="cstat-no" title="statement not covered" >        entriesToSearch = [plistContent[0]];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        while (entriesToSearch.length &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >          currentEntry = entriesToSearch.pop();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (currentEntry instanceof Array) {</span>
<span class="cstat-no" title="statement not covered" >            entriesToSearch = entriesToSearch.concat(currentEntry);</span>
          } else <span class="cstat-no" title="statement not covered" >if (currentEntry._name &amp;&amp; currentEntry._name.substring(0, 4) === "iPad" || currentEntry._name &amp;&amp; currentEntry._name.substring(0, 6) === "iPhone") {</span>
<span class="cstat-no" title="statement not covered" >            deviceInfo = {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            devicesFound.push(deviceInfo);</span>
          } else <span class="cstat-no" title="statement not covered" >if (currentEntry._items) {</span>
<span class="cstat-no" title="statement not covered" >            entriesToSearch = entriesToSearch.concat(currentEntry._items);</span>
          }
        }
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', devicesFound);</span>
&nbsp;
      case 11:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function getInstrumentsPathWithoutRetry() {</span>
<span class="cstat-no" title="statement not covered" >  var timeout = arguments.length &lt;= 0 || arguments[0] === undefined ? XCRUN_TIMEOUT : arguments[0];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var args, _ref4, stdout, instrumentsPath;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function getInstrumentsPathWithoutRetry$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        args = ['-find', 'instruments'];</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 3;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(runXcrunCommand(args, timeout));</span>
&nbsp;
      case 3:
<span class="cstat-no" title="statement not covered" >        _ref4 = context$1$0.sent;</span>
<span class="cstat-no" title="statement not covered" >        stdout = _ref4.stdout;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!stdout) {</span>
<span class="cstat-no" title="statement not covered" >          stdout = "";</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        instrumentsPath = stdout.trim();</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        throw new Error('Could not find path to instruments binary using \'xcrun ' + args.join(' ') + '\'');</span>
&nbsp;
      case 9:
...
&nbsp;
var getInstrumentsPath = _lodash2['default'].memoize(<span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >  var retries = arguments.length &lt;= 0 || arguments[0] === undefined ? DEFAULT_NUMBER_OF_RETRIES : arguments[0];</span>
<span class="cstat-no" title="statement not covered" >  var timeout = arguments.length &lt;= 1 || arguments[1] === undefined ? XCRUN_TIMEOUT : arguments[1];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return (0, _asyncbox.retry)(retries, getInstrumentsPathWithoutRetry, timeout);</span>
});
&nbsp;
<span class="fstat-no" title="function not covered" >function clearInternalCache() {</span>
&nbsp;
  // memoized functions
<span class="cstat-no" title="statement not covered" >  var memoized = [getPath, getVersionMemoized, getAutomationTraceTemplatePath, getMaxIOSSDK, getInstrumentsPath];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  memoized.forEach(<span class="fstat-no" title="function not covered" >function (f) {</span></span>
<span class="cstat-no" title="statement not covered" >    if (f.cache) {</span>
<span class="cstat-no" title="statement not covered" >      f.cache = new _lodash2['default'].memoize.Cache();</span>
    }
  });
}
&nbsp;
