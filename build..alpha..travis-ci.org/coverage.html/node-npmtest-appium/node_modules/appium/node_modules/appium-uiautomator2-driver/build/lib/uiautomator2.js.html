...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-uiautomator2-driver/build/lib/uiautomator2.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-uiautomator2-driver/build/lib/uiautomator2.js</span></h1>
    <h2>
        
        Statements: <span class="metric">10.36% <small>(23 / 222)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">10.95% <small>(23 / 210)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-uiautomator2-driver/build/lib/</a> &#187; uiautomator2.js</div>
</div>
<div class="body">
...
<span class="fstat-no" title="function not covered" >  function UiAutomator2Server() {</span>
<span class="cstat-no" title="statement not covered" >    var opts = arguments.length &lt;= 0 || arguments[0] === undefined ? {} : arguments[0];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, UiAutomator2Server);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      for (var _iterator = _getIterator(REQD_PARAMS), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {</span>
<span class="cstat-no" title="statement not covered" >        var req = _step.value;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!opts || !opts[req]) {</span>
<span class="cstat-no" title="statement not covered" >          throw new Error('Option \'' + req + '\' is required!');</span>
        }
<span class="cstat-no" title="statement not covered" >        this[req] = opts[req];</span>
      }
    } catch (err) {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.jwproxy = new _appiumBaseDriver.JWProxy({ host: this.host, port: this.systemPort });</span>
...
&nbsp;
  _createClass(UiAutomator2Server, [{
    ...
    value: <span class="fstat-no" title="function not covered" >function installServerApk() {</span>
<span class="cstat-no" title="statement not covered" >      var apkPackage, testApkPackage, isApkInstalled, isTestApkInstalled, apkVersion, pkgVersion;</span>
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function installServerApk$(context$2$0) {</span></span>
...
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.getPackageName(_installer.UI2_SERVER_APK_PATH));</span>
&nbsp;
          case 2:
<span class="cstat-no" title="statement not covered" >            apkPackage = context$2$0.sent;</span>
<span class="cstat-no" title="statement not covered" >            testApkPackage = apkPackage + '.test';</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 6;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.adb.isAppInstalled(apkPackage));</span>
&nbsp;
          case 6:
<span class="cstat-no" title="statement not covered" >            isApkInstalled = context$2$0.sent;</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 9;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.adb.isAppInstalled(testApkPackage));</span>
&nbsp;
          case 9:
<span class="cstat-no" title="statement not covered" >            isTestApkInstalled = context$2$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (!(isApkInstalled || isTestApkInstalled)) {</span>
...
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.getAPKVersion(_installer.UI2_SERVER_APK_PATH));</span>
&nbsp;
          case 13:
<span class="cstat-no" title="statement not covered" >            apkVersion = context$2$0.sent;</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 16;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.getInstalledPackageVersion(apkPackage));</span>
&nbsp;
          case 16:
<span class="cstat-no" title="statement not covered" >            pkgVersion = context$2$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (!(apkVersion !== pkgVersion)) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 24;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            isApkInstalled = false;</span>
<span class="cstat-no" title="statement not covered" >            isTestApkInstalled = false;</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 22;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.adb.uninstallApk(apkPackage));</span>
&nbsp;
          case 22:
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 24;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.adb.uninstallApk(testApkPackage));</span>
&nbsp;
          case 24:
<span class="cstat-no" title="statement not covered" >            if (isApkInstalled) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 27;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 27;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.signAndInstall(_installer.UI2_SERVER_APK_PATH, apkPackage));</span>
&nbsp;
          case 27:
<span class="cstat-no" title="statement not covered" >            if (isTestApkInstalled) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 30;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 30;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.signAndInstall(_installer.UI2_TEST_APK_PATH, testApkPackage));</span>
&nbsp;
          case 30:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    key: 'signAndInstall',
    value: <span class="fstat-no" title="function not covered" >function signAndInstall(apk, apkPackage) {</span>
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function signAndInstall$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.checkAndSignCert(apk, apkPackage));</span>
&nbsp;
          case 2:
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 4;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.adb.install(apk));</span>
&nbsp;
          case 4:
<span class="cstat-no" title="statement not covered" >            _logger2['default'].info("Installed UiAutomator2 server apk");</span>
&nbsp;
          case 5:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    key: 'getPackageName',
    value: <span class="fstat-no" title="function not covered" >function getPackageName(apk) {</span>
<span class="cstat-no" title="statement not covered" >      var args, _ref, stdout, apkPackage;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function getPackageName$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
...
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.adb.initAapt());</span>
&nbsp;
          case 3:
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 5;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap((0, _teen_process.exec)(this.adb.binaries.aapt, args));</span>
&nbsp;
          case 5:
...
<span class="cstat-no" title="statement not covered" >            return context$2$0.abrupt('return', apkPackage);</span>
&nbsp;
          case 10:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    key: 'getAPKVersion',
    value: <span class="fstat-no" title="function not covered" >function getAPKVersion(apk) {</span>
<span class="cstat-no" title="statement not covered" >      var args, _ref2, stdout, apkVersion;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function getAPKVersion$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            args = ['dump', 'badging', apk];</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 3;</span>
...
<span class="cstat-no" title="statement not covered" >            apkVersion = new RegExp(/versionName='([^']+)'/g).exec(stdout);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (apkVersion &amp;&amp; apkVersion.length &gt;= 2) {</span>
<span class="cstat-no" title="statement not covered" >              apkVersion = apkVersion[1];</span>
            } else {
<span class="cstat-no" title="statement not covered" >              apkVersion = null;</span>
            }
<span class="cstat-no" title="statement not covered" >            return context$2$0.abrupt('return', apkVersion.toString());</span>
&nbsp;
          case 10:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    value: <span class="fstat-no" title="function not covered" >function getInstalledPackageVersion(pkg) {</span>
<span class="cstat-no" title="statement not covered" >      var stdout, pkgVersion;</span>
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function getInstalledPackageVersion$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.adb.shell(['dumpsys', 'package', pkg]));</span>
&nbsp;
          case 2:
<span class="cstat-no" title="statement not covered" >            stdout = context$2$0.sent;</span>
<span class="cstat-no" title="statement not covered" >            pkgVersion = new RegExp(/versionName=([^\s\s]+)/g).exec(stdout);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (pkgVersion &amp;&amp; pkgVersion.length &gt;= 2) {</span>
<span class="cstat-no" title="statement not covered" >              pkgVersion = pkgVersion[1];</span>
            } else {
<span class="cstat-no" title="statement not covered" >              pkgVersion = null;</span>
            }
<span class="cstat-no" title="statement not covered" >            return context$2$0.abrupt('return', pkgVersion.toString());</span>
&nbsp;
          case 6:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    value: <span class="fstat-no" title="function not covered" >function checkAndSignCert(apk, apkPackage) {</span>
<span class="cstat-no" title="statement not covered" >      var signed;</span>
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function checkAndSignCert$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.adb.checkApkCert(apk, apkPackage));</span>
&nbsp;
          case 2:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 6;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.adb.sign(apk));</span>
&nbsp;
          case 6:
<span class="cstat-no" title="statement not covered" >            return context$2$0.abrupt('return', !signed);</span>
&nbsp;
          case 7:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    key: 'startSession',
    value: <span class="fstat-no" title="function not covered" >function startSession(caps) {</span>
...
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            cmd = ['am', 'instrument', '-w', 'io.appium.uiautomator2.server.test/android.support.test.runner.AndroidJUnitRunner'];</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 3;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.killUiAutomatorOnDevice());</span>
&nbsp;
          case 3:
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].info('Starting uiautomator2 server ' + _installer.UI2_VER + ' with cmd: ' + ('' + cmd));</span>
            //this.adb.shell(cmd);
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (caps.deviceUDID) {</span>
<span class="cstat-no" title="statement not covered" >              this.startSessionOnSpecificDeviceUsingAdbKit(caps.deviceUDID);</span>
            } else {
<span class="cstat-no" title="statement not covered" >              this.startSessionUsingAdbkit();</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].info('Waiting for UiAutomator2 to be online...');</span>
            // wait 20s for UiAutomator2 to be online
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 8;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap((0, _asyncbox.retryInterval)(20, 1000, <span class="fstat-no" title="function not covered" >function callee$2$0() {</span></span>
...
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.jwproxy.command('/session', 'POST', { desiredCapabilities: caps }));</span>
&nbsp;
          case 10:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    value: <span class="fstat-no" title="function not covered" >function startSessionOnSpecificDeviceUsingAdbKit(deviceUDID) {</span>
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function startSessionOnSpecificDeviceUsingAdbKit$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            _bluebird2['default']['try'](<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >              _logger2['default'].info('running command...\n adb -s ' + deviceUDID + ' shell am instrument -w io.appium.uiautomator2.server.test/android.support.test.runner.AndroidJUnitRunner... ');</span>
<span class="cstat-no" title="statement not covered" >              client.shell(deviceUDID, "am instrument -w io.appium.uiautomator2.server.test/android.support.test.runner.AndroidJUnitRunner");</span>
            })['catch'](<span class="fstat-no" title="function not covered" >function (err) {</span>
<span class="cstat-no" title="statement not covered" >              _logger2['default'].error('Something went wrong while executing instrument test:', err.stack);</span>
            });
&nbsp;
          case 1:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    value: <span class="fstat-no" title="function not covered" >function startSessionUsingAdbkit() {</span>
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function startSessionUsingAdbkit$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            client.listDevices().then(<span class="fstat-no" title="function not covered" >function (devices) {</span></span>
<span class="cstat-no" title="statement not covered" >              _bluebird2['default'].map(devices, <span class="fstat-no" title="function not covered" >function (device) {</span></span>
<span class="cstat-no" title="statement not covered" >                _logger2['default'].info("running command...\n adb shell am instrument -w io.appium.uiautomator2.server.test/android.support.test.runner.AndroidJUnitRunner... ");</span>
<span class="cstat-no" title="statement not covered" >                client.shell(device.id, "am instrument -w io.appium.uiautomator2.server.test/android.support.test.runner.AndroidJUnitRunner");</span>
              });
            })['catch'](<span class="fstat-no" title="function not covered" >function (err) {</span>
<span class="cstat-no" title="statement not covered" >              _logger2['default'].error('Something went wrong while executing instrument test:', err.stack);</span>
            });
...
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Deleting UiAutomator2 server session');</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].warn('Did not get confirmation UiAutomator2 deleteSession worked; ' + ('Error was: ' + context$2$0.t0));</span>
&nbsp;
          case 9:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    value: <span class="fstat-no" title="function not covered" >function killUiAutomatorOnDevice() {</span>
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function killUiAutomatorOnDevice$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            context$2$0.prev = 0;</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 3;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.adb.forceStop('io.appium.uiautomator2.server'));</span>
&nbsp;
          case 3:
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 8;</span>
<span class="cstat-no" title="statement not covered" >            break;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].info("Unable to kill the io.appium.uiautomator2.server process, assuming it is already killed");</span>
&nbsp;
          case 8:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
