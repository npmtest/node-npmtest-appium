...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-xcuitest-driver/build/lib/commands/find.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-xcuitest-driver/build/lib/commands/find.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-xcuitest-driver/build/lib/commands/</a> &#187; find.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.findNativeElementOrElements(strategy, selector, mult, context));</span>
&nbsp;
      case 8:
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', context$1$0.sent);</span>
&nbsp;
...
&nbsp;
helpers.findNativeElementOrElements = <span class="fstat-no" title="function not covered" >function callee$0$0(strategy, selector, mult, context) {</span>
<span class="cstat-no" title="statement not covered" >  var initSelector, rewroteSelector, stripViewFromSelector, endpoint, body, method, els;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    var _this = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        stripViewFromSelector = <span class="fstat-no" title="function not covered" >function stripViewFromSelector(selector) {</span></span>
...
<span class="cstat-no" title="statement not covered" >          var keepView = ['XCUIElementTypeScrollView', 'XCUIElementTypeCollectionView', 'XCUIElementTypeTextView', 'XCUIElementTypeWebView'].indexOf(selector) &gt;= 0;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (!keepView &amp;&amp; selector.indexOf('View') === selector.length - 4) {</span>
<span class="cstat-no" title="statement not covered" >            return selector.substr(0, selector.length - 4);</span>
          } else {
<span class="cstat-no" title="statement not covered" >            return selector;</span>
          }
        };
&nbsp;
<span class="cstat-no" title="statement not covered" >        initSelector = selector;</span>
<span class="cstat-no" title="statement not covered" >        rewroteSelector = false;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (strategy === '-ios predicate string') {</span>
          // WebDriverAgent uses 'predicate string'
<span class="cstat-no" title="statement not covered" >          strategy = 'predicate string';</span>
        } else <span class="cstat-no" title="statement not covered" >if (strategy === '-ios class chain') {</span>
          // WebDriverAgent uses 'class chain'
<span class="cstat-no" title="statement not covered" >          strategy = 'class chain';</span>
        }
&nbsp;
        // Check if the word 'View' is appended to selector and if it is, strip it out
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (strategy === 'class name') {</span>
          // XCUITest classes have `XCUIElementType` prepended
          // first check if there is the old `UIA` prefix
<span class="cstat-no" title="statement not covered" >          if (selector.indexOf('UIA') === 0) {</span>
<span class="cstat-no" title="statement not covered" >            selector = selector.substring(3);</span>
          }
          // now check if we need to add `XCUIElementType`
<span class="cstat-no" title="statement not covered" >          if (selector.indexOf('XCUIElementType') !== 0) {</span>
<span class="cstat-no" title="statement not covered" >            selector = stripViewFromSelector('XCUIElementType' + selector);</span>
<span class="cstat-no" title="statement not covered" >            rewroteSelector = true;</span>
          }
        }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >          selector = selector.replace(/(^|\/)(UIA)([^\[\/]+)/g, <span class="fstat-no" title="function not covered" >function (str, g1, g2, g3) {</span></span>
<span class="cstat-no" title="statement not covered" >            rewroteSelector = true;</span>
<span class="cstat-no" title="statement not covered" >            return g1 + stripViewFromSelector('XCUIElementType' + g3);</span>
          });
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (rewroteSelector) {</span>
<span class="cstat-no" title="statement not covered" >          _logger2['default'].info('Rewrote incoming selector from \'' + initSelector + '\' to ' + ('\'' + selector + '\' to match XCUI type. You should consider ') + 'updating your tests to use the new selectors directly');</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        context = _appiumSupport.util.unwrapElement(context);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        endpoint = undefined;</span>
&nbsp;
        /* jshint ignore:start */
<span class="cstat-no" title="statement not covered" >        endpoint = '/element' + (context ? '/' + context + '/element' : '') + (mult ? 's' : '');</span>
        /* jshint ignore:end */
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        els = undefined;</span>
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.implicitWaitForCondition(<span class="fstat-no" title="function not covered" >function callee$1$0() {</span></span>
...
<span class="cstat-no" title="statement not covered" >                return _regeneratorRuntime.awrap(this.proxyCommand(endpoint, method, body));</span>
&nbsp;
              case 3:
<span class="cstat-no" title="statement not covered" >                els = context$2$0.sent;</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                return context$2$0.abrupt('return', els &amp;&amp; els.length);</span>
&nbsp;
              case 8:
<span class="cstat-no" title="statement not covered" >                return context$2$0.abrupt('return', !els.status || els.status === 0);</span>
&nbsp;
              case 9:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', els);</span>
&nbsp;
      case 29:
<span class="cstat-no" title="statement not covered" >        if (!(!els || _lodash2['default'].size(els) === 0)) {</span>
