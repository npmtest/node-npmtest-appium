...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-xcuitest-driver/build/lib/webdriveragent.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-xcuitest-driver/build/lib/webdriveragent.js</span></h1>
    <h2>
        
        Statements: <span class="metric">8% <small>(42 / 525)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">8.2% <small>(42 / 512)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-xcuitest-driver/build/lib/</a> &#187; webdriveragent.js</div>
</div>
<div class="body">
...
1043
1044
1045</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function WebDriverAgent(xcodeVersion) {</span>
<span class="cstat-no" title="statement not covered" >    var args = arguments.length &lt;= 1 || arguments[1] === undefined ? {} : arguments[1];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, WebDriverAgent);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.xcodeVersion = xcodeVersion;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.device = args.device;</span>
<span class="cstat-no" title="statement not covered" >    this.platformVersion = args.platformVersion;</span>
<span class="cstat-no" title="statement not covered" >    this.host = args.host;</span>
<span class="cstat-no" title="statement not covered" >    this.realDevice = !!args.realDevice;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.setWDAPaths(args.bootstrapPath, args.agentPath);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.wdaLocalPort = args.wdaLocalPort;</span>
<span class="cstat-no" title="statement not covered" >    this.showXcodeLog = !!args.showXcodeLog;</span>
<span class="cstat-no" title="statement not covered" >    this.xcodeConfigFile = args.xcodeConfigFile;</span>
<span class="cstat-no" title="statement not covered" >    this.xcodeOrgId = args.xcodeOrgId;</span>
<span class="cstat-no" title="statement not covered" >    this.xcodeSigningId = args.xcodeSigningId || DEFAULT_SIGNING_ID;</span>
<span class="cstat-no" title="statement not covered" >    this.keychainPath = args.keychainPath;</span>
<span class="cstat-no" title="statement not covered" >    this.keychainPassword = args.keychainPassword;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.prebuildWDA = args.prebuildWDA;</span>
<span class="cstat-no" title="statement not covered" >    this.usePrebuiltWDA = args.usePrebuiltWDA;</span>
<span class="cstat-no" title="statement not covered" >    this.useSimpleBuildTest = args.useSimpleBuildTest;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.webDriverAgentUrl = args.webDriverAgentUrl;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.updatedWDABundleId = args.updatedWDABundleId;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.expectIProxyErrors = true;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.wdaLaunchTimeout = args.wdaLaunchTimeout || WDA_LAUNCH_TIMEOUT;</span>
<span class="cstat-no" title="statement not covered" >    this.wdaConnectionTimeout = args.wdaConnectionTimeout;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.useCarthageSsl = _lodash2['default'].isBoolean(args.useCarthageSsl) &amp;&amp; args.useCarthageSsl;</span>
  }
&nbsp;
  _createClass(WebDriverAgent, [{
    key: 'setWDAPaths',
    value: <span class="fstat-no" title="function not covered" >function setWDAPaths(bootstrapPath, agentPath) {</span>
...
<span class="cstat-no" title="statement not covered" >      this.bootstrapPath = bootstrapPath || BOOTSTRAP_PATH;</span>
<span class="cstat-no" title="statement not covered" >      _logger2['default'].info('Using WDA path: \'' + this.bootstrapPath + '\'');</span>
&nbsp;
      // for backward compatibility we need to be able to specify agentPath too
<span class="cstat-no" title="statement not covered" >      this.agentPath = agentPath || _path2['default'].resolve(this.bootstrapPath, 'WebDriverAgent.xcodeproj');</span>
<span class="cstat-no" title="statement not covered" >      _logger2['default'].info('Using WDA agent: \'' + this.agentPath + '\'');</span>
    }
  }, {
    key: 'uninstall',
    value: <span class="fstat-no" title="function not covered" >function uninstall() {</span>
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function uninstall$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Removing WDA application from device');</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 3;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.device.removeApp(WDA_BUNDLE_ID));</span>
&nbsp;
          case 3:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    key: 'launch',
    value: <span class="fstat-no" title="function not covered" >function launch(sessionId) {</span>
...
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            if (!this.webDriverAgentUrl) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 5;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].info('Using provided WebdriverAgent at \'' + this.webDriverAgentUrl + '\'');</span>
<span class="cstat-no" title="statement not covered" >            this.url = this.webDriverAgentUrl;</span>
<span class="cstat-no" title="statement not covered" >            this.setupProxies(sessionId);</span>
<span class="cstat-no" title="statement not covered" >            return context$2$0.abrupt('return', this.webDriverAgentUrl);</span>
&nbsp;
          case 5:
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].info('Launching WebDriverAgent on the device');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            this.setupProxies(sessionId);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 9;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(_appiumSupport.fs.exists(this.agentPath));</span>
&nbsp;
          case 9:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            throw new Error('Trying to use WebDriverAgent project at \'' + this.agentPath + '\' but the ' + 'file does not exist');</span>
&nbsp;
          case 11:
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 13;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap((0, _webdriveragentUtils.checkForDependencies)(this.bootstrapPath, this.useCarthageSsl));</span>
&nbsp;
          case 13:
<span class="cstat-no" title="statement not covered" >            if (!(this.realDevice &amp;&amp; this.updatedWDABundleId)) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 16;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 16;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap((0, _webdriveragentUtils.updateProjectFile)(this.agentPath, this.updatedWDABundleId));</span>
&nbsp;
          case 16:
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 18;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.killHangingProcesses());</span>
&nbsp;
          case 18:
<span class="cstat-no" title="statement not covered" >            if (!(this.xcodeVersion.major === 7 || this.xcodeVersion.major === 8 &amp;&amp; this.xcodeVersion.minor === 0)) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 22;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Using Xcode ' + this.xcodeVersion.versionString + ', so fixing WDA codebase');</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 22;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap((0, _webdriveragentUtils.fixForXcode7)(this.bootstrapPath, true));</span>
&nbsp;
          case 22:
<span class="cstat-no" title="statement not covered" >            if (!this.prebuildWDA) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 37;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (!(this.xcodeVersion.major === 7)) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 27;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Capability \'prebuildWDA\' set, but on xcode version ' + this.xcodeVersion.versionString + ' so skipping');</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 37;</span>
<span class="cstat-no" title="statement not covered" >            break;</span>
&nbsp;
          case 27:
            // first do a build phase
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Pre-building WDA before launching test');</span>
<span class="cstat-no" title="statement not covered" >            this.usePrebuiltWDA = true;</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 31;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.createXcodeBuildSubProcess(true));</span>
&nbsp;
          case 31:
<span class="cstat-no" title="statement not covered" >            this.xcodebuild = context$2$0.sent;</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 34;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.startXcodebuild(true));</span>
&nbsp;
          case 34:
<span class="cstat-no" title="statement not covered" >            this.xcodebuild = null;</span>
            // pause a moment
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 37;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(_bluebird2['default'].delay(BUILD_TEST_DELAY));</span>
&nbsp;
          case 37:
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 39;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.createXcodeBuildSubProcess());</span>
&nbsp;
          case 39:
<span class="cstat-no" title="statement not covered" >            this.xcodebuild = context$2$0.sent;</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            this.iproxy = this.createiProxySubProcess(this.url.port, WDA_AGENT_PORT);</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 44;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.startiproxy());</span>
&nbsp;
          case 44:
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 46;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.startXcodebuild());</span>
&nbsp;
          case 46:
...
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    key: 'setupProxies',
    value: <span class="fstat-no" title="function not covered" >function setupProxies(sessionId) {</span>
<span class="cstat-no" title="statement not covered" >      var proxyOpts = {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.jwproxy = new _appiumBaseDriver.JWProxy(proxyOpts);</span>
<span class="cstat-no" title="statement not covered" >      this.jwproxy.sessionId = sessionId;</span>
<span class="cstat-no" title="statement not covered" >      this.proxyReqRes = this.jwproxy.proxyReqRes.bind(this.jwproxy);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.noSessionProxy = new _noSessionProxy.NoSessionProxy(proxyOpts);</span>
<span class="cstat-no" title="statement not covered" >      this.noSessionProxyReqRes = this.noSessionProxy.proxyReqRes.bind(this.noSessionProxy);</span>
    }
  }, {
    key: 'getXcodeBuildCommand',
    value: <span class="fstat-no" title="function not covered" >function getXcodeBuildCommand() {</span>
<span class="cstat-no" title="statement not covered" >      var _args;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var buildOnly = arguments.length &lt;= 0 || arguments[0] === undefined ? false : arguments[0];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var cmd = 'xcodebuild';</span>
...
<span class="cstat-no" title="statement not covered" >        if (this.usePrebuiltWDA) {</span>
<span class="cstat-no" title="statement not covered" >          var msg = '\'usePrebuiltWDA\' set, but on Xcode ' + ('\'' + this.xcodeVersion.versionString + '\', so skipping, as it ') + 'needs a version &gt;= 8';</span>
<span class="cstat-no" title="statement not covered" >          _logger2['default'].warn(msg);</span>
        }
<span class="cstat-no" title="statement not covered" >        args = ['build', 'test'];</span>
      } else {
<span class="cstat-no" title="statement not covered" >        var _ref = this.useSimpleBuildTest ? ['build', 'test'] : ['build-for-testing', 'test-without-building'];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        var _ref2 = _slicedToArray(_ref, 2);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        var buildCmd = _ref2[0];</span>
<span class="cstat-no" title="statement not covered" >        var testCmd = _ref2[1];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (buildOnly) {</span>
<span class="cstat-no" title="statement not covered" >          args = [buildCmd];</span>
        } else <span class="cstat-no" title="statement not covered" >if (this.usePrebuiltWDA) {</span>
<span class="cstat-no" title="statement not covered" >          args = [testCmd];</span>
        } else {
<span class="cstat-no" title="statement not covered" >          args = [buildCmd, testCmd];</span>
        }
      }
&nbsp;
      // add the rest of the arguments for the xcodebuild command
<span class="cstat-no" title="statement not covered" >      var genericArgs = ['-project', this.agentPath, '-scheme', 'WebDriverAgentRunner', '-destination', 'id=' + this.device.udid, '-configuration', 'Debug'];</span>
<span class="cstat-no" title="statement not covered" >      (_args = args).push.apply(_args, genericArgs);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var versionMatch = new RegExp(/^(\d+)\.(\d+)/).exec(this.platformVersion);</span>
<span class="cstat-no" title="statement not covered" >      if (versionMatch) {</span>
<span class="cstat-no" title="statement not covered" >        args.push('IPHONEOS_DEPLOYMENT_TARGET=' + versionMatch[1] + '.' + versionMatch[2]);</span>
      } else {
<span class="cstat-no" title="statement not covered" >        _logger2['default'].warn('Cannot parse major and minor version numbers from platformVersion "' + this.platformVersion + '". ' + 'Will build for the default platform instead');</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (this.realDevice &amp;&amp; this.xcodeConfigFile) {</span>
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Using Xcode configuration file: \'' + this.xcodeConfigFile + '\'');</span>
<span class="cstat-no" title="statement not covered" >        args.push('-xcconfig', this.xcodeConfigFile);</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      return { cmd: cmd, args: args };</span>
    }
  }, {
    key: 'createXcodeBuildSubProcess',
    value: <span class="fstat-no" title="function not covered" >function createXcodeBuildSubProcess() {</span>
<span class="cstat-no" title="statement not covered" >      var buildOnly = arguments.length &lt;= 0 || arguments[0] === undefined ? false : arguments[0];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var _getXcodeBuildCommand, cmd, args, xcodebuild, logXcodeOutput;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function createXcodeBuildSubProcess$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            if (!this.realDevice) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (!(this.keychainPath &amp;&amp; this.keychainPassword)) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 4;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 4;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap((0, _webdriveragentUtils.setRealDeviceSecurity)(this.keychainPath, this.keychainPassword));</span>
&nbsp;
          case 4:
<span class="cstat-no" title="statement not covered" >            if (!(this.xcodeOrgId &amp;&amp; this.xcodeSigningId &amp;&amp; !this.xcodeConfigFile)) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 8;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 7;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap((0, _utilsJs.generateXcodeConfigFile)(this.xcodeOrgId, this.xcodeSigningId));</span>
&nbsp;
          case 7:
<span class="cstat-no" title="statement not covered" >            this.xcodeConfigFile = context$2$0.sent;</span>
&nbsp;
          case 8:
<span class="cstat-no" title="statement not covered" >            _getXcodeBuildCommand = this.getXcodeBuildCommand(buildOnly);</span>
<span class="cstat-no" title="statement not covered" >            cmd = _getXcodeBuildCommand.cmd;</span>
<span class="cstat-no" title="statement not covered" >            args = _getXcodeBuildCommand.args;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Beginning ' + (buildOnly ? 'build' : 'test') + ' with command \'' + cmd + ' ' + args.join(' ') + '\' ' + ('in directory \'' + this.bootstrapPath + '\''));</span>
<span class="cstat-no" title="statement not covered" >            xcodebuild = new _teen_process.SubProcess(cmd, args, { cwd: this.bootstrapPath });</span>
<span class="cstat-no" title="statement not covered" >            logXcodeOutput = this.showXcodeLog;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Output from xcodebuild ' + (logXcodeOutput ? 'will' : 'will not') + ' be logged');</span>
<span class="cstat-no" title="statement not covered" >            xcodebuild.on('output', <span class="fstat-no" title="function not covered" >function (stdout, stderr) {</span></span>
<span class="cstat-no" title="statement not covered" >              var out = stdout || stderr;</span>
              // we want to pull out the log file that is created, and highlight it
              // for diagnostic purposes
<span class="cstat-no" title="statement not covered" >              if (out.indexOf('Writing diagnostic log for test session to') !== -1) {</span>
                // pull out the first line that begins with the path separator
                // which *should* be the line indicating the log file generated
<span class="cstat-no" title="statement not covered" >                xcodebuild.logLocation = _lodash2['default'].first(_lodash2['default'].remove(out.trim().split('\n'), <span class="fstat-no" title="function not covered" >function (v) {</span></span>
<span class="cstat-no" title="statement not covered" >                  return v.indexOf(_path2['default'].sep) === 0;</span>
                }));
<span class="cstat-no" title="statement not covered" >                _logger2['default'].debug('Log file for xcodebuild test: ' + xcodebuild.logLocation);</span>
              }
&nbsp;
              // if we have an error we want to output the logs
              // otherwise the failure is inscrutible
              // but do not log permission errors from trying to write to attachments folder
<span class="cstat-no" title="statement not covered" >              if (out.indexOf('Error Domain=') !== -1 &amp;&amp; out.indexOf('Error writing attachment data to file') === -1) {</span>
<span class="cstat-no" title="statement not covered" >                logXcodeOutput = true;</span>
&nbsp;
                // terrible hack to handle case where xcode return 0 but is failing
<span class="cstat-no" title="statement not covered" >                xcodebuild._wda_error_occurred = true;</span>
              }
&nbsp;
<span class="cstat-no" title="statement not covered" >              if (logXcodeOutput) {</span>
                // do not log permission errors from trying to write to attachments folder
<span class="cstat-no" title="statement not covered" >                if (out.indexOf('Error writing attachment data to file') === -1) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            return context$2$0.abrupt('return', xcodebuild);</span>
&nbsp;
          case 17:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    value: <span class="fstat-no" title="function not covered" >function createiProxySubProcess(localport, deviceport) {</span>
<span class="cstat-no" title="statement not covered" >      _logger2['default'].debug('Starting iproxy to forward traffic from local port ' + localport + ' to device port ' + deviceport + ' over USB');</span>
<span class="cstat-no" title="statement not covered" >      return new _teen_process.SubProcess('iproxy', [localport, deviceport, this.device.udid]);</span>
    }
  }, {
    key: 'startXcodebuild',
    value: <span class="fstat-no" title="function not covered" >function startXcodebuild() {</span>
<span class="cstat-no" title="statement not covered" >      var buildOnly = arguments.length &lt;= 0 || arguments[0] === undefined ? false : arguments[0];</span>
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function startXcodebuild$(context$2$0) {</span></span>
...
<span class="cstat-no" title="statement not covered" >              _this.xcodebuild.on('exit', <span class="fstat-no" title="function not covered" >function callee$3$0(code, signal) {</span></span>
<span class="cstat-no" title="statement not covered" >                var data, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, line;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                  while (1) <span class="cstat-no" title="statement not covered" >switch (context$4$0.prev = context$4$0.next) {</span></span>
                    case 0:
<span class="cstat-no" title="statement not covered" >                      _logger2['default'].info('xcodebuild exited with code \'' + code + '\' and signal \'' + signal + '\'');</span>
                      // print out the xcodebuild file if users have asked for it
&nbsp;
<span class="cstat-no" title="statement not covered" >                      if (!(this.showXcodeLog &amp;&amp; this.xcodebuild.logLocation)) {</span>
<span class="cstat-no" title="statement not covered" >                        context$4$0.next = 31;</span>
<span class="cstat-no" title="statement not covered" >                        break;</span>
                      }
&nbsp;
<span class="cstat-no" title="statement not covered" >                      xcodeLog.info('Contents of xcodebuild log file \'' + this.xcodebuild.logLocation + '\':');</span>
<span class="cstat-no" title="statement not covered" >                      context$4$0.prev = 3;</span>
<span class="cstat-no" title="statement not covered" >                      context$4$0.next = 6;</span>
<span class="cstat-no" title="statement not covered" >                      return _regeneratorRuntime.awrap(_appiumSupport.fs.readFile(this.xcodebuild.logLocation, 'utf-8'));</span>
&nbsp;
                    case 6:
<span class="cstat-no" title="statement not covered" >                      data = context$4$0.sent;</span>
...
<span class="cstat-no" title="statement not covered" >                      context$4$0.prev = 10;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                      for (_iterator2 = _getIterator(data.split('\n')); !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {</span>
<span class="cstat-no" title="statement not covered" >                        line = _step2.value;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                        xcodeLog.info(line);</span>
                      }
<span class="cstat-no" title="statement not covered" >                      context$4$0.next = 18;</span>
<span class="cstat-no" title="statement not covered" >                      break;</span>
&nbsp;
                    case 14:
<span class="cstat-no" title="statement not covered" >                      context$4$0.prev = 14;</span>
<span class="cstat-no" title="statement not covered" >                      context$4$0.t0 = context$4$0['catch'](10);</span>
<span class="cstat-no" title="statement not covered" >                      _didIteratorError2 = true;</span>
<span class="cstat-no" title="statement not covered" >                      _iteratorError2 = context$4$0.t0;</span>
&nbsp;
                    case 18:
<span class="cstat-no" title="statement not covered" >                      context$4$0.prev = 18;</span>
<span class="cstat-no" title="statement not covered" >                      context$4$0.prev = 19;</span>
&nbsp;
...
&nbsp;
                    case 21:
<span class="cstat-no" title="statement not covered" >                      context$4$0.prev = 21;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                      if (!_didIteratorError2) {</span>
<span class="cstat-no" title="statement not covered" >                        context$4$0.next = 24;</span>
<span class="cstat-no" title="statement not covered" >                        break;</span>
                      }
&nbsp;
...
&nbsp;
                    case 24:
<span class="cstat-no" title="statement not covered" >                      return context$4$0.finish(21);</span>
&nbsp;
                    case 25:
<span class="cstat-no" title="statement not covered" >                      return context$4$0.finish(18);</span>
&nbsp;
                    case 26:
<span class="cstat-no" title="statement not covered" >                      context$4$0.next = 31;</span>
<span class="cstat-no" title="statement not covered" >                      break;</span>
&nbsp;
                    case 28:
<span class="cstat-no" title="statement not covered" >                      context$4$0.prev = 28;</span>
<span class="cstat-no" title="statement not covered" >                      context$4$0.t1 = context$4$0['catch'](3);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                      _logger2['default'].debug('Unable to access xcodebuild log file: \'' + context$4$0.t1.message + '\'');</span>
&nbsp;
                    case 31:
<span class="cstat-no" title="statement not covered" >                      this.xcodebuild.processExited = true;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                      if (!(this.xcodebuild._wda_error_occurred || !signal &amp;&amp; code !== 0)) {</span>
<span class="cstat-no" title="statement not covered" >                        context$4$0.next = 34;</span>
<span class="cstat-no" title="statement not covered" >                        break;</span>
                      }
&nbsp;
<span class="cstat-no" title="statement not covered" >                      return context$4$0.abrupt('return', reject(new Error('xcodebuild failed with code ' + code)));</span>
&nbsp;
                    case 34:
<span class="cstat-no" title="statement not covered" >                      if (!buildOnly) {</span>
<span class="cstat-no" title="statement not covered" >                        context$4$0.next = 36;</span>
<span class="cstat-no" title="statement not covered" >                        break;</span>
                      }
&nbsp;
<span class="cstat-no" title="statement not covered" >                      return context$4$0.abrupt('return', resolve());</span>
&nbsp;
                    case 36:
                    case 'end':
...
<span class="cstat-no" title="statement not covered" >                var startTime, _status, msg;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$3$0$(context$4$0) {</span></span>
<span class="cstat-no" title="statement not covered" >                  while (1) <span class="cstat-no" title="statement not covered" >switch (context$4$0.prev = context$4$0.next) {</span></span>
                    case 0:
...
<span class="cstat-no" title="statement not covered" >                      return _regeneratorRuntime.awrap(this.xcodebuild.start());</span>
&nbsp;
                    case 4:
<span class="cstat-no" title="statement not covered" >                      if (buildOnly) {</span>
...
<span class="cstat-no" title="statement not covered" >                      return _regeneratorRuntime.awrap(this.waitForStart(startTime));</span>
&nbsp;
                    case 7:
<span class="cstat-no" title="statement not covered" >                      _status = context$4$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                      resolve(_status);</span>
&nbsp;
                    case 9:
<span class="cstat-no" title="statement not covered" >                      context$4$0.next = 16;</span>
<span class="cstat-no" title="statement not covered" >                      break;</span>
&nbsp;
                    case 11:
<span class="cstat-no" title="statement not covered" >                      context$4$0.prev = 11;</span>
<span class="cstat-no" title="statement not covered" >                      context$4$0.t0 = context$4$0['catch'](0);</span>
<span class="cstat-no" title="statement not covered" >                      msg = 'Unable to start WebDriverAgent: ' + context$4$0.t0;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    key: 'waitForStart',
    value: <span class="fstat-no" title="function not covered" >function waitForStart(startTime) {</span>
<span class="cstat-no" title="statement not covered" >      var currentStatus, retries, endTime, startupTime;</span>
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function waitForStart$(context$2$0) {</span></span>
...
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Waiting up to ' + this.wdaLaunchTimeout + 'ms for WebDriverAgent to start');</span>
<span class="cstat-no" title="statement not covered" >            currentStatus = null;</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.prev = 2;</span>
<span class="cstat-no" title="statement not covered" >            retries = parseInt(this.wdaLaunchTimeout / 500, 10);</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 6;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap((0, _asyncbox.retryInterval)(retries, 500, <span class="fstat-no" title="function not covered" >function callee$2$0() {</span></span>
<span class="cstat-no" title="statement not covered" >              var proxyTimeout;</span>
...
<span class="cstat-no" title="statement not covered" >                while (1) <span class="cstat-no" title="statement not covered" >switch (context$3$0.prev = context$3$0.next) {</span></span>
                  case 0:
<span class="cstat-no" title="statement not covered" >                    if (!this.xcodebuild.processExited) {</span>
...
&nbsp;
                  case 2:
<span class="cstat-no" title="statement not covered" >                    proxyTimeout = this.noSessionProxy.timeout;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                    this.noSessionProxy.timeout = 1000;</span>
<span class="cstat-no" title="statement not covered" >                    context$3$0.prev = 4;</span>
<span class="cstat-no" title="statement not covered" >                    context$3$0.next = 7;</span>
<span class="cstat-no" title="statement not covered" >                    return _regeneratorRuntime.awrap(this.noSessionProxy.command('/status', 'GET'));</span>
&nbsp;
                  case 7:
<span class="cstat-no" title="statement not covered" >                    currentStatus = context$3$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                    if (currentStatus &amp;&amp; currentStatus.ios &amp;&amp; currentStatus.ios.ip) {</span>
<span class="cstat-no" title="statement not covered" >                      this.agentUrl = currentStatus.ios.ip;</span>
<span class="cstat-no" title="statement not covered" >                      _logger2['default'].debug('WebDriverAgent running on ip \'' + this.agentUrl + '\'');</span>
                    }
<span class="cstat-no" title="statement not covered" >                    context$3$0.next = 14;</span>
<span class="cstat-no" title="statement not covered" >                    break;</span>
&nbsp;
                  case 11:
<span class="cstat-no" title="statement not covered" >                    context$3$0.prev = 11;</span>
<span class="cstat-no" title="statement not covered" >                    context$3$0.t0 = context$3$0['catch'](4);</span>
<span class="cstat-no" title="statement not covered" >                    throw new Error('Unable to connect to running WebDriverAgent: ' + context$3$0.t0.message);</span>
&nbsp;
                  case 14:
<span class="cstat-no" title="statement not covered" >                    context$3$0.prev = 14;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                    this.noSessionProxy.timeout = proxyTimeout;</span>
<span class="cstat-no" title="statement not covered" >                    return context$3$0.finish(14);</span>
&nbsp;
                  case 17:
                  case 'end':
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            return context$2$0.abrupt('return', currentStatus);</span>
&nbsp;
          case 8:
<span class="cstat-no" title="statement not covered" >            endTime = process.hrtime(startTime);</span>
<span class="cstat-no" title="statement not covered" >            startupTime = parseInt((endTime[0] * 1e9 + endTime[1]) / 1e6, 10);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('WebDriverAgent successfully started after ' + startupTime + 'ms');</span>
...
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug(context$2$0.t0.message);</span>
<span class="cstat-no" title="statement not covered" >            _logger2['default'].warn('Getting status of WebDriverAgent on device timed out. Continuing');</span>
&nbsp;
          case 17:
<span class="cstat-no" title="statement not covered" >            return context$2$0.abrupt('return', currentStatus);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    key: 'startiproxy',
    value: <span class="fstat-no" title="function not covered" >function startiproxy() {</span>
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function startiproxy$(context$2$0) {</span></span>
...
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(new _bluebird2['default'](<span class="fstat-no" title="function not covered" >function (resolve, reject) {</span></span>
<span class="cstat-no" title="statement not covered" >              _this3.iproxy.on('exit', <span class="fstat-no" title="function not covered" >function (code) {</span></span>
<span class="cstat-no" title="statement not covered" >                _logger2['default'].debug('iproxy exited with code \'' + code + '\'');</span>
<span class="cstat-no" title="statement not covered" >                if (code) {</span>
<span class="cstat-no" title="statement not covered" >                  return reject(new Error('iproxy exited with code \'' + code + '\''));</span>
                }
              });
<span class="cstat-no" title="statement not covered" >              _this3.iproxy.on('output', <span class="fstat-no" title="function not covered" >function (stdout, stderr) {</span></span>
                // do nothing if we expect errors
<span class="cstat-no" title="statement not covered" >                if (_this3.expectIProxyErrors) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                try {</span>
<span class="cstat-no" title="statement not covered" >                  for (var _iterator3 = _getIterator(out.split('\n')), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {</span>
<span class="cstat-no" title="statement not covered" >                    var line = _step3.value;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                    if (!line.length) {</span>
<span class="cstat-no" title="statement not covered" >                      continue;</span>
                    }
&nbsp;
<span class="cstat-no" title="statement not covered" >                    if (line.indexOf('Resource temporarily unavailable') !== -1) {</span>
                      // this generally happens when WDA does not respond,
                      // so print a more useful message
<span class="cstat-no" title="statement not covered" >                      _logger2['default'].debug('Connection to WDA timed out');</span>
                    } else {
<span class="cstat-no" title="statement not covered" >                      iproxyLog.debug(line);</span>
                    }
                  }
                } catch (err) {
...
<span class="cstat-no" title="statement not covered" >                      return _regeneratorRuntime.awrap(this.iproxy.start(IPROXY_TIMEOUT));</span>
&nbsp;
                    case 3:
<span class="cstat-no" title="statement not covered" >                      resolve();</span>
<span class="cstat-no" title="statement not covered" >                      context$4$0.next = 10;</span>
<span class="cstat-no" title="statement not covered" >                      break;</span>
&nbsp;
                    case 6:
...
<span class="cstat-no" title="statement not covered" >                      context$4$0.t0 = context$4$0['catch'](0);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                      _logger2['default'].error('Error starting iproxy: \'' + context$4$0.t0.message + '\'');</span>
<span class="cstat-no" title="statement not covered" >                      reject(new Error('Unable to start iproxy. Is it installed?'));</span>
&nbsp;
                    case 10:
                    case 'end':
<span class="cstat-no" title="statement not covered" >                      return context$4$0.stop();</span>
...
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    value: <span class="fstat-no" title="function not covered" >function killHangingProcesses() {</span>
<span class="cstat-no" title="statement not covered" >      var procNames, _iteratorNormalCompletion4, _didIteratorError4, _iteratorError4, _iterator4, _step4, proc;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function killHangingProcesses$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Killing hanging processes');</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 3;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap((0, _utilsJs.killAppUsingAppName)(this.device.udid, 'xcodebuild'));</span>
&nbsp;
          case 3:
<span class="cstat-no" title="statement not covered" >            procNames = this.realDevice ? ['iproxy'] : ['XCTRunner'];</span>
...
<span class="cstat-no" title="statement not covered" >            _iterator4 = _getIterator(procNames);</span>
&nbsp;
          case 9:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            proc = _step4.value;</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 13;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap((0, _utilsJs.killAppUsingAppName)(this.device.udid, proc));</span>
&nbsp;
          case 13:
<span class="cstat-no" title="statement not covered" >            _iteratorNormalCompletion4 = true;</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 9;</span>
...
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    key: 'quit',
    value: <span class="fstat-no" title="function not covered" >function quit() {</span>
<span class="cstat-no" title="statement not covered" >      var killProcess;</span>
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function quit$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            killProcess = <span class="fstat-no" title="function not covered" >function killProcess(name, proc) {</span></span>
<span class="cstat-no" title="statement not covered" >              return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function killProcess$(context$3$0) {</span></span>
<span class="cstat-no" title="statement not covered" >                while (1) <span class="cstat-no" title="statement not covered" >switch (context$3$0.prev = context$3$0.next) {</span></span>
                  case 0:
<span class="cstat-no" title="statement not covered" >                    if (!(proc &amp;&amp; proc.proc)) {</span>
<span class="cstat-no" title="statement not covered" >                      context$3$0.next = 22;</span>
<span class="cstat-no" title="statement not covered" >                      break;</span>
                    }
&nbsp;
<span class="cstat-no" title="statement not covered" >                    _logger2['default'].info('Shutting down ' + name + ' process (pid ' + proc.proc.pid + ')');</span>
<span class="cstat-no" title="statement not covered" >                    context$3$0.prev = 2;</span>
<span class="cstat-no" title="statement not covered" >                    context$3$0.next = 5;</span>
<span class="cstat-no" title="statement not covered" >                    return _regeneratorRuntime.awrap(proc.stop('SIGTERM', 1000));</span>
&nbsp;
                  case 5:
<span class="cstat-no" title="statement not covered" >                    context$3$0.next = 22;</span>
<span class="cstat-no" title="statement not covered" >                    break;</span>
...
<span class="cstat-no" title="statement not covered" >                    context$3$0.t0 = context$3$0['catch'](2);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                    if (!(context$3$0.t0.message.indexOf('Process didn\'t end after') === -1)) {</span>
<span class="cstat-no" title="statement not covered" >                      context$3$0.next = 11;</span>
<span class="cstat-no" title="statement not covered" >                      break;</span>
                    }
&nbsp;
<span class="cstat-no" title="statement not covered" >                    throw context$3$0.t0;</span>
&nbsp;
                  case 11:
<span class="cstat-no" title="statement not covered" >                    _logger2['default'].debug(name + ' process did not end in a timely fashion: \'' + context$3$0.t0.message + '\'. ' + 'Sending \'SIGKILL\'...');</span>
<span class="cstat-no" title="statement not covered" >                    context$3$0.prev = 12;</span>
<span class="cstat-no" title="statement not covered" >                    context$3$0.next = 15;</span>
<span class="cstat-no" title="statement not covered" >                    return _regeneratorRuntime.awrap(proc.stop('SIGKILL'));</span>
&nbsp;
                  case 15:
<span class="cstat-no" title="statement not covered" >                    context$3$0.next = 22;</span>
<span class="cstat-no" title="statement not covered" >                    break;</span>
&nbsp;
                  case 17:
<span class="cstat-no" title="statement not covered" >                    context$3$0.prev = 17;</span>
<span class="cstat-no" title="statement not covered" >                    context$3$0.t1 = context$3$0['catch'](12);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                    if (!(context$3$0.t1.message.indexOf('not currently running') !== -1)) {</span>
...
&nbsp;
                  case 21:
<span class="cstat-no" title="statement not covered" >                    throw context$3$0.t1;</span>
&nbsp;
                  case 22:
                  case 'end':
<span class="cstat-no" title="statement not covered" >                    return context$3$0.stop();</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].info('Shutting down sub-processes');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 4;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(killProcess('xcodebuild', this.xcodebuild));</span>
&nbsp;
          case 4:
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 6;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(killProcess('iproxy', this.iproxy));</span>
&nbsp;
          case 6:
<span class="cstat-no" title="statement not covered" >            if (!(this.realDevice &amp;&amp; this.updatedWDABundleId)) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 9;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 9;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap((0, _webdriveragentUtils.resetProjectFile)(this.agentPath, this.updatedWDABundleId));</span>
&nbsp;
          case 9:
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (this.jwproxy) {</span>
<span class="cstat-no" title="statement not covered" >              this.jwproxy.sessionId = null;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            this.expectIProxyErrors = true;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        if (this.realDevice &amp;&amp; this.wdaLocalPort) {</span>
<span class="cstat-no" title="statement not covered" >          this._url = _url3['default'].parse(WDA_BASE_URL + ':' + this.wdaLocalPort);</span>
        } else {
<span class="cstat-no" title="statement not covered" >          this._url = _url3['default'].parse(WDA_BASE_URL + ':' + WDA_AGENT_PORT);</span>
        }
      }
<span class="cstat-no" title="statement not covered" >      return this._url;</span>
    },
    set: <span class="fstat-no" title="function not covered" >function set(_url) {</span>
<span class="cstat-no" title="statement not covered" >      this._url = _url3['default'].parse(_url);</span>
    }
  }, {
    key: 'fullyStarted',
    get: <span class="fstat-no" title="function not covered" >function get() {</span>
<span class="cstat-no" title="statement not covered" >      return !this.expectIProxyErrors;</span>
    },
    set: <span class="fstat-no" title="function not covered" >function set() {</span>
<span class="cstat-no" title="statement not covered" >      var started = arguments.length &lt;= 0 || arguments[0] === undefined ? false : arguments[0];</span>
&nbsp;
      // before WDA is started we expect errors from iproxy, since it is not
      // communicating with anything yet
<span class="cstat-no" title="statement not covered" >      this.expectIProxyErrors = !started;</span>
    }
  }, {
    key: 'derivedDataPath',
    get: <span class="fstat-no" title="function not covered" >function get() {</span>
<span class="cstat-no" title="statement not covered" >      if (!this._derivedDataPath) {</span>
        // https://regex101.com/r/PqmX8I/1
<span class="cstat-no" title="statement not covered" >        var folderRegexp = /(.+\/WebDriverAgent-[^\/]+)/;</span>
<span class="cstat-no" title="statement not covered" >        var match = folderRegexp.exec(this.xcodebuild.logLocation);</span>
<span class="cstat-no" title="statement not covered" >        if (!match) {</span>
<span class="cstat-no" title="statement not covered" >          return;</span>
        }
<span class="cstat-no" title="statement not covered" >        this._derivedDataPath = match[1];</span>
      }
<span class="cstat-no" title="statement not covered" >      return this._derivedDataPath;</span>
    }
  }]);
&nbsp;
