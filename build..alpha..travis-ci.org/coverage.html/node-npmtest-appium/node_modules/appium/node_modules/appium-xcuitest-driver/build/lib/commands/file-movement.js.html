...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-xcuitest-driver/build/lib/commands/file-movement.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-xcuitest-driver/build/lib/commands/file-movement.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-xcuitest-driver/build/lib/commands/</a> &#187; file-movement.js</div>
</div>
<div class="body">
...
&nbsp;
commands.getSimFileFullPath = <span class="fstat-no" title="function not covered" >function callee$0$0(remotePath) {</span>
<span class="cstat-no" title="statement not covered" >  var basePath, appName, appNameRegex, appNameMatches, findPath, _ref, stdout, appRoot, subPath, fullPath;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        basePath = this.opts.device.getDir();</span>
...
<span class="cstat-no" title="statement not covered" >        fullPath = _path2['default'].resolve(appRoot, subPath);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Finding app-relative file: \'' + fullPath + '\'');</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', fullPath);</span>
&nbsp;
      case 19:
<span class="cstat-no" title="statement not covered" >        fullPath = _path2['default'].resolve(basePath, remotePath);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Finding sim-relative file: ' + fullPath);</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', fullPath);</span>
&nbsp;
      case 22:
      case 'end':
