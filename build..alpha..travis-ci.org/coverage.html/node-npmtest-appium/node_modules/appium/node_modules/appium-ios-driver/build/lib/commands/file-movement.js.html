...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-ios-driver/build/lib/commands/file-movement.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-ios-driver/build/lib/commands/file-movement.js</span></h1>
    <h2>
        
        Statements: <span class="metric">18.6% <small>(24 / 129)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">19.2% <small>(24 / 125)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-ios-driver/build/lib/commands/</a> &#187; file-movement.js</div>
</div>
<div class="body">
 ...
 */
helpers.getSimFileFullPath = <span class="fstat-no" title="function not covered" >function callee$0$0(remotePath) {</span>
<span class="cstat-no" title="statement not covered" >  var basePath, appName, appNameRegex, appNameMatches, findPath, _ref, stdout, appRoot, subPath;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        basePath = this.sim.getDir();</span>
<span class="cstat-no" title="statement not covered" >        appName = null;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (this.opts.app) {</span>
<span class="cstat-no" title="statement not covered" >          appNameRegex = new RegExp('\\' + _path2['default'].sep + '([\\w-]+\\.app)');</span>
<span class="cstat-no" title="statement not covered" >          appNameMatches = appNameRegex.exec(this.opts.app);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (appNameMatches) {</span>
<span class="cstat-no" title="statement not covered" >            appName = appNameMatches[1];</span>
          }
        }
        // de-absolutize the path
<span class="cstat-no" title="statement not covered" >        if (_appiumSupport.system.isWindows()) {</span>
<span class="cstat-no" title="statement not covered" >          if (remotePath.indexof("://") === 1) {</span>
<span class="cstat-no" title="statement not covered" >            remotePath = remotePath.slice(4);</span>
          }
        } else {
<span class="cstat-no" title="statement not covered" >          if (remotePath.indexOf("/") === 0) {</span>
<span class="cstat-no" title="statement not covered" >            remotePath = remotePath.slice(1);</span>
          }
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!(remotePath.indexOf(appName) === 0)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 18;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug("We want an app-relative file");</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        findPath = basePath;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (this.opts.platformVersion &gt;= 8) {</span>
          // the .app file appears in /Containers/Data and /Containers/Bundle both. We only want /Bundle
<span class="cstat-no" title="statement not covered" >          findPath = _path2['default'].resolve(basePath, "Containers", "Bundle");</span>
        }
<span class="cstat-no" title="statement not covered" >        findPath = findPath.replace(/\s/g, '\\ ');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 11;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _teen_process.exec)('find', [findPath, '-name', appName]));</span>
&nbsp;
      case 11:
...
<span class="cstat-no" title="statement not covered" >        appRoot = stdout.replace(/\n$/, '');</span>
<span class="cstat-no" title="statement not covered" >        subPath = remotePath.substring(appName.length + 1);</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', _path2['default'].resolve(appRoot, subPath));</span>
&nbsp;
      case 18:
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug("We want a sim-relative file");</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', _path2['default'].resolve(basePath, remotePath));</span>
&nbsp;
      case 20:
      case 'end':
...
<span class="cstat-no" title="statement not covered" >  var fullPath, content;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Pushing ' + remotePath + ' to iOS simulator');</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug("Unsupported: cannot write files to physical device");</span>
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.getSimFileFullPath(remotePath));</span>
&nbsp;
      case 6:
<span class="cstat-no" title="statement not covered" >        fullPath = context$1$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Attempting to write ' + fullPath + '...');</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 10;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_appiumSupport.fs.exists(fullPath));</span>
&nbsp;
      case 10:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug(fullPath + ' already exists, deleting...');</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 14;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_appiumSupport.fs.unlink(fullPath));</span>
&nbsp;
      case 14:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 16;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _appiumSupport.mkdirp)(_path2['default'].dirname(fullPath)));</span>
&nbsp;
      case 16:
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_appiumSupport.fs.writeFile(fullPath, content));</span>
&nbsp;
      case 19:
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Wrote ' + content.length + ' bytes to ' + fullPath);</span>
&nbsp;
      case 20:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
<span class="cstat-no" title="statement not covered" >  var fullPath, data;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Pulling ' + remotePath + ' from sim');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!this.isRealDevice()) {</span>
...
<span class="cstat-no" title="statement not covered" >        fullPath = context$1$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Attempting to read ' + fullPath);</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 9;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_appiumSupport.fs.readFile(fullPath, { encoding: 'base64' }));</span>
&nbsp;
      case 9:
...
<span class="cstat-no" title="statement not covered" >  var fullPath, zip, buffer, data;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Pulling ' + remotePath + ' from sim');</span>
...
<span class="cstat-no" title="statement not covered" >        fullPath = context$1$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Adding ' + fullPath + ' to an in-memory zip archive');</span>
<span class="cstat-no" title="statement not covered" >        zip = new _admZip2['default']();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        zip.addLocalFolder(fullPath);</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 11;</span>
...
<span class="cstat-no" title="statement not covered" >          zip.toBuffer(resolve, reject);</span>
        }));
&nbsp;
      case 11:
<span class="cstat-no" title="statement not covered" >        buffer = context$1$0.sent;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        data = buffer.toString('base64');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug("Returning in-memory zip file as base54 encoded string");</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', data);</span>
&nbsp;
      case 16:
      case 'end':
