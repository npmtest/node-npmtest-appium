...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-ios-driver/build/lib/utils.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-ios-driver/build/lib/utils.js</span></h1>
    <h2>
        
        Statements: <span class="metric">9.82% <small>(33 / 336)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">10.09% <small>(33 / 327)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-ios-driver/build/lib/</a> &#187; utils.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >function prepareIosOpts(opts) {</span>
<span class="cstat-no" title="statement not covered" >  var pv;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function prepareIosOpts$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        opts.backendRetries = 4;</span>
<span class="cstat-no" title="statement not covered" >        opts.withoutDelay = !opts.nativeInstrumentsLib;</span>
<span class="cstat-no" title="statement not covered" >        opts.reset = !opts.noReset;</span>
<span class="cstat-no" title="statement not covered" >        opts.initialOrientation = opts.deviceOrientation || opts.orientation || "PORTRAIT";</span>
<span class="cstat-no" title="statement not covered" >        opts.useRobot = opts.robotPort &gt; 0;</span>
<span class="cstat-no" title="statement not covered" >        opts.robotUrl = opts.useRobot ? 'http://' + opts.robotAddress + ':' + opts.robotPort : null;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!(opts.locationServicesAuthorized &amp;&amp; !opts.bundleId)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 8;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        throw new Error("You must set the bundleId cap if using locationServicesEnabled");</span>
&nbsp;
      case 8:
<span class="cstat-no" title="statement not covered" >        context$1$0.t0 = opts.platformVersion;</span>
&nbsp;
...
&nbsp;
      case 13:
<span class="cstat-no" title="statement not covered" >        opts.platformVersion = context$1$0.t0;</span>
<span class="cstat-no" title="statement not covered" >        pv = parseFloat(opts.platformVersion);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (pv &lt; 8) {</span>
<span class="cstat-no" title="statement not covered" >          _logger2['default'].warn('iOS version ' + opts.platformVersion + ' support has been ' + 'deprecated and will be removed in a future version of ' + 'Appium.');</span>
        }
<span class="cstat-no" title="statement not covered" >        opts.localizableStringsDir = opts.localizableStringsDir || 'en.lproj';</span>
<span class="cstat-no" title="statement not covered" >        opts.autoAcceptAlerts = _lodash2['default'].isNull(opts.autoAcceptAlerts) || _lodash2['default'].isUndefined(opts.autoAcceptAlerts) ? false : opts.autoAcceptAlerts;</span>
<span class="cstat-no" title="statement not covered" >        opts.autoDismissAlerts = _lodash2['default'].isNull(opts.autoDismissAlerts) || _lodash2['default'].isUndefined(opts.autoDismissAlerts) ? false : opts.autoDismissAlerts;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if ((opts.browserName || '').toLowerCase() === 'safari' || (opts.app || '').toLowerCase() === 'safari' || (opts.bundleId || '').toLowerCase() === _commandsSafari.SAFARI_BUNDLE) {</span>
          // preparing a safari session
<span class="cstat-no" title="statement not covered" >          if (opts.udid) {</span>
            // on a real device
<span class="cstat-no" title="statement not covered" >            opts.app = opts.app || _safariLauncher.SAFARI_LAUNCHER_APP_FILE;</span>
<span class="cstat-no" title="statement not covered" >            opts.bundleId = opts.bundleId || _safariLauncher.SAFARI_LAUNCHER_BUNDLE;</span>
          } else {
<span class="cstat-no" title="statement not covered" >            if (parseFloat(opts.platformVersion) &lt;= 8) {</span>
              // make sure args.app has something in it so we get to the right spots
              // in moveBuiltInApp()
<span class="cstat-no" title="statement not covered" >              opts.app = 'safari';</span>
<span class="cstat-no" title="statement not covered" >              opts.bundleId = null;</span>
            } else {
<span class="cstat-no" title="statement not covered" >              opts.app = null;</span>
<span class="cstat-no" title="statement not covered" >              opts.bundleId = _commandsSafari.SAFARI_BUNDLE;</span>
            }
          }
<span class="cstat-no" title="statement not covered" >          opts.safari = true;</span>
        }
&nbsp;
      case 20:
      case 'end':
...
&nbsp;
<span class="fstat-no" title="function not covered" >function appIsPackageOrBundle(app) {</span>
<span class="cstat-no" title="statement not covered" >  return (/^([a-zA-Z0-9\-_]+\.[a-zA-Z0-9\-_]+)+$/.test(app)</span>
  );
}
&nbsp;
<span class="fstat-no" title="function not covered" >function removeInstrumentsSocket(sock) {</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function removeInstrumentsSocket$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug("Removing any remaining instruments sockets");</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 3;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_appiumSupport.fs.rimraf(sock));</span>
&nbsp;
      case 3:
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Cleaned up instruments socket ' + sock);</span>
&nbsp;
      case 4:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function getAndCheckXcodeVersion(caps) {</span>
<span class="cstat-no" title="statement not covered" >  var version, minorVersion, pv;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function getAndCheckXcodeVersion$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        version = undefined;</span>
...
&nbsp;
      case 4:
<span class="cstat-no" title="statement not covered" >        version = context$1$0.sent;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 12;</span>
<span class="cstat-no" title="statement not covered" >        break;</span>
&nbsp;
      case 7:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug(context$1$0.t0);</span>
<span class="cstat-no" title="statement not covered" >        _logger2['default'].error('Could not determine Xcode version: ' + context$1$0.t0.message);</span>
<span class="cstat-no" title="statement not covered" >        throw context$1$0.t0;</span>
&nbsp;
      case 12:
<span class="cstat-no" title="statement not covered" >        minorVersion = version.versionFloat;</span>
<span class="cstat-no" title="statement not covered" >        pv = parseFloat(caps.platformVersion);</span>
&nbsp;
        // we deprecate Xcodes &lt; 6.3, except for iOS 8.0 in which case we
        // support Xcode 6.0 as well
<span class="cstat-no" title="statement not covered" >        if (minorVersion &lt; 6.3 &amp;&amp; !(minorVersion === 6.0 &amp;&amp; pv === 8.0)) {</span>
<span class="cstat-no" title="statement not covered" >          _logger2['default'].warn('Xcode version \'' + version.versionString + '\'. Support for Xcode ' + (version.versionString + ' has been deprecated and will be removed ') + 'in a future version. Please upgrade to version 6.3 or ' + 'higher (or version 6.0.1 for iOS 8.0)');</span>
        }
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', version);</span>
&nbsp;
      case 16:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function getAndCheckIosSdkVersion() {</span>
<span class="cstat-no" title="statement not covered" >  var versionNumber;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function getAndCheckIosSdkVersion$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        versionNumber = undefined;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.prev = 1;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 4;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_appiumXcode2['default'].getMaxIOSSDK());</span>
&nbsp;
      case 4:
<span class="cstat-no" title="statement not covered" >        versionNumber = context$1$0.sent;</span>
...
<span class="cstat-no" title="statement not covered" >        context$1$0.t0 = context$1$0['catch'](1);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].error("Could not determine iOS SDK version");</span>
<span class="cstat-no" title="statement not covered" >        throw context$1$0.t0;</span>
&nbsp;
      case 11:
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', versionNumber);</span>
&nbsp;
      case 12:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function getSimForDeviceString(dString, availDevices) {</span>
<span class="cstat-no" title="statement not covered" >  var matchedDevice = null;</span>
<span class="cstat-no" title="statement not covered" >  var matchedUdid = null;</span>
<span class="cstat-no" title="statement not covered" >  _lodash2['default'].each(availDevices, <span class="fstat-no" title="function not covered" >function (device) {</span></span>
<span class="cstat-no" title="statement not covered" >    if (device.indexOf(dString) !== -1) {</span>
<span class="cstat-no" title="statement not covered" >      matchedDevice = device;</span>
<span class="cstat-no" title="statement not covered" >      try {</span>
<span class="cstat-no" title="statement not covered" >        matchedUdid = /.+\[([^\]]+)\]/.exec(device)[1];</span>
      } catch (e) {
<span class="cstat-no" title="statement not covered" >        matchedUdid = null;</span>
      }
    }
  });
<span class="cstat-no" title="statement not covered" >  return [matchedDevice, matchedUdid];</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function detectUdid(caps) {</span>
<span class="cstat-no" title="statement not covered" >  var cmd, args, udid, _ref, stdout;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function detectUdid$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        if (!(caps.udid !== null &amp;&amp; caps.udid === "auto")) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 34;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug("Auto-detecting iOS udid...");</span>
<span class="cstat-no" title="statement not covered" >        cmd = undefined, args = [];</span>
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_appiumSupport.fs.which('idevice_id'));</span>
&nbsp;
      case 6:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        cmd = require.resolve('udidetect');</span>
&nbsp;
      case 13:
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _teen_process.exec)(cmd, args, { timeout: 3000 }));</span>
&nbsp;
      case 17:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        udid = stdout.split("\n")[0];</span>
...
<span class="cstat-no" title="statement not covered" >        context$1$0.t1 = context$1$0['catch'](14);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].error("Error detecting udid");</span>
<span class="cstat-no" title="statement not covered" >        throw context$1$0.t1;</span>
&nbsp;
      case 26:
<span class="cstat-no" title="statement not covered" >        if (!(udid &amp;&amp; udid.length &gt; 2)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 31;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        caps.udid = udid;</span>
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Detected udid as \'' + caps.udid + '\'');</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 32;</span>
<span class="cstat-no" title="statement not covered" >        break;</span>
&nbsp;
      case 31:
<span class="cstat-no" title="statement not covered" >        throw new Error("Could not detect udid.");</span>
&nbsp;
      case 32:
...
&nbsp;
      case 34:
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug("Not auto-detecting udid.");</span>
&nbsp;
      case 35:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function parseLocalizableStrings(opts) {</span>
<span class="cstat-no" title="statement not covered" >  var language, stringFile, strings, obj;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function parseLocalizableStrings$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        if (!(_lodash2['default'].isNull(opts.app) || _lodash2['default'].isUndefined(opts.app))) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 3;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug("Localizable.strings is not currently supported when using real devices.");</span>
...
<span class="cstat-no" title="statement not covered" >        stringFile = opts.stringFile || "Localizable.strings";</span>
<span class="cstat-no" title="statement not covered" >        strings = null;</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        strings = _path2['default'].resolve(opts.app, language + '.lproj', stringFile);</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 10;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_appiumSupport.fs.exists(strings));</span>
&nbsp;
      case 10:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('No strings file \'' + stringFile + '\' for language \'' + language + '\', getting default strings');</span>
<span class="cstat-no" title="statement not covered" >        strings = _path2['default'].resolve(opts.app, stringFile);</span>
&nbsp;
      case 13:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 17;</span>
<span class="cstat-no" title="statement not covered" >        break;</span>
&nbsp;
      case 15:
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('No language specified. Using default strings');</span>
<span class="cstat-no" title="statement not covered" >        strings = _path2['default'].resolve(opts.app, stringFile);</span>
&nbsp;
      case 17:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (opts.localizableStringsDir) {</span>
<span class="cstat-no" title="statement not covered" >          _logger2['default'].debug('Strings file not found. Looking in \'' + opts.localizableStringsDir + '\' directory');</span>
<span class="cstat-no" title="statement not covered" >          strings = _path2['default'].resolve(opts.app, opts.localizableStringsDir, stringFile);</span>
        } else {
<span class="cstat-no" title="statement not covered" >          strings = null;</span>
        }
&nbsp;
      case 21:
<span class="cstat-no" title="statement not covered" >        context$1$0.t0 = !strings;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (context$1$0.t0) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 26;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].warn('Could not file localizable strings file \'' + stringFile + '\'!');</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return');</span>
&nbsp;
      case 29:
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_appiumSupport.plist.parsePlistFile(strings));</span>
&nbsp;
      case 33:
<span class="cstat-no" title="statement not covered" >        obj = context$1$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Parsed app \'' + stringFile + '\'');</span>
<span class="cstat-no" title="statement not covered" >        opts.localizableStrings = obj;</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', obj);</span>
&nbsp;
      case 39:
<span class="cstat-no" title="statement not covered" >        context$1$0.prev = 39;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.t1 = context$1$0['catch'](30);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].warn('Could not parse app \'' + stringFile + '\' assuming it does not exist');</span>
&nbsp;
      case 42:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function setBundleIdFromApp(caps) {</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function setBundleIdFromApp$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        if (caps.bundleId) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 12;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        context$1$0.prev = 1;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 4;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _appUtils.extractBundleId)(caps.app));</span>
&nbsp;
      case 4:
<span class="cstat-no" title="statement not covered" >        caps.bundleId = context$1$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].info('Extracted bundleID: ' + caps.bundleId + ' from app: ' + caps.app);</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 12;</span>
<span class="cstat-no" title="statement not covered" >        break;</span>
&nbsp;
      case 8:
...
<span class="cstat-no" title="statement not covered" >        context$1$0.t0 = context$1$0['catch'](1);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].error("Could not set the bundleId from app.");</span>
<span class="cstat-no" title="statement not covered" >        throw context$1$0.t0;</span>
&nbsp;
      case 12:
      case 'end':
...
&nbsp;
<span class="fstat-no" title="function not covered" >function shouldPrelaunchSimulator(caps, iosSdkVersion) {</span>
<span class="cstat-no" title="statement not covered" >  var shouldPrelaunch = false;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (caps.defaultDevice || iosSdkVersion &gt;= 7.1) {</span>
<span class="cstat-no" title="statement not covered" >    if (this.iosSdkVersion &gt;= 7.1) {</span>
<span class="cstat-no" title="statement not covered" >      _logger2['default'].debug("We're on iOS7.1+ so forcing defaultDevice on");</span>
    } else {
<span class="cstat-no" title="statement not covered" >      _logger2['default'].debug("User specified default device, letting instruments launch it");</span>
    }
  } else {
<span class="cstat-no" title="statement not covered" >    shouldPrelaunch = true;</span>
  }
<span class="cstat-no" title="statement not covered" >  return shouldPrelaunch;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function setDeviceTypeInInfoPlist(app, deviceString) {</span>
<span class="cstat-no" title="statement not covered" >  var plistFile, isiPhone, deviceTypeCode;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function setDeviceTypeInInfoPlist$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
...
&nbsp;
      case 2:
<span class="cstat-no" title="statement not covered" >        plistFile = _path2['default'].resolve(app, "Info.plist");</span>
<span class="cstat-no" title="statement not covered" >        isiPhone = deviceString.toLowerCase().indexOf("ipad") === -1;</span>
<span class="cstat-no" title="statement not covered" >        deviceTypeCode = isiPhone ? 1 : 2;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 7;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_appiumSupport.plist.updatePlistFile(plistFile, { UIDeviceFamily: [deviceTypeCode] }));</span>
&nbsp;
      case 7:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function unwrapEl(el) {</span>
<span class="cstat-no" title="statement not covered" >  if (typeof el === 'object' &amp;&amp; el.ELEMENT) {</span>
<span class="cstat-no" title="statement not covered" >    return el.ELEMENT;</span>
  }
<span class="cstat-no" title="statement not covered" >  return el;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function clearLogs(locations) {</span>
<span class="cstat-no" title="statement not covered" >  var _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, _location, size, _ref2, stdout;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function clearLogs$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Clearing log files');</span>
...
<span class="cstat-no" title="statement not covered" >        _iterator = _getIterator(locations);</span>
&nbsp;
      case 6:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        _location = _step.value;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 10;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_appiumSupport.fs.exists(_location));</span>
&nbsp;
      case 10:
<span class="cstat-no" title="statement not covered" >        if (!context$1$0.sent) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 31;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        size = undefined;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.prev = 12;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 15;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _teen_process.exec)('du', ['-sh', _location]));</span>
&nbsp;
      case 15:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        size = stdout.trim().split(/\s+/)[0];</span>
...
&nbsp;
        /* jshint ignore:start */
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Deleting \'' + _location + '\'. ' + (size ? 'Freeing ' + size + '.' : ''));</span>
        /* jshint ignore:end */
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 26;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_appiumSupport.fs.rimraf(_location));</span>
&nbsp;
      case 26:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 31;</span>
<span class="cstat-no" title="statement not covered" >        break;</span>
...
<span class="cstat-no" title="statement not covered" >        context$1$0.t1 = context$1$0['catch'](22);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].warn('Unable to delete \'' + _location + '\': ' + context$1$0.t1.message);</span>
&nbsp;
      case 31:
<span class="cstat-no" title="statement not covered" >        _iteratorNormalCompletion = true;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 6;</span>
...
<span class="cstat-no" title="statement not covered" >        context$1$0.t2 = context$1$0['catch'](4);</span>
...
&nbsp;
      case 48:
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Finished clearing log files');</span>
&nbsp;
      case 49:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
