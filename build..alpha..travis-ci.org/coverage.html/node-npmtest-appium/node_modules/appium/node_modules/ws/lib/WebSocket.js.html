...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/ws/lib/WebSocket.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/ws/lib/WebSocket.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">9.13% <small>(40 / 438)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/ws/lib/</a> &#187; WebSocket.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >  if (this instanceof WebSocket === false) {</span>
<span class="cstat-no" title="statement not covered" >    return new WebSocket(address, protocols, options);</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >  this._ultron = null;</span>
<span class="cstat-no" title="statement not covered" >  this._closeReceived = false;</span>
...
<span class="cstat-no" title="statement not covered" >  this._binaryType = 'nodebuffer';</span>
&nbsp;
 ...
 * @api public
 */
WebSocket.prototype.close = <span class="fstat-no" title="function not covered" >function close(code, data) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (this.readyState === WebSocket.CLOSING) {</span>
<span class="cstat-no" title="statement not covered" >    if (this._closeReceived &amp;&amp; this._isServer) {</span>
...
<span class="cstat-no" title="statement not covered" >    this._sender.close(code, data, mask, <span class="fstat-no" title="function not covered" >function(err) {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (self._closeReceived &amp;&amp; self._isServer) {</span>
<span class="cstat-no" title="statement not covered" >        self.terminate();</span>
      } else {
        // ensure that the connection is cleaned up even when no response of closing handshake.
<span class="cstat-no" title="statement not covered" >        clearTimeout(self._closeTimer);</span>
<span class="cstat-no" title="statement not covered" >        self._closeTimer = setTimeout(cleanupWebsocketResources.bind(self, true), closeTimeout);</span>
      }
    });
  } catch (e) {
 ...
 * @api public
 */
WebSocket.prototype.pause = <span class="fstat-no" title="function not covered" >function pauser() {</span>
 ...
 * @api public
 */
WebSocket.prototype.ping = <span class="fstat-no" title="function not covered" >function ping(data, options, dontFailWhenClosed) {</span>
 ...
 * @api public
 */
WebSocket.prototype.resume = <span class="fstat-no" title="function not covered" >function resume() {</span>
<span class="cstat-no" title="statement not covered" >  if (this.readyState !== WebSocket.OPEN) <span class="cstat-no" title="statement not covered" >throw new Error('not opened');</span></span>
&nbsp;
 ...
 */
&nbsp;
WebSocket.prototype.send = <span class="fstat-no" title="function not covered" >function send(data, options, cb) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (typeof options.mask === 'undefined') <span class="cstat-no" title="statement not covered" >options.mask = !this._isServer;</span></span>
<span class="cstat-no" title="statement not covered" >  if (typeof options.compress === 'undefined') <span class="cstat-no" title="statement not covered" >options.compress = true;</span></span>
<span class="cstat-no" title="statement not covered" >  if (!this.extensions[PerMessageDeflate.extensionName]) {</span>
<span class="cstat-no" title="statement not covered" >    options.compress = false;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  var readable = typeof stream.Readable === 'function'</span>
    ? stream.Readable
    : stream.Stream;
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (data instanceof readable) {</span>
<span class="cstat-no" title="statement not covered" >    startQueue(this);</span>
<span class="cstat-no" title="statement not covered" >    var self = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    sendStream(this, data, options, <span class="fstat-no" title="function not covered" >function send(error) {</span></span>
...
<span class="cstat-no" title="statement not covered" >        executeQueueSends(self);</span>
      });
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    this._sender.send(data, options, cb);</span>
  }
};
&nbsp;
/**
 ...
 * @api public
 */
WebSocket.prototype.stream = <span class="fstat-no" title="function not covered" >function stream(options, cb) {</span>
<span class="cstat-no" title="statement not covered" >  if (typeof options === 'function') {</span>
<span class="cstat-no" title="statement not covered" >    cb = options;</span>
<span class="cstat-no" title="statement not covered" >    options = {};</span>
  }
...
<span class="cstat-no" title="statement not covered" >  startQueue(this);</span>
&nbsp;
<span class="fstat-no" title="function not covered" >  function send(data, final) {</span>
<span class="cstat-no" title="statement not covered" >    try {</span>
 ...
 * @api public
 */
WebSocket.prototype.terminate = <span class="fstat-no" title="function not covered" >function terminate() {</span>
<span class="cstat-no" title="statement not covered" >  if (this.readyState === WebSocket.CLOSED) <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
...
&nbsp;
    // End the connection
<span class="cstat-no" title="statement not covered" >    try { <span class="cstat-no" title="statement not covered" >this._socket.end(); </span>}</span>
    catch (e) {
...
<span class="cstat-no" title="statement not covered" >    if (type === 'arraybuffer' || type === 'nodebuffer')</span>
<span class="cstat-no" title="statement not covered" >      this._binaryType = type;</span>
    else
<span class="cstat-no" title="statement not covered" >      throw new SyntaxError('unsupported binaryType: must be either "nodebuffer" or "arraybuffer"');</span>
  }
});
&nbsp;
/**
...
<span class="cstat-no" title="statement not covered" >    if (flags.binary &amp;&amp; this.binaryType === 'arraybuffer')</span>
<span class="cstat-no" title="statement not covered" >        data = new Uint8Array(data).buffer;</span>
<span class="cstat-no" title="statement not covered" >    listener.call(target, new MessageEvent(data, !!flags.binary, target));</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  function onClose (code, message) {</span>
<span class="cstat-no" title="statement not covered" >    listener.call(target, new CloseEvent(code, message, target));</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  function onError (event) {</span>
<span class="cstat-no" title="statement not covered" >    event.type = 'error';</span>
<span class="cstat-no" title="statement not covered" >    event.target = target;</span>
<span class="cstat-no" title="statement not covered" >    listener.call(target, event);</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  function onOpen () {</span>
<span class="cstat-no" title="statement not covered" >    listener.call(target, new OpenEvent(target));</span>
  }
&nbsp;
 ...
 * @api private
 */
<span class="fstat-no" title="function not covered" >function MessageEvent(dataArg, isBinary, target) {</span>
<span class="cstat-no" title="statement not covered" >  this.type = 'message';</span>
...
<span class="cstat-no" title="statement not covered" >  this.binary = isBinary; </span>// non-standard.
}
&nbsp;
/**
 * W3C CloseEvent
...
<span class="cstat-no" title="statement not covered" >  this.type = 'close';</span>
...
<span class="cstat-no" title="statement not covered" >  this.type = 'open';</span>
<span class="cstat-no" title="statement not covered" >  this.target = target;</span>
}
&nbsp;
// Append port number to Host header, only if specified in the url
// and non-default
<span class="fstat-no" title="function not covered" >function buildHostHeader(isSecure, hostname, port) {</span>
<span class="cstat-no" title="statement not covered" >  var headerHost = hostname;</span>
...
<span class="cstat-no" title="statement not covered" >  return headerHost;</span>
}
&nbsp;
/**
...
<span class="cstat-no" title="statement not covered" >  this.extensions = options.value.extensions;</span>
...
<span class="cstat-no" title="statement not covered" >  this.maxPayload = options.value.maxPayload;</span>
  // establish connection
<span class="cstat-no" title="statement not covered" >  if (options.value.protocolVersion === 'hixie-76') {</span>
<span class="cstat-no" title="statement not covered" >    establishConnection.call(this, ReceiverHixie, SenderHixie, socket, upgradeHead);</span>
  } else {
<span class="cstat-no" title="statement not covered" >    establishConnection.call(this, Receiver, Sender, socket, upgradeHead);</span>
  }
}
&nbsp;
...
&nbsp;
  // prepare extensions
<span class="cstat-no" title="statement not covered" >  var extensionsOffer = {};</span>
<span class="cstat-no" title="statement not covered" >  var perMessageDeflate;</span>
<span class="cstat-no" title="statement not covered" >  if (options.value.perMessageDeflate) {</span>
<span class="cstat-no" title="statement not covered" >    perMessageDeflate = new PerMessageDeflate(typeof options.value.perMessageDeflate !== true ? options.value.perMessageDeflate : {}, false);</span>
<span class="cstat-no" title="statement not covered" >    extensionsOffer[PerMessageDeflate.extensionName] = perMessageDeflate.offer();</span>
  }
&nbsp;
  // expose state properties
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  var headerHost = buildHostHeader(isSecure, serverUrl.hostname, port)</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (Object.keys(extensionsOffer).length) {</span>
<span class="cstat-no" title="statement not covered" >    requestOptions.headers['Sec-WebSocket-Extensions'] = Extensions.format(extensionsOffer);</span>
  }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  requestOptions.path = serverUrl.path || '/';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (agent) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (options.value.localAddress) {</span>
<span class="cstat-no" title="statement not covered" >    requestOptions.localAddress = options.value.localAddress;</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    cleanupWebsocketResources.call(self, error);</span>
  });
&nbsp;
<span class="cstat-no" title="statement not covered" >  req.once('response', <span class="fstat-no" title="function not covered" >function response(res) {</span></span>
<span class="cstat-no" title="statement not covered" >    var error;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!self.emit('unexpected-response', req, res)) {</span>
<span class="cstat-no" title="statement not covered" >      error = new Error('unexpected server response (' + res.statusCode + ')');</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  req.once('upgrade', <span class="fstat-no" title="function not covered" >function upgrade(res, socket, upgradeHead) {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    var serverExtensions = Extensions.parse(res.headers['sec-websocket-extensions']);</span>
<span class="cstat-no" title="statement not covered" >    if (perMessageDeflate &amp;&amp; serverExtensions[PerMessageDeflate.extensionName]) {</span>
<span class="cstat-no" title="statement not covered" >      try {</span>
<span class="cstat-no" title="statement not covered" >        perMessageDeflate.accept(serverExtensions[PerMessageDeflate.extensionName]);</span>
      } catch (err) {
<span class="cstat-no" title="statement not covered" >        self.emit('error', 'invalid extension parameter');</span>
<span class="cstat-no" title="statement not covered" >        self.removeAllListeners();</span>
<span class="cstat-no" title="statement not covered" >        socket.end();</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
<span class="cstat-no" title="statement not covered" >      self.extensions[PerMessageDeflate.extensionName] = perMessageDeflate;</span>
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >  var ultron = this._ultron = new Ultron(socket)</span>
    , called = false
    , self = this;
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  this._receiver = new ReceiverClass(this.extensions,this.maxPayload);</span>
<span class="cstat-no" title="statement not covered" >  this._socket = socket;</span>
&nbsp;
  // socket cleanup handlers
<span class="cstat-no" title="statement not covered" >  ultron.on('end', cleanupWebsocketResources.bind(this));</span>
<span class="cstat-no" title="statement not covered" >  ultron.on('close', cleanupWebsocketResources.bind(this));</span>
<span class="cstat-no" title="statement not covered" >  ultron.on('error', cleanupWebsocketResources.bind(this));</span>
&nbsp;
  // ensure that the upgradeHead is added to the receiver
<span class="fstat-no" title="function not covered" >  function firstHandler(data) {</span>
<span class="cstat-no" title="statement not covered" >    if (called || self.readyState === WebSocket.CLOSED) <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    called = true;</span>
<span class="cstat-no" title="statement not covered" >    socket.removeListener('data', firstHandler);</span>
<span class="cstat-no" title="statement not covered" >    ultron.on('data', realHandler);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (upgradeHead &amp;&amp; upgradeHead.length &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >      realHandler(upgradeHead);</span>
<span class="cstat-no" title="statement not covered" >      upgradeHead = null;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (data) <span class="cstat-no" title="statement not covered" >realHandler(data);</span></span>
  }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  ultron.on('data', firstHandler);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >  self._receiver.ontext = <span class="fstat-no" title="function not covered" >function ontext(data, flags) {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  self._receiver.onbinary = <span class="fstat-no" title="function not covered" >function onbinary(data, flags) {</span></span>
<span class="cstat-no" title="statement not covered" >    flags = flags || {};</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  self._receiver.onping = <span class="fstat-no" title="function not covered" >function onping(data, flags) {</span></span>
<span class="cstat-no" title="statement not covered" >    flags = flags || {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    self.pong(data, {</span>
      mask: !self._isServer,
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  self._receiver.onpong = <span class="fstat-no" title="function not covered" >function onpong(data, flags) {</span></span>
<span class="cstat-no" title="statement not covered" >    self.emit('pong', data, flags || {});</span>
  };
&nbsp;
<span class="cstat-no" title="statement not covered" >  self._receiver.onclose = <span class="fstat-no" title="function not covered" >function onclose(code, data, flags) {</span></span>
<span class="cstat-no" title="statement not covered" >    flags = flags || {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    self._closeReceived = true;</span>
<span class="cstat-no" title="statement not covered" >    self.close(code, data);</span>
  };
&nbsp;
<span class="cstat-no" title="statement not covered" >  self._receiver.onerror = <span class="fstat-no" title="function not covered" >function onerror(reason, errorCode) {</span></span>
    // close the connection when the receiver reports a HyBi error code
<span class="cstat-no" title="statement not covered" >    self.close(typeof errorCode !== 'undefined' ? errorCode : 1002, '');</span>
<span class="cstat-no" title="statement not covered" >    self.emit('error', (reason instanceof Error) ? reason : (new Error(reason)));</span>
  };
&nbsp;
  // finalize the client
<span class="cstat-no" title="statement not covered" >  this._sender = new SenderClass(socket, this.extensions);</span>
<span class="cstat-no" title="statement not covered" >  this._sender.on('error', <span class="fstat-no" title="function not covered" >function onerror(error) {</span></span>
...
<span class="cstat-no" title="statement not covered" >  stream.on('data', <span class="fstat-no" title="function not covered" >function incoming(data) {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  stream.on('end', <span class="fstat-no" title="function not covered" >function end() {</span></span>
<span class="cstat-no" title="statement not covered" >    if (instance.readyState !== WebSocket.OPEN) {</span>
<span class="cstat-no" title="statement not covered" >      if (typeof cb === 'function') <span class="cstat-no" title="statement not covered" >cb(new Error('not opened'));</span></span>
      else {
<span class="cstat-no" title="statement not covered" >        delete instance._queue;</span>
...
<span class="cstat-no" title="statement not covered" >  if (error || !this._closeReceived) {</span>
<span class="cstat-no" title="statement not covered" >    this._closeCode = 1006;</span>
  }
<span class="cstat-no" title="statement not covered" >  this.emit('close', this._closeCode || 1000, this._closeMessage || '');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (this._socket) {</span>
<span class="cstat-no" title="statement not covered" >    if (this._ultron) <span class="cstat-no" title="statement not covered" >this._ultron.destroy();</span></span>
<span class="cstat-no" title="statement not covered" >    this._socket.on('error', <span class="fstat-no" title="function not covered" >function onerror() {</span></span>
<span class="cstat-no" title="statement not covered" >      try { <span class="cstat-no" title="statement not covered" >this.destroy(); </span>}</span>
      catch (e) {}
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    try {</span>
...
<span class="cstat-no" title="statement not covered" >    this._sender.removeAllListeners();</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (this.extensions[PerMessageDeflate.extensionName]) {</span>
<span class="cstat-no" title="statement not covered" >    this.extensions[PerMessageDeflate.extensionName].cleanup();</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.extensions = null;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.removeAllListeners();</span>
<span class="cstat-no" title="statement not covered" >  this.on('error', <span class="fstat-no" title="function not covered" >function onerror() {</span>}); </span>// catch all errors after this
