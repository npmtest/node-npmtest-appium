...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/ws/lib/Receiver.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/ws/lib/Receiver.js</span></h1>
    <h2>
        
        Statements: <span class="metric">4.61% <small>(21 / 456)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">4.77% <small>(21 / 440)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/ws/lib/</a> &#187; Receiver.js</div>
</div>
<div class="body">
 ...
 */
&nbsp;
<span class="fstat-no" title="function not covered" >function Receiver (extensions,maxPayload) {</span>
<span class="cstat-no" title="statement not covered" >  if (this instanceof Receiver === false) {</span>
<span class="cstat-no" title="statement not covered" >    throw new TypeError("Classes can't be function-called");</span>
  }
<span class="cstat-no" title="statement not covered" >  if(typeof extensions==='number'){</span>
<span class="cstat-no" title="statement not covered" >    maxPayload=extensions;</span>
...
<span class="cstat-no" title="statement not covered" >  this.maxPayload = maxPayload || 0;</span>
<span class="cstat-no" title="statement not covered" >  this.currentPayloadLength = 0;</span>
...
<span class="cstat-no" title="statement not covered" >  this.currentMessageLength = 0;</span>
<span class="cstat-no" title="statement not covered" >  this.messageHandlers = [];</span>
 ...
 */
&nbsp;
Receiver.prototype.allocateFromPool = <span class="fstat-no" title="function not covered" >function(length, isFragmented) {</span>
<span class="cstat-no" title="statement not covered" >  return (isFragmented ? this.fragmentedBufferPool : this.unfragmentedBufferPool).get(length);</span>
};
&nbsp;
/**
...
<span class="cstat-no" title="statement not covered" >    if ((data[0] &amp; 0x30) != 0) {</span>
<span class="cstat-no" title="statement not covered" >      this.error('reserved fields (2, 3) must be empty', 1002);</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
  } else {
...
<span class="cstat-no" title="statement not covered" >  var compressed = (data[0] &amp; 0x40) == 0x40;</span>
...
<span class="cstat-no" title="statement not covered" >      this.error('continuation frame cannot have the Per-message Compressed bits', 1002);</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
    // continuation frame
...
<span class="cstat-no" title="statement not covered" >    if (opcode &gt;= 8 &amp;&amp; compressed) {</span>
<span class="cstat-no" title="statement not covered" >      this.error('control frames cannot have the Per-message Compressed bits', 1002);</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
<span class="cstat-no" title="statement not covered" >    this.state.compressed = compressed;</span>
...
<span class="cstat-no" title="statement not covered" >  if (!this.state.fragmentedOperation) <span class="cstat-no" title="statement not covered" >this.unfragmentedBufferPool.reset(true);</span></span>
  else <span class="cstat-no" title="statement not covered" >if (this.state.lastFragment) <span class="cstat-no" title="statement not covered" >this.fragmentedBufferPool.reset(true);</span></span>
<span class="cstat-no" title="statement not covered" >  this.expectOffset = 0;</span>
<span class="cstat-no" title="statement not covered" >  this.expectBuffer = null;</span>
<span class="cstat-no" title="statement not covered" >  this.expectHandler = null;</span>
...
<span class="cstat-no" title="statement not covered" >    this.onerror(new Error(reason), protocolErrorCode);</span>
  }
  else <span class="cstat-no" title="statement not covered" >if(reason.constructor == Error){</span>
<span class="cstat-no" title="statement not covered" >    this.onerror(reason, protocolErrorCode);</span>
  }
  else{
<span class="cstat-no" title="statement not covered" >    this.onerror(new Error("An error occured"),protocolErrorCode);</span>
  }
 ...
 */
&nbsp;
Receiver.prototype.flush = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  if (this.processing || this.dead) <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var handler = this.messageHandlers.shift();</span>
...
<span class="cstat-no" title="statement not covered" >    self.processing = false;</span>
 ...
 */
&nbsp;
Receiver.prototype.applyExtensions = <span class="fstat-no" title="function not covered" >function(messageBuffer, fin, compressed, callback) {</span>
<span class="cstat-no" title="statement not covered" >  var self = this;</span>
<span class="cstat-no" title="statement not covered" >  if (compressed) {</span>
<span class="cstat-no" title="statement not covered" >    this.extensions[PerMessageDeflate.extensionName].decompress(messageBuffer, fin, <span class="fstat-no" title="function not covered" >function(err, buffer) {</span></span>
<span class="cstat-no" title="statement not covered" >      if (self.dead) <span class="cstat-no" title="statement not covered" >return;</span></span>
<span class="cstat-no" title="statement not covered" >      if (err) {</span>
<span class="cstat-no" title="statement not covered" >        callback(new Error('invalid compressed data'));</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
<span class="cstat-no" title="statement not covered" >      callback(null, buffer);</span>
    });
  } else {
<span class="cstat-no" title="statement not covered" >    callback(null, messageBuffer);</span>
  }
};
&nbsp;
/**
...
* @api private
*/
Receiver.prototype.maxPayloadExceeded = <span class="fstat-no" title="function not covered" >function(length) {</span>
<span class="cstat-no" title="statement not covered" >  if (this.maxPayload=== undefined || this.maxPayload === null || this.maxPayload &lt; 1) {</span>
<span class="cstat-no" title="statement not covered" >    return false;</span>
  }
<span class="cstat-no" title="statement not covered" >  var fullLength = this.currentPayloadLength + length;</span>
<span class="cstat-no" title="statement not covered" >  if (fullLength &lt; this.maxPayload) {</span>
<span class="cstat-no" title="statement not covered" >    this.currentPayloadLength = fullLength;</span>
<span class="cstat-no" title="statement not covered" >    return false;</span>
  }
<span class="cstat-no" title="statement not covered" >  this.error('payload cannot exceed ' + this.maxPayload + ' bytes', 1009);</span>
...
<span class="cstat-no" title="statement not covered" >      cloned[k] = obj[k];</span>
    }
  }
...
<span class="cstat-no" title="statement not covered" >        if (self.maxPayloadExceeded(firstLength)){</span>
<span class="cstat-no" title="statement not covered" >          self.error('Maximumpayload exceeded in compressed text message. Aborting...', 1009);</span>
<span class="cstat-no" title="statement not covered" >          return;</span>
        }
...
<span class="cstat-no" title="statement not covered" >          var length = readUInt16BE.call(data, 0);</span>
<span class="cstat-no" title="statement not covered" >          if (self.maxPayloadExceeded(length)){</span>
<span class="cstat-no" title="statement not covered" >            self.error('Maximumpayload exceeded in compressed text message. Aborting...', 1009);</span>
<span class="cstat-no" title="statement not covered" >            return;</span>
          }
<span class="cstat-no" title="statement not covered" >          opcodes['1'].getData.call(self, length);</span>
        });
      }
...
<span class="cstat-no" title="statement not covered" >          var length = readUInt32BE.call(data, 4);</span>
<span class="cstat-no" title="statement not covered" >          if (self.maxPayloadExceeded(length)){</span>
<span class="cstat-no" title="statement not covered" >            self.error('Maximumpayload exceeded in compressed text message. Aborting...', 1009);</span>
<span class="cstat-no" title="statement not covered" >            return;</span>
          }
...
<span class="cstat-no" title="statement not covered" >      var self = this;</span>
<span class="cstat-no" title="statement not covered" >      var packet = this.unmask(mask, data, true) || new Buffer(0);</span>
<span class="cstat-no" title="statement not covered" >      var state = clone(this.state);</span>
<span class="cstat-no" title="statement not covered" >      this.messageHandlers.push(<span class="fstat-no" title="function not covered" >function(callback) {</span></span>
<span class="cstat-no" title="statement not covered" >        self.applyExtensions(packet, state.lastFragment, state.compressed, <span class="fstat-no" title="function not covered" >function(err, buffer) {</span></span>
<span class="cstat-no" title="statement not covered" >          if (err) {</span>
<span class="cstat-no" title="statement not covered" >            if(err.type===1009){</span>
<span class="cstat-no" title="statement not covered" >                return self.error('Maximumpayload exceeded in compressed text message. Aborting...', 1009);</span>
            }
<span class="cstat-no" title="statement not covered" >            return self.error(err.message, 1007);</span>
          }
<span class="cstat-no" title="statement not covered" >          if (buffer != null) {</span>
<span class="cstat-no" title="statement not covered" >            if( self.maxPayload==0 || (self.maxPayload &gt; 0 &amp;&amp; (self.currentMessageLength + buffer.length) &lt; self.maxPayload) ){</span>
<span class="cstat-no" title="statement not covered" >              self.currentMessage.push(buffer);</span>
            }
            else{
<span class="cstat-no" title="statement not covered" >                self.currentMessage=null;</span>
<span class="cstat-no" title="statement not covered" >                self.currentMessage = [];</span>
<span class="cstat-no" title="statement not covered" >                self.currentMessageLength = 0;</span>
<span class="cstat-no" title="statement not covered" >                self.error(new Error('Maximum payload exceeded. maxPayload: '+self.maxPayload), 1009);</span>
<span class="cstat-no" title="statement not covered" >                return;</span>
            }
<span class="cstat-no" title="statement not covered" >            self.currentMessageLength += buffer.length;</span>
          }
<span class="cstat-no" title="statement not covered" >          if (state.lastFragment) {</span>
<span class="cstat-no" title="statement not covered" >            var messageBuffer = Buffer.concat(self.currentMessage);</span>
<span class="cstat-no" title="statement not covered" >            self.currentMessage = [];</span>
<span class="cstat-no" title="statement not covered" >            self.currentMessageLength = 0;</span>
<span class="cstat-no" title="statement not covered" >            if (!isValidUTF8(messageBuffer)) {</span>
<span class="cstat-no" title="statement not covered" >              self.error('invalid utf8 sequence', 1007);</span>
<span class="cstat-no" title="statement not covered" >              return;</span>
            }
<span class="cstat-no" title="statement not covered" >            self.ontext(messageBuffer.toString('utf8'), {masked: state.masked, buffer: messageBuffer});</span>
          }
...
<span class="cstat-no" title="statement not covered" >      if (firstLength &lt; 126) {</span>
<span class="cstat-no" title="statement not covered" >          if (self.maxPayloadExceeded(firstLength)){</span>
<span class="cstat-no" title="statement not covered" >            self.error('Max payload exceeded in compressed text message. Aborting...', 1009);</span>
<span class="cstat-no" title="statement not covered" >            return;</span>
          }
...
<span class="cstat-no" title="statement not covered" >          opcodes['2'].getData.call(self, length);</span>
        });
      }
      else <span class="cstat-no" title="statement not covered" >if (firstLength == 127) {</span>
<span class="cstat-no" title="statement not covered" >        self.expectHeader(8, <span class="fstat-no" title="function not covered" >function(data) {</span></span>
...
<span class="cstat-no" title="statement not covered" >          var length = readUInt32BE.call(data, 4, true);</span>
<span class="cstat-no" title="statement not covered" >          if (self.maxPayloadExceeded(length)){</span>
<span class="cstat-no" title="statement not covered" >            self.error('Max payload exceeded in compressed text message. Aborting...', 1009);</span>
<span class="cstat-no" title="statement not covered" >            return;</span>
          }
...
<span class="cstat-no" title="statement not covered" >          if (err) {</span>
<span class="cstat-no" title="statement not covered" >            if(err.type===1009){</span>
<span class="cstat-no" title="statement not covered" >                return self.error('Max payload exceeded in compressed binary message. Aborting...', 1009);</span>
            }
<span class="cstat-no" title="statement not covered" >            return self.error(err.message, 1007);</span>
          }
<span class="cstat-no" title="statement not covered" >          if (buffer != null) {</span>
...
<span class="cstat-no" title="statement not covered" >                self.currentMessage = [];</span>
<span class="cstat-no" title="statement not covered" >                self.currentMessageLength = 0;</span>
<span class="cstat-no" title="statement not covered" >                self.error(new Error('Maximum payload exceeded'), 1009);</span>
<span class="cstat-no" title="statement not covered" >                return;</span>
            }
<span class="cstat-no" title="statement not covered" >            self.currentMessageLength += buffer.length;</span>
          }
...
<span class="cstat-no" title="statement not covered" >            self.currentMessage = [];</span>
<span class="cstat-no" title="statement not covered" >            self.currentMessageLength = 0;</span>
<span class="cstat-no" title="statement not covered" >            self.onbinary(messageBuffer, {masked: state.masked, buffer: messageBuffer});</span>
          }
<span class="cstat-no" title="statement not covered" >          callback();</span>
        });
      });
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      var state = clone(this.state);</span>
<span class="cstat-no" title="statement not covered" >      this.messageHandlers.push(<span class="fstat-no" title="function not covered" >function() {</span></span>
...
<span class="cstat-no" title="statement not covered" >        self.onclose(code, message, {masked: state.masked});</span>
...
<span class="cstat-no" title="statement not covered" >          opcodes['9'].finish.call(self, null, data);</span>
    ...
    finish: <span class="fstat-no" title="function not covered" >function(mask, data) {</span>
<span class="cstat-no" title="statement not covered" >      var self = this;</span>
<span class="cstat-no" title="statement not covered" >      data = this.unmask(mask, data, true);</span>
<span class="cstat-no" title="statement not covered" >      var state = clone(this.state);</span>
<span class="cstat-no" title="statement not covered" >      this.messageHandlers.push(<span class="fstat-no" title="function not covered" >function(callback) {</span></span>
<span class="cstat-no" title="statement not covered" >        self.onping(data, {masked: state.masked, binary: true});</span>
<span class="cstat-no" title="statement not covered" >        callback();</span>
      });
<span class="cstat-no" title="statement not covered" >      this.flush();</span>
<span class="cstat-no" title="statement not covered" >      this.endPacket();</span>
...
<span class="cstat-no" title="statement not covered" >      var state = clone(this.state);</span>
<span class="cstat-no" title="statement not covered" >      this.messageHandlers.push(<span class="fstat-no" title="function not covered" >function(callback) {</span></span>
<span class="cstat-no" title="statement not covered" >        self.onpong(data, {masked: state.masked, binary: true});</span>
<span class="cstat-no" title="statement not covered" >        callback();</span>
      });
<span class="cstat-no" title="statement not covered" >      this.flush();</span>
<span class="cstat-no" title="statement not covered" >      this.endPacket();</span>
