...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-base-driver/build/lib/express/server.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-base-driver/build/lib/express/server.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-base-driver/build/lib/express/</a> &#187; server.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >function server(configureRoutes, port) {</span>
<span class="cstat-no" title="statement not covered" >  var hostname = arguments.length &lt;= 2 || arguments[2] === undefined ? null : arguments[2];</span>
<span class="cstat-no" title="statement not covered" >  var app, httpServer, close;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function server$(context$1$0) {</span></span>
...
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        app = (0, _express2['default'])();</span>
<span class="cstat-no" title="statement not covered" >        httpServer = _http2['default'].createServer(app);</span>
<span class="cstat-no" title="statement not covered" >        close = httpServer.close.bind(httpServer);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        httpServer.close = <span class="fstat-no" title="function not covered" >function callee$1$0() {</span></span>
...
<span class="cstat-no" title="statement not covered" >                  httpServer.on('close', resolve);</span>
<span class="cstat-no" title="statement not covered" >                  close(<span class="fstat-no" title="function not covered" >function (err) {</span></span>
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(new _Promise(<span class="fstat-no" title="function not covered" >function (resolve, reject) {</span></span>
<span class="cstat-no" title="statement not covered" >          httpServer.on('error', <span class="fstat-no" title="function not covered" >function (err) {</span></span>
<span class="cstat-no" title="statement not covered" >            if (err.code === 'EADDRNOTAVAIL') {</span>
<span class="cstat-no" title="statement not covered" >              _logger2['default'].error('Could not start REST http interface listener. ' + 'Requested address is not available.');</span>
            } else {
<span class="cstat-no" title="statement not covered" >              _logger2['default'].error('Could not start REST http interface listener. The requested ' + 'port may already be in use. Please make sure there is no ' + 'other instance of this server running already.');</span>
            }
<span class="cstat-no" title="statement not covered" >            reject(err);</span>
          });
<span class="cstat-no" title="statement not covered" >          httpServer.on('connection', <span class="fstat-no" title="function not covered" >function (socket) {</span></span>
<span class="cstat-no" title="statement not covered" >            socket.setTimeout(600 * 1000); </span>// 10 minute timeout
          });
<span class="cstat-no" title="statement not covered" >          configureServer(app, configureRoutes);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          var serverArgs = [port];</span>
...
<span class="cstat-no" title="statement not covered" >            serverArgs.push(hostname);</span>
          }
<span class="cstat-no" title="statement not covered" >          httpServer.listen.apply(httpServer, serverArgs.concat([<span class="fstat-no" title="function not covered" >function (err) {</span></span>
<span class="cstat-no" title="statement not covered" >            if (err) {</span>
<span class="cstat-no" title="statement not covered" >              reject(err);</span>
            }
<span class="cstat-no" title="statement not covered" >            resolve(httpServer);</span>
          }]));
        }));
&nbsp;
      case 6:
...
&nbsp;
<span class="fstat-no" title="function not covered" >function configureServer(app, configureRoutes) {</span>
<span class="cstat-no" title="statement not covered" >  app.use(_expressLogging.endLogFormatter);</span>
&nbsp;
  // set up static assets
<span class="cstat-no" title="statement not covered" >  app.use((0, _serveFavicon2['default'])(_path2['default'].resolve(_static.STATIC_DIR, 'favicon.ico')));</span>
<span class="cstat-no" title="statement not covered" >  app.use(_express2['default']['static'](_static.STATIC_DIR));</span>
&nbsp;
  // crash routes, for testing
<span class="cstat-no" title="statement not covered" >  app.use('/wd/hub/produce_error', _crash.produceError);</span>
<span class="cstat-no" title="statement not covered" >  app.use('/wd/hub/crash', _crash.produceCrash);</span>
&nbsp;
  // add middlewares
<span class="cstat-no" title="statement not covered" >  app.use(_middleware.allowCrossDomain);</span>
<span class="cstat-no" title="statement not covered" >  app.use(_middleware.fixPythonContentType);</span>
<span class="cstat-no" title="statement not covered" >  app.use(_middleware.defaultToJSONContentType);</span>
...
<span class="cstat-no" title="statement not covered" >  app.use(_middleware.catch4XXHandler);</span>
<span class="cstat-no" title="statement not covered" >  app.use(_middleware.catchAllHandler);</span>
&nbsp;
  // make sure appium never fails because of a file size upload limit
<span class="cstat-no" title="statement not covered" >  app.use(_bodyParser2['default'].json({ limit: '1gb' }));</span>
&nbsp;
  // set up start logging (which depends on bodyParser doing its thing)
<span class="cstat-no" title="statement not covered" >  app.use(_expressLogging.startLogFormatter);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  configureRoutes(app);</span>
&nbsp;
  // dynamic routes for testing, etc.
<span class="cstat-no" title="statement not covered" >  app.all('/welcome', _static.welcome);</span>
<span class="cstat-no" title="statement not covered" >  app.all('/test/guinea-pig', _static.guineaPig);</span>
<span class="cstat-no" title="statement not covered" >  app.all('/test/guinea-pig-scrollable', _static.guineaPigScrollable);</span>
&nbsp;
  // catch this last, so anything that falls through is 404ed
<span class="cstat-no" title="statement not covered" >  app.use(_middleware.catch404Handler);</span>
}
&nbsp;
