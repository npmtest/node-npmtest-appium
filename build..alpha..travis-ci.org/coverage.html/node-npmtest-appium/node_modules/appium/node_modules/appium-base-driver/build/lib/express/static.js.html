...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-base-driver/build/lib/express/static.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-base-driver/build/lib/express/static.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-base-driver/build/lib/express/</a> &#187; static.js</div>
</div>
<div class="body">
...
<span class="missing-if-branch" title="if path not taken" >I</span>if (_lodash2['default'].isNull(_path2['default'].resolve(__dirname).match(/build[\/\\]lib[\/\\]express$/))) {
  // in some contexts we are not in the build directory,
  // so we don't want to go back the extra level
<span class="cstat-no" title="statement not covered" >  exports.STATIC_DIR = STATIC_DIR = _path2['default'].resolve(__dirname, '..', '..', 'static');</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function guineaPigTemplate(req, res, page) {</span>
<span class="cstat-no" title="statement not covered" >  var delay, params;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function guineaPigTemplate$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        delay = parseInt(req.params.delay || req.query.delay || 0);</span>
...
<span class="cstat-no" title="statement not covered" >          params.comment = req.body.comments || params.comment;</span>
        }
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Sending guinea pig response with params: ' + JSON.stringify(params));</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Waiting ' + delay + 'ms before responding');</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 8;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_bluebird2['default'].delay(delay));</span>
&nbsp;
      case 8:
<span class="cstat-no" title="statement not covered" >        res.set('Content-Type', 'text/html');</span>
<span class="cstat-no" title="statement not covered" >        res.cookie('guineacookie1', 'i am a cookie value', { path: '/' });</span>
<span class="cstat-no" title="statement not covered" >        res.cookie('guineacookie2', 'cookié2', { path: '/' });</span>
<span class="cstat-no" title="statement not covered" >        res.cookie('guineacookie3', 'cant access this', {</span>
          domain: '.blargimarg.com',
          path: '/'
        });
<span class="cstat-no" title="statement not covered" >        context$1$0.t0 = res;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 15;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(getTemplate(page));</span>
&nbsp;
      case 15:
<span class="cstat-no" title="statement not covered" >        context$1$0.t1 = params;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.t2 = (0, context$1$0.sent)(context$1$0.t1);</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.t0.send.call(context$1$0.t0, context$1$0.t2);</span>
&nbsp;
      case 18:
      case 'end':
 ...
 */
<span class="fstat-no" title="function not covered" >function guineaPig(req, res) {</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function guineaPig$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(guineaPigTemplate(req, res, 'guinea-pig.html'));</span>
&nbsp;
      case 2:
 ...
 * Dynamic page mapped to /test/guinea-pig
 */
<span class="fstat-no" title="function not covered" >function guineaPigScrollable(req, res) {</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function guineaPigScrollable$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(guineaPigTemplate(req, res, 'guinea-pig-scrollable.html'));</span>
&nbsp;
      case 2:
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', context$1$0.sent);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function welcome$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        params = { message: 'Let\'s browse!' };</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].debug('Sending welcome response with params: ' + JSON.stringify(params));</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.t0 = res;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 5;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(getTemplate('welcome.html'));</span>
&nbsp;
      case 5:
<span class="cstat-no" title="statement not covered" >        context$1$0.t1 = params;</span>
<span class="cstat-no" title="statement not covered" >        context$1$0.t2 = (0, context$1$0.sent)(context$1$0.t1);</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function getTemplate(templateName) {</span>
<span class="cstat-no" title="statement not covered" >  var content;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function getTemplate$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_appiumSupport.fs.readFile(_path2['default'].resolve(STATIC_DIR, 'test', templateName)));</span>
&nbsp;
      case 2:
<span class="cstat-no" title="statement not covered" >        content = context$1$0.sent;</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', _lodash2['default'].template(content.toString()));</span>
&nbsp;
      case 4:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
