...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-base-driver/build/lib/jsonwp-status/status.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-base-driver/build/lib/jsonwp-status/status.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-base-driver/build/lib/jsonwp-status/</a> &#187; status.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >function getSummaryByCode(code) {</span>
...
<span class="cstat-no" title="statement not covered" >    for (var _iterator = _getIterator(_lodash2['default'].values(codes)), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {</span>
<span class="cstat-no" title="statement not covered" >      var obj = _step.value;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (!_lodash2['default'].isUndefined(obj.code) &amp;&amp; obj.code === code) {</span>
<span class="cstat-no" title="statement not covered" >        return obj.summary;</span>
      }
    }
  } catch (err) {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  return 'An error occurred';</span>
}
&nbsp;
