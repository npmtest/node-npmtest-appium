...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-base-driver/build/lib/basedriver/commands/session.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-base-driver/build/lib/basedriver/commands/session.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-base-driver/build/lib/basedriver/commands/</a> &#187; session.js</div>
</div>
<div class="body">
...
var commands = {};
&nbsp;
commands.createSession = <span class="fstat-no" title="function not covered" >function callee$0$0(caps) {</span>
...
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        if (!(this.sessionId !== null)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        throw new _mjsonwp.errors.SessionNotCreatedError('Cannot create a new session ' + 'while one is in progress');</span>
&nbsp;
      case 2:
<span class="cstat-no" title="statement not covered" >        caps = fixCaps(caps, this.desiredCapConstraints);</span>
<span class="cstat-no" title="statement not covered" >        this.validateDesiredCaps(caps);</span>
<span class="cstat-no" title="statement not covered" >        this.sessionId = _uuidJs2['default'].create().hex;</span>
<span class="cstat-no" title="statement not covered" >        this.caps = caps;</span>
<span class="cstat-no" title="statement not covered" >        this.opts = _lodash2['default'].cloneDeep(this.initialOpts);</span>
&nbsp;
        // merge caps onto opts so we don't need to worry about what's where
<span class="cstat-no" title="statement not covered" >        _Object$assign(this.opts, this.caps);</span>
&nbsp;
        // deal with resets
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!(this.opts.noReset &amp;&amp; this.opts.fullReset)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 10;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        throw new Error("The 'noReset' and 'fullReset' capabilities are mutually " + "exclusive and should not both be set to true. You " + "probably meant to just use 'fullReset' on its own");</span>
&nbsp;
      case 10:
...
<span class="cstat-no" title="statement not covered" >        if (typeof this.opts.app === 'string' &amp;&amp; this.opts.app.trim() === '') {</span>
<span class="cstat-no" title="statement not covered" >          this.opts.app = null;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!_lodash2['default'].isUndefined(this.caps.newCommandTimeout)) {</span>
<span class="cstat-no" title="statement not covered" >          this.newCommandTimeoutMs = this.caps.newCommandTimeout * 1000;</span>
        }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].info('Session created with session id: ' + this.sessionId);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', [this.sessionId, caps]);</span>
&nbsp;
      case 19:
      case 'end':
...
&nbsp;
commands.getSessions = <span class="fstat-no" title="function not covered" >function callee$0$0() {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', ret);</span>
&nbsp;
      case 3:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
commands.getSession = <span class="fstat-no" title="function not covered" >function callee$0$0() {</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        if (!this.caps.eventTimings) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', _Object$assign({}, this.caps, { events: this.eventHistory }));</span>
&nbsp;
      case 2:
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', this.caps);</span>
&nbsp;
      case 3:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
commands.deleteSession = <span class="fstat-no" title="function not covered" >function callee$0$0() {</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
...
&nbsp;
<span class="fstat-no" title="function not covered" >function fixCaps(originalCaps) {</span>
<span class="cstat-no" title="statement not covered" >  var desiredCapConstraints = arguments.length &lt;= 1 || arguments[1] === undefined ? {} : arguments[1];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var caps = _lodash2['default'].clone(originalCaps);</span>
&nbsp;
  // boolean capabilities can be passed in as strings 'false' and 'true'
  // which we want to translate into boolean values
<span class="cstat-no" title="statement not covered" >  var booleanCaps = _lodash2['default'].keys(_lodash2['default'].pickBy(desiredCapConstraints, <span class="fstat-no" title="function not covered" >function (k) {</span></span>
<span class="cstat-no" title="statement not covered" >    return k.isBoolean === true;</span>
  }));
...
<span class="cstat-no" title="statement not covered" >    for (var _iterator = _getIterator(booleanCaps), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {</span>
<span class="cstat-no" title="statement not covered" >      var cap = _step.value;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var value = originalCaps[cap];</span>
...
<span class="cstat-no" title="statement not covered" >          _logger2['default'].warn('Capability \'' + cap + '\' changed from string to boolean. This may cause unexpected behavior');</span>
<span class="cstat-no" title="statement not covered" >          caps[cap] = value === 'true';</span>
        }
      }
    }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  var intCaps = _lodash2['default'].keys(_lodash2['default'].pickBy(desiredCapConstraints, <span class="fstat-no" title="function not covered" >function (k) {</span></span>
<span class="cstat-no" title="statement not covered" >    return k.isNumber === true;</span>
  }));
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  try {</span>
<span class="cstat-no" title="statement not covered" >    for (var _iterator2 = _getIterator(intCaps), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {</span>
<span class="cstat-no" title="statement not covered" >      var cap = _step2.value;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var value = originalCaps[cap];</span>
<span class="cstat-no" title="statement not covered" >      if (_lodash2['default'].isString(value)) {</span>
<span class="cstat-no" title="statement not covered" >        var newValue = parseInt(value, 10);</span>
<span class="cstat-no" title="statement not covered" >        if (value.indexOf('.') !== -1) {</span>
<span class="cstat-no" title="statement not covered" >          newValue = parseFloat(value);</span>
        }
<span class="cstat-no" title="statement not covered" >        _logger2['default'].warn('Capability \'' + cap + '\' changed from string (\'' + value + '\') to integer (' + newValue + '). This may cause unexpected behavior');</span>
<span class="cstat-no" title="statement not covered" >        caps[cap] = newValue;</span>
      }
    }
  } catch (err) {
