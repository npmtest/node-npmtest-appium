...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-base-driver/build/lib/mjsonwp/validators.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-base-driver/build/lib/mjsonwp/validators.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-base-driver/build/lib/mjsonwp/</a> &#187; validators.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >  return _lodash2['default'].isNumber(o) || !_lodash2['default'].isNaN(parseInt(o)) || !_lodash2['default'].isNaN(parseFloat(o));</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function msValidator(ms) {</span>
<span class="cstat-no" title="statement not covered" >  if (!_lodash2['default'].isNumber(ms) || ms &lt; 0) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('Wait ms must be a number equal to 0 or greater');</span>
  }
}
&nbsp;
var validators = {
  setUrl: <span class="fstat-no" title="function not covered" >function setUrl(url) {</span>
    // either an `xyz://`, `about:`, or `data:` scheme is allowed
<span class="cstat-no" title="statement not covered" >    if (!url || !url.match(/^([a-zA-Z0-9_-]+:\/\/)|(about:)|(data:)/)) {</span>
<span class="cstat-no" title="statement not covered" >      throw new Error('Url or Uri must start with &lt;scheme&gt;://');</span>
    }
  },
  implicitWait: <span class="fstat-no" title="function not covered" >function implicitWait(ms) {</span>
<span class="cstat-no" title="statement not covered" >    msValidator(ms);</span>
  },
  asyncScriptTimeout: <span class="fstat-no" title="function not covered" >function asyncScriptTimeout(ms) {</span>
<span class="cstat-no" title="statement not covered" >    msValidator(ms);</span>
  },
  timeouts: <span class="fstat-no" title="function not covered" >function timeouts(type, ms) {</span>
<span class="cstat-no" title="statement not covered" >    msValidator(ms);</span>
<span class="cstat-no" title="statement not covered" >    if (!_lodash2['default'].includes(['script', 'implicit', 'page load', 'command'], type)) {</span>
<span class="cstat-no" title="statement not covered" >      throw new Error('\'' + type + '\' is not a valid timeout type');</span>
    }
  },
  clickCurrent: <span class="fstat-no" title="function not covered" >function clickCurrent(button) {</span>
<span class="cstat-no" title="statement not covered" >    if (!(isNumber(button) || _lodash2['default'].isUndefined(button)) || button &lt; 0 || button &gt; 2) {</span>
<span class="cstat-no" title="statement not covered" >      throw new Error('Click button must be 0, 1, or 2');</span>
    }
  },
  setNetworkConnection: <span class="fstat-no" title="function not covered" >function setNetworkConnection(type) {</span>
<span class="cstat-no" title="statement not covered" >    if (!isNumber(type) || [0, 1, 2, 4, 6].indexOf(type) === -1) {</span>
<span class="cstat-no" title="statement not covered" >      throw new Error('Network type must be one of 0, 1, 2, 4, 6');</span>
    }
  }
};
&nbsp;
