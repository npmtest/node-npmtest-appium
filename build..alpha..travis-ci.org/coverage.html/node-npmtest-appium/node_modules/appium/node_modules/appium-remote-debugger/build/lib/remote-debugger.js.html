...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-remote-debugger/build/lib/remote-debugger.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-remote-debugger/build/lib/remote-debugger.js</span></h1>
    <h2>
        
        Statements: <span class="metric">7.61% <small>(55 / 723)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">7.85% <small>(55 / 701)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-remote-debugger/build/lib/</a> &#187; remote-debugger.js</div>
</div>
<div class="body">
...
1497
1498
1499</td><td class="line-coverage"><span class="cline-any cline-yes">1</span>
...
&nbsp;
   ...
   */
&nbsp;
<span class="fstat-no" title="function not covered" >  function RemoteDebugger() {</span>
<span class="cstat-no" title="statement not covered" >    var opts = arguments.length &lt;= 0 || arguments[0] === undefined ? {} : arguments[0];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, RemoteDebugger);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _get(Object.getPrototypeOf(RemoteDebugger.prototype), 'constructor', this).call(this);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var bundleId = opts.bundleId;</span>
<span class="cstat-no" title="statement not covered" >    var platformVersion = opts.platformVersion;</span>
<span class="cstat-no" title="statement not covered" >    var debuggerType = opts.debuggerType;</span>
<span class="cstat-no" title="statement not covered" >    var useNewSafari = opts.useNewSafari;</span>
<span class="cstat-no" title="statement not covered" >    var pageLoadMs = opts.pageLoadMs;</span>
<span class="cstat-no" title="statement not covered" >    var host = opts.host;</span>
<span class="cstat-no" title="statement not covered" >    var port = opts.port;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.bundleId = bundleId;</span>
<span class="cstat-no" title="statement not covered" >    this.platformVersion = platformVersion;</span>
<span class="cstat-no" title="statement not covered" >    this.debuggerType = debuggerType || DEBUGGER_TYPES.webinspector;</span>
<span class="cstat-no" title="statement not covered" >    if (this.debuggerType === DEBUGGER_TYPES.webinspector) {</span>
<span class="cstat-no" title="statement not covered" >      this.useNewSafari = useNewSafari || false;</span>
<span class="cstat-no" title="statement not covered" >      this.pageLoadMs = pageLoadMs;</span>
<span class="cstat-no" title="statement not covered" >      _logger2['default'].debug('useNewSafari --&gt; ' + this.useNewSafari);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.host = host || 'localhost';</span>
<span class="cstat-no" title="statement not covered" >    this.port = port || REMOTE_DEBUGGER_PORT;</span>
  }
&nbsp;
...
&nbsp;
  _createClass(RemoteDebugger, [{
    key: 'setup',
    value: <span class="fstat-no" title="function not covered" >function setup() {</span>
      // app handling configuration
<span class="cstat-no" title="statement not covered" >      this.appDict = {};</span>
<span class="cstat-no" title="statement not covered" >      this.appIdKey = null;</span>
<span class="cstat-no" title="statement not covered" >      this.pageIdKey = null;</span>
<span class="cstat-no" title="statement not covered" >      this.pageLoading = false;</span>
&nbsp;
      // set up the special callbacks for handling rd events
<span class="cstat-no" title="statement not covered" >      this.specialCbs = {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.rpcClient = null;</span>
    }
  }, {
    key: 'teardown',
    value: <span class="fstat-no" title="function not covered" >function teardown() {</span>
<span class="cstat-no" title="statement not covered" >      _logger2['default'].debug('Cleaning up listeners');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.appDict = {};</span>
<span class="cstat-no" title="statement not covered" >      this.appIdKey = null;</span>
<span class="cstat-no" title="statement not covered" >      this.pageIdKey = null;</span>
...
<span class="cstat-no" title="statement not covered" >      var appInfo;</span>
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function connect$(context$2$0) {</span></span>
...
<span class="cstat-no" title="statement not covered" >            this.rpcClient = new _remoteDebuggerRpcClient2['default'](this.host, this.port, this.specialCbs);</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 4;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.rpcClient.connect());</span>
&nbsp;
          case 4:
...
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.setConnectionKey());</span>
&nbsp;
          case 7:
<span class="cstat-no" title="statement not covered" >            appInfo = context$2$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Connected to application');</span>
<span class="cstat-no" title="statement not covered" >            return context$2$0.abrupt('return', appInfo);</span>
&nbsp;
          case 12:
...
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.disconnect());</span>
&nbsp;
          case 16:
<span class="cstat-no" title="statement not covered" >            return context$2$0.abrupt('return', null);</span>
&nbsp;
          case 17:
          case 'end':
...
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function disconnect$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.rpcClient.disconnect());</span>
&nbsp;
          case 2:
<span class="cstat-no" title="statement not covered" >            this.teardown();</span>
<span class="cstat-no" title="statement not covered" >            this.emit(RemoteDebugger.EVENT_DISCONNECT, true);</span>
&nbsp;
          case 4:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
...
<span class="cstat-no" title="statement not covered" >      return !!(this.rpcClient &amp;&amp; this.rpcClient.isConnected());</span>
    }
  }, {
    key: 'logApplicationDictionary',
    value: <span class="fstat-no" title="function not covered" >function logApplicationDictionary(apps) {</span>
<span class="fstat-no" title="function not covered" >      function getValueString(key, value) {</span>
<span class="cstat-no" title="statement not covered" >        if (_lodash2['default'].isFunction(value)) {</span>
<span class="cstat-no" title="statement not covered" >          return '[Function]';</span>
        }
<span class="cstat-no" title="statement not covered" >        if (key === 'pageDict' &amp;&amp; !_lodash2['default'].isArray(value)) {</span>
<span class="cstat-no" title="statement not covered" >          return '"Waiting for data"';</span>
        }
...
<span class="cstat-no" title="statement not covered" >        for (var _iterator = _getIterator(_lodash2['default'].toPairs(apps)), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {</span>
<span class="cstat-no" title="statement not covered" >          var _step$value = _slicedToArray(_step.value, 2);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          var app = _step$value[0];</span>
<span class="cstat-no" title="statement not covered" >          var info = _step$value[1];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          _logger2['default'].debug('Application: \'' + app + '\'');</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >          try {</span>
<span class="cstat-no" title="statement not covered" >            for (var _iterator2 = _getIterator(_lodash2['default'].toPairs(info)), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {</span>
<span class="cstat-no" title="statement not covered" >              var _step2$value = _slicedToArray(_step2.value, 2);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >              var key = _step2$value[0];</span>
<span class="cstat-no" title="statement not covered" >              var value = _step2$value[1];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >              var valueString = getValueString(key, value);</span>
<span class="cstat-no" title="statement not covered" >              _logger2['default'].debug('    ' + key + ': ' + valueString);</span>
            }
          } catch (err) {
...
<span class="cstat-no" title="statement not covered" >            throw _iteratorError;</span>
    ...
    value: <span class="fstat-no" title="function not covered" >function setConnectionKey() {</span>
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function setConnectionKey$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >        var _this = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(new _bluebird2['default'](<span class="fstat-no" title="function not covered" >function (resolve, reject) {</span></span>
...
<span class="cstat-no" title="statement not covered" >              var connectCb = <span class="fstat-no" title="function not covered" >function connectCb(apps) {</span></span>
<span class="cstat-no" title="statement not covered" >                if (_lodash2['default'].isUndefined(apps) || _lodash2['default'].keys(apps).length === 0) {</span>
<span class="cstat-no" title="statement not covered" >                  _logger2['default'].debug('Received no apps from remote debugger. Unable to connect.');</span>
<span class="cstat-no" title="statement not covered" >                  return resolve(_this.appDict);</span>
                }
<span class="cstat-no" title="statement not covered" >                var newDict = {};</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                try {</span>
<span class="cstat-no" title="statement not covered" >                  for (var _iterator3 = _getIterator(_lodash2['default'].values(apps)), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {</span>
<span class="cstat-no" title="statement not covered" >                    var dict = _step3.value;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                    var _appInfoFromDict = (0, _helpers.appInfoFromDict)(dict);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                    var _appInfoFromDict2 = _slicedToArray(_appInfoFromDict, 2);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                    var id = _appInfoFromDict2[0];</span>
<span class="cstat-no" title="statement not covered" >                    var entry = _appInfoFromDict2[1];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                    newDict[id] = entry;</span>
                  }
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                _lodash2['default'].defaults(_this.appDict, newDict);</span>
<span class="cstat-no" title="statement not covered" >                resolve(newDict);</span>
              };
<span class="cstat-no" title="statement not covered" >              _this.rpcClient.setSpecialMessageHandler('_rpc_reportConnectedApplicationList:', reject, connectCb);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >              _logger2['default'].debug('Sending connection key request');</span>
<span class="cstat-no" title="statement not covered" >              return (<span class="fstat-no" title="function not covered" >function callee$3$0() {</span></span>
<span class="cstat-no" title="statement not covered" >                var _ref, _ref2, simNameKey, simBuildKey, simPlatformVersion;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                      return _regeneratorRuntime.awrap(this.rpcClient.send('setConnectionKey'));</span>
&nbsp;
                    case 2:
<span class="cstat-no" title="statement not covered" >                      _ref = context$4$0.sent;</span>
<span class="cstat-no" title="statement not covered" >                      _ref2 = _slicedToArray(_ref, 3);</span>
<span class="cstat-no" title="statement not covered" >                      simNameKey = _ref2[0];</span>
<span class="cstat-no" title="statement not covered" >                      simBuildKey = _ref2[1];</span>
<span class="cstat-no" title="statement not covered" >                      simPlatformVersion = _ref2[2];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                      _logger2['default'].debug('Sim name: ' + simNameKey);</span>
<span class="cstat-no" title="statement not covered" >                      _logger2['default'].debug('Sim build: ' + simBuildKey);</span>
<span class="cstat-no" title="statement not covered" >                      _logger2['default'].debug('Sim platform version: ' + simPlatformVersion);</span>
&nbsp;
                    case 10:
                    case 'end':
...
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    value: <span class="fstat-no" title="function not covered" >function updateAppsWithDict(dict) {</span>
      // get the dictionary entry into a nice form, and add it to the
      // application dictionary
<span class="cstat-no" title="statement not covered" >      this.appDict = this.appDict || {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var _appInfoFromDict3 = (0, _helpers.appInfoFromDict)(dict);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var _appInfoFromDict32 = _slicedToArray(_appInfoFromDict3, 2);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var id = _appInfoFromDict32[0];</span>
<span class="cstat-no" title="statement not covered" >      var entry = _appInfoFromDict32[1];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (this.appDict[id]) {</span>
        // preserve the page dictionary for this entry
<span class="cstat-no" title="statement not covered" >        entry.pageDict = this.appDict[id].pageDict;</span>
      }
<span class="cstat-no" title="statement not covered" >      this.appDict[id] = entry;</span>
&nbsp;
      // add a promise to get the page dictionary
<span class="cstat-no" title="statement not covered" >      if (_lodash2['default'].isUndefined(entry.pageDict)) {</span>
<span class="cstat-no" title="statement not covered" >        entry.pageDict = (0, _helpers.deferredPromise)();</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      _logger2['default'].debug('Current applications available:');</span>
<span class="cstat-no" title="statement not covered" >      this.logApplicationDictionary(this.appDict);</span>
&nbsp;
      // try to get the app id from our connected apps
<span class="cstat-no" title="statement not covered" >      if (!this.appIdKey) {</span>
<span class="cstat-no" title="statement not covered" >        this.appIdKey = (0, _helpers.getDebuggerAppKey)(this.bundleId, this.platformVersion, this.appDict);</span>
      }
    }
  }, {
    key: 'selectApp',
    value: <span class="fstat-no" title="function not covered" >function selectApp() {</span>
<span class="cstat-no" title="statement not covered" >      var currentUrl = arguments.length &lt;= 0 || arguments[0] === undefined ? null : arguments[0];</span>
<span class="cstat-no" title="statement not covered" >      var maxTries = arguments.length &lt;= 1 || arguments[1] === undefined ? SELECT_APP_RETRIES : arguments[1];</span>
<span class="cstat-no" title="statement not covered" >      var ignoreAboutBlankUrl = arguments.length &lt;= 2 || arguments[2] === undefined ? false : arguments[2];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var pageDict, appIdKey, i, possibleAppIds, _iteratorNormalCompletion4, _didIteratorError4, _iteratorError4, _iterator4, _step4, attemptedAppIdKey, _ref3, _ref32, found, _iteratorNormalCompletion5, _didIteratorError5, _iteratorError5, _iterator5, _step5, appDict, _iteratorNormalCompletion6, _didIteratorError6, _iteratorError6, _iterator6, _step6, dict, pagePromises, pageArray, fullPageArray, _iteratorNormalCompletion7, _didIteratorError7, _iteratorError7, _iterator7, _step7, _step7$value, app, info, id, _iteratorNormalCompletion8, _didIteratorError8, _iteratorError8, _iterator8, _step8, page, _pageDict;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function selectApp$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Selecting application');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (!(!this.appDict || _lodash2['default'].keys(this.appDict).length === 0)) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 4;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('No applications currently connected.');</span>
<span class="cstat-no" title="statement not covered" >            return context$2$0.abrupt('return', []);</span>
&nbsp;
          case 4:
<span class="cstat-no" title="statement not covered" >            pageDict = undefined, appIdKey = undefined;</span>
<span class="cstat-no" title="statement not covered" >            i = 0;</span>
&nbsp;
          case 6:
<span class="cstat-no" title="statement not covered" >            if (!(i &lt; maxTries)) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 114;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            possibleAppIds = (0, _helpers.getPossibleDebuggerAppKeys)(this.bundleId, this.platformVersion, this.appDict);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Trying out the possible app ids: ' + possibleAppIds.join(', '));</span>
...
<span class="cstat-no" title="statement not covered" >            context$2$0.prev = 12;</span>
<span class="cstat-no" title="statement not covered" >            _iterator4 = _getIterator(possibleAppIds);</span>
&nbsp;
          case 14:
<span class="cstat-no" title="statement not covered" >            if (_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 97;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            attemptedAppIdKey = _step4.value;</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.prev = 16;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Selecting app ' + attemptedAppIdKey + ' (try #' + (i + 1) + ' of ' + maxTries + ')');</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 20;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.rpcClient.selectApp(attemptedAppIdKey, this.onAppConnect.bind(this)));</span>
&nbsp;
          case 20:
<span class="cstat-no" title="statement not covered" >            _ref3 = context$2$0.sent;</span>
<span class="cstat-no" title="statement not covered" >            _ref32 = _slicedToArray(_ref3, 2);</span>
<span class="cstat-no" title="statement not covered" >            appIdKey = _ref32[0];</span>
<span class="cstat-no" title="statement not covered" >            pageDict = _ref32[1];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (!_lodash2['default'].isEmpty(pageDict)) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 27;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Empty page dictionary received. Trying again.');</span>
<span class="cstat-no" title="statement not covered" >            return context$2$0.abrupt('continue', 94);</span>
&nbsp;
          case 27:
&nbsp;
            // save the page array for this app
<span class="cstat-no" title="statement not covered" >            this.appDict[appIdKey].pageDict = (0, _helpers.pageArrayFromDict)(pageDict);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            context$2$0.prev = 32;</span>
<span class="cstat-no" title="statement not covered" >            _iterator5 = _getIterator(_lodash2['default'].values(this.appDict));</span>
&nbsp;
          case 34:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            appDict = _step5.value;</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            return context$2$0.abrupt('break', 70);</span>
&nbsp;
          case 38:
<span class="cstat-no" title="statement not covered" >            _iteratorNormalCompletion6 = true;</span>
<span class="cstat-no" title="statement not covered" >            _didIteratorError6 = false;</span>
<span class="cstat-no" title="statement not covered" >            _iteratorError6 = undefined;</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.prev = 41;</span>
<span class="cstat-no" title="statement not covered" >            _iterator6 = _getIterator(appDict.pageDict || []);</span>
&nbsp;
          case 43:
<span class="cstat-no" title="statement not covered" >            if (_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 53;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            dict = _step6.value;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (!((!ignoreAboutBlankUrl || dict.url !== 'about:blank') &amp;&amp; (!currentUrl || dict.url === currentUrl))) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 50;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
            }
&nbsp;
            // save where we found the right page
<span class="cstat-no" title="statement not covered" >            appIdKey = appDict.id;</span>
<span class="cstat-no" title="statement not covered" >            pageDict = dict;</span>
...
&nbsp;
          case 53:
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 59;</span>
<span class="cstat-no" title="statement not covered" >            break;</span>
&nbsp;
          case 55:
<span class="cstat-no" title="statement not covered" >            context$2$0.prev = 55;</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.t0 = context$2$0['catch'](41);</span>
<span class="cstat-no" title="statement not covered" >            _didIteratorError6 = true;</span>
<span class="cstat-no" title="statement not covered" >            _iteratorError6 = context$2$0.t0;</span>
&nbsp;
          case 59:
<span class="cstat-no" title="statement not covered" >            context$2$0.prev = 59;</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.prev = 60;</span>
&nbsp;
...
&nbsp;
          case 62:
<span class="cstat-no" title="statement not covered" >            context$2$0.prev = 62;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (!_didIteratorError6) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 65;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
            }
&nbsp;
...
&nbsp;
          case 65:
<span class="cstat-no" title="statement not covered" >            return context$2$0.finish(62);</span>
&nbsp;
          case 66:
<span class="cstat-no" title="statement not covered" >            return context$2$0.finish(59);</span>
&nbsp;
          case 67:
<span class="cstat-no" title="statement not covered" >            _iteratorNormalCompletion5 = true;</span>
...
&nbsp;
          case 70:
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 76;</span>
<span class="cstat-no" title="statement not covered" >            break;</span>
&nbsp;
          case 72:
<span class="cstat-no" title="statement not covered" >            context$2$0.prev = 72;</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.t1 = context$2$0['catch'](32);</span>
<span class="cstat-no" title="statement not covered" >            _didIteratorError5 = true;</span>
<span class="cstat-no" title="statement not covered" >            _iteratorError5 = context$2$0.t1;</span>
&nbsp;
          case 76:
<span class="cstat-no" title="statement not covered" >            context$2$0.prev = 76;</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.prev = 77;</span>
&nbsp;
...
&nbsp;
          case 79:
<span class="cstat-no" title="statement not covered" >            context$2$0.prev = 79;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (!_didIteratorError5) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 82;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
            }
&nbsp;
...
&nbsp;
          case 82:
<span class="cstat-no" title="statement not covered" >            return context$2$0.finish(79);</span>
&nbsp;
          case 83:
<span class="cstat-no" title="statement not covered" >            return context$2$0.finish(76);</span>
&nbsp;
          case 84:
<span class="cstat-no" title="statement not covered" >            if (found) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Received app, but expected url (\'' + currentUrl + '\') was not found. Trying again.');</span>
<span class="cstat-no" title="statement not covered" >            pageDict = null;</span>
<span class="cstat-no" title="statement not covered" >            return context$2$0.abrupt('continue', 94);</span>
&nbsp;
          case 88:
<span class="cstat-no" title="statement not covered" >            return context$2$0.abrupt('break', 114);</span>
&nbsp;
          case 91:
<span class="cstat-no" title="statement not covered" >            context$2$0.prev = 91;</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.t2 = context$2$0['catch'](16);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Error checking application: \'' + context$2$0.t2 + '\'. Retrying connection');</span>
&nbsp;
          case 94:
<span class="cstat-no" title="statement not covered" >            _iteratorNormalCompletion4 = true;</span>
...
&nbsp;
          case 97:
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 103;</span>
<span class="cstat-no" title="statement not covered" >            break;</span>
&nbsp;
          case 99:
<span class="cstat-no" title="statement not covered" >            context$2$0.prev = 99;</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.t3 = context$2$0['catch'](12);</span>
<span class="cstat-no" title="statement not covered" >            _didIteratorError4 = true;</span>
<span class="cstat-no" title="statement not covered" >            _iteratorError4 = context$2$0.t3;</span>
&nbsp;
          case 103:
<span class="cstat-no" title="statement not covered" >            context$2$0.prev = 103;</span>
...
&nbsp;
          case 106:
<span class="cstat-no" title="statement not covered" >            context$2$0.prev = 106;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (!_didIteratorError4) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 109;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
            }
&nbsp;
...
&nbsp;
          case 109:
<span class="cstat-no" title="statement not covered" >            return context$2$0.finish(106);</span>
&nbsp;
          case 110:
<span class="cstat-no" title="statement not covered" >            return context$2$0.finish(103);</span>
&nbsp;
          case 111:
...
<span class="cstat-no" title="statement not covered" >            if (!pageDict) {</span>
<span class="cstat-no" title="statement not covered" >              _logger2['default'].errorAndThrow('Could not connect to a valid app after ' + maxTries + ' tries.');</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (this.appIdKey !== appIdKey) {</span>
<span class="cstat-no" title="statement not covered" >              _logger2['default'].debug('Received altered app id, updating from \'' + this.appIdKey + '\' to \'' + appIdKey + '\'');</span>
<span class="cstat-no" title="statement not covered" >              this.appIdKey = appIdKey;</span>
            }
&nbsp;
            // set the callback for getting a listing to the page change callback
<span class="cstat-no" title="statement not covered" >            this.rpcClient.setSpecialMessageHandler('_rpc_forwardGetListing:', null, this.onPageChange.bind(this));</span>
&nbsp;
            // wait for all the promises are back, or 30s passes
<span class="cstat-no" title="statement not covered" >            pagePromises = _Object$values(this.appDict).filter(<span class="fstat-no" title="function not covered" >function (app) {</span></span>
<span class="cstat-no" title="statement not covered" >              return !!app.pageDict &amp;&amp; !!app.pageDict.promise;</span>
            }).map(<span class="fstat-no" title="function not covered" >function (app) {</span>
<span class="cstat-no" title="statement not covered" >              return app.pageDict.promise;</span>
            });
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (!pagePromises.length) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 122;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Waiting for ' + pagePromises.length + ' pages to be fulfilled');</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 122;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(_bluebird2['default'].any([_bluebird2['default'].delay(30000), _bluebird2['default'].all(pagePromises)]));</span>
&nbsp;
          case 122:
<span class="cstat-no" title="statement not covered" >            pageArray = (0, _helpers.pageArrayFromDict)(pageDict);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Finally selecting app ' + this.appIdKey + ': ' + (0, _helpers.simpleStringify)(pageArray));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            fullPageArray = [];</span>
<span class="cstat-no" title="statement not covered" >            _iteratorNormalCompletion7 = true;</span>
<span class="cstat-no" title="statement not covered" >            _didIteratorError7 = false;</span>
<span class="cstat-no" title="statement not covered" >            _iteratorError7 = undefined;</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.prev = 128;</span>
<span class="cstat-no" title="statement not covered" >            _iterator7 = _getIterator(_lodash2['default'].toPairs(this.appDict));</span>
&nbsp;
          case 130:
<span class="cstat-no" title="statement not covered" >            if (_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 159;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            _step7$value = _slicedToArray(_step7.value, 2);</span>
<span class="cstat-no" title="statement not covered" >            app = _step7$value[0];</span>
<span class="cstat-no" title="statement not covered" >            info = _step7$value[1];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (_lodash2['default'].isArray(info.pageDict)) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 136;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            return context$2$0.abrupt('continue', 156);</span>
&nbsp;
          case 136:
<span class="cstat-no" title="statement not covered" >            id = app.replace('PID:', '');</span>
<span class="cstat-no" title="statement not covered" >            _iteratorNormalCompletion8 = true;</span>
<span class="cstat-no" title="statement not covered" >            _didIteratorError8 = false;</span>
<span class="cstat-no" title="statement not covered" >            _iteratorError8 = undefined;</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.prev = 140;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            for (_iterator8 = _getIterator(info.pageDict); !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {</span>
<span class="cstat-no" title="statement not covered" >              page = _step8.value;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >              if (page.url &amp;&amp; (!ignoreAboutBlankUrl || page.url !== 'about:blank') &amp;&amp; (!currentUrl || page.url === currentUrl)) {</span>
<span class="cstat-no" title="statement not covered" >                _pageDict = _lodash2['default'].clone(page);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                _pageDict.id = id + '.' + _pageDict.id;</span>
<span class="cstat-no" title="statement not covered" >                fullPageArray.push(_pageDict);</span>
              }
            }
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 148;</span>
<span class="cstat-no" title="statement not covered" >            break;</span>
&nbsp;
          case 144:
<span class="cstat-no" title="statement not covered" >            context$2$0.prev = 144;</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.t4 = context$2$0['catch'](140);</span>
<span class="cstat-no" title="statement not covered" >            _didIteratorError8 = true;</span>
<span class="cstat-no" title="statement not covered" >            _iteratorError8 = context$2$0.t4;</span>
&nbsp;
          case 148:
<span class="cstat-no" title="statement not covered" >            context$2$0.prev = 148;</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.prev = 149;</span>
&nbsp;
...
&nbsp;
          case 151:
<span class="cstat-no" title="statement not covered" >            context$2$0.prev = 151;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (!_didIteratorError8) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 154;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
            }
&nbsp;
...
&nbsp;
          case 154:
<span class="cstat-no" title="statement not covered" >            return context$2$0.finish(151);</span>
&nbsp;
          case 155:
<span class="cstat-no" title="statement not covered" >            return context$2$0.finish(148);</span>
&nbsp;
          case 156:
<span class="cstat-no" title="statement not covered" >            _iteratorNormalCompletion7 = true;</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 130;</span>
<span class="cstat-no" title="statement not covered" >            break;</span>
&nbsp;
          case 159:
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 165;</span>
<span class="cstat-no" title="statement not covered" >            break;</span>
&nbsp;
          case 161:
<span class="cstat-no" title="statement not covered" >            context$2$0.prev = 161;</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.t5 = context$2$0['catch'](128);</span>
<span class="cstat-no" title="statement not covered" >            _didIteratorError7 = true;</span>
<span class="cstat-no" title="statement not covered" >            _iteratorError7 = context$2$0.t5;</span>
&nbsp;
          case 165:
<span class="cstat-no" title="statement not covered" >            context$2$0.prev = 165;</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.prev = 166;</span>
&nbsp;
...
&nbsp;
          case 168:
<span class="cstat-no" title="statement not covered" >            context$2$0.prev = 168;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (!_didIteratorError7) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 171;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
            }
&nbsp;
...
&nbsp;
          case 171:
<span class="cstat-no" title="statement not covered" >            return context$2$0.finish(168);</span>
&nbsp;
          case 172:
<span class="cstat-no" title="statement not covered" >            return context$2$0.finish(165);</span>
&nbsp;
          case 173:
<span class="cstat-no" title="statement not covered" >            return context$2$0.abrupt('return', fullPageArray);</span>
&nbsp;
          case 174:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    key: 'selectPage',
    value: <span class="fstat-no" title="function not covered" >function selectPage(appIdKey, pageIdKey) {</span>
<span class="cstat-no" title="statement not covered" >      var skipReadyCheck = arguments.length &lt;= 2 || arguments[2] === undefined ? false : arguments[2];</span>
<span class="cstat-no" title="statement not covered" >      var ready;</span>
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function selectPage$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            this.appIdKey = 'PID:' + appIdKey;</span>
<span class="cstat-no" title="statement not covered" >            this.pageIdKey = pageIdKey;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Selecting page \'' + pageIdKey + '\' on app \'' + this.appIdKey + '\' and forwarding socket setup');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 5;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.rpcClient.send('setSenderKey', {</span>
              appIdKey: this.appIdKey,
              pageIdKey: this.pageIdKey
            }));
&nbsp;
          case 5:
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Sender key set');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 8;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.rpcClient.send('enablePage', {</span>
              appIdKey: this.appIdKey,
              pageIdKey: this.pageIdKey,
...
&nbsp;
          case 8:
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Enabled activity on page');</span>
&nbsp;
            // make sure everything is ready to go
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 11;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.checkPageIsReady());</span>
&nbsp;
          case 11:
<span class="cstat-no" title="statement not covered" >            ready = context$2$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (!(!skipReadyCheck &amp;&amp; !ready)) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 15;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 15;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.pageUnload());</span>
&nbsp;
          case 15:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    key: 'executeAtom',
    value: <span class="fstat-no" title="function not covered" >function executeAtom(atom, args, frames) {</span>
<span class="cstat-no" title="statement not covered" >      var script, value;</span>
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function executeAtom$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            if (this.rpcClient.connected) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            throw new Error('Remote debugger is not connected');</span>
&nbsp;
          case 2:
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 4;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap((0, _helpers.getScriptForAtom)(atom, args, frames));</span>
&nbsp;
          case 4:
<span class="cstat-no" title="statement not covered" >            script = context$2$0.sent;</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 7;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.execute(script, true));</span>
&nbsp;
          case 7:
<span class="cstat-no" title="statement not covered" >            value = context$2$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Received result for atom \'' + atom + '\' execution: ' + (0, _helpers.simpleStringify)(value));</span>
<span class="cstat-no" title="statement not covered" >            return context$2$0.abrupt('return', value);</span>
&nbsp;
          case 10:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    value: <span class="fstat-no" title="function not covered" >function executeAtomAsync(atom, args, frames, responseUrl) {</span>
<span class="cstat-no" title="statement not covered" >      var asyncCallBack, script;</span>
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function executeAtomAsync$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            asyncCallBack = 'function (res) { xmlHttp = new XMLHttpRequest(); ' + ('xmlHttp.open(\'POST\', \'' + responseUrl + '\', true);') + 'xmlHttp.setRequestHeader(\'Content-type\',\'application/json\'); ' + 'xmlHttp.send(res); }';</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 3;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap((0, _helpers.getScriptForAtom)(atom, args, frames, asyncCallBack));</span>
&nbsp;
          case 3:
<span class="cstat-no" title="statement not covered" >            script = context$2$0.sent;</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 6;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.execute(script));</span>
&nbsp;
          case 6:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    key: 'pageLoad',
    value: <span class="fstat-no" title="function not covered" >function pageLoad(startPageLoadMs) {</span>
<span class="cstat-no" title="statement not covered" >      var timeoutMs, start, verify;</span>
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function pageLoad$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >        var _this2 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            timeoutMs = 500;</span>
<span class="cstat-no" title="statement not covered" >            start = startPageLoadMs || Date.now();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Page loaded, verifying whether ready');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            verify = <span class="fstat-no" title="function not covered" >function verify() {</span></span>
<span class="cstat-no" title="statement not covered" >              var ready;</span>
<span class="cstat-no" title="statement not covered" >              return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function verify$(context$3$0) {</span></span>
<span class="cstat-no" title="statement not covered" >                while (1) <span class="cstat-no" title="statement not covered" >switch (context$3$0.prev = context$3$0.next) {</span></span>
                  case 0:
<span class="cstat-no" title="statement not covered" >                    this.pageLoadDelay = _appiumSupport.util.cancellableDelay(timeoutMs);</span>
...
<span class="cstat-no" title="statement not covered" >                    return _regeneratorRuntime.awrap(this.pageLoadDelay);</span>
&nbsp;
                  case 4:
<span class="cstat-no" title="statement not covered" >                    context$3$0.next = 10;</span>
<span class="cstat-no" title="statement not covered" >                    break;</span>
&nbsp;
                  case 6:
<span class="cstat-no" title="statement not covered" >                    context$3$0.prev = 6;</span>
<span class="cstat-no" title="statement not covered" >                    context$3$0.t0 = context$3$0['catch'](1);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                    if (!(context$3$0.t0 instanceof _bluebird2['default'].CancellationError)) {</span>
<span class="cstat-no" title="statement not covered" >                      context$3$0.next = 10;</span>
<span class="cstat-no" title="statement not covered" >                      break;</span>
                    }
&nbsp;
<span class="cstat-no" title="statement not covered" >                    return context$3$0.abrupt('return');</span>
&nbsp;
                  case 10:
<span class="cstat-no" title="statement not covered" >                    if (this.appIdKey) {</span>
<span class="cstat-no" title="statement not covered" >                      context$3$0.next = 13;</span>
<span class="cstat-no" title="statement not covered" >                      break;</span>
                    }
&nbsp;
<span class="cstat-no" title="statement not covered" >                    _logger2['default'].debug('Not connected to an application. Ignoring page load');</span>
<span class="cstat-no" title="statement not covered" >                    return context$3$0.abrupt('return');</span>
&nbsp;
                  case 13:
<span class="cstat-no" title="statement not covered" >                    context$3$0.next = 15;</span>
<span class="cstat-no" title="statement not covered" >                    return _regeneratorRuntime.awrap(this.checkPageIsReady());</span>
&nbsp;
                  case 15:
<span class="cstat-no" title="statement not covered" >                    ready = context$3$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                    if (!(ready || this.pageLoadMs &gt; 0 &amp;&amp; start + this.pageLoadMs &lt; Date.now())) {</span>
<span class="cstat-no" title="statement not covered" >                      context$3$0.next = 21;</span>
<span class="cstat-no" title="statement not covered" >                      break;</span>
                    }
&nbsp;
<span class="cstat-no" title="statement not covered" >                    _logger2['default'].debug('Page is ready');</span>
<span class="cstat-no" title="statement not covered" >                    this.pageLoading = false;</span>
<span class="cstat-no" title="statement not covered" >                    context$3$0.next = 24;</span>
<span class="cstat-no" title="statement not covered" >                    break;</span>
&nbsp;
                  case 21:
<span class="cstat-no" title="statement not covered" >                    _logger2['default'].debug('Page was not ready, retrying');</span>
<span class="cstat-no" title="statement not covered" >                    context$3$0.next = 24;</span>
<span class="cstat-no" title="statement not covered" >                    return _regeneratorRuntime.awrap(verify());</span>
&nbsp;
                  case 24:
                  case 'end':
...
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    key: 'cancelPageLoad',
    value: <span class="fstat-no" title="function not covered" >function cancelPageLoad() {</span>
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function cancelPageLoad$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Unregistering from page readiness notifications');</span>
<span class="cstat-no" title="statement not covered" >            this.pageLoading = false;</span>
<span class="cstat-no" title="statement not covered" >            if (this.pageLoadDelay) {</span>
<span class="cstat-no" title="statement not covered" >              this.pageLoadDelay.cancel();</span>
            }
&nbsp;
          case 3:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    key: 'pageUnload',
    value: <span class="fstat-no" title="function not covered" >function pageUnload() {</span>
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function pageUnload$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Page unloading');</span>
<span class="cstat-no" title="statement not covered" >            this.pageLoading = true;</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 4;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.waitForDom());</span>
&nbsp;
          case 4:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    key: 'waitForDom',
    value: <span class="fstat-no" title="function not covered" >function waitForDom(startPageLoadMs) {</span>
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function waitForDom$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Waiting for dom...');</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 3;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.pageLoad(startPageLoadMs));</span>
&nbsp;
          case 3:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    value: <span class="fstat-no" title="function not covered" >function checkPageIsReady() {</span>
<span class="cstat-no" title="statement not covered" >      var errors, readyCmd, readyState;</span>
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function checkPageIsReady$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            errors = (0, _helpers.checkParams)({ appIdKey: this.appIdKey });</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            throw new Error(errors);</span>
&nbsp;
          case 3:
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Checking document readyState');</span>
<span class="cstat-no" title="statement not covered" >            readyCmd = '(function (){ return document.readyState; })()';</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 7;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.execute(readyCmd, true));</span>
&nbsp;
          case 7:
<span class="cstat-no" title="statement not covered" >            readyState = context$2$0.sent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('readyState was ' + (0, _helpers.simpleStringify)(readyState));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            return context$2$0.abrupt('return', readyState === 'complete');</span>
&nbsp;
          case 10:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    key: 'navToUrl',
    value: <span class="fstat-no" title="function not covered" >function navToUrl(url) {</span>
<span class="cstat-no" title="statement not covered" >      var _errors;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function navToUrl$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            if (!(this.debuggerType === DEBUGGER_TYPES.webinspector)) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 4;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            _errors = (0, _helpers.checkParams)({ appIdKey: this.appIdKey, pageIdKey: this.pageIdKey });</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (!_errors) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 4;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            throw new Error(_errors);</span>
&nbsp;
          case 4:
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Navigating to new URL: ' + url);</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 7;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.rpcClient.send('setUrl', {</span>
              url: url,
              appIdKey: this.appIdKey,
              pageIdKey: this.pageIdKey,
              debuggerType: this.debuggerType
...
&nbsp;
          case 7:
<span class="cstat-no" title="statement not covered" >            if (this.useNewSafari) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 13;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.waitForFrameNavigated());</span>
&nbsp;
          case 13:
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 15;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.waitForDom(Date.now()));</span>
&nbsp;
          case 15:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    value: <span class="fstat-no" title="function not covered" >function waitForFrameNavigated() {</span>
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function waitForFrameNavigated$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >        var _this4 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            return context$2$0.abrupt('return', new _bluebird2['default'](<span class="fstat-no" title="function not covered" >function callee$2$0(resolve, reject) {</span></span>
<span class="cstat-no" title="statement not covered" >              var startMs, navEventListener, timeout;</span>
...
<span class="cstat-no" title="statement not covered" >                while (1) <span class="cstat-no" title="statement not covered" >switch (context$3$0.prev = context$3$0.next) {</span></span>
                  case 0:
<span class="cstat-no" title="statement not covered" >                    _logger2['default'].debug('Waiting for frame navigated message...');</span>
<span class="cstat-no" title="statement not covered" >                    startMs = Date.now();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                    navEventListener = <span class="fstat-no" title="function not covered" >function navEventListener(value) {</span></span>
<span class="cstat-no" title="statement not covered" >                      _logger2['default'].debug('Frame navigated in ' + (Date.now() - startMs) / 1000 + ' sec from source: ' + value);</span>
<span class="cstat-no" title="statement not covered" >                      if (_this3.navigationDelay) {</span>
<span class="cstat-no" title="statement not covered" >                        _this3.navigationDelay.cancel();</span>
                      }
<span class="cstat-no" title="statement not covered" >                      resolve(value);</span>
                    };
&nbsp;
<span class="cstat-no" title="statement not covered" >                    this.rpcClient.setSpecialMessageHandler('Page.frameNavigated', reject, navEventListener);</span>
&nbsp;
                    // timeout, in case remote debugger doesn't respond,
                    // or takes a long time
&nbsp;
<span class="cstat-no" title="statement not covered" >                    if (!(!this.useNewSafari || this.pageLoadMs &gt;= 0)) {</span>
<span class="cstat-no" title="statement not covered" >                      context$3$0.next = 15;</span>
<span class="cstat-no" title="statement not covered" >                      break;</span>
                    }
&nbsp;
<span class="cstat-no" title="statement not covered" >                    timeout = this.useNewSafari ? this.pageLoadMs : 500;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                    this.navigationDelay = _appiumSupport.util.cancellableDelay(timeout);</span>
<span class="cstat-no" title="statement not covered" >                    context$3$0.prev = 7;</span>
<span class="cstat-no" title="statement not covered" >                    context$3$0.next = 10;</span>
<span class="cstat-no" title="statement not covered" >                    return _regeneratorRuntime.awrap(this.navigationDelay);</span>
&nbsp;
                  case 10:
<span class="cstat-no" title="statement not covered" >                    navEventListener('timeout');</span>
<span class="cstat-no" title="statement not covered" >                    context$3$0.next = 15;</span>
<span class="cstat-no" title="statement not covered" >                    break;</span>
&nbsp;
                  case 13:
<span class="cstat-no" title="statement not covered" >                    context$3$0.prev = 13;</span>
<span class="cstat-no" title="statement not covered" >                    context$3$0.t0 = context$3$0['catch'](7);</span>
&nbsp;
                  case 15:
                  case 'end':
<span class="cstat-no" title="statement not covered" >                    return context$3$0.stop();</span>
...
&nbsp;
    ...
    // was cancelled
    value: <span class="fstat-no" title="function not covered" >function startTimeline(fn) {</span>
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function startTimeline$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Starting to record the timeline');</span>
<span class="cstat-no" title="statement not covered" >            this.rpcClient.setTimelineEventHandler(fn);</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 4;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.rpcClient.send('startTimeline', {</span>
              appIdKey: this.appIdKey,
              pageIdKey: this.pageIdKey,
              debuggerType: this.debuggerType
            }));
...
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    key: 'stopTimeline',
    value: <span class="fstat-no" title="function not covered" >function stopTimeline() {</span>
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function stopTimeline$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Stopping to record the timeline');</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 3;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.rpcClient.send('stopTimeline', {</span>
              appIdKey: this.appIdKey,
              pageIdKey: this.pageIdKey,
              debuggerType: this.debuggerType
            }));
...
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    key: 'execute',
    value: <span class="fstat-no" title="function not covered" >function execute(command, override) {</span>
<span class="cstat-no" title="statement not covered" >      var _errors2, res;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function execute$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            if (!(this.pageLoading &amp;&amp; !override)) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 4;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Trying to execute but page is not loaded.');</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 4;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.waitForDom());</span>
&nbsp;
          case 4:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            _errors2 = (0, _helpers.checkParams)({ appIdKey: this.appIdKey, pageIdKey: this.pageIdKey });</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (!_errors2) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 8;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            throw new Error(_errors2);</span>
&nbsp;
          case 8:
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Sending javascript command ' + _lodash2['default'].truncate(command, { length: 50 }));</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 11;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.rpcClient.send('sendJSCommand', {</span>
              command: command,
              appIdKey: this.appIdKey,
              pageIdKey: this.pageIdKey,
              debuggerType: this.debuggerType
...
<span class="cstat-no" title="statement not covered" >            return context$2$0.abrupt('return', this.convertResult(res));</span>
&nbsp;
          case 13:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    key: 'callFunction',
    value: <span class="fstat-no" title="function not covered" >function callFunction(objId, fn, args) {</span>
<span class="cstat-no" title="statement not covered" >      var errors, res;</span>
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callFunction$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            errors = (0, _helpers.checkParams)({ appIdKey: this.appIdKey, pageIdKey: this.pageIdKey });</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (!errors) {</span>
<span class="cstat-no" title="statement not covered" >              context$2$0.next = 3;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
...
&nbsp;
          case 3:
&nbsp;
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('Calling javascript function');</span>
<span class="cstat-no" title="statement not covered" >            context$2$0.next = 6;</span>
<span class="cstat-no" title="statement not covered" >            return _regeneratorRuntime.awrap(this.rpcClient.send('callJSFunction', {</span>
              objId: objId,
              fn: fn,
              args: args,
              appIdKey: this.appIdKey,
...
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
    ...
    key: 'convertResult',
    value: <span class="fstat-no" title="function not covered" >function convertResult(res) {</span>
<span class="cstat-no" title="statement not covered" >      if (_lodash2['default'].isUndefined(res)) {</span>
<span class="cstat-no" title="statement not covered" >        throw new Error('Did not get OK result from remote debugger. Result was: ' + (0, _helpers.simpleStringify)(res));</span>
      } else <span class="cstat-no" title="statement not covered" >if (_lodash2['default'].isString(res)) {</span>
<span class="cstat-no" title="statement not covered" >        try {</span>
<span class="cstat-no" title="statement not covered" >          res = JSON.parse(res);</span>
      ...
      } else <span class="cstat-no" title="statement not covered" >if (!_lodash2['default'].isObject(res)) {</span>
<span class="cstat-no" title="statement not covered" >          throw new Error('Result has unexpected type: (' + typeof res + ').');</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (res.status &amp;&amp; res.status !== 0) {</span>
        // we got some form of error.
<span class="cstat-no" title="statement not covered" >        var message = res.value.message || res.value;</span>
<span class="cstat-no" title="statement not covered" >        throw new _appiumBaseDriver.errors.JavaScriptError(message + ' (status: ' + res.status + ')');</span>
      }
&nbsp;
      // with either have an object with a `value` property (even if `null`),
      // or a plain object
<span class="cstat-no" title="statement not covered" >      return res.hasOwnProperty('value') ? res.value : res;</span>
    }
  }, {
    key: 'allowNavigationWithoutReload',
    value: <span class="fstat-no" title="function not covered" >function allowNavigationWithoutReload() {</span>
<span class="cstat-no" title="statement not covered" >      var allow = arguments.length &lt;= 0 || arguments[0] === undefined ? true : arguments[0];</span>
<span class="cstat-no" title="statement not covered" >      return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function allowNavigationWithoutReload$(context$2$0) {</span></span>
<span class="cstat-no" title="statement not covered" >        while (1) <span class="cstat-no" title="statement not covered" >switch (context$2$0.prev = context$2$0.next) {</span></span>
          case 0:
<span class="cstat-no" title="statement not covered" >            this.rpcClient.allowNavigationWithoutReload(allow);</span>
&nbsp;
          case 1:
          case 'end':
<span class="cstat-no" title="statement not covered" >            return context$2$0.stop();</span>
...
<span class="cstat-no" title="statement not covered" >  _iteratorError9 = err;</span>
  ...
  try {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!_iteratorNormalCompletion9 &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >_iterator9['return'])</span> {
<span class="cstat-no" title="statement not covered" >      _iterator9['return']();</span>
    }
  } finally {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (_didIteratorError9) {
