...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-uiauto/build/lib/uiauto-response.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-uiauto/build/lib/uiauto-response.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-uiauto/build/lib/</a> &#187; uiauto-response.js</div>
</div>
<div class="body">
...
<span class="fstat-no" title="function not covered" >  function UIAutoResponse() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, UIAutoResponse);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.bufferedData = '';</span>
<span class="cstat-no" title="statement not covered" >    this.resultBuffer = '';</span>
  }
&nbsp;
  _createClass(UIAutoResponse, [{
    key: 'resetBuffer',
    value: <span class="fstat-no" title="function not covered" >function resetBuffer() {</span>
<span class="cstat-no" title="statement not covered" >      this.bufferedData = '';</span>
    }
  }, {
    key: 'addData',
    value: <span class="fstat-no" title="function not covered" >function addData(data) {</span>
<span class="cstat-no" title="statement not covered" >      this.bufferedData += data;</span>
    }
  }, {
    key: 'finalizeData',
    value: <span class="fstat-no" title="function not covered" >function finalizeData() {</span>
<span class="cstat-no" title="statement not covered" >      var data = this.bufferedData;</span>
<span class="cstat-no" title="statement not covered" >      this.bufferedData = '';</span>
&nbsp;
      // try to figure out what type of data we have, and return it
<span class="cstat-no" title="statement not covered" >      var parsedData = undefined;</span>
<span class="cstat-no" title="statement not covered" >      try {</span>
<span class="cstat-no" title="statement not covered" >        parsedData = {</span>
          type: MESSAGE_TYPES[parseInt(data[0], 10)]
        };
<span class="cstat-no" title="statement not covered" >        if (parsedData.type !== 'no data') {</span>
          // format is &lt;one char message type&gt;,&lt;DATA&gt;
<span class="cstat-no" title="statement not covered" >          parsedData.result = data.substring(2);</span>
        }
      } catch (err) {
<span class="cstat-no" title="statement not covered" >        _logger2['default'].error('Could not parse data from socket: ' + err);</span>
<span class="cstat-no" title="statement not covered" >        _logger2['default'].error(data);</span>
<span class="cstat-no" title="statement not covered" >        parsedData = {</span>
          type: 'error',
          error: UNKNOWN_ERROR
        };
...
<span class="cstat-no" title="statement not covered" >      return parsedData;</span>
    ...
    key: 'getResult',
    value: <span class="fstat-no" title="function not covered" >function getResult() {</span>
<span class="cstat-no" title="statement not covered" >      var data = this.finalizeData();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (!_lodash2['default'].isUndefined(data.result) &amp;&amp; data.result !== false) {</span>
        // we have a result, try to make use of it
<span class="cstat-no" title="statement not covered" >        if (data.result) {</span>
<span class="cstat-no" title="statement not covered" >          _logger2['default'].debug('Got result from instruments: ' + data.result.slice(0, 300));</span>
        } else {
<span class="cstat-no" title="statement not covered" >          _logger2['default'].debug('Got null result from instruments');</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (data.type &amp;&amp; data.type.indexOf('chunk') !== -1) {</span>
          // a "chunk" of data, so add to our buffer
<span class="cstat-no" title="statement not covered" >          this.resultBuffer += data.result;</span>
<span class="cstat-no" title="statement not covered" >          _logger2['default'].debug('Got chunk data, current resultBuffer length: ' + this.resultBuffer.length);</span>
<span class="cstat-no" title="statement not covered" >          if (data.type === 'last chunk') {</span>
<span class="cstat-no" title="statement not covered" >            _logger2['default'].debug('This is the last data final length: ' + this.resultBuffer.length);</span>
            // this is the last row, unpack and return response
<span class="cstat-no" title="statement not covered" >            var result = undefined;</span>
<span class="cstat-no" title="statement not covered" >            try {</span>
<span class="cstat-no" title="statement not covered" >              result = JSON.parse(this.resultBuffer);</span>
            } catch (err) {
<span class="cstat-no" title="statement not covered" >              _logger2['default'].error('Could not parse result buffer: ' + err);</span>
<span class="cstat-no" title="statement not covered" >              result = UNKNOWN_ERROR;</span>
            }
<span class="cstat-no" title="statement not covered" >            this.resultBuffer = '';</span>
...
<span class="cstat-no" title="statement not covered" >          var result = undefined;</span>
<span class="cstat-no" title="statement not covered" >          try {</span>
<span class="cstat-no" title="statement not covered" >            result = JSON.parse(data.result);</span>
          } catch (err) {
<span class="cstat-no" title="statement not covered" >            _logger2['default'].error('Could not parse result buffer: ' + err);</span>
<span class="cstat-no" title="statement not covered" >            result = UNKNOWN_ERROR;</span>
          }
