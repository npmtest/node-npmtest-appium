...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-fake-driver/build/lib/commands/element.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-fake-driver/build/lib/commands/element.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">22.66% <small>(29 / 128)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-fake-driver/build/lib/commands/</a> &#187; element.js</div>
</div>
<div class="body">
...
var commands = {},
    ...
    extensions = {};
&nbsp;
helpers.getElements = <span class="fstat-no" title="function not covered" >function (elIds) {</span>
...
<span class="cstat-no" title="statement not covered" >    for (var _iterator = _getIterator(elIds), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {</span>
<span class="cstat-no" title="statement not covered" >      var elId = _step.value;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (!_lodash2['default'].has(this.elMap, elId)) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  return elIds.map(<span class="fstat-no" title="function not covered" >function (e) {</span></span>
<span class="cstat-no" title="statement not covered" >    return _this.elMap[e];</span>
  });
};
&nbsp;
helpers.getElement = <span class="fstat-no" title="function not covered" >function (elId) {</span>
<span class="cstat-no" title="statement not covered" >  return this.getElements([elId])[0];</span>
};
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', el.tagName);</span>
&nbsp;
      case 2:
      case 'end':
...
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        el = this.getElement(elementId);</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', el.isVisible());</span>
&nbsp;
      case 2:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        el = this.getElement(elementId);</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', el.isEnabled());</span>
&nbsp;
      case 2:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        el = this.getElement(elementId);</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', el.isSelected());</span>
&nbsp;
      case 2:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
<span class="cstat-no" title="statement not covered" >  var value, el;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        value = keys;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (keys instanceof Array) {</span>
<span class="cstat-no" title="statement not covered" >          value = keys.join("");</span>
        }
<span class="cstat-no" title="statement not covered" >        el = this.getElement(elementId);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!(el.type !== "MockInputField")) {</span>
...
&nbsp;
      case 5:
<span class="cstat-no" title="statement not covered" >        el.setAttr('value', value);</span>
&nbsp;
      case 6:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        el = this.getElement(elementId);</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', el.getAttr('value'));</span>
&nbsp;
      case 2:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(this.setValue('', elementId));</span>
&nbsp;
      case 2:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        this.assertNoAlert();</span>
<span class="cstat-no" title="statement not covered" >        el = this.getElement(elementId);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (el.isVisible()) {</span>
...
&nbsp;
      case 4:
<span class="cstat-no" title="statement not covered" >        el.click();</span>
<span class="cstat-no" title="statement not covered" >        this.focusedElId = elementId;</span>
&nbsp;
      case 6:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
commands.getAttribute = <span class="fstat-no" title="function not covered" >function callee$0$0(attr, elementId) {</span>
<span class="cstat-no" title="statement not covered" >  var el;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        el = this.getElement(elementId);</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', el.getAttr(attr));</span>
&nbsp;
      case 2:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
...
&nbsp;
commands.getLocation = <span class="fstat-no" title="function not covered" >function (elementId) {</span>
<span class="cstat-no" title="statement not covered" >  var el = this.getElement(elementId);</span>
<span class="cstat-no" title="statement not covered" >  return el.getLocation();</span>
};
&nbsp;
commands.getSize = <span class="fstat-no" title="function not covered" >function (elementId) {</span>
<span class="cstat-no" title="statement not covered" >  var el = this.getElement(elementId);</span>
<span class="cstat-no" title="statement not covered" >  return el.getSize();</span>
};
&nbsp;
commands.equalsElement = <span class="fstat-no" title="function not covered" >function (el1Id, el2Id) {</span>
<span class="cstat-no" title="statement not covered" >  var el1 = this.getElement(el1Id);</span>
<span class="cstat-no" title="statement not covered" >  var el2 = this.getElement(el2Id);</span>
<span class="cstat-no" title="statement not covered" >  return el1.equals(el2);</span>
};
&nbsp;
commands.getLocationInView = commands.getLocation;
&nbsp;
commands.getCssProperty = <span class="fstat-no" title="function not covered" >function callee$0$0(prop, elementId) {</span>
<span class="cstat-no" title="statement not covered" >  var el;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function callee$0$0$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
...
<span class="cstat-no" title="statement not covered" >        el = this.getElement(elementId);</span>
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', el.getCss(prop));</span>
&nbsp;
      case 3:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
