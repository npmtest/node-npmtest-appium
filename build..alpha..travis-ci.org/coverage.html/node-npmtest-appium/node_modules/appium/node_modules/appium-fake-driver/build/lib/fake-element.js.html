...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-fake-driver/build/lib/fake-element.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-fake-driver/build/lib/fake-element.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-fake-driver/build/lib/</a> &#187; fake-element.js</div>
</div>
<div class="body">
...
<span class="fstat-no" title="function not covered" >  function FakeElement(xmlNode, app) {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, FakeElement);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.app = app;</span>
<span class="cstat-no" title="statement not covered" >    this.node = xmlNode;</span>
<span class="cstat-no" title="statement not covered" >    this.nodeAttrs = {};</span>
<span class="cstat-no" title="statement not covered" >    this.type = this.node.tagName;</span>
...
<span class="cstat-no" title="statement not covered" >      for (var _iterator = _getIterator(_lodash2['default'].values(this.node.attributes)), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {</span>
<span class="cstat-no" title="statement not covered" >        var _step$value = _step.value;</span>
<span class="cstat-no" title="statement not covered" >        var _name = _step$value.name;</span>
<span class="cstat-no" title="statement not covered" >        var value = _step$value.value;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        this.nodeAttrs[_name] = value;</span>
      }
    } catch (err) {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.parseCss();</span>
  }
&nbsp;
  _createClass(FakeElement, [{
    key: 'parseCss',
    value: <span class="fstat-no" title="function not covered" >function parseCss() {</span>
<span class="cstat-no" title="statement not covered" >      if (this.nodeAttrs.style) {</span>
<span class="cstat-no" title="statement not covered" >        var segments = this.nodeAttrs.style.split(";");</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        try {</span>
<span class="cstat-no" title="statement not covered" >          for (var _iterator2 = _getIterator(segments), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {</span>
<span class="cstat-no" title="statement not covered" >            var s = _step2.value;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            var _s$split = s.split(":");</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            var _s$split2 = _slicedToArray(_s$split, 2);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            var prop = _s$split2[0];</span>
<span class="cstat-no" title="statement not covered" >            var val = _s$split2[1];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            prop = prop.trim();</span>
<span class="cstat-no" title="statement not covered" >            val = val.trim();</span>
<span class="cstat-no" title="statement not covered" >            this.css[prop] = val;</span>
          }
        } catch (err) {
...
<span class="cstat-no" title="statement not covered" >              throw _iteratorError2;</span>
    ...
    key: 'setAttr',
    value: <span class="fstat-no" title="function not covered" >function setAttr(k, v) {</span>
<span class="cstat-no" title="statement not covered" >      this.attrs[k] = v;</span>
    }
  }, {
    key: 'getAttr',
    value: <span class="fstat-no" title="function not covered" >function getAttr(k) {</span>
<span class="cstat-no" title="statement not covered" >      return this.attrs[k] || "";</span>
    }
  }, {
    key: 'isVisible',
    value: <span class="fstat-no" title="function not covered" >function isVisible() {</span>
<span class="cstat-no" title="statement not covered" >      return this.nodeAttrs.visible !== "false";</span>
    }
  }, {
    key: 'isEnabled',
    value: <span class="fstat-no" title="function not covered" >function isEnabled() {</span>
<span class="cstat-no" title="statement not covered" >      return this.nodeAttrs.enabled !== "false";</span>
    }
  }, {
    key: 'isSelected',
    value: <span class="fstat-no" title="function not covered" >function isSelected() {</span>
<span class="cstat-no" title="statement not covered" >      return this.nodeAttrs.selected === "true";</span>
    }
  }, {
    key: 'getLocation',
    value: <span class="fstat-no" title="function not covered" >function getLocation() {</span>
<span class="cstat-no" title="statement not covered" >      return {</span>
    ...
    key: 'getSize',
    value: <span class="fstat-no" title="function not covered" >function getSize() {</span>
<span class="cstat-no" title="statement not covered" >      return {</span>
    ...
    key: 'click',
    value: <span class="fstat-no" title="function not covered" >function click() {</span>
<span class="cstat-no" title="statement not covered" >      var curClicks = this.getAttr('clicks') || 0;</span>
<span class="cstat-no" title="statement not covered" >      this.setAttr('clicks', curClicks + 1);</span>
<span class="cstat-no" title="statement not covered" >      var alertId = this.nodeAttrs.showAlert;</span>
<span class="cstat-no" title="statement not covered" >      if (alertId) {</span>
<span class="cstat-no" title="statement not covered" >        this.app.showAlert(alertId);</span>
      }
    }
  }, {
    key: 'equals',
    value: <span class="fstat-no" title="function not covered" >function equals(other) {</span>
<span class="cstat-no" title="statement not covered" >      return this.node === other.node;</span>
    }
  }, {
    key: 'hasPrompt',
    value: <span class="fstat-no" title="function not covered" >function hasPrompt() {</span>
<span class="cstat-no" title="statement not covered" >      return this.nodeAttrs.hasPrompt === "true";</span>
    }
  }, {
    key: 'getCss',
    value: <span class="fstat-no" title="function not covered" >function getCss(prop) {</span>
<span class="cstat-no" title="statement not covered" >      if (_lodash2['default'].has(this.css, prop)) {</span>
<span class="cstat-no" title="statement not covered" >        return this.css[prop];</span>
      }
...
<span class="cstat-no" title="statement not covered" >      return this.node.tagName;</span>
    }
  }, {
    key: 'xmlFragment',
    get: <span class="fstat-no" title="function not covered" >function get() {</span>
<span class="cstat-no" title="statement not covered" >      var frag = new _xmldom2['default'].XMLSerializer().serializeToString(this.node);</span>
<span class="cstat-no" title="statement not covered" >      return new _xmldom2['default'].DOMParser().parseFromString(frag, "application/xml");</span>
    }
  }]);
&nbsp;
  return FakeElement;
