...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-appium/node_modules/appium/node_modules/appium-ios-simulator/build/lib/simulator.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-appium/node_modules/appium/node_modules/appium-ios-simulator/build/lib/simulator.js</span></h1>
    <h2>
        
        Statements: <span class="metric">25.93% <small>(21 / 81)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-appium/node_modules/appium/node_modules/appium-ios-simulator/build/lib/</a> &#187; simulator.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >function handleUnsupportedXcode(xcodeVersion) {</span>
<span class="cstat-no" title="statement not covered" >  if (xcodeVersion.major &lt; 6) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('Tried to use an iOS simulator with xcode ' + ('version ' + xcodeVersion.versionString + ' but only Xcode version ') + '6.0.0 and up are supported');</span>
  } else <span class="cstat-no" title="statement not covered" >if (xcodeVersion.major &gt;= 9) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('Xcode version ' + xcodeVersion.versionString + ' is ' + 'not yet supported');</span>
  }
}
&nbsp;
<span class="fstat-no" title="function not covered" >function getSimulator(udid) {</span>
<span class="cstat-no" title="statement not covered" >  var xcodeVersion;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function getSimulator$(context$1$0) {</span></span>
...
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap((0, _utils.simExists)(udid));</span>
&nbsp;
      case 5:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        throw new Error('No sim found with udid ' + udid);</span>
&nbsp;
      case 7:
&nbsp;
<span class="cstat-no" title="statement not covered" >        handleUnsupportedXcode(xcodeVersion);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].info('Constructing iOS simulator for Xcode version ' + xcodeVersion.versionString + ' ' + ('with udid \'' + udid + '\''));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!(xcodeVersion.major === 6)) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', new _simulatorXcode62['default'](udid, xcodeVersion));</span>
&nbsp;
      case 13:
<span class="cstat-no" title="statement not covered" >        if (!(xcodeVersion.major &gt;= 7 &amp;&amp; xcodeVersion.major &lt; 8)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 21;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!(xcodeVersion.minor &lt; 3)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 18;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', new _simulatorXcode72['default'](udid, xcodeVersion));</span>
&nbsp;
      case 18:
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', new _simulatorXcode732['default'](udid, xcodeVersion));</span>
&nbsp;
      case 19:
...
&nbsp;
      case 21:
<span class="cstat-no" title="statement not covered" >        if (!(xcodeVersion.major &gt;= 8)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 23;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', new _simulatorXcode82['default'](udid, xcodeVersion));</span>
&nbsp;
      case 23:
      case 'end':
...
&nbsp;
<span class="fstat-no" title="function not covered" >function getDeviceString(opts) {</span>
<span class="cstat-no" title="statement not covered" >  var xcodeVersion;</span>
<span class="cstat-no" title="statement not covered" >  return _regeneratorRuntime.async(<span class="fstat-no" title="function not covered" >function getDeviceString$(context$1$0) {</span></span>
<span class="cstat-no" title="statement not covered" >    while (1) <span class="cstat-no" title="statement not covered" >switch (context$1$0.prev = context$1$0.next) {</span></span>
      case 0:
<span class="cstat-no" title="statement not covered" >        context$1$0.next = 2;</span>
<span class="cstat-no" title="statement not covered" >        return _regeneratorRuntime.awrap(_appiumXcode2['default'].getVersion(true));</span>
...
<span class="cstat-no" title="statement not covered" >        handleUnsupportedXcode(xcodeVersion);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        _logger2['default'].info('Retrieving device name string for Xcode version ' + xcodeVersion.versionString);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!(xcodeVersion.major === 8)) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', _simulatorXcode72['default'].getDeviceString(opts));</span>
&nbsp;
      case 9:
<span class="cstat-no" title="statement not covered" >        if (!(xcodeVersion.major === 7)) {</span>
<span class="cstat-no" title="statement not covered" >          context$1$0.next = 13;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        return context$1$0.abrupt('return', _simulatorXcode62['default'].getDeviceString(opts));</span>
&nbsp;
      case 15:
      case 'end':
<span class="cstat-no" title="statement not covered" >        return context$1$0.stop();</span>
